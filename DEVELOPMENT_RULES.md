...
| `pytest tests/` | 1490 项测试全绿（2026-09-11 复核；历史基线 945） | ✅ pre-commit |
...
- 仓库 `tests/` 从 v2 时期的 3 个文件增长到 2026-08-28 的 **265 个文件 / 945 个用例**，2026-09-11 已达 **1490 个用例**——A9 是这套增长的核心推手，继续保持"每个新增业务函数至少 1 个失败测试"，逼迫 AI 写可验证的代码。
