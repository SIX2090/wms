...
| 10 | AI-R10 | 下一项 | 仓库角色 AI 工作台整合 | AI-R08 | R16、R17 |
...
开始前必须检查仓库角色工作台、今日待收/待出/待盘/异常库存/文档待确认/失败任务/未完成草稿和业务下钻是否已关联台账任务编号；整合现有 AI 能力到仓库角色单一工作台入口。
