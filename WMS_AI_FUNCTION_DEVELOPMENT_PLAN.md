...
| 9 | AI-R09 | 下一项 | 字段级反馈和文档质量指标 | R03、R08 | R15、R17 |
...
开始前必须检查字段级反馈记录（字段名/原值/新值/修正原因/是否采纳/模型/提示词/Schema 版本）与文档质量指标（按来源与版本聚合准确率和修正率）是否已关联台账任务编号；可定位质量下降的字段和版本，不保存不必要的敏感原文。
