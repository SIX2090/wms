...
| P2 修复 | AI-R07-F02-FIX-01 | 已完成 | 物料编码改为分类三位数字+三位流水（如100001=电线类第1号） | AI-R07-F02 | material_category_coding 规则、专项验证 | 电线2.5平方→分类100→100001；规格进名称/规格字段 | 2026-07-26 | [待提交] | material_category_coding.py、verify_ai_material_category_coding.py | verify PASS | 分类主数据编码须为三位数字 |
