...
| 15 | AI-R15 | 下一项 | 业务质量指标和版本对比 | AI-R09 | R17 |
...
开始前必须检查分类准确率、表头准确率、行召回率、物料匹配率、人工修正率、草稿采用率、重复拦截率和版本对比是否已关联台账任务编号；支持按时间、角色、来源、模型、提示词和 Schema 版本筛选，指标可复算。
