...
| 16 | AI-R16 | 下一项 | AI 关键流程浏览器 E2E | R08、R10～R14 | R17 |
...
开始前必须检查仓库、采购、主管、普通用户和管理员角色覆盖；覆盖上传、确认、草稿、工作台、Agent、知识和运维页面；不只检查 HTTP 200，检查中文、空状态、错误、权限、按钮、返回路径、下钻和重复点击，形成可重复脚本。
