...
当前修复项：AI-AUDIT-001-F01（AI 审计回归检查误报修复）正在开发中。
...
| P0 修复 | AI-AUDIT-001-F01 | 开发中 | 修复 AI 审计回归检查对关键字参数调用的误报 | AI-R01、AI-R17-F01 | 验证脚本匹配合法的能力审计调用，保持权限和审计逻辑不变 | 回归检查通过且核心/完整套件通过 |
