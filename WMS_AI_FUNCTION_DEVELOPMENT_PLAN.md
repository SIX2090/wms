...
| 11 | AI-R11 | 下一项 | 采购到货跟进 AI 工作台整合 | R01、R06、R08 | R16、R17 |
...
开始前必须检查待到、延期、短交、超收、未关联通知、多订单候选、供应商跟进清单和采购订单下钻是否已关联台账任务编号；指标口径和时间范围明确；对外沟通和业务提交必须人工确认。
