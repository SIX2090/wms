...
AI-R01～R17 的基础能力已经完成。下一阶段停止新增 R 系列大任务，统一使用已有任务的修复/运营子项编号，把现有能力从“代码和测试完成”推进到“真实用户可灰度、可衡量、可回滚、可运营”。

## 12. 下一批 AI 开发总表

| 优先级 | 子项编号 | 状态 | 任务 | 依赖 | 主要交付 | 生产完成门槛 |
|---|---|---|---|---|---|---|
| P0 | AI-R17-F01 | 下一项 | 真实用户白名单灰度与一键回滚 | AI-R13、R16、R17 | 用户白名单、灰度审计、Provider 降级、回滚控制 | 非白名单不可用；高风险动作自动执行为 0；10 分钟内关闭并恢复 |
