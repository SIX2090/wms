...
public final class AnimatedContentKt {
    public static final <S> void AnimatedContent(final S s, Modifier modifier, Function1<? super AnimatedContentTransitionScope<S>, ContentTransform> function1, Alignment contentAlignment, String label, Function1<? super S, ? extends Object> function12, final Function4<? super AnimatedContentScope, ? super S, ? super Composer, ? super Integer, Unit> function4, Composer $composer, final int $changed, final int i) {
        ...
        if (($dirty & 2995931) == 599186 && $composer2.getSkipping()) {
            ...
            AnimatedContent(transition, modifier3, transitionSpec, contentAlignment2, contentKey, function4, $composer2, ($dirty & 112) | ($dirty & 896) | ($dirty & 7168) | (($dirty >> 3) & 57344) | (($dirty >> 3) & 458752), 0);
            if (ComposerKt.isTraceInProgress()) {
        ...
        if ((i & 2) != 0) {
            function2 = new Function2<IntSize, IntSize, SpringSpec<IntSize>>() { // from class: androidx.compose.animation.AnimatedContentKt$SizeTransform$1
                ...
                public final SpringSpec<IntSize> m37invokeTemP2vQ(long j, long j2) {
                    return AnimationSpecKt.spring$default(0.0f, 400.0f, IntSize.m6256boximpl(VisibilityThresholdsKt.getVisibilityThreshold(IntSize.INSTANCE)), 1, null);
                }
            };
        }
    ...
    /* JADX WARN: Removed duplicated region for block: B:126:0x0475 A[ADDED_TO_REGION] */
    ...
    /* JADX WARN: Removed duplicated region for block: B:133:0x02ed A[LOOP:2: B:132:0x02eb->B:133:0x02ed, LOOP_END] */
    ...
    */
    public static final <S> void AnimatedContent(final androidx.compose.animation.core.Transition<S> r31, androidx.compose.ui.Modifier r32, kotlin.jvm.functions.Function1<? super androidx.compose.animation.AnimatedContentTransitionScope<S>, androidx.compose.animation.ContentTransform> r33, androidx.compose.ui.Alignment r34, kotlin.jvm.functions.Function1<? super S, ? extends java.lang.Object> r35, final kotlin.jvm.functions.Function4<? super androidx.compose.animation.AnimatedContentScope, ? super S, ? super androidx.compose.runtime.Composer, ? super java.lang.Integer, kotlin.Unit> r36, androidx.compose.runtime.Composer r37, final int r38, final int r39) {
        /*
