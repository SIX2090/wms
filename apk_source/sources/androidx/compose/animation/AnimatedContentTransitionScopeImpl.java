...
public final class AnimatedContentTransitionScopeImpl<S> implements AnimatedContentTransitionScope<S> {
    ...
    private final MutableState measuredSize = SnapshotStateKt__SnapshotStateKt.mutableStateOf$default(IntSize.m6256boximpl(IntSize.INSTANCE.m6269getZeroYbymL2g()), null, 2, null);
    ...
    public EnterTransition mo41slideIntoContainermOhB8PU(int towards, FiniteAnimationSpec<IntOffset> animationSpec, final Function1<? super Integer, Integer> initialOffset) {
        return m60isLeftgWo6LJ4(towards) ? EnterExitTransitionKt.slideInHorizontally(animationSpec, new Function1<Integer, Integer>() { // from class: androidx.compose.animation.AnimatedContentTransitionScopeImpl$slideIntoContainer$1
            ...
            public final Integer invoke(int it) {
                ...
                m59getCurrentSizeYbymL2g = this.m59getCurrentSizeYbymL2g();
                int m6264getWidthimpl = IntSize.m6264getWidthimpl(m59getCurrentSizeYbymL2g);
                AnimatedContentTransitionScopeImpl<S> animatedContentTransitionScopeImpl = this;
                long IntSize = IntSizeKt.IntSize(it, it);
                m59getCurrentSizeYbymL2g2 = this.m59getCurrentSizeYbymL2g();
                m58calculateOffsetemnUabE = animatedContentTransitionScopeImpl.m58calculateOffsetemnUabE(IntSize, m59getCurrentSizeYbymL2g2);
                return function1.invoke(Integer.valueOf(m6264getWidthimpl - IntOffset.m6222getXimpl(m58calculateOffsetemnUabE)));
            }
            ...
            public final Integer invoke(int it) {
                ...
                long IntSize = IntSizeKt.IntSize(it, it);
                m59getCurrentSizeYbymL2g = this.m59getCurrentSizeYbymL2g();
                m58calculateOffsetemnUabE = animatedContentTransitionScopeImpl.m58calculateOffsetemnUabE(IntSize, m59getCurrentSizeYbymL2g);
                return function1.invoke(Integer.valueOf((-IntOffset.m6222getXimpl(m58calculateOffsetemnUabE)) - it));
            }
            ...
            public final Integer invoke(int it) {
                ...
                Function1<Integer, Integer> function1 = initialOffset;
                m59getCurrentSizeYbymL2g = this.m59getCurrentSizeYbymL2g();
                int m6263getHeightimpl = IntSize.m6263getHeightimpl(m59getCurrentSizeYbymL2g);
                AnimatedContentTransitionScopeImpl<S> animatedContentTransitionScopeImpl = this;
                long IntSize = IntSizeKt.IntSize(it, it);
                m59getCurrentSizeYbymL2g2 = this.m59getCurrentSizeYbymL2g();
                m58calculateOffsetemnUabE = animatedContentTransitionScopeImpl.m58calculateOffsetemnUabE(IntSize, m59getCurrentSizeYbymL2g2);
                return function1.invoke(Integer.valueOf(m6263getHeightimpl - IntOffset.m6223getYimpl(m58calculateOffsetemnUabE)));
            }
            ...
            public final Integer invoke(int it) {
                ...
                m59getCurrentSizeYbymL2g = this.m59getCurrentSizeYbymL2g();
                m58calculateOffsetemnUabE = animatedContentTransitionScopeImpl.m58calculateOffsetemnUabE(IntSize, m59getCurrentSizeYbymL2g);
                return function1.invoke(Integer.valueOf((-IntOffset.m6223getYimpl(m58calculateOffsetemnUabE)) - it));
            }
    ...
    public final long m58calculateOffsetemnUabE(long fullSize, long currentSize) {
        return getContentAlignment().mo3382alignKFBX0sM(fullSize, currentSize, LayoutDirection.Ltr);
    }
    ...
    public ExitTransition mo42slideOutOfContainermOhB8PU(int towards, FiniteAnimationSpec<IntOffset> animationSpec, final Function1<? super Integer, Integer> targetOffset) {
        return m60isLeftgWo6LJ4(towards) ? EnterExitTransitionKt.slideOutHorizontally(animationSpec, new Function1<Integer, Integer>(this) { // from class: androidx.compose.animation.AnimatedContentTransitionScopeImpl$slideOutOfContainer$1
            ...
            public final Integer invoke(int it) {
                ...
                long targetSize = state != null ? ((IntSize) state.getValue()).getPackedValue() : IntSize.INSTANCE.m6269getZeroYbymL2g();
                Function1<Integer, Integer> function1 = targetOffset;
                m58calculateOffsetemnUabE = this.this$0.m58calculateOffsetemnUabE(IntSizeKt.IntSize(it, it), targetSize);
                return function1.invoke(Integer.valueOf((-IntOffset.m6222getXimpl(m58calculateOffsetemnUabE)) - it));
            }
            ...
            public final Integer invoke(int it) {
                ...
                Function1<Integer, Integer> function1 = targetOffset;
                m58calculateOffsetemnUabE = this.this$0.m58calculateOffsetemnUabE(IntSizeKt.IntSize(it, it), targetSize);
                return function1.invoke(Integer.valueOf((-IntOffset.m6222getXimpl(m58calculateOffsetemnUabE)) + IntSize.m6264getWidthimpl(targetSize)));
            }
            ...
            public final Integer invoke(int it) {
                ...
                Function1<Integer, Integer> function1 = targetOffset;
                m58calculateOffsetemnUabE = this.this$0.m58calculateOffsetemnUabE(IntSizeKt.IntSize(it, it), targetSize);
                return function1.invoke(Integer.valueOf((-IntOffset.m6223getYimpl(m58calculateOffsetemnUabE)) + IntSize.m6263getHeightimpl(targetSize)));
            }
    ...
    public final void m63setMeasuredSizeozmzZPI$animation_release(long j) {
        ...
        $this$setValue$iv.setValue(IntSize.m6256boximpl(j));
    }
    ...
    public final Modifier createSizeAnimationModifier$animation_release(ContentTransform contentTransform, Composer $composer, int $changed) {
        ...
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventStart(93755870, $changed, -1, "androidx.compose.animation.AnimatedContentTransitionScopeImpl.createSizeAnimationModifier (AnimatedContent.kt:538)");
        }
        ...
        if (createSizeAnimationModifier$lambda$2(shouldAnimateSize$delegate)) {
            ...
            if (invalid$iv$iv2 || it$iv$iv2 == Composer.INSTANCE.getEmpty()) {
                ...
                value$iv$iv2 = companion2.then(new SizeModifier(sizeAnimation, sizeTransform));
    ...
    final class SizeModifier extends LayoutModifierWithPassThroughIntrinsics {
        ...
        public MeasureResult mo64measure3p2s80s(MeasureScope measureScope, Measurable measurable, long j) {
            final Placeable mo5016measureBRTryo0 = measurable.mo5016measureBRTryo0(j);
            ...
            Function1<Transition.Segment<S>, FiniteAnimationSpec<IntSize>> function1 = new Function1<Transition.Segment<S>, FiniteAnimationSpec<IntSize>>() { // from class: androidx.compose.animation.AnimatedContentTransitionScopeImpl$SizeModifier$measure$size$1
                ...
                public final FiniteAnimationSpec<IntSize> invoke(Transition.Segment<S> segment) {
                    FiniteAnimationSpec<IntSize> mo113createAnimationSpecTemP2vQ;
                    State<IntSize> state = animatedContentTransitionScopeImpl.getTargetSizeMap$animation_release().get(segment.getInitialState());
                    long initial = state != null ? state.getValue().getPackedValue() : IntSize.INSTANCE.m6269getZeroYbymL2g();
                    State<IntSize> state2 = animatedContentTransitionScopeImpl.getTargetSizeMap$animation_release().get(segment.getTargetState());
                    long target = state2 != null ? state2.getValue().getPackedValue() : IntSize.INSTANCE.m6269getZeroYbymL2g();
                    SizeTransform value = this.getSizeTransform().getValue();
                    return (value == null || (mo113createAnimationSpecTemP2vQ = value.mo113createAnimationSpecTemP2vQ(initial, target)) == null) ? AnimationSpecKt.spring$default(0.0f, 0.0f, null, 7, null) : mo113createAnimationSpecTemP2vQ;
                }
            };
            ...
            State<IntSize> animate = deferredAnimation.animate(function1, new Function1<S, IntSize>() { // from class: androidx.compose.animation.AnimatedContentTransitionScopeImpl$SizeModifier$measure$size$2
                ...
                public /* bridge */ /* synthetic */ IntSize invoke(Object obj) {
                    return IntSize.m6256boximpl(m65invokeYEO4UFw(obj));
                }
                ...
                public final long m65invokeYEO4UFw(S s) {
                    ...
                    return state != null ? state.getValue().getPackedValue() : IntSize.INSTANCE.m6269getZeroYbymL2g();
                }
            });
            AnimatedContentTransitionScopeImpl.this.setAnimatedSize$animation_release(animate);
            final long mo3382alignKFBX0sM = AnimatedContentTransitionScopeImpl.this.getContentAlignment().mo3382alignKFBX0sM(IntSizeKt.IntSize(mo5016measureBRTryo0.getWidth(), mo5016measureBRTryo0.getHeight()), animate.getValue().getPackedValue(), LayoutDirection.Ltr);
            return MeasureScope.layout$default(measureScope, IntSize.m6264getWidthimpl(animate.getValue().getPackedValue()), IntSize.m6263getHeightimpl(animate.getValue().getPackedValue()), null, new Function1<Placeable.PlacementScope, Unit>() { // from class: androidx.compose.animation.AnimatedContentTransitionScopeImpl$SizeModifier$measure$1
                /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
                {
                    super(1);
                }
                ...
                public final void invoke2(Placeable.PlacementScope $this$layout) {
                    Placeable.PlacementScope.m5067place70tqf50$default($this$layout, Placeable.this, mo3382alignKFBX0sM, 0.0f, 2, null);
                }
            }, 4, null);
        }
    }
