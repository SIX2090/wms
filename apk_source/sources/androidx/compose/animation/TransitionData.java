...
public final /* data */ class TransitionData {
    ...
    public TransitionData(Fade fade, Slide slide, ChangeSize changeSize, Scale scale, boolean hold, Map<Object, ? extends ModifierNodeElement<? extends Modifier.Node>> map) {
        this.fade = fade;
        this.slide = slide;
