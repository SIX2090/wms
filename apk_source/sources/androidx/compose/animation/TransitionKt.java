...
public final class TransitionKt {
    public static final <S> State<Color> animateColor(Transition<S> transition, Function3<? super Transition.Segment<S>, ? super Composer, ? super Integer, ? extends FiniteAnimationSpec<Color>> function3, String label, Function3<? super S, ? super Composer, ? super Integer, Color> function32, Composer $composer, int $changed, int i) {
        ...
        ColorSpace colorSpace = Color.m3750getColorSpaceimpl(function32.invoke(transition.getTargetState(), $composer, Integer.valueOf(($changed >> 6) & 112)).m3756unboximpl());
    ...
    public static final State<Color> m114animateColorDTcfvLk(InfiniteTransition $this$animateColor_u2dDTcfvLk, long initialValue, long targetValue, InfiniteRepeatableSpec<Color> infiniteRepeatableSpec, String label, Composer $composer, int $changed, int i) {
        Object value$iv$iv;
        ...
        State<Color> animateValue = InfiniteTransitionKt.animateValue($this$animateColor_u2dDTcfvLk, Color.m3736boximpl(initialValue), Color.m3736boximpl(targetValue), converter, infiniteRepeatableSpec, label2, $composer, InfiniteTransition.$stable | 4096 | ($changed & 14) | ($changed & 112) | ($changed & 896) | (InfiniteRepeatableSpec.$stable << 12) | (($changed << 3) & 57344) | (458752 & ($changed << 3)), 0);
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventEnd();
        }
        $composer.endReplaceableGroup();
    ...
    public static final /* synthetic */ State m115animateColorRIQooxk(InfiniteTransition $this$animateColor_u2dRIQooxk, long initialValue, long targetValue, InfiniteRepeatableSpec animationSpec, Composer $composer, int $changed) {
        ...
        State<Color> m114animateColorDTcfvLk = m114animateColorDTcfvLk($this$animateColor_u2dRIQooxk, initialValue, targetValue, animationSpec, "ColorAnimation", $composer, InfiniteTransition.$stable | 24576 | ($changed & 14) | ($changed & 112) | ($changed & 896) | (InfiniteRepeatableSpec.$stable << 9) | ($changed & 7168), 0);
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventEnd();
        }
        $composer.endReplaceableGroup();
        return m114animateColorDTcfvLk;
    }
}
