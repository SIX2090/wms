...
public final class Transition<S> {
    ...
    public Transition(TransitionState<S> transitionState, String label) {
        ...
        this.totalDurationNanos = SnapshotStateKt.derivedStateOf(new Function0<Long>(this) { // from class: androidx.compose.animation.core.Transition$totalDurationNanos$2
            ...
            public final Long invoke() {
                ...
                list = ((Transition) this.this$0)._animations;
                List $this$fastForEach$iv = list;
                int size = $this$fastForEach$iv.size();
                for (int index$iv = 0; index$iv < size; index$iv++) {
                    Object item$iv = $this$fastForEach$iv.get(index$iv);
                    Transition.TransitionAnimationState it = (Transition.TransitionAnimationState) item$iv;
                    maxDurationNanos = Math.max(maxDurationNanos, it.getDurationNanos$animation_core_release());
                }
                list2 = ((Transition) this.this$0)._transitions;
    ...
    public Transition(MutableTransitionState<S> mutableTransitionState, String label) {
        this((TransitionState) mutableTransitionState, label);
    ...
    public final void onTransitionEnd$animation_core_release() {
        ...
        if (this.transitionState instanceof MutableTransitionState) {
            ((MutableTransitionState) this.transitionState).setCurrentState$animation_core_release(getTargetState());
        }
        setPlayTimeNanos(0L);
    ...
    public final void seek(S initialState, S targetState, long playTimeNanos) {
        ...
        if (!isSeeking() || !Intrinsics.areEqual(getCurrentState(), initialState) || !Intrinsics.areEqual(getTargetState(), targetState)) {
            if (!Intrinsics.areEqual(getCurrentState(), initialState) && (this.transitionState instanceof MutableTransitionState)) {
                ((MutableTransitionState) this.transitionState).setCurrentState$animation_core_release(initialState);
            }
    ...
    public final void updateTarget$animation_core_release(final S s, Composer $composer, final int $changed) {
        ...
        if (($dirty & 91) != 18 || !$composer2.getSkipping()) {
            if (ComposerKt.isTraceInProgress()) {
                ComposerKt.traceEventStart(-583974681, $dirty, -1, "androidx.compose.animation.core.Transition.updateTarget (Transition.kt:608)");
            }
    ...
    public final void animateTo$animation_core_release(final S s, Composer $composer, final int $changed) {
        ...
        ComposerKt.sourceInformation($composer2, "C(animateTo)641@25072L25,645@25321L676:Transition.kt#pdpnli");
        int $dirty = $changed;
        if (($changed & 14) == 0) {
            $dirty |= $composer2.changed(s) ? 4 : 2;
        }
        ...
        if (($dirty & 91) != 18 || !$composer2.getSkipping()) {
            if (ComposerKt.isTraceInProgress()) {
                ComposerKt.traceEventStart(-1493585151, $dirty, -1, "androidx.compose.animation.core.Transition.animateTo (Transition.kt:639)");
            }
            if (!isSeeking()) {
                ...
                if (!Intrinsics.areEqual(s, getCurrentState()) || isRunning() || getUpdateChildrenNeeded$animation_core_release()) {
                    $composer2.startReplaceableGroup(1951115890);
                    boolean invalid$iv = $composer2.changed(this);
                    Object it$iv = $composer2.rememberedValue();
                    if (invalid$iv || it$iv == Composer.INSTANCE.getEmpty()) {
                        value$iv = new Transition$animateTo$1$1(this, null);
                        $composer2.updateRememberedValue(value$iv);
                    } else {
                        value$iv = it$iv;
                    }
                    $composer2.endReplaceableGroup();
                    EffectsKt.LaunchedEffect(this, (Function2<? super CoroutineScope, ? super Continuation<? super Unit>, ? extends Object>) value$iv, $composer2, (($dirty >> 3) & 14) | 64);
                }
            }
            if (ComposerKt.isTraceInProgress()) {
                ComposerKt.traceEventEnd();
