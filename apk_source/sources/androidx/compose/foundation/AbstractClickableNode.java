...
abstract class AbstractClickableNode extends DelegatingNode implements PointerInputModifierNode, KeyInputModifierNode {
    ...
    private AbstractClickableNode(MutableInteractionSource interactionSource, boolean enabled, String onClickLabel, Role role, Function0<Unit> function0) {
    ...
    public static final class InteractionData {
        ...
        private long centreOffset = Offset.INSTANCE.m3521getZeroF1C5BW0();
    ...
    public static /* synthetic */ void m177updateCommonXHw0xAI$default(AbstractClickableNode abstractClickableNode, MutableInteractionSource mutableInteractionSource, boolean z, String str, Role role, Function0 function0, int i, Object obj) {
        ...
        abstractClickableNode.m181updateCommonXHw0xAI(mutableInteractionSource, z, str, role2, function0);
    }
    ...
    public boolean mo178onKeyEventZmokQxo(KeyEvent event) {
        if (this.enabled && Clickable_androidKt.m259isPressZmokQxo(event)) {
            if (this.interactionData.getCurrentKeyPressInteractions().containsKey(Key.m4443boximpl(KeyEvent_androidKt.m4754getKeyZmokQxo(event)))) {
                return false;
            }
            PressInteraction.Press press = new PressInteraction.Press(this.interactionData.getCentreOffset(), null);
            this.interactionData.getCurrentKeyPressInteractions().put(Key.m4443boximpl(KeyEvent_androidKt.m4754getKeyZmokQxo(event)), press);
        ...
        if (!this.enabled || !Clickable_androidKt.m257isClickZmokQxo(event)) {
            return false;
        }
        PressInteraction.Press it = this.interactionData.getCurrentKeyPressInteractions().remove(Key.m4443boximpl(KeyEvent_androidKt.m4754getKeyZmokQxo(event)));
        if (it != null) {
