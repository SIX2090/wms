...
final class AndroidEmbeddedExternalSurfaceState extends BaseAndroidExternalSurfaceState implements TextureView.SurfaceTextureListener {
    ...
    public AndroidEmbeddedExternalSurfaceState(CoroutineScope scope) {
        super(scope);
        this.surfaceSize = IntSize.INSTANCE.m6269getZeroYbymL2g();
    ...
    public void onSurfaceTextureAvailable(SurfaceTexture surfaceTexture, int width, int height) {
        int w = width;
        int h = height;
        if (!IntSize.m6262equalsimpl0(this.surfaceSize, IntSize.INSTANCE.m6269getZeroYbymL2g())) {
            w = IntSize.m6264getWidthimpl(this.surfaceSize);
            h = IntSize.m6263getHeightimpl(this.surfaceSize);
