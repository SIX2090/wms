...
final class BackgroundNode extends Modifier.Node implements DrawModifierNode {
    ...
    private final void drawRect(ContentDrawScope $this$drawRect) {
        if (!Color.m3747equalsimpl0(this.color, Color.INSTANCE.m3782getUnspecified0d7_KjU())) {
            DrawScope.m4290drawRectnJ9OG0$default($this$drawRect, this.color, 0L, 0L, 0.0f, null, null, 0, WebSocketProtocol.PAYLOAD_SHORT, null);
        }
        Brush it = this.brush;
        if (it != null) {
            DrawScope.m4289drawRectAsUm42w$default($this$drawRect, it, 0L, 0L, this.alpha, null, null, 0, 118, null);
        }
    }

    private final void drawOutline(ContentDrawScope $this$drawOutline) {
        Outline outline;
        if (Size.m3569equalsimpl($this$drawOutline.mo4295getSizeNHjbRc(), this.lastSize) && $this$drawOutline.getLayoutDirection() == this.lastLayoutDirection && Intrinsics.areEqual(this.lastShape, this.shape)) {
            outline = this.lastOutline;
            Intrinsics.checkNotNull(outline);
        } else {
            outline = this.shape.mo260createOutlinePq9zytI($this$drawOutline.mo4295getSizeNHjbRc(), $this$drawOutline.getLayoutDirection(), $this$drawOutline);
        }
        if (!Color.m3747equalsimpl0(this.color, Color.INSTANCE.m3782getUnspecified0d7_KjU())) {
            OutlineKt.m4004drawOutlinewDX37Ww($this$drawOutline, outline, this.color, (r17 & 4) != 0 ? 1.0f : 0.0f, (r17 & 8) != 0 ? Fill.INSTANCE : null, (r17 & 16) != 0 ? null : null, (r17 & 32) != 0 ? DrawScope.INSTANCE.m4296getDefaultBlendMode0nO6VwU() : 0);
        }
        Brush it = this.brush;
        if (it != null) {
            OutlineKt.m4002drawOutlinehn5TExg($this$drawOutline, outline, it, (r14 & 4) != 0 ? 1.0f : this.alpha, (r14 & 8) != 0 ? Fill.INSTANCE : null, (r14 & 16) != 0 ? null : null, (r14 & 32) != 0 ? DrawScope.INSTANCE.m4296getDefaultBlendMode0nO6VwU() : 0);
        }
        this.lastOutline = outline;
        this.lastSize = Size.m3562boximpl($this$drawOutline.mo4295getSizeNHjbRc());
