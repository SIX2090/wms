...
public final class BasicTooltip_androidKt {
    ...
    */
    ...
    /*
        ...
        To view partially-correct add '--show-bad-code' argument
    */
    public static final void WrappedAnchor(final boolean r31, final androidx.compose.foundation.BasicTooltipState r32, androidx.compose.ui.Modifier r33, final kotlin.jvm.functions.Function2<? super androidx.compose.runtime.Composer, ? super java.lang.Integer, kotlin.Unit> r34, androidx.compose.runtime.Composer r35, final int r36, final int r37) {
        /*
                ...
                public final void invoke2(SemanticsPropertyReceiver $this$semantics) {
                    ...
                    SemanticsPropertiesKt.onLongClick($this$semantics, str, new Function0<Boolean>() { // from class: androidx.compose.foundation.BasicTooltip_androidKt$anchorSemantics$1.1
                        ...
                        static final class C00011 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
                            ...
                            /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
                            C00011(BasicTooltipState basicTooltipState, Continuation<? super C00011> continuation) {
                                super(2, continuation);
                                this.$state = basicTooltipState;
                            }
                            ...
                            @Override // kotlin.coroutines.jvm.internal.BaseContinuationImpl
                            public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
                                return new C00011(this.$state, continuation);
                            }
                        ...
                        public final Boolean invoke() {
                            BuildersKt__Builders_commonKt.launch$default(CoroutineScope.this, null, null, new C00011(basicTooltipState, null), 3, null);
                            return true;
                        }
                    });
                }
