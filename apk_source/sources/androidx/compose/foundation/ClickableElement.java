...
final class ClickableElement extends ModifierNodeElement<ClickableNode> {
    ...
    */
    ...
    private ClickableElement(MutableInteractionSource interactionSource, boolean enabled, String onClickLabel, Role role, Function0<Unit> function0) {
    ...
    public int hashCode() {
        ...
        Role role = this.role;
        return ((result3 + (role != null ? Role.m5396hashCodeimpl(role.getValue()) : 0)) * 31) + this.onClick.hashCode();
    }
}
