...
final class ClickableNode extends AbstractClickableNode {
    ...
    private ClickableNode(MutableInteractionSource interactionSource, boolean enabled, String onClickLabel, Role role, Function0<Unit> function0) {
        super(interactionSource, enabled, onClickLabel, role, function0, null);
        this.clickableSemanticsNode = (ClickableSemanticsNode) delegate(new ClickableSemanticsNode(enabled, onClickLabel, role, function0, null, null, null));
        this.clickablePointerInputNode = (ClickablePointerInputNode) delegate(new ClickablePointerInputNode(enabled, interactionSource, function0, getInteractionData()));
    }
    ...
    public final void m253updateXHw0xAI(MutableInteractionSource interactionSource, boolean enabled, String onClickLabel, Role role, Function0<Unit> onClick) {
        m181updateCommonXHw0xAI(interactionSource, enabled, onClickLabel, role, onClick);
        getClickableSemanticsNode().m256updateUMe6uN4(enabled, onClickLabel, role, onClick, null, null);
