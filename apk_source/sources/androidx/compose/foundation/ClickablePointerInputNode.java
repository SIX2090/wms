...
final class ClickablePointerInputNode extends AbstractClickablePointerInputNode {
    public ClickablePointerInputNode(boolean enabled, MutableInteractionSource interactionSource, Function0<Unit> function0, AbstractClickableNode.InteractionData interactionData) {
    ...
    protected Object pointerInput(PointerInputScope $this$pointerInput, Continuation<? super Unit> continuation) {
        ...
        long $this$toOffset_u2d_u2dgyyYBs$iv = IntSizeKt.m6270getCenterozmzZPI($this$pointerInput.getBoundsSize());
        interactionData.m183setCentreOffsetk4lQ0M(OffsetKt.Offset(IntOffset.m6222getXimpl($this$toOffset_u2d_u2dgyyYBs$iv), IntOffset.m6223getYimpl($this$toOffset_u2d_u2dgyyYBs$iv)));
        Object detectTapAndPress = TapGestureDetectorKt.detectTapAndPress($this$pointerInput, new ClickablePointerInputNode$pointerInput$2(this, null), new Function1<Offset, Unit>() { // from class: androidx.compose.foundation.ClickablePointerInputNode$pointerInput$3
            ...
            public /* bridge */ /* synthetic */ Unit invoke(Offset offset) {
                m255invokek4lQ0M(offset.getPackedValue());
                return Unit.INSTANCE;
            }

            /* renamed from: invoke-k-4lQ0M, reason: not valid java name */
            public final void m255invokek4lQ0M(long it) {
