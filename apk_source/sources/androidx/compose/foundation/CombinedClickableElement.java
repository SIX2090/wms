...
final class CombinedClickableElement extends ModifierNodeElement<CombinedClickableNodeImpl> {
    ...
    */
    ...
    private CombinedClickableElement(MutableInteractionSource interactionSource, boolean enabled, String onClickLabel, Role role, Function0<Unit> function0, String onLongClickLabel, Function0<Unit> function02, Function0<Unit> function03) {
    ...
    public int hashCode() {
        ...
        Role role = this.role;
        int result4 = (((result3 + (role != null ? Role.m5396hashCodeimpl(role.getValue()) : 0)) * 31) + this.onClick.hashCode()) * 31;
