...
final class HoverableNode extends Modifier.Node implements PointerInputModifierNode {
    ...
    public void mo179onPointerEventH0pRuoY(PointerEvent pointerEvent, PointerEventPass pass, long bounds) {
        if (pass == PointerEventPass.Main) {
            ...
            if (PointerEventType.m4839equalsimpl0(type, PointerEventType.INSTANCE.m4843getEnter7fucELk())) {
            ...
            } else if (PointerEventType.m4839equalsimpl0(type, PointerEventType.INSTANCE.m4844getExit7fucELk())) {
