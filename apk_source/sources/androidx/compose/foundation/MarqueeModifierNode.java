...
final class MarqueeModifierNode extends Modifier.Node implements LayoutModifierNode, DrawModifierNode, FocusEventModifierNode {
    ...
    public final void m298updatelWfNwf4(int iterations, int animationMode, int delayMillis, int initialDelayMillis, MarqueeSpacing spacing, float velocity) {
        ...
        if (this.iterations != iterations || this.delayMillis != delayMillis || this.initialDelayMillis != initialDelayMillis || !Dp.m6099equalsimpl0(this.velocity, velocity)) {
            this.iterations = iterations;
            this.delayMillis = delayMillis;
            this.initialDelayMillis = initialDelayMillis;
            this.velocity = velocity;
    ...
    public MeasureResult mo90measure3p2s80s(MeasureScope $this$measure_u2d3p2s80s, Measurable measurable, long constraints) {
        ...
        setContainerWidth(ConstraintsKt.m6064constrainWidthK40F9xA(constraints, placeable.getWidth()));
        ...
        return MeasureScope.layout$default($this$measure_u2d3p2s80s, getContainerWidth(), placeable.getHeight(), null, new Function1<Placeable.PlacementScope, Unit>() { // from class: androidx.compose.foundation.MarqueeModifierNode$measure$1
            ...
            public final void invoke2(Placeable.PlacementScope $this$layout) {
                ...
                Placeable.PlacementScope.placeWithLayer$default($this$layout, placeable2, MathKt.roundToInt(f * direction), 0, 0.0f, null, 12, null);
            }
        }, 4, null);
    }
    ...
    public void draw(ContentDrawScope $this$draw) {
        ...
        float bottom$iv = Size.m3571getHeightimpl($this$clipRect_u2drOu3jXo_u24default$iv.mo4295getSizeNHjbRc());
        ...
        $this$clipRect_rOu3jXo_u24lambda_u244$iv.mo4223clipRectN_I0leg(clipOffset, 0.0f, right$iv, bottom$iv, clipOp$iv);
        if (firstCopyVisible) {
