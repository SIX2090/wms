...
final class DropTargetElement extends ModifierNodeElement<DragAndDropTargetNode> {
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof DropTargetElement) && Intrinsics.areEqual(this.target, ((DropTargetElement) other).target)) {
            return Intrinsics.areEqual(this.shouldStartDragAndDrop, ((DropTargetElement) other).shouldStartDragAndDrop);
        }
        return false;
    }
