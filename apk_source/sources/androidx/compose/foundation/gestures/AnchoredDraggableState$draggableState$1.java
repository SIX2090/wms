...
public final class AnchoredDraggableState$draggableState$1 implements DraggableState {
    ...
    /* JADX WARN: Type inference failed for: r0v0, types: [androidx.compose.foundation.gestures.AnchoredDraggableState$draggableState$1$dragScope$1, androidx.compose.foundation.gestures.AnchoredDraggableState$draggableState$1$dragScope$1<T>] */
    AnchoredDraggableState$draggableState$1(final AnchoredDraggableState<T> anchoredDraggableState) {
        ...
        this.dragScope = new DragScope() { // from class: androidx.compose.foundation.gestures.AnchoredDraggableState$draggableState$1$dragScope$1
            ...
            public void dragBy(float pixels) {
                ...
                AnchoredDragScope.dragTo$default($this$dragBy_u24lambda_u240, anchoredDraggableState.newOffsetForDelta$foundation_release(pixels), 0.0f, 2, null);
            }
        };
    }
