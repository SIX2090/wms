    ...
    public AnchoredDraggableState(T t, Function1<? super Float, Float> function1, Function0<Float> function0, AnimationSpec<Float> animationSpec, Function1<? super T, Boolean> function12) {
        ...
        this.progress = SnapshotStateKt.derivedStateOf(SnapshotStateKt.structuralEqualityPolicy(), new Function0<Float>(this) { // from class: androidx.compose.foundation.gestures.AnchoredDraggableState$progress$2
            ...
            public final Float invoke() {
                ...
                float b = this.this$0.getAnchors().positionOf(this.this$0.getClosestValue$foundation_release());
    ...
    */
    public /* synthetic */ AnchoredDraggableState(java.lang.Object r7, kotlin.jvm.functions.Function1 r8, kotlin.jvm.functions.Function0 r9, androidx.compose.animation.core.AnimationSpec r10, kotlin.jvm.functions.Function1 r11, int r12, kotlin.jvm.internal.DefaultConstructorMarker r13) {
        /*
            ...
            r12 = r12 & 16
            if (r12 == 0) goto La
            androidx.compose.foundation.gestures.AnchoredDraggableState$1 r11 = new kotlin.jvm.functions.Function1<T, java.lang.Boolean>() { // from class: androidx.compose.foundation.gestures.AnchoredDraggableState.1
                static {
                    /*
        ...
        Lb:
            ...
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: androidx.compose.foundation.gestures.AnchoredDraggableState.<init>(java.lang.Object, kotlin.jvm.functions.Function1, kotlin.jvm.functions.Function0, androidx.compose.animation.core.AnimationSpec, kotlin.jvm.functions.Function1, int, kotlin.jvm.internal.DefaultConstructorMarker):void");
    }
    ...
    /*
        ...
        To view partially-correct add '--show-bad-code' argument
    */
    public /* synthetic */ AnchoredDraggableState(java.lang.Object r8, androidx.compose.foundation.gestures.DraggableAnchors r9, kotlin.jvm.functions.Function1 r10, kotlin.jvm.functions.Function0 r11, androidx.compose.animation.core.AnimationSpec r12, kotlin.jvm.functions.Function1 r13, int r14, kotlin.jvm.internal.DefaultConstructorMarker r15) {
        /*
            r7 = this;
            r14 = r14 & 32
            if (r14 == 0) goto La
            androidx.compose.foundation.gestures.AnchoredDraggableState$2 r13 = new kotlin.jvm.functions.Function1<T, java.lang.Boolean>() { // from class: androidx.compose.foundation.gestures.AnchoredDraggableState.2
                static {
                    /*
        ...
        Lb:
            ...
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: androidx.compose.foundation.gestures.AnchoredDraggableState.<init>(java.lang.Object, androidx.compose.foundation.gestures.DraggableAnchors, kotlin.jvm.functions.Function1, kotlin.jvm.functions.Function0, androidx.compose.animation.core.AnimationSpec, kotlin.jvm.functions.Function1, int, kotlin.jvm.internal.DefaultConstructorMarker):void");
    }
    ...
    public final T computeTarget(float offset, T currentValue, float velocity) {
        ...
        if (!(currentAnchorPosition == offset) && !Float.isNaN(currentAnchorPosition)) {
            if (Math.abs(velocity) >= Math.abs(velocityThresholdPx)) {
                T closestAnchor = currentAnchors.closestAnchor(offset, offset - currentAnchorPosition > 0.0f);
    ...
    public final T computeTargetWithoutThresholds(float offset, T currentValue) {
        DraggableAnchors currentAnchors = getAnchors();
        float currentAnchor = currentAnchors.positionOf(currentValue);
        if (!(currentAnchor == offset) && !Float.isNaN(currentAnchor)) {
            T closestAnchor = currentAnchors.closestAnchor(offset, offset - currentAnchor > 0.0f);
    ...
    /*
        ...
        To view partially-correct add '--show-bad-code' argument
    */
    public final java.lang.Object anchoredDrag(androidx.compose.foundation.MutatePriority r8, kotlin.jvm.functions.Function3<? super androidx.compose.foundation.gestures.AnchoredDragScope, ? super androidx.compose.foundation.gestures.DraggableAnchors<T>, ? super kotlin.coroutines.Continuation<? super kotlin.Unit>, ? extends java.lang.Object> r9, kotlin.coroutines.Continuation<? super kotlin.Unit> r10) {
        /*
            r7 = this;
            boolean r0 = r10 instanceof androidx.compose.foundation.gestures.AnchoredDraggableState$anchoredDrag$1
            if (r0 == 0) goto L14
            r0 = r10
        ...
        L3a:
            ...
            r2 = r7
            androidx.compose.foundation.MutatorMutex r4 = r2.dragMutex     // Catch: java.lang.Throwable -> L8e
            androidx.compose.foundation.gestures.AnchoredDraggableState$anchoredDrag$2 r5 = new androidx.compose.foundation.gestures.AnchoredDraggableState$anchoredDrag$2     // Catch: java.lang.Throwable -> L8e
            r6 = 0
            r5.<init>(r2, r9, r6)     // Catch: java.lang.Throwable -> L8e
            kotlin.jvm.functions.Function1 r5 = (kotlin.jvm.functions.Function1) r5     // Catch: java.lang.Throwable -> L8e
            r10.L$0 = r2     // Catch: java.lang.Throwable -> L8e
            r6 = 1
            r10.label = r6     // Catch: java.lang.Throwable -> L8e
            java.lang.Object r4 = r4.mutate(r8, r5, r10)     // Catch: java.lang.Throwable -> L8e
            if (r4 != r1) goto L55
            return r1
        L55:
            r8 = r2
        L56:
            androidx.compose.foundation.gestures.DraggableAnchors r9 = r8.getAnchors()
            float r1 = r8.getOffset()
            java.lang.Object r9 = r9.closestAnchor(r1)
            if (r9 == 0) goto L8a
            float r1 = r8.getOffset()
            androidx.compose.foundation.gestures.DraggableAnchors r2 = r8.getAnchors()
        ...
        L8e:
            ...
            r8 = r2
        L90:
            androidx.compose.foundation.gestures.DraggableAnchors r1 = r8.getAnchors()
            float r2 = r8.getOffset()
            java.lang.Object r1 = r1.closestAnchor(r2)
            if (r1 == 0) goto Lc4
            float r2 = r8.getOffset()
            androidx.compose.foundation.gestures.DraggableAnchors r4 = r8.getAnchors()
    ...
    */
    public final java.lang.Object anchoredDrag(T r9, androidx.compose.foundation.MutatePriority r10, kotlin.jvm.functions.Function4<? super androidx.compose.foundation.gestures.AnchoredDragScope, ? super androidx.compose.foundation.gestures.DraggableAnchors<T>, ? super T, ? super kotlin.coroutines.Continuation<? super kotlin.Unit>, ? extends java.lang.Object> r11, kotlin.coroutines.Continuation<? super kotlin.Unit> r12) {
        ...
        L3b:
            kotlin.ResultKt.throwOnFailure(r0)
            r2 = r8
            androidx.compose.foundation.gestures.DraggableAnchors r5 = r2.getAnchors()
            boolean r5 = r5.hasAnchorFor(r9)
            if (r5 == 0) goto Ld2
        L4a:
            androidx.compose.foundation.MutatorMutex r5 = r2.dragMutex     // Catch: java.lang.Throwable -> L98
            androidx.compose.foundation.gestures.AnchoredDraggableState$anchoredDrag$4 r6 = new androidx.compose.foundation.gestures.AnchoredDraggableState$anchoredDrag$4     // Catch: java.lang.Throwable -> L98
            r6.<init>(r2, r9, r11, r4)     // Catch: java.lang.Throwable -> L98
            kotlin.jvm.functions.Function1 r6 = (kotlin.jvm.functions.Function1) r6     // Catch: java.lang.Throwable -> L98
            r12.L$0 = r2     // Catch: java.lang.Throwable -> L98
            r7 = 1
            r12.label = r7     // Catch: java.lang.Throwable -> L98
            java.lang.Object r5 = r5.mutate(r10, r6, r12)     // Catch: java.lang.Throwable -> L98
            if (r5 != r1) goto L5f
            return r1
        L5f:
            r9 = r2
        L60:
            r9.setDragTarget(r4)
            androidx.compose.foundation.gestures.DraggableAnchors r10 = r9.getAnchors()
            float r11 = r9.getOffset()
            java.lang.Object r10 = r10.closestAnchor(r11)
            if (r10 == 0) goto L97
            float r11 = r9.getOffset()
            androidx.compose.foundation.gestures.DraggableAnchors r1 = r9.getAnchors()
        ...
        L9a:
            r9.setDragTarget(r4)
            androidx.compose.foundation.gestures.DraggableAnchors r11 = r9.getAnchors()
    ...
    private final boolean trySnapTo(T targetValue) {
        ...
        if (didLock$iv) {
            try {
                AnchoredDragScope $this$trySnapTo_u24lambda_u242_u24lambda_u241 = this.anchoredDragScope;
    ...
    /* compiled from: AnchoredDraggable.kt */
    @Metadata(d1 = {"\u0000:\n\u0002\u0018\u0002\n\u0002\u0010\u0000\n\u0002\b\u0002\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\b\u0002\n\u0002\u0018\u0002\n\u0002\u0010\u0007\n\u0000\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\b\u0003\n\u0002\u0018\u0002\n\u0000\n\u0002\u0010\u000b\n\u0000\b\u0086\u0003\u0018\u00002\u00020\u0001B\u0007\b\u0002¢\u0006\u0002\u0010\u0002Jy\u0010\u0003\u001a\u0014\u0012\n\u0012\b\u0012\u0004\u0012\u0002H\u00060\u0005\u0012\u0004\u0012\u0002H\u00060\u0004\"\b\b\u0001\u0010\u0006*\u00020\u00012\f\u0010\u0007\u001a\b\u0012\u0004\u0012\u00020\t0\b2!\u0010\n\u001a\u001d\u0012\u0013\u0012\u00110\t¢\u0006\f\b\f\u0012\b\b\r\u0012\u0004\b\b(\u000e\u0012\u0004\u0012\u00020\t0\u000b2\f\u0010\u000f\u001a\b\u0012\u0004\u0012\u00020\t0\u00102\u0014\b\u0002\u0010\u0011\u001a\u000e\u0012\u0004\u0012\u0002H\u0006\u0012\u0004\u0012\u00020\u00120\u000bH\u0007¨\u0006\u0013"}, d2 = {"Landroidx/compose/foundation/gestures/AnchoredDraggableState$Companion;", "", "()V", "Saver", "Landroidx/compose/runtime/saveable/Saver;", "Landroidx/compose/foundation/gestures/AnchoredDraggableState;", "T", "animationSpec", "Landroidx/compose/animation/core/AnimationSpec;", "", "positionalThreshold", "Lkotlin/Function1;", "Lkotlin/ParameterName;", HintConstants.AUTOFILL_HINT_NAME, "distance", "velocityThreshold", "Lkotlin/Function0;", "confirmValueChange", "", "foundation_release"}, k = 1, mv = {1, 8, 0}, xi = 48)
