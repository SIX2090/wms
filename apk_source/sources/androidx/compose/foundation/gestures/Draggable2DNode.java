...
public final class Draggable2DNode extends AbstractDraggableNode {
    ...
    /* JADX WARN: Type inference failed for: r1v2, types: [androidx.compose.foundation.gestures.Draggable2DNode$abstractDragScope$1] */
    public Draggable2DNode(Draggable2DState state, Function1<? super PointerInputChange, Boolean> function1, boolean enabled, MutableInteractionSource interactionSource, Function0<Boolean> function0, Function3<? super CoroutineScope, ? super Offset, ? super Continuation<? super Unit>, ? extends Object> function3, Function3<? super CoroutineScope, ? super Velocity, ? super Continuation<? super Unit>, ? extends Object> function32, boolean reverseDirection) {
        ...
        this.abstractDragScope = new AbstractDragScope() { // from class: androidx.compose.foundation.gestures.Draggable2DNode$abstractDragScope$1
            ...
            public void mo318dragByk4lQ0M(long pixels) {
                Draggable2DNode.this.getDrag2DScope().mo328dragByk4lQ0M(pixels);
            }
        };
