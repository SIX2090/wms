            ...
            case 0:
                ...
                final Function1 outerScopeScroll = new Function1<Offset, Offset>() { // from class: androidx.compose.foundation.gestures.ScrollingLogic$doFlingAnimation$2$outerScopeScroll$1
                    ...
                    public /* bridge */ /* synthetic */ Offset invoke(Offset offset) {
                        return Offset.m3494boximpl(m414invokeMKHz9U(offset.getPackedValue()));
                    }

                    /* renamed from: invoke-MK-Hz9U, reason: not valid java name */
                    public final long m414invokeMKHz9U(long delta) {
                        return ScrollingLogic.this.m406reverseIfNeededMKHz9U(ScrollingLogic.this.m402dispatchScroll3eAAhYA($this$scroll, ScrollingLogic.this.m406reverseIfNeededMKHz9U(delta), NestedScrollSource.INSTANCE.m4785getFlingWNlRxjI()));
                    }
                };
                ...
                ScrollScope scrollScope = new ScrollScope() { // from class: androidx.compose.foundation.gestures.ScrollingLogic$doFlingAnimation$2$scope$1
                    ...
                    public float scrollBy(float pixels) {
                        return ScrollingLogic.this.m410toFloatk4lQ0M(outerScopeScroll.invoke(Offset.m3494boximpl(ScrollingLogic.this.m411toOffsettuRUvjQ(pixels))).getPackedValue());
                    }
                };
                ...
                float reverseIfNeeded = scrollingLogic.reverseIfNeeded(scrollingLogic.m409toFloatTH1AsA0(j2));
