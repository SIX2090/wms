...
final class TapGestureDetectorKt$detectTapGestures$2 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
    ...
    static final class AnonymousClass1 extends RestrictedSuspendLambda implements Function2<AwaitPointerEventScope, Continuation<? super Unit>, Object> {
        ...
        /* JADX WARN: Removed duplicated region for block: B:25:0x02dd A[RETURN] */
        ...
        /* JADX WARN: Removed duplicated region for block: B:71:0x0141 A[Catch: PointerEventTimeoutCancellationException -> 0x0176, TryCatch #2 {PointerEventTimeoutCancellationException -> 0x0176, blocks: (B:69:0x013b, B:71:0x0141, B:73:0x0157), top: B:68:0x013b }] */
        /* JADX WARN: Removed duplicated region for block: B:73:0x0157 A[Catch: PointerEventTimeoutCancellationException -> 0x0176, TRY_LEAVE, TryCatch #2 {PointerEventTimeoutCancellationException -> 0x0176, blocks: (B:69:0x013b, B:71:0x0141, B:73:0x0157), top: B:68:0x013b }] */
            ...
            public final Object invokeSuspend(Object $result) {
                ...
                switch (this.label) {
                    case 0:
                        ...
                        Offset m3494boximpl = Offset.m3494boximpl(this.$down.getPosition());
                        this.label = 1;
                        if (function3.invoke(pressGestureScopeImpl, m3494boximpl, this) != coroutine_suspended) {
                            break;
                        } else {
                            return coroutine_suspended;
                        }
            ...
            public final Object invokeSuspend(Object $result) {
                ...
                switch (this.label) {
                    case 0:
                        ...
                        Function3<PressGestureScope, Offset, Continuation<? super Unit>, Object> function3 = this.$onPress;
                        PressGestureScopeImpl pressGestureScopeImpl = this.$pressScope;
                        Offset m3494boximpl = Offset.m3494boximpl(this.$secondDown.getPosition());
                        this.label = 1;
                        if (function3.invoke(pressGestureScopeImpl, m3494boximpl, this) != coroutine_suspended) {
                            break;
                        } else {
        ...
        static final class AnonymousClass9 extends RestrictedSuspendLambda implements Function2<AwaitPointerEventScope, Continuation<? super Unit>, Object> {
            ...
            public final Object invokeSuspend(Object $result) {
                ...
                if (secondUp == null) {
                    ...
                    function1.invoke(Offset.m3494boximpl(anonymousClass9.$upOrCancel.element.getPosition()));
                    return Unit.INSTANCE;
                }
                secondUp.consume();
                ...
                anonymousClass9.$onDoubleTap.invoke(Offset.m3494boximpl(secondUp.getPosition()));
                return Unit.INSTANCE;
            }
