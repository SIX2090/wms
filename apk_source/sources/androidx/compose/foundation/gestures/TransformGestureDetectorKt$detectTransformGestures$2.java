...
final class TransformGestureDetectorKt$detectTransformGestures$2 extends RestrictedSuspendLambda implements Function2<AwaitPointerEventScope, Continuation<? super Unit>, Object> {
    ...
    /* JADX WARN: Code restructure failed: missing block: B:37:0x0196, code lost:
        ...
        if (androidx.compose.ui.geometry.Offset.m3502equalsimpl0(r1, androidx.compose.ui.geometry.Offset.INSTANCE.m3521getZeroF1C5BW0()) == false) goto L63;
     */
    ...
    /* JADX WARN: Unsupported multi-entry loop pattern (BACK_EDGE: B:54:0x00c1 -> B:7:0x00cd). Please report as a decompilation issue!!! */
    @Override // kotlin.coroutines.jvm.internal.BaseContinuationImpl
    /*
