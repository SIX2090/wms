...
final class TransformableElement extends ModifierNodeElement<TransformableNode> {
    ...
    public boolean equals(Object other) {
        ...
        if (Intrinsics.areEqual(this.state, ((TransformableElement) other).state) && Intrinsics.areEqual(this.canPan, ((TransformableElement) other).canPan) && this.lockRotationOnZoomPan == ((TransformableElement) other).lockRotationOnZoomPan && this.enabled == ((TransformableElement) other).enabled) {
            return true;
        }
        return false;
    }
