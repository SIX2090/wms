...
final class AlignmentLineOffsetDpNode extends Modifier.Node implements LayoutModifierNode {
    ...
    public MeasureResult mo90measure3p2s80s(MeasureScope $this$measure_u2d3p2s80s, Measurable measurable, long constraints) {
        ...
        m440alignmentLineOffsetMeasuretjqqzMA = AlignmentLineKt.m440alignmentLineOffsetMeasuretjqqzMA($this$measure_u2d3p2s80s, this.alignmentLine, this.before, this.after, measurable, constraints);
