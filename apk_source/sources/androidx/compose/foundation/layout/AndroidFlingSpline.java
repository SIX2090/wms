...
final class AndroidFlingSpline {
    ...
    public final long m461flingPositionLfoxSSI(float time) {
        float f = 100;
        ...
        return FlingResult.m463constructorimpl((v1$iv << 32) | (4294967295L & v2$iv));
    }
    ...
    public static final class FlingResult {
        ...
        public static final /* synthetic */ FlingResult m462boximpl(long j) {
        ...
        public static boolean m464equalsimpl(long j, Object obj) {
            return (obj instanceof FlingResult) && j == ((FlingResult) obj).getPackedValue();
        }

        /* renamed from: equals-impl0, reason: not valid java name */
        public static final boolean m465equalsimpl0(long j, long j2) {
            return j == j2;
        }
        ...
        public boolean equals(Object obj) {
            return m464equalsimpl(this.packedValue, obj);
        }

        public int hashCode() {
            return m468hashCodeimpl(this.packedValue);
        }

        public String toString() {
            return m469toStringimpl(this.packedValue);
        }
        ...
        public static final float m466getDistanceCoefficientimpl(long arg0) {
            FloatCompanionObject floatCompanionObject = FloatCompanionObject.INSTANCE;
            return Float.intBitsToFloat((int) (arg0 >> 32));
        }

        /* renamed from: getVelocityCoefficient-impl, reason: not valid java name */
        public static final float m467getVelocityCoefficientimpl(long arg0) {
            FloatCompanionObject floatCompanionObject = FloatCompanionObject.INSTANCE;
