...
final class Insets implements WindowInsets {
    ...
    public int getLeft(Density density, LayoutDirection layoutDirection) {
        return density.mo307roundToPx0680j_4(this.left);
    }

    @Override // androidx.compose.foundation.layout.WindowInsets
    public int getTop(Density density) {
        return density.mo307roundToPx0680j_4(this.top);
    }

    @Override // androidx.compose.foundation.layout.WindowInsets
    public int getRight(Density density, LayoutDirection layoutDirection) {
        return density.mo307roundToPx0680j_4(this.right);
    }

    @Override // androidx.compose.foundation.layout.WindowInsets
    public int getBottom(Density density) {
        return density.mo307roundToPx0680j_4(this.bottom);
    }

    public String toString() {
        return "Insets(left=" + ((Object) Dp.m6105toStringimpl(this.left)) + ", top=" + ((Object) Dp.m6105toStringimpl(this.top)) + ", right=" + ((Object) Dp.m6105toStringimpl(this.right)) + ", bottom=" + ((Object) Dp.m6105toStringimpl(this.bottom)) + ')';
    }
    ...
    public boolean equals(Object other) {
        ...
        if (other instanceof Insets) {
            return Dp.m6099equalsimpl0(this.left, ((Insets) other).left) && Dp.m6099equalsimpl0(this.top, ((Insets) other).top) && Dp.m6099equalsimpl0(this.right, ((Insets) other).right) && Dp.m6099equalsimpl0(this.bottom, ((Insets) other).bottom);
        }
        return false;
    }

    public int hashCode() {
        int result = Dp.m6100hashCodeimpl(this.left);
        return (((((result * 31) + Dp.m6100hashCodeimpl(this.top)) * 31) + Dp.m6100hashCodeimpl(this.right)) * 31) + Dp.m6100hashCodeimpl(this.bottom);
    }
}
