...
final class OffsetModifierElement extends ModifierNodeElement<OffsetNode> {
    ...
    public boolean equals(Object other) {
        ...
        return Dp.m6099equalsimpl0(this.x, otherModifierElement.x) && Dp.m6099equalsimpl0(this.y, otherModifierElement.y) && this.rtlAware == otherModifierElement.rtlAware;
    }

    @Override // androidx.compose.ui.node.ModifierNodeElement
    public int hashCode() {
        int result = Dp.m6100hashCodeimpl(this.x);
        return (((result * 31) + Dp.m6100hashCodeimpl(this.y)) * 31) + Boolean.hashCode(this.rtlAware);
    }

    public String toString() {
        return "OffsetModifierElement(x=" + ((Object) Dp.m6105toStringimpl(this.x)) + ", y=" + ((Object) Dp.m6105toStringimpl(this.y)) + ", rtlAware=" + this.rtlAware + ')';
    }
