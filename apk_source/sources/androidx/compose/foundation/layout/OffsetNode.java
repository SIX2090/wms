        ...
        return MeasureScope.layout$default($this$measure_u2d3p2s80s, placeable.getWidth(), placeable.getHeight(), null, new Function1<Placeable.PlacementScope, Unit>() { // from class: androidx.compose.foundation.layout.OffsetNode$measure$1
            ...
            public final void invoke2(Placeable.PlacementScope $this$layout) {
                if (OffsetNode.this.getRtlAware()) {
                    Placeable.PlacementScope.placeRelative$default($this$layout, placeable, $this$measure_u2d3p2s80s.mo307roundToPx0680j_4(OffsetNode.this.getX()), $this$measure_u2d3p2s80s.mo307roundToPx0680j_4(OffsetNode.this.getY()), 0.0f, 4, null);
                } else {
                    Placeable.PlacementScope.place$default($this$layout, placeable, $this$measure_u2d3p2s80s.mo307roundToPx0680j_4(OffsetNode.this.getX()), $this$measure_u2d3p2s80s.mo307roundToPx0680j_4(OffsetNode.this.getY()), 0.0f, 4, null);
                }
            }
        }, 4, null);
    }
