        ...
        return MeasureScope.layout$default($this$measure_u2d3p2s80s, placeable.getWidth(), placeable.getHeight(), null, new Function1<Placeable.PlacementScope, Unit>() { // from class: androidx.compose.foundation.layout.OffsetPxNode$measure$1
            ...
            public final void invoke2(Placeable.PlacementScope $this$layout) {
                ...
                if (OffsetPxNode.this.getRtlAware()) {
                    Placeable.PlacementScope.placeRelativeWithLayer$default($this$layout, placeable, IntOffset.m6222getXimpl(offsetValue), IntOffset.m6223getYimpl(offsetValue), 0.0f, null, 12, null);
                } else {
                    Placeable.PlacementScope.placeWithLayer$default($this$layout, placeable, IntOffset.m6222getXimpl(offsetValue), IntOffset.m6223getYimpl(offsetValue), 0.0f, null, 12, null);
                }
            }
        }, 4, null);
    }
