...
public final /* data */ class RowColumnMeasurePolicy implements MeasurePolicy {
    ...
    public boolean equals(Object other) {
        ...
        return this.orientation == rowColumnMeasurePolicy.orientation && Intrinsics.areEqual(this.horizontalArrangement, rowColumnMeasurePolicy.horizontalArrangement) && Intrinsics.areEqual(this.verticalArrangement, rowColumnMeasurePolicy.verticalArrangement) && Dp.m6099equalsimpl0(this.arrangementSpacing, rowColumnMeasurePolicy.arrangementSpacing) && this.crossAxisSize == rowColumnMeasurePolicy.crossAxisSize && Intrinsics.areEqual(this.crossAxisAlignment, rowColumnMeasurePolicy.crossAxisAlignment);
    }

    public int hashCode() {
        return (((((((((this.orientation.hashCode() * 31) + (this.horizontalArrangement == null ? 0 : this.horizontalArrangement.hashCode())) * 31) + (this.verticalArrangement != null ? this.verticalArrangement.hashCode() : 0)) * 31) + Dp.m6100hashCodeimpl(this.arrangementSpacing)) * 31) + this.crossAxisSize.hashCode()) * 31) + this.crossAxisAlignment.hashCode();
    }

    public String toString() {
        return "RowColumnMeasurePolicy(orientation=" + this.orientation + ", horizontalArrangement=" + this.horizontalArrangement + ", verticalArrangement=" + this.verticalArrangement + ", arrangementSpacing=" + ((Object) Dp.m6105toStringimpl(this.arrangementSpacing)) + ", crossAxisSize=" + this.crossAxisSize + ", crossAxisAlignment=" + this.crossAxisAlignment + ')';
    }
    ...
    public MeasureResult mo38measure3p2s80s(final MeasureScope $this$measure_u2d3p2s80s, List<? extends Measurable> list, long constraints) {
        ...
        return MeasureScope.layout$default($this$measure_u2d3p2s80s, layoutWidth, layoutHeight, null, new Function1<Placeable.PlacementScope, Unit>() { // from class: androidx.compose.foundation.layout.RowColumnMeasurePolicy$measure$1
            ...
            public final void invoke2(Placeable.PlacementScope $this$layout) {
                RowColumnMeasurementHelper.this.placeHelper($this$layout, measureResult, 0, $this$measure_u2d3p2s80s.getLayoutDirection());
            }
        }, 4, null);
    }
    ...
    public int minIntrinsicWidth(IntrinsicMeasureScope $this$minIntrinsicWidth, List<? extends IntrinsicMeasurable> list, int height) {
        ...
        return ((Number) MinIntrinsicWidthMeasureBlock.invoke(list, Integer.valueOf(height), Integer.valueOf($this$minIntrinsicWidth.mo307roundToPx0680j_4(this.arrangementSpacing)))).intValue();
    }
    ...
    public int minIntrinsicHeight(IntrinsicMeasureScope $this$minIntrinsicHeight, List<? extends IntrinsicMeasurable> list, int width) {
        ...
        return ((Number) MinIntrinsicHeightMeasureBlock.invoke(list, Integer.valueOf(width), Integer.valueOf($this$minIntrinsicHeight.mo307roundToPx0680j_4(this.arrangementSpacing)))).intValue();
    }
    ...
    public int maxIntrinsicWidth(IntrinsicMeasureScope $this$maxIntrinsicWidth, List<? extends IntrinsicMeasurable> list, int height) {
        ...
        return ((Number) MaxIntrinsicWidthMeasureBlock.invoke(list, Integer.valueOf(height), Integer.valueOf($this$maxIntrinsicWidth.mo307roundToPx0680j_4(this.arrangementSpacing)))).intValue();
    }
    ...
    public int maxIntrinsicHeight(IntrinsicMeasureScope $this$maxIntrinsicHeight, List<? extends IntrinsicMeasurable> list, int width) {
        ...
        return ((Number) MaxIntrinsicHeightMeasureBlock.invoke(list, Integer.valueOf(width), Integer.valueOf($this$maxIntrinsicHeight.mo307roundToPx0680j_4(this.arrangementSpacing)))).intValue();
    }
}
