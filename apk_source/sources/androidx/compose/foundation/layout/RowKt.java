...
public final class RowKt {
    ...
    static {
        ...
        DefaultRowMeasurePolicy = new RowColumnMeasurePolicy(LayoutOrientation.Horizontal, Arrangement.INSTANCE.getStart(), vertical, Arrangement.INSTANCE.getStart().getSpacing(), SizeMode.Wrap, CrossAxisAlignment.INSTANCE.vertical$foundation_layout_release(Alignment.INSTANCE.getTop()), null);
    }
    ...
    public static final MeasurePolicy rowMeasurePolicy(Arrangement.Horizontal horizontalArrangement, Alignment.Vertical verticalAlignment, Composer $composer, int $changed) {
        ...
        if (Intrinsics.areEqual(horizontalArrangement, Arrangement.INSTANCE.getStart()) && Intrinsics.areEqual(verticalAlignment, Alignment.INSTANCE.getTop())) {
            ...
            if (invalid$iv$iv || value$iv$iv == Composer.INSTANCE.getEmpty()) {
                Arrangement.Vertical vertical = null;
                value$iv$iv = new RowColumnMeasurePolicy(LayoutOrientation.Horizontal, horizontalArrangement, vertical, horizontalArrangement.getSpacing(), SizeMode.Wrap, CrossAxisAlignment.INSTANCE.vertical$foundation_layout_release(verticalAlignment), null);
