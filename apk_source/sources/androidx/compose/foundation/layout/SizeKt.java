...
public final class SizeKt {
    ...
    public static final Modifier m616width3ABfNKs(Modifier $this$width_u2d3ABfNKs, final float width) {
        return $this$width_u2d3ABfNKs.then(new SizeElement(width, 0.0f, width, 0.0f, true, InspectableValueKt.isDebugInspectorInfoEnabled() ? new Function1<InspectorInfo, Unit>() { // from class: androidx.compose.foundation.layout.SizeKt$width-3ABfNKs$$inlined$debugInspectorInfo$1
            ...
            public final void invoke2(InspectorInfo $this$null) {
                ...
                $this$null.setValue(Dp.m6092boximpl(width));
            }
        } : InspectableValueKt.getNoInspectorInfo(), 10, null));
    }

    /* renamed from: height-3ABfNKs, reason: not valid java name */
    public static final Modifier m597height3ABfNKs(Modifier $this$height_u2d3ABfNKs, final float height) {
        return $this$height_u2d3ABfNKs.then(new SizeElement(0.0f, height, 0.0f, height, true, InspectableValueKt.isDebugInspectorInfoEnabled() ? new Function1<InspectorInfo, Unit>() { // from class: androidx.compose.foundation.layout.SizeKt$height-3ABfNKs$$inlined$debugInspectorInfo$1
            ...
            public final void invoke2(InspectorInfo $this$null) {
                ...
                $this$null.setValue(Dp.m6092boximpl(height));
            }
        } : InspectableValueKt.getNoInspectorInfo(), 5, null));
    }

    /* renamed from: size-3ABfNKs, reason: not valid java name */
    public static final Modifier m611size3ABfNKs(Modifier $this$size_u2d3ABfNKs, final float size) {
        return $this$size_u2d3ABfNKs.then(new SizeElement(size, size, size, size, true, InspectableValueKt.isDebugInspectorInfoEnabled() ? new Function1<InspectorInfo, Unit>() { // from class: androidx.compose.foundation.layout.SizeKt$size-3ABfNKs$$inlined$debugInspectorInfo$1
            ...
            public final void invoke2(InspectorInfo $this$null) {
                ...
                $this$null.setValue(Dp.m6092boximpl(size));
            }
        } : InspectableValueKt.getNoInspectorInfo(), null));
    }

    /* renamed from: size-VpY3zN4, reason: not valid java name */
    public static final Modifier m613sizeVpY3zN4(Modifier $this$size_u2dVpY3zN4, final float width, final float height) {
        return $this$size_u2dVpY3zN4.then(new SizeElement(width, height, width, height, true, InspectableValueKt.isDebugInspectorInfoEnabled() ? new Function1<InspectorInfo, Unit>() { // from class: androidx.compose.foundation.layout.SizeKt$size-VpY3zN4$$inlined$debugInspectorInfo$1
            ...
            public final void invoke2(InspectorInfo $this$null) {
                $this$null.setName("size");
                $this$null.getProperties().set("width", Dp.m6092boximpl(width));
                $this$null.getProperties().set("height", Dp.m6092boximpl(height));
            }
        } : InspectableValueKt.getNoInspectorInfo(), null));
    }

    /* renamed from: size-6HolHcs, reason: not valid java name */
    public static final Modifier m612size6HolHcs(Modifier $this$size_u2d6HolHcs, long size) {
        return m613sizeVpY3zN4($this$size_u2d6HolHcs, DpSize.m6192getWidthD9Ej5fM(size), DpSize.m6190getHeightD9Ej5fM(size));
    }

    /* renamed from: widthIn-VpY3zN4$default, reason: not valid java name */
    public static /* synthetic */ Modifier m618widthInVpY3zN4$default(Modifier modifier, float f, float f2, int i, Object obj) {
        if ((i & 1) != 0) {
        ...
        return m617widthInVpY3zN4(modifier, f, f2);
    }

    /* renamed from: widthIn-VpY3zN4, reason: not valid java name */
    public static final Modifier m617widthInVpY3zN4(Modifier $this$widthIn_u2dVpY3zN4, final float min, final float max) {
        return $this$widthIn_u2dVpY3zN4.then(new SizeElement(min, 0.0f, max, 0.0f, true, InspectableValueKt.isDebugInspectorInfoEnabled() ? new Function1<InspectorInfo, Unit>() { // from class: androidx.compose.foundation.layout.SizeKt$widthIn-VpY3zN4$$inlined$debugInspectorInfo$1
            ...
            public final void invoke2(InspectorInfo $this$null) {
                ...
                $this$null.getProperties().set("min", Dp.m6092boximpl(min));
                $this$null.getProperties().set("max", Dp.m6092boximpl(max));
            }
        } : InspectableValueKt.getNoInspectorInfo(), 10, null));
    }

    /* renamed from: heightIn-VpY3zN4$default, reason: not valid java name */
    public static /* synthetic */ Modifier m599heightInVpY3zN4$default(Modifier modifier, float f, float f2, int i, Object obj) {
        if ((i & 1) != 0) {
            f = Dp.INSTANCE.m6114getUnspecifiedD9Ej5fM();
        }
        if ((i & 2) != 0) {
        ...
        return m598heightInVpY3zN4(modifier, f, f2);
    }

    /* renamed from: heightIn-VpY3zN4, reason: not valid java name */
    public static final Modifier m598heightInVpY3zN4(Modifier $this$heightIn_u2dVpY3zN4, final float min, final float max) {
    ...
    public static /* synthetic */ Modifier m615sizeInqDBjuR0$default(Modifier modifier, float f, float f2, float f3, float f4, int i, Object obj) {
        if ((i & 1) != 0) {
            f = Dp.INSTANCE.m6114getUnspecifiedD9Ej5fM();
        }
        if ((i & 2) != 0) {
        ...
        if ((i & 4) != 0) {
            f3 = Dp.INSTANCE.m6114getUnspecifiedD9Ej5fM();
        }
        if ((i & 8) != 0) {
            f4 = Dp.INSTANCE.m6114getUnspecifiedD9Ej5fM();
        }
        return m614sizeInqDBjuR0(modifier, f, f2, f3, f4);
    }

    /* renamed from: sizeIn-qDBjuR0, reason: not valid java name */
    public static final Modifier m614sizeInqDBjuR0(Modifier $this$sizeIn_u2dqDBjuR0, final float minWidth, final float minHeight, final float maxWidth, final float maxHeight) {
        return $this$sizeIn_u2dqDBjuR0.then(new SizeElement(minWidth, minHeight, maxWidth, maxHeight, true, InspectableValueKt.isDebugInspectorInfoEnabled() ? new Function1<InspectorInfo, Unit>() { // from class: androidx.compose.foundation.layout.SizeKt$sizeIn-qDBjuR0$$inlined$debugInspectorInfo$1
            ...
            public final void invoke2(InspectorInfo $this$null) {
                ...
                $this$null.getProperties().set("minWidth", Dp.m6092boximpl(minWidth));
                $this$null.getProperties().set("minHeight", Dp.m6092boximpl(minHeight));
                $this$null.getProperties().set("maxWidth", Dp.m6092boximpl(maxWidth));
                $this$null.getProperties().set("maxHeight", Dp.m6092boximpl(maxHeight));
            }
        } : InspectableValueKt.getNoInspectorInfo(), null));
    }

    /* renamed from: requiredWidth-3ABfNKs, reason: not valid java name */
    public static final Modifier m608requiredWidth3ABfNKs(Modifier $this$requiredWidth_u2d3ABfNKs, final float width) {
    ...
    public static final Modifier m600requiredHeight3ABfNKs(Modifier $this$requiredHeight_u2d3ABfNKs, final float height) {
    ...
    public static final Modifier m603requiredSize3ABfNKs(Modifier $this$requiredSize_u2d3ABfNKs, final float size) {
    ...
    public static final Modifier m605requiredSizeVpY3zN4(Modifier $this$requiredSize_u2dVpY3zN4, final float width, final float height) {
    ...
    public static final Modifier m604requiredSize6HolHcs(Modifier $this$requiredSize_u2d6HolHcs, long size) {
        return m605requiredSizeVpY3zN4($this$requiredSize_u2d6HolHcs, DpSize.m6192getWidthD9Ej5fM(size), DpSize.m6190getHeightD9Ej5fM(size));
    }

    /* renamed from: requiredWidthIn-VpY3zN4$default, reason: not valid java name */
    public static /* synthetic */ Modifier m610requiredWidthInVpY3zN4$default(Modifier modifier, float f, float f2, int i, Object obj) {
        if ((i & 1) != 0) {
            f = Dp.INSTANCE.m6114getUnspecifiedD9Ej5fM();
        }
        if ((i & 2) != 0) {
        ...
        return m609requiredWidthInVpY3zN4(modifier, f, f2);
    }

    /* renamed from: requiredWidthIn-VpY3zN4, reason: not valid java name */
    public static final Modifier m609requiredWidthInVpY3zN4(Modifier $this$requiredWidthIn_u2dVpY3zN4, final float min, final float max) {
    ...
    public static /* synthetic */ Modifier m602requiredHeightInVpY3zN4$default(Modifier modifier, float f, float f2, int i, Object obj) {
        if ((i & 1) != 0) {
            f = Dp.INSTANCE.m6114getUnspecifiedD9Ej5fM();
        }
        if ((i & 2) != 0) {
        ...
        return m601requiredHeightInVpY3zN4(modifier, f, f2);
    }

    /* renamed from: requiredHeightIn-VpY3zN4, reason: not valid java name */
    public static final Modifier m601requiredHeightInVpY3zN4(Modifier $this$requiredHeightIn_u2dVpY3zN4, final float min, final float max) {
    ...
    public static /* synthetic */ Modifier m607requiredSizeInqDBjuR0$default(Modifier modifier, float f, float f2, float f3, float f4, int i, Object obj) {
        if ((i & 1) != 0) {
            f = Dp.INSTANCE.m6114getUnspecifiedD9Ej5fM();
        }
        if ((i & 2) != 0) {
        ...
        return m606requiredSizeInqDBjuR0(modifier, f, f2, f3, f4);
    }

    /* renamed from: requiredSizeIn-qDBjuR0, reason: not valid java name */
    public static final Modifier m606requiredSizeInqDBjuR0(Modifier $this$requiredSizeIn_u2dqDBjuR0, final float minWidth, final float minHeight, final float maxWidth, final float maxHeight) {
    ...
    public static /* synthetic */ Modifier m596defaultMinSizeVpY3zN4$default(Modifier modifier, float f, float f2, int i, Object obj) {
        if ((i & 1) != 0) {
            f = Dp.INSTANCE.m6114getUnspecifiedD9Ej5fM();
        }
        if ((i & 2) != 0) {
        ...
        return m595defaultMinSizeVpY3zN4(modifier, f, f2);
    }

    /* renamed from: defaultMinSize-VpY3zN4, reason: not valid java name */
    public static final Modifier m595defaultMinSizeVpY3zN4(Modifier $this$defaultMinSize_u2dVpY3zN4, float minWidth, float minHeight) {
