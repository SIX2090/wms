...
final class SpacerMeasurePolicy implements MeasurePolicy {
    ...
    public MeasureResult mo38measure3p2s80s(MeasureScope $this$measure_u2d3p2s80s, List<? extends Measurable> list, long constraints) {
        int width = Constraints.m6048getHasFixedWidthimpl(constraints) ? Constraints.m6050getMaxWidthimpl(constraints) : 0;
        int height = Constraints.m6047getHasFixedHeightimpl(constraints) ? Constraints.m6049getMaxHeightimpl(constraints) : 0;
