...
final class UnspecifiedConstraintsElement extends ModifierNodeElement<UnspecifiedConstraintsNode> {
    ...
    public void inspectableProperties(InspectorInfo $this$inspectableProperties) {
        ...
        $this$inspectableProperties.getProperties().set("minWidth", Dp.m6092boximpl(this.minWidth));
        $this$inspectableProperties.getProperties().set("minHeight", Dp.m6092boximpl(this.minHeight));
    }

    @Override // androidx.compose.ui.node.ModifierNodeElement
    public boolean equals(Object other) {
        return (other instanceof UnspecifiedConstraintsElement) && Dp.m6099equalsimpl0(this.minWidth, ((UnspecifiedConstraintsElement) other).minWidth) && Dp.m6099equalsimpl0(this.minHeight, ((UnspecifiedConstraintsElement) other).minHeight);
    }

    @Override // androidx.compose.ui.node.ModifierNodeElement
    public int hashCode() {
        return (Dp.m6100hashCodeimpl(this.minWidth) * 31) + Dp.m6100hashCodeimpl(this.minHeight);
    }
}
