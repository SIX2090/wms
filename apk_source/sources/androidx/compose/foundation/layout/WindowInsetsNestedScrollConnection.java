...
final class WindowInsetsNestedScrollConnection implements NestedScrollConnection, WindowInsetsAnimationControlListener {
    ...
    public long mo401onPreScrollOzD1aCk(long available, int source) {
        return m640scroll8S9VItk(available, this.sideCalculator.hideMotion(Offset.m3505getXimpl(available), Offset.m3506getYimpl(available)));
    }

    @Override // androidx.compose.ui.input.nestedscroll.NestedScrollConnection
    /* renamed from: onPostScroll-DzOQY0M */
    public long mo400onPostScrollDzOQY0M(long consumed, long available, int source) {
        return m640scroll8S9VItk(available, this.sideCalculator.showMotion(Offset.m3505getXimpl(available), Offset.m3506getYimpl(available)));
    }

    /* renamed from: scroll-8S9VItk, reason: not valid java name */
    private final long m640scroll8S9VItk(long available, float scrollAmount) {
        ...
        if (!(scrollAmount == 0.0f)) {
            if (this.windowInsets.isVisible() != (scrollAmount > 0.0f) || animationController != null) {
                if (animationController == null) {
                    ...
                    requestAnimationController();
                    return this.sideCalculator.mo592consumedOffsetsMKHz9U(available);
                }
    ...
    public Object mo641onPreFlingQWom1Mo(long available, Continuation<? super Velocity> continuation) {
        return m639flinghuYlsQE(available, this.sideCalculator.hideMotion(Velocity.m6329getXimpl(available), Velocity.m6330getYimpl(available)), false, continuation);
    }

    @Override // androidx.compose.ui.input.nestedscroll.NestedScrollConnection
    /* renamed from: onPostFling-RZ2iAVY */
    public Object mo399onPostFlingRZ2iAVY(long consumed, long available, Continuation<? super Velocity> continuation) {
        return m639flinghuYlsQE(available, this.sideCalculator.showMotion(Velocity.m6329getXimpl(available), Velocity.m6330getYimpl(available)), true, continuation);
    }
    ...
    */
    public final java.lang.Object m639flinghuYlsQE(long r27, float r29, boolean r30, kotlin.coroutines.Continuation<? super androidx.compose.ui.unit.Velocity> r31) {
        /*
            Method dump skipped, instructions count: 448
            To view this dump add '--comments-level debug' option
        */
        throw new UnsupportedOperationException("Method not decompiled: androidx.compose.foundation.layout.WindowInsetsNestedScrollConnection.m639flinghuYlsQE(long, float, boolean, kotlin.coroutines.Continuation):java.lang.Object");
    }
