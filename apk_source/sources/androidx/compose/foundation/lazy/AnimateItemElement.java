...
final /* data */ class AnimateItemElement extends ModifierNodeElement<LazyLayoutAnimationSpecsNode> {
    ...
    @Override // androidx.compose.ui.node.ModifierNodeElement
    public int hashCode() {
        return ((this.appearanceSpec == null ? 0 : this.appearanceSpec.hashCode()) * 31) + (this.placementSpec != null ? this.placementSpec.hashCode() : 0);
    }
    ...
    public void inspectableProperties(InspectorInfo $this$inspectableProperties) {
        ...
        $this$inspectableProperties.setValue(this.placementSpec);
    }
}
