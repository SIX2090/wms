...
public final class LazyListStateKt {
    private static final float DeltaThresholdForScrollAnimation = Dp.m6094constructorimpl(1);
    ...
    public static final LazyListState rememberLazyListState(final int initialFirstVisibleItemIndex, final int initialFirstVisibleItemScrollOffset, Composer $composer, int $changed, int i) {
        ...
        LazyListState lazyListState = (LazyListState) RememberSaveableKt.m3363rememberSaveable(objArr, (Saver) saver, (String) null, (Function0) value$iv, $composer, 72, 4);
        if (ComposerKt.isTraceInProgress()) {
