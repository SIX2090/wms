...
final class ParentSizeNode extends Modifier.Node implements LayoutModifierNode {
    ...
    public MeasureResult mo90measure3p2s80s(MeasureScope $this$measure_u2d3p2s80s, Measurable measurable, long constraints) {
        ...
        int height = i2;
        long childConstraints = ConstraintsKt.Constraints(width != Integer.MAX_VALUE ? width : Constraints.m6052getMinWidthimpl(constraints), width != Integer.MAX_VALUE ? width : Constraints.m6050getMaxWidthimpl(constraints), height != Integer.MAX_VALUE ? height : Constraints.m6051getMinHeightimpl(constraints), height != Integer.MAX_VALUE ? height : Constraints.m6049getMaxHeightimpl(constraints));
