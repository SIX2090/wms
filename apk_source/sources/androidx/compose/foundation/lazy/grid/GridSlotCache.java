...
final class GridSlotCache implements LazyGridSlotsProvider {
    ...
    public LazyGridSlots mo687invoke0kLqBqw(Density density, long constraints) {
        if (this.cachedSizes != null && Constraints.m6043equalsimpl0(this.cachedConstraints, constraints)) {
        ...
        LazyGridSlots invoke = this.calculation.invoke(density, Constraints.m6038boximpl(constraints));
