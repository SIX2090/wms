...
public final class LazyGridState implements ScrollableState {
    ...
    */
    ...
    private final void notifyPrefetch(float delta, LazyGridLayoutInfo layoutInfo) {
        ...
        LazyGridLayoutInfo info = layoutInfo;
            ...
            if (lineToPrefetch != closestNextItemToPrefetch2) {
                ...
                if (z) {
                    ...
                    while (index$iv < size) {
                        ...
                        this.currentLinePrefetchHandles.add(prefetchState.m727schedulePrefetch0kLqBqw(it3.getFirst().intValue(), it3.getSecond().getValue()));
                        index$iv++;
                        info = info;
