                ...
                public final void invoke(Composer $composer, int $changed) {
                    ...
                    if (($changed & 11) != 2 || !$composer.getSkipping()) {
                        ...
                        if (active$iv) {
                            ...
                            LazyLayoutItemContentFactoryKt.m723SkippableItemJVlU9Rs(itemProvider, StableValue.m741constructorimpl(saveableStateHolder), index, StableValue.m741constructorimpl(cachedItemContent.getKey()), $composer, 0);
