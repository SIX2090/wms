...
public final class LazyLayoutSemanticsKt {
    public static final Modifier lazyLayoutSemantics(Modifier $this$lazyLayoutSemantics, final Function0<? extends LazyLayoutItemProvider> function0, final LazyLayoutSemanticState state, Orientation orientation, boolean userScrollEnabled, boolean reverseScrolling, Composer $composer, int $changed) {
        ...
        $composer.endReplaceableGroup();
        Object[] keys$iv = {function0, state, orientation, Boolean.valueOf(userScrollEnabled)};
        ...
        if (invalid$iv || it$iv$iv == Composer.INSTANCE.getEmpty()) {
            ...
            value$iv$iv = SemanticsModifierKt.semantics$default(Modifier.INSTANCE, false, new Function1<SemanticsPropertyReceiver, Unit>() { // from class: androidx.compose.foundation.lazy.layout.LazyLayoutSemanticsKt$lazyLayoutSemantics$1$1
                ...
                public final void invoke2(SemanticsPropertyReceiver $this$semantics) {
                    ...
                    SemanticsPropertiesKt.indexForKey($this$semantics, indexForKeyMapping);
                    if (z) {
                    ...
                    if (scrollByAction != null) {
                        SemanticsPropertiesKt.scrollBy$default($this$semantics, null, scrollByAction, 1, null);
                    }
                    if (scrollToIndexAction != null) {
                        SemanticsPropertiesKt.scrollToIndex$default($this$semantics, null, scrollToIndexAction, 1, null);
                    }
                    SemanticsPropertiesKt.setCollectionInfo($this$semantics, collectionInfo);
                }
            }, 1, null);
