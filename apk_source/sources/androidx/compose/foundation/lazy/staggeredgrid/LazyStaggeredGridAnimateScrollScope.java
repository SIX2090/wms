...
public final class LazyStaggeredGridAnimateScrollScope implements LazyLayoutAnimateScrollScope {
    ...
    public int getVisibleItemScrollOffset(final int index) {
        ...
        return this.state.getIsVertical() ? IntOffset.m6223getYimpl(it) : IntOffset.m6222getXimpl(it);
    }
    ...
    public int getVisibleItemsAverageSize() {
        ...
        for (int index$iv$iv = 0; index$iv$iv < size; index$iv$iv++) {
            ...
            sum$iv += this.state.getIsVertical() ? IntSize.m6263getHeightimpl(it.getSize()) : IntSize.m6264getWidthimpl(it.getSize());
        }
