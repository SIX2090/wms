...
public final class LazyStaggeredGridItemPlacementAnimator {
    ...
    /* JADX WARN: Removed duplicated region for block: B:133:0x0414 A[LOOP:10: B:126:0x03f4->B:133:0x0414, LOOP_END] */
    /* JADX WARN: Removed duplicated region for block: B:134:0x0412 A[SYNTHETIC] */
    /*
        Code decompiled incorrectly, please refer to instructions dump.
        To view partially-correct add '--show-bad-code' argument
    */
    public final void onMeasured(int r47, int r48, int r49, java.util.List<androidx.compose.foundation.lazy.staggeredgrid.LazyStaggeredGridMeasuredItem> r50, androidx.compose.foundation.lazy.staggeredgrid.LazyStaggeredGridMeasureProvider r51, boolean r52, int r53, kotlinx.coroutines.CoroutineScope r54) {
        /*
    ...
    private final boolean getHasAnimations(LazyStaggeredGridMeasuredItem $this$hasAnimations) {
        ...
        for (int i = 0; i < placeablesCount; i++) {
            int index = i;
            specs = LazyStaggeredGridItemPlacementAnimatorKt.getSpecs($this$hasAnimations.getParentData(index));
            if (specs != null) {
                return true;
            }
        }
