...
public final class MeasuredPage implements PageInfo {
    ...
    public final void place(Placeable.PlacementScope scope) {
        ...
        while (i3 < size) {
            ...
            long offset = m787getOffsetBjo55l4(index);
            if (this.reverseLayout) {
                if (this.isVertical) {
                    mainAxisOffset = IntOffset.m6222getXimpl(offset);
                } else {
                    int mainAxisOffset2 = IntOffset.m6222getXimpl(offset);
                    mainAxisOffset = (this.mainAxisLayoutSize - mainAxisOffset2) - getMainAxisSize(placeable);
                }
                if (this.isVertical) {
                    int mainAxisOffset3 = IntOffset.m6223getYimpl(offset);
                    m6223getYimpl = (this.mainAxisLayoutSize - mainAxisOffset3) - getMainAxisSize(placeable);
                } else {
                    m6223getYimpl = IntOffset.m6223getYimpl(offset);
                }
                long $this$copy_u2d4Tuh3kE$iv = IntOffsetKt.IntOffset(mainAxisOffset, m6223getYimpl);
                offset = $this$copy_u2d4Tuh3kE$iv;
            }
            long other$iv = this.visualOffset;
            long offset2 = IntOffsetKt.IntOffset(IntOffset.m6222getXimpl(offset) + IntOffset.m6222getXimpl(other$iv), IntOffset.m6223getYimpl(offset) + IntOffset.m6223getYimpl(other$iv));
            if (this.isVertical) {
    ...
    private final long m786copy4Tuh3kE(long $this$copy_u2d4Tuh3kE, Function1<? super Integer, Integer> function1) {
