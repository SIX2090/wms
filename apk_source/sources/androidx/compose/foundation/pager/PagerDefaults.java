...
public final class PagerDefaults {
    ...
    public final SnapFlingBehavior flingBehavior(PagerState state, PagerSnapDistance pagerSnapDistance, AnimationSpec<Float> animationSpec, DecayAnimationSpec<Float> decayAnimationSpec, AnimationSpec<Float> animationSpec2, float snapPositionalThreshold, Composer $composer, int $changed, int i) {
        ...
        AnimationSpec lowVelocityAnimationSpec = (i & 4) != 0 ? LowVelocityAnimationSpec : animationSpec;
        ...
        if (invalid$iv || it$iv$iv == Composer.INSTANCE.getEmpty()) {
            ...
            value$iv$iv = new SnapFlingBehavior(snapLayoutInfoProvider, lowVelocityAnimationSpec, highVelocityAnimationSpec, snapAnimationSpec);
    ...
    public final SnapFlingBehavior m789flingBehaviorPfoAEA0(PagerState state, PagerSnapDistance pagerSnapDistance, AnimationSpec<Float> animationSpec, DecayAnimationSpec<Float> decayAnimationSpec, AnimationSpec<Float> animationSpec2, float snapVelocityThreshold, float snapPositionalThreshold, Composer $composer, int $changed, int i) {
        ...
        SnapFlingBehavior flingBehavior = flingBehavior(state, pagerSnapDistance2, lowVelocityAnimationSpec, highVelocityAnimationSpec, snapAnimationSpec, snapPositionalThreshold2, $composer, ($changed & 14) | 2134528 | ($changed & 112) | (($changed >> 3) & 458752), 0);
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventEnd();
        }
        $composer.endReplaceableGroup();
