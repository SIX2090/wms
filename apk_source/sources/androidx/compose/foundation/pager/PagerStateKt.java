...
public final class PagerStateKt {
    ...
    private static final float DefaultPositionThreshold = Dp.m6094constructorimpl(56);
    ...
    public static final PagerState rememberPagerState(final int initialPage, final float initialPageOffsetFraction, final Function0<Integer> function0, Composer $composer, int $changed, int i) {
        ...
        Object m3363rememberSaveable = RememberSaveableKt.m3363rememberSaveable(objArr, saver, (String) null, (Function0<? extends Object>) value$iv, $composer, 72, 4);
        PagerStateImpl $this$rememberPagerState_u24lambda_u241 = (PagerStateImpl) m3363rememberSaveable;
        $this$rememberPagerState_u24lambda_u241.getPageCountState().setValue(function0);
        PagerStateImpl pagerStateImpl = (PagerStateImpl) m3363rememberSaveable;
        if (ComposerKt.isTraceInProgress()) {
    ...
    private static final int getSingleAxisViewPort(PagerLayoutInfo $this$singleAxisViewPort) {
        return $this$singleAxisViewPort.getOrientation() == Orientation.Vertical ? IntSize.m6263getHeightimpl($this$singleAxisViewPort.mo792getViewportSizeYbymL2g()) : IntSize.m6264getWidthimpl($this$singleAxisViewPort.mo792getViewportSizeYbymL2g());
    }
