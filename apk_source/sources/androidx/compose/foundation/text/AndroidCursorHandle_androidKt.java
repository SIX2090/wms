...
public final class AndroidCursorHandle_androidKt {
    private static final float CursorHandleHeight = Dp.m6094constructorimpl(25);
    private static final float CursorHandleWidth;
    private static final float Sqrt2 = 1.4142135f;

    static {
        float arg0$iv = CursorHandleHeight;
        CursorHandleWidth = Dp.m6094constructorimpl(Dp.m6094constructorimpl(arg0$iv * 2.0f) / 2.4142137f);
    }
    ...
    public static final void m835CursorHandleULxng0E(final long handlePosition, final Modifier modifier, final Function2<? super Composer, ? super Integer, Unit> function2, Composer $composer, final int $changed) {
        Object value$iv;
        Composer $composer2 = $composer.startRestartGroup(-5185995);
        ComposerKt.sourceInformation($composer2, "C(CursorHandle)P(1:c#ui.geometry.Offset,2)43@1674L268:AndroidCursorHandle.android.kt#423gt5");
        int $dirty = $changed;
        if (($changed & 14) == 0) {
        ...
        if (($dirty & 731) != 146 || !$composer2.getSkipping()) {
            if (ComposerKt.isTraceInProgress()) {
                ComposerKt.traceEventStart(-5185995, $dirty, -1, "androidx.compose.foundation.text.CursorHandle (AndroidCursorHandle.android.kt:42)");
            }
            $composer2.startReplaceableGroup(-1739374713);
            boolean invalid$iv = $composer2.changed(handlePosition);
            Object it$iv = $composer2.rememberedValue();
            if (invalid$iv || it$iv == Composer.INSTANCE.getEmpty()) {
                value$iv = new OffsetProvider() { // from class: androidx.compose.foundation.text.AndroidCursorHandle_androidKt$CursorHandle$1$1
            ...
            AndroidSelectionHandles_androidKt.HandlePopup((OffsetProvider) value$iv, HandleReferencePoint.TopMiddle, ComposableLambdaKt.composableLambda($composer2, -1458480226, true, new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.foundation.text.AndroidCursorHandle_androidKt$CursorHandle$2
                ...
                public final void invoke(Composer $composer3, int $changed2) {
                    ...
                    if (($changed2 & 11) != 2 || !$composer3.getSkipping()) {
                        if (ComposerKt.isTraceInProgress()) {
                            ComposerKt.traceEventStart(-1458480226, $changed2, -1, "androidx.compose.foundation.text.CursorHandle.<anonymous> (AndroidCursorHandle.android.kt:47)");
                        }
                        if (function2 == null) {
                            $composer3.startReplaceableGroup(1275643845);
                            ComposerKt.sourceInformation($composer3, "48@1847L40");
                            AndroidCursorHandle_androidKt.DefaultCursorHandle(modifier, $composer3, 0);
                            $composer3.endReplaceableGroup();
                        } else {
                            $composer3.startReplaceableGroup(1275643915);
                            ComposerKt.sourceInformation($composer3, "50@1917L9");
        ...
        if (endRestartGroup != null) {
            endRestartGroup.updateScope(new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.foundation.text.AndroidCursorHandle_androidKt$CursorHandle$3
                ...
                public final void invoke(Composer composer, int i) {
                    AndroidCursorHandle_androidKt.m835CursorHandleULxng0E(handlePosition, modifier, function2, composer, RecomposeScopeImplKt.updateChangedFlags($changed | 1));
                }
            });
        }
    }
    ...
    public static final void DefaultCursorHandle(final Modifier modifier, Composer $composer, final int $changed) {
        ...
        ComposerKt.sourceInformation($composer2, "C(DefaultCursorHandle)58@2040L79:AndroidCursorHandle.android.kt#423gt5");
        int $dirty = $changed;
        if (($changed & 14) == 0) {
        ...
        if (($dirty & 11) != 2 || !$composer2.getSkipping()) {
            if (ComposerKt.isTraceInProgress()) {
                ComposerKt.traceEventStart(694251107, $dirty, -1, "androidx.compose.foundation.text.DefaultCursorHandle (AndroidCursorHandle.android.kt:57)");
            }
            SpacerKt.Spacer(drawCursorHandle(SizeKt.m613sizeVpY3zN4(modifier, CursorHandleWidth, CursorHandleHeight)), $composer2, 0);
            if (ComposerKt.isTraceInProgress()) {
                ComposerKt.traceEventEnd();
            }
        } else {
                ...
                if (invalid$iv || it$iv == Composer.INSTANCE.getEmpty()) {
                    value$iv = new Function1<CacheDrawScope, DrawResult>() { // from class: androidx.compose.foundation.text.AndroidCursorHandle_androidKt$drawCursorHandle$1$1$1
                        ...
                        public final DrawResult invoke(CacheDrawScope $this$drawWithCache) {
                            final float radius = Size.m3574getWidthimpl($this$drawWithCache.m3412getSizeNHjbRc()) / 2.0f;
                            final ImageBitmap imageBitmap = AndroidSelectionHandles_androidKt.createHandleImage($this$drawWithCache, radius);
                            final ColorFilter colorFilter = ColorFilter.Companion.m3787tintxETnrds$default(ColorFilter.INSTANCE, handleColor, 0, 2, null);
                            return $this$drawWithCache.onDrawWithContent(new Function1<ContentDrawScope, Unit>() { // from class: androidx.compose.foundation.text.AndroidCursorHandle_androidKt$drawCursorHandle$1$1$1.1
                                ...
                                public final void invoke2(ContentDrawScope $this$onDrawWithContent) {
                                    ...
                                    $this$invoke_u24lambda_u240.mo4226rotateUv8p0NA(45.0f, Offset.INSTANCE.m3521getZeroF1C5BW0());
                                    DrawScope.m4280drawImagegbVJVH8$default($this$withTransform$iv, imageBitmap2, 0L, 0.0f, null, colorFilter2, 0, 46, null);
