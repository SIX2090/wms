...
public final class AnnotatedStringResolveInlineContentKt {
    ...
    public static final void InlineChildren(final AnnotatedString text, final List<AnnotatedString.Range<Function3<String, Composer, Integer, Unit>>> list, Composer $composer, final int $changed) {
        ...
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventStart(-1794596951, $changed, -1, "androidx.compose.foundation.text.InlineChildren (AnnotatedStringResolveInlineContent.kt:73)");
        }
            ...
            MeasurePolicy measurePolicy$iv = new MeasurePolicy() { // from class: androidx.compose.foundation.text.AnnotatedStringResolveInlineContentKt$InlineChildren$1$2
                ...
                public final MeasureResult mo38measure3p2s80s(MeasureScope $this$Layout, List<? extends Measurable> list2, long constrains) {
                    ...
                    for (int index$iv$iv = 0; index$iv$iv < size2; index$iv$iv++) {
                        ...
                        target$iv.add(it.mo5016measureBRTryo0(constrains));
                    }
                    final List placeables = target$iv;
                    return MeasureScope.layout$default($this$Layout, Constraints.m6050getMaxWidthimpl(constrains), Constraints.m6049getMaxHeightimpl(constrains), null, new Function1<Placeable.PlacementScope, Unit>() { // from class: androidx.compose.foundation.text.AnnotatedStringResolveInlineContentKt$InlineChildren$1$2.1
