        ...
        return ComposedModifierKt.composed($this$heightInLines, InspectableValueKt.isDebugInspectorInfoEnabled() ? new Function1<InspectorInfo, Unit>() { // from class: androidx.compose.foundation.text.HeightInLinesModifierKt$heightInLines$$inlined$debugInspectorInfo$1
            ...
            public final Modifier invoke(Modifier $this$composed, Composer $composer, int $changed) {
                ...
                if (invalid$iv$iv2 || it$iv$iv2 == Composer.INSTANCE.getEmpty()) {
                    ...
                    FontStyle m5603getFontStyle4Lr2A7w = resolvedStyle.m5603getFontStyle4Lr2A7w();
                    int $changed$iv = m5603getFontStyle4Lr2A7w != null ? m5603getFontStyle4Lr2A7w.m5683unboximpl() : FontStyle.INSTANCE.m5687getNormal_LCdwA();
                    FontSynthesis m5604getFontSynthesisZQGJjVo = resolvedStyle.m5604getFontSynthesisZQGJjVo();
                    int $i$f$remember = m5604getFontSynthesisZQGJjVo != null ? m5604getFontSynthesisZQGJjVo.getValue() : FontSynthesis.INSTANCE.m5697getAllGVVA2EU();
                    value$iv$iv2 = fontFamilyResolver.mo5655resolveDPcqOEQ(fontFamily, fontWeight2, $changed$iv, $i$f$remember);
                ...
                if (invalid$iv || it$iv$iv3 == Composer.INSTANCE.getEmpty()) {
                    value$iv$iv3 = Integer.valueOf(IntSize.m6263getHeightimpl(TextFieldDelegateKt.computeSizeForDefaultText(resolvedStyle, density, fontFamilyResolver, TextFieldDelegateKt.getEmptyTextReplacement(), 1)));
                ...
                if (invalid$iv2 || it$iv$iv4 == Composer.INSTANCE.getEmpty()) {
                    ...
                    value$iv$iv4 = Integer.valueOf(IntSize.m6263getHeightimpl(TextFieldDelegateKt.computeSizeForDefaultText(resolvedStyle, density, fontFamilyResolver, twoLines, 2)));
                ...
                Modifier m598heightInVpY3zN4 = SizeKt.m598heightInVpY3zN4(Modifier.INSTANCE, precomputedMinLinesHeight != null ? density.mo310toDpu2uoSUM(precomputedMinLinesHeight.intValue()) : Dp.INSTANCE.m6114getUnspecifiedD9Ej5fM(), precomputedMaxLinesHeight != null ? density.mo310toDpu2uoSUM(precomputedMaxLinesHeight.intValue()) : Dp.INSTANCE.m6114getUnspecifiedD9Ej5fM());
                if (ComposerKt.isTraceInProgress()) {
                    ComposerKt.traceEventEnd();
                }
                $composer.endReplaceableGroup();
                return m598heightInVpY3zN4;
            }
        });
    }
