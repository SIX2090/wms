...
public final class TextFieldScrollerPosition {
    ...
    public TextFieldScrollerPosition(Orientation initialOrientation, float initial) {
        ...
        this.previousSelection = TextRange.INSTANCE.m5576getZerod9O1mEE();
    ...
    */
    ...
    public final int m925getOffsetToFollow5zctL8(long selection) {
        return TextRange.m5571getStartimpl(selection) != TextRange.m5571getStartimpl(this.previousSelection) ? TextRange.m5571getStartimpl(selection) : TextRange.m5566getEndimpl(selection) != TextRange.m5566getEndimpl(this.previousSelection) ? TextRange.m5566getEndimpl(selection) : TextRange.m5569getMinimpl(selection);
    }
