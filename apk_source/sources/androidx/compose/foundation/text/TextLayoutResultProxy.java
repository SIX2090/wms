...
public final class TextLayoutResultProxy {
    ...
    public final int m938getOffsetForPosition3MmeM6k(long position, boolean coerceInVisibleBounds) {
        ...
        return this.value.m5543getOffsetForPositionk4lQ0M(relativePosition);
    }

    public final int getLineForVerticalPosition(float vertical) {
        long coercedPosition = m936coercedInVisibleBoundsOfInputTextMKHz9U(OffsetKt.Offset(0.0f, vertical));
        float relativeVertical = Offset.m3506getYimpl(m940translateDecorationToInnerCoordinatesMKHz9U$foundation_release(coercedPosition));
    ...
    public final boolean m939isPositionOnTextk4lQ0M(long offset) {
        ...
        int line = this.value.getLineForVerticalPosition(Offset.m3506getYimpl(relativeOffset));
        return Offset.m3505getXimpl(relativeOffset) >= this.value.getLineLeft(line) && Offset.m3505getXimpl(relativeOffset) <= this.value.getLineRight(line);
    }
            ...
            if (innerCoords != null) {
                ...
                if (it != null) {
                    ...
                    if (layoutCoordinates != null) {
                        ...
                        return innerCoords.mo5024localPositionOfR5De75A(decorationCoords, offset);
                    }
                }
                return offset;
            }
        ...
        if (innerCoords != null) {
            ...
            if (innerCoords != null) {
                ...
                if (it != null) {
                    ...
                    if (layoutCoordinates != null) {
                        LayoutCoordinates decorationCoords = layoutCoordinates;
                        return decorationCoords.mo5024localPositionOfR5De75A(innerCoords, offset);
                    }
                }
                return offset;
            }
