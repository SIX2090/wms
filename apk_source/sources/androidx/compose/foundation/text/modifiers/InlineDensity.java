...
public final class InlineDensity {
    ...
    /* renamed from: constructor-impl, reason: not valid java name */
    public static long m945constructorimpl(float density, float fontScale) {
        long v1$iv = Float.floatToRawIntBits(density);
        long v2$iv = Float.floatToRawIntBits(fontScale);
        return m946constructorimpl((v1$iv << 32) | (4294967295L & v2$iv));
    }
    ...
    public static final float m950getDensityimpl(long arg0) {
        FloatCompanionObject floatCompanionObject = FloatCompanionObject.INSTANCE;
        return Float.intBitsToFloat((int) (arg0 >> 32));
    }

    /* renamed from: getFontScale-impl, reason: not valid java name */
    public static final float m951getFontScaleimpl(long arg0) {
        FloatCompanionObject floatCompanionObject = FloatCompanionObject.INSTANCE;
    ...
    public static String m953toStringimpl(long arg0) {
        return "InlineDensity(density=" + m950getDensityimpl(arg0) + ", fontScale=" + m951getFontScaleimpl(arg0) + ')';
    }
