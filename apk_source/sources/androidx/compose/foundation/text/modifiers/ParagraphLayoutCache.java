...
public final class ParagraphLayoutCache {
    ...
    private ParagraphLayoutCache(String text, TextStyle style, FontFamily.Resolver fontFamilyResolver, int overflow, boolean softWrap, int maxLines, int minLines) {
        ...
        this.prevConstraints = Constraints.INSTANCE.m6058fixedJhjzzOo(0, 0);
    ...
    public /* synthetic */ ParagraphLayoutCache(String str, TextStyle textStyle, FontFamily.Resolver resolver, int i, boolean z, int i2, int i3, int i4, DefaultConstructorMarker defaultConstructorMarker) {
        this(str, textStyle, resolver, (i4 & 8) != 0 ? TextOverflow.INSTANCE.m6013getClipgIe3tQ8() : i, (i4 & 16) != 0 ? true : z, (i4 & 32) != 0 ? Integer.MAX_VALUE : i2, (i4 & 64) != 0 ? 1 : i3, null);
    }
    ...
    public final boolean m970layoutWithConstraintsK40F9xA(long constraints, LayoutDirection layoutDirection) {
        ...
        if (!m968newLayoutWillBeDifferentK40F9xA(finalConstraints, layoutDirection)) {
            if (!Constraints.m6043equalsimpl0(finalConstraints, this.prevConstraints)) {
                ...
                long localSize = ConstraintsKt.m6061constrain4WqzIAM(finalConstraints, IntSizeKt.IntSize(TextDelegateKt.ceilToIntPx(layoutWidth), TextDelegateKt.ceilToIntPx(localParagraph.getHeight())));
                this.layoutSize = localSize;
                if (TextOverflow.m6006equalsimpl0(this.overflow, TextOverflow.INSTANCE.m6015getVisiblegIe3tQ8()) || (IntSize.m6264getWidthimpl(localSize) >= localParagraph.getWidth() && IntSize.m6263getHeightimpl(localSize) >= localParagraph.getHeight())) {
                    z = false;
                }
                this.didOverflow = z;
        ...
        this.prevConstraints = finalConstraints;
        long localSize2 = ConstraintsKt.m6061constrain4WqzIAM(finalConstraints, IntSizeKt.IntSize(TextDelegateKt.ceilToIntPx(it.getWidth()), TextDelegateKt.ceilToIntPx(it.getHeight())));
        this.layoutSize = localSize2;
        if (!TextOverflow.m6006equalsimpl0(this.overflow, TextOverflow.INSTANCE.m6015getVisiblegIe3tQ8()) && (IntSize.m6264getWidthimpl(localSize2) < it.getWidth() || IntSize.m6263getHeightimpl(localSize2) < it.getHeight())) {
            z2 = true;
        }
        this.didOverflow = z2;
        this.paragraph = it;
    ...
    private final Paragraph m967layoutTextK40F9xA(long constraints, LayoutDirection layoutDirection) {
        ...
        return ParagraphKt.m5464Paragraph_EkL_Y(localParagraphIntrinsics, LayoutUtilsKt.m956finalConstraintstfFHcEY(constraints, this.softWrap, this.overflow, localParagraphIntrinsics.getMaxIntrinsicWidth()), LayoutUtilsKt.m957finalMaxLinesxdlQI24(this.softWrap, this.overflow, this.maxLines), TextOverflow.m6006equalsimpl0(this.overflow, TextOverflow.INSTANCE.m6014getEllipsisgIe3tQ8()));
    }
    ...
    private final boolean m968newLayoutWillBeDifferentK40F9xA(long constraints, LayoutDirection layoutDirection) {
        ...
        if (Constraints.m6043equalsimpl0(constraints, this.prevConstraints)) {
            return false;
        }
        return Constraints.m6050getMaxWidthimpl(constraints) != Constraints.m6050getMaxWidthimpl(this.prevConstraints) || ((float) Constraints.m6049getMaxHeightimpl(constraints)) < localParagraph.getHeight() || localParagraph.getDidExceedMaxLines();
    }
    ...
    public final TextLayoutResult slowCreateTextLayoutResultOrNull(TextStyle style) {
        ...
        finalConstraints = Constraints.m6040copyZbe2FdA(r10, (r12 & 1) != 0 ? Constraints.m6052getMinWidthimpl(r10) : 0, (r12 & 2) != 0 ? Constraints.m6050getMaxWidthimpl(r10) : 0, (r12 & 4) != 0 ? Constraints.m6051getMinHeightimpl(r10) : 0, (r12 & 8) != 0 ? Constraints.m6049getMaxHeightimpl(this.prevConstraints) : 0);
        return new TextLayoutResult(new TextLayoutInput(annotatedString, style, CollectionsKt.emptyList(), this.maxLines, this.softWrap, this.overflow, localDensity, localLayoutDirection, this.fontFamilyResolver, finalConstraints, (DefaultConstructorMarker) null), new MultiParagraph(new MultiParagraphIntrinsics(annotatedString, style, (List<AnnotatedString.Range<Placeholder>>) CollectionsKt.emptyList(), localDensity, this.fontFamilyResolver), finalConstraints, this.maxLines, TextOverflow.m6006equalsimpl0(this.overflow, TextOverflow.INSTANCE.m6014getEllipsisgIe3tQ8()), null), this.layoutSize, null);
    }
