...
public class StaticTextSelectionParams {
    ...
    public boolean getShouldClip() {
        ...
        return (it == null || TextOverflow.m6006equalsimpl0(it.getLayoutInput().getOverflow(), TextOverflow.INSTANCE.m6015getVisiblegIe3tQ8()) || !it.getHasVisualOverflow()) ? false : true;
    }
