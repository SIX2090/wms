...
public final class SelectionColors {
    ...
    public boolean equals(Object other) {
        ...
        return (other instanceof SelectionColors) && Color.m3747equalsimpl0(this.selectionHandleColor, ((SelectionColors) other).selectionHandleColor) && Color.m3747equalsimpl0(this.selectionBackgroundColor, ((SelectionColors) other).selectionBackgroundColor);
    }

    public int hashCode() {
        int result = Color.m3753hashCodeimpl(this.selectionHandleColor);
        return (result * 31) + Color.m3753hashCodeimpl(this.selectionBackgroundColor);
    }

    public String toString() {
        return "SelectionColors(selectionHandleColor=" + ((Object) Color.m3754toStringimpl(this.selectionHandleColor)) + ", selectionBackgroundColor=" + ((Object) Color.m3754toStringimpl(this.selectionBackgroundColor)) + ')';
    }
}
