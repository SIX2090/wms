            ...
            case 0:
                ...
                Flow snapshotFlow = SnapshotStateKt.snapshotFlow(new Function0<Offset>() { // from class: androidx.compose.foundation.text.selection.SelectionMagnifierKt$rememberAnimatedMagnifierPosition$1.1
                    ...
                    public /* bridge */ /* synthetic */ Offset invoke() {
                        return Offset.m3494boximpl(m1011invokeF1C5BW0());
                    }
                ...
                if (snapshotFlow.collect(new FlowCollector() { // from class: androidx.compose.foundation.text.selection.SelectionMagnifierKt$rememberAnimatedMagnifierPosition$1.2
                    ...
                    public /* bridge */ /* synthetic */ Object emit(Object value, Continuation $completion) {
                        return m1012emit3MmeM6k(((Offset) value).getPackedValue(), $completion);
                    }

                    /* renamed from: emit-3MmeM6k, reason: not valid java name */
                    public final Object m1012emit3MmeM6k(long targetValue, Continuation<? super Unit> continuation) {
                        if (OffsetKt.m3524isSpecifiedk4lQ0M(animatable.getValue().getPackedValue()) && OffsetKt.m3524isSpecifiedk4lQ0M(targetValue)) {
                            if (!(Offset.m3506getYimpl(animatable.getValue().getPackedValue()) == Offset.m3506getYimpl(targetValue))) {
                        ...
                        Object snapTo = animatable.snapTo(Offset.m3494boximpl(targetValue), continuation);
