...
public final class InputTransformationKt {
    public static final InputTransformation thenOrNull(InputTransformation $this$then, InputTransformation next) {
        return $this$then == null ? next : next == null ? $this$then : then($this$then, next);
    }
