...
final class TextFieldCharSequenceWrapper implements TextFieldCharSequence {
    ...
    private TextFieldCharSequenceWrapper(CharSequence text, long selection, TextRange composition) {
        this.text = text;
        this.selectionInChars = TextRangeKt.m5577coerceIn8ffj60Q(selection, 0, this.text.length());
        this.compositionInChars = composition != null ? TextRange.m5559boximpl(TextRangeKt.m5577coerceIn8ffj60Q(composition.getPackedValue(), 0, this.text.length())) : null;
    }
    ...
    public boolean equals(Object other) {
        ...
        if (TextRange.m5564equalsimpl0(getSelectionInChars(), ((TextFieldCharSequenceWrapper) other).getSelectionInChars()) && Intrinsics.areEqual(getCompositionInChars(), ((TextFieldCharSequenceWrapper) other).getCompositionInChars()) && contentEquals(((TextFieldCharSequenceWrapper) other).text)) {
            return true;
        }
        return false;
    }
    ...
    public int hashCode() {
        ...
        int result2 = ((result * 31) + TextRange.m5572hashCodeimpl(getSelectionInChars())) * 31;
        TextRange compositionInChars = getCompositionInChars();
        return result2 + (compositionInChars != null ? TextRange.m5572hashCodeimpl(compositionInChars.getPackedValue()) : 0);
    }
}
