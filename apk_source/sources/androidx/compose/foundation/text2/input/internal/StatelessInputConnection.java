...
public final class StatelessInputConnection implements InputConnection {
    ...
    public CharSequence getSelectedText(int flags) {
        CharSequence result;
        if (TextRange.m5565getCollapsedimpl(getText().getSelectionInChars())) {
            result = null;
        } else {
    ...
    public int getCursorCapsMode(int reqModes) {
        ...
        return TextUtils.getCapsMode(getText(), TextRange.m5569getMinimpl(getText().getSelectionInChars()), reqModes);
    }
