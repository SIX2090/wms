...
public final class StatelessInputConnection_androidKt {
    ...
    public static final ExtractedText toExtractedText(TextFieldCharSequence textFieldCharSequence) {
        ...
        extractedText.selectionStart = TextRange.m5569getMinimpl(textFieldCharSequence.getSelectionInChars());
        extractedText.selectionEnd = TextRange.m5568getMaximpl(textFieldCharSequence.getSelectionInChars());
