...
public final class TextFieldTextLayoutModifierNode extends Modifier.Node implements LayoutModifierNode, GlobalPositionAwareModifierNode, CompositionLocalConsumerModifierNode {
    ...
    public MeasureResult mo90measure3p2s80s(MeasureScope $this$measure_u2d3p2s80s, Measurable measurable, long constraints) {
        ...
        TextLayoutResult result = this.textLayoutState.m1145layoutWithNewMeasureInputshBUhpc($this$measure_u2d3p2s80s, $this$measure_u2d3p2s80s.getLayoutDirection(), (FontFamily.Resolver) CompositionLocalConsumerModifierNodeKt.currentValueOf(this, CompositionLocalsKt.getLocalFontFamilyResolver()), constraints);
        final Placeable placeable = measurable.mo5016measureBRTryo0(Constraints.INSTANCE.m6058fixedJhjzzOo(IntSize.m6264getWidthimpl(result.getSize()), IntSize.m6263getHeightimpl(result.getSize())));
        TextLayoutState textLayoutState = this.textLayoutState;
        if (this.singleLine) {
            m6094constructorimpl = $this$measure_u2d3p2s80s.mo310toDpu2uoSUM(TextDelegateKt.ceilToIntPx(result.getLineBottom(0)));
        } else {
            m6094constructorimpl = Dp.m6094constructorimpl(0);
        }
        textLayoutState.m1146setMinHeightForSingleLineField0680j_4(m6094constructorimpl);
        return $this$measure_u2d3p2s80s.layout(IntSize.m6264getWidthimpl(result.getSize()), IntSize.m6263getHeightimpl(result.getSize()), MapsKt.mapOf(TuplesKt.to(AlignmentLineKt.getFirstBaseline(), Integer.valueOf(MathKt.roundToInt(result.getFirstBaseline()))), TuplesKt.to(AlignmentLineKt.getLastBaseline(), Integer.valueOf(MathKt.roundToInt(result.getLastBaseline())))), new Function1<Placeable.PlacementScope, Unit>() { // from class: androidx.compose.foundation.text2.input.internal.TextFieldTextLayoutModifierNode$measure$1
            {
                super(1);
            }
