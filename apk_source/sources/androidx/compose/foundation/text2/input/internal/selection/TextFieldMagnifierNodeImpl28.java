...
public final class TextFieldMagnifierNodeImpl28 extends TextFieldMagnifierNode implements CompositionLocalConsumerModifierNode {
    ...
    private final MutableState magnifierSize = SnapshotStateKt__SnapshotStateKt.mutableStateOf$default(IntSize.m6256boximpl(IntSize.INSTANCE.m6269getZeroYbymL2g()), null, 2, null);
    private final MagnifierNode magnifierNode = (MagnifierNode) delegate(new MagnifierNode(new Function1<Density, Offset>() { // from class: androidx.compose.foundation.text2.input.internal.selection.TextFieldMagnifierNodeImpl28$magnifierNode$1
        ...
        public /* bridge */ /* synthetic */ Offset invoke(Density density) {
            return Offset.m3494boximpl(m1173invoketuRUvjQ(density));
        }
        ...
        public final void m1174invokeEaSLcWc(long size) {
            ...
            textFieldMagnifierNodeImpl28.m1172setMagnifierSizeozmzZPI(IntSizeKt.IntSize($this$invoke_EaSLcWc_u24lambda_u240.mo307roundToPx0680j_4(DpSize.m6192getWidthD9Ej5fM(size)), $this$invoke_EaSLcWc_u24lambda_u240.mo307roundToPx0680j_4(DpSize.m6190getHeightD9Ej5fM(size))));
        }
    ...
    public TextFieldMagnifierNodeImpl28(TransformedTextFieldState textFieldState, TextFieldSelectionState textFieldSelectionState, TextLayoutState textLayoutState, boolean isFocused) {
        ...
        this.animatable = new Animatable<>(Offset.m3494boximpl(TextFieldMagnifierKt.m1168calculateSelectionMagnifierCenterAndroidhUlJWOE(this.textFieldState, this.textFieldSelectionState, this.textLayoutState, m1171getMagnifierSizeYbymL2g())), SelectionMagnifierKt.getUnspecifiedSafeOffsetVectorConverter(), Offset.m3494boximpl(SelectionMagnifierKt.getOffsetDisplacementThreshold()), null, 8, null);
    }
