...
public final class TextUndoOperation {
    ...
    private static final Saver<TextUndoOperation, Object> Saver = new Saver<TextUndoOperation, Object>() { // from class: androidx.compose.foundation.text2.input.internal.undo.TextUndoOperation$Companion$Saver$1
        ...
        public Object save(SaverScope $this$save, TextUndoOperation value) {
            return CollectionsKt.listOf(Integer.valueOf(value.getIndex()), value.getPreText(), value.getPostText(), Integer.valueOf(TextRange.m5571getStartimpl(value.getPreSelection())), Integer.valueOf(TextRange.m5566getEndimpl(value.getPreSelection())), Integer.valueOf(TextRange.m5571getStartimpl(value.getPostSelection())), Integer.valueOf(TextRange.m5566getEndimpl(value.getPostSelection())), Long.valueOf(value.getTimeInMillis()));
        }
    ...
    */
    public /* synthetic */ TextUndoOperation(int r15, java.lang.String r16, java.lang.String r17, long r18, long r20, long r22, boolean r24, int r25, kotlin.jvm.internal.DefaultConstructorMarker r26) {
        ...
        L15:
            ...
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: androidx.compose.foundation.text2.input.internal.undo.TextUndoOperation.<init>(int, java.lang.String, java.lang.String, long, long, long, boolean, int, kotlin.jvm.internal.DefaultConstructorMarker):void");
    }
    ...
    public final TextDeleteType getDeletionType() {
        if (this.textEditType == TextEditType.Delete && TextRange.m5565getCollapsedimpl(this.postSelection)) {
            if (TextRange.m5565getCollapsedimpl(this.preSelection)) {
                if (TextRange.m5571getStartimpl(this.preSelection) > TextRange.m5571getStartimpl(this.postSelection)) {
                    return TextDeleteType.Start;
                }
                return TextDeleteType.End;
            }
            if (TextRange.m5571getStartimpl(this.preSelection) == TextRange.m5571getStartimpl(this.postSelection) && TextRange.m5571getStartimpl(this.preSelection) == this.index) {
