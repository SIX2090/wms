...
public final class BackdropScaffoldDefaults {
    ...
    private static final float PeekHeight = Dp.m6094constructorimpl(56);
    private static final float HeaderHeight = Dp.m6094constructorimpl(48);
    private static final float FrontLayerElevation = Dp.m6094constructorimpl(1);
    ...
    public final Shape getFrontLayerShape(Composer $composer, int $changed) {
        ...
        CornerBasedShape copy$default = CornerBasedShape.copy$default(MaterialTheme.INSTANCE.getShapes($composer, 6).getLarge(), CornerSizeKt.m824CornerSize0680j_4(Dp.m6094constructorimpl(16)), CornerSizeKt.m824CornerSize0680j_4(Dp.m6094constructorimpl(16)), null, null, 12, null);
        if (ComposerKt.isTraceInProgress()) {
    ...
    public final long getFrontLayerScrimColor(Composer $composer, int $changed) {
        ...
        m3744copywmQWz5c = Color.m3744copywmQWz5c(r1, (r12 & 1) != 0 ? Color.m3748getAlphaimpl(r1) : 0.6f, (r12 & 2) != 0 ? Color.m3752getRedimpl(r1) : 0.0f, (r12 & 4) != 0 ? Color.m3751getGreenimpl(r1) : 0.0f, (r12 & 8) != 0 ? Color.m3749getBlueimpl(MaterialTheme.INSTANCE.getColors($composer, 6).m1290getSurface0d7_KjU()) : 0.0f);
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventEnd();
        }
        $composer.endReplaceableGroup();
