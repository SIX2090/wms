...
final /* data */ class BottomAppBarCutoutShape implements Shape {
    ...
    public Outline mo260createOutlinePq9zytI(long size, LayoutDirection layoutDirection, Density density) {
        ...
        boundingRectangle.addRect(new Rect(0.0f, 0.0f, Size.m3574getWidthimpl(size), Size.m3571getHeightimpl(size)));
        ...
        $this$createOutline_Pq9zytI_u24lambda_u241.mo3638opN5in7k0(boundingRectangle, $this$createOutline_Pq9zytI_u24lambda_u241, PathOperation.INSTANCE.m4037getDifferenceb3I0S0c());
    ...
    private final void addCutoutShape(Path $this$addCutoutShape, LayoutDirection layoutDirection, Density density) {
        ...
        float cutoutOffset = density.mo313toPx0680j_4(f);
        float f3 = 2;
        ...
        float cutoutEndX = cutoutStartX + Size.m3574getWidthimpl(cutoutSize);
        float cutoutRadius = Size.m3571getHeightimpl(cutoutSize) / 2.0f;
        float cutoutStartY = -cutoutRadius;
        OutlineKt.addOutline($this$addCutoutShape, this.cutoutShape.mo260createOutlinePq9zytI(cutoutSize, layoutDirection, density));
        $this$addCutoutShape.mo3641translatek4lQ0M(OffsetKt.Offset(cutoutStartX, cutoutStartY));
        if (Intrinsics.areEqual(this.cutoutShape, RoundedCornerShapeKt.getCircleShape())) {
            f2 = AppBarKt.BottomAppBarRoundedEdgeRadius;
            float edgeRadius = density.mo313toPx0680j_4(f2);
