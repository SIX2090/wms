...
public final class BottomSheetScaffoldKt$ConsumeSwipeWithinBottomSheetBoundsNestedScrollConnection$1 implements NestedScrollConnection {
    ...
    public long mo401onPreScrollOzD1aCk(long available, int source) {
        ...
        if (delta < 0.0f && NestedScrollSource.m4779equalsimpl0(source, NestedScrollSource.INSTANCE.m4784getDragWNlRxjI())) {
    ...
    */
    public java.lang.Object mo641onPreFlingQWom1Mo(long r7, kotlin.coroutines.Continuation<? super androidx.compose.ui.unit.Velocity> r9) {
        ...
        L64:
            ...
            long r7 = r7.m6340getZero9UxMQ8M()
        L6a:
            androidx.compose.ui.unit.Velocity r7 = androidx.compose.ui.unit.Velocity.m6320boximpl(r7)
            return r7
        */
        throw new UnsupportedOperationException("Method not decompiled: androidx.compose.material.BottomSheetScaffoldKt$ConsumeSwipeWithinBottomSheetBoundsNestedScrollConnection$1.mo641onPreFlingQWom1Mo(long, kotlin.coroutines.Continuation):java.lang.Object");
    }
    ...
    */
    public java.lang.Object mo399onPostFlingRZ2iAVY(long r5, long r7, kotlin.coroutines.Continuation<? super androidx.compose.ui.unit.Velocity> r9) {
        ...
        L33:
            ...
            return r9
        L49:
            androidx.compose.ui.unit.Velocity r9 = androidx.compose.ui.unit.Velocity.m6320boximpl(r7)
            return r9
        */
        throw new UnsupportedOperationException("Method not decompiled: androidx.compose.material.BottomSheetScaffoldKt$ConsumeSwipeWithinBottomSheetBoundsNestedScrollConnection$1.mo399onPostFlingRZ2iAVY(long, long, kotlin.coroutines.Continuation):java.lang.Object");
    }
    ...
    private final float velocityToFloat(long $this$toFloat) {
        return this.$orientation == Orientation.Horizontal ? Velocity.m6329getXimpl($this$toFloat) : Velocity.m6330getYimpl($this$toFloat);
    }

    private final float offsetToFloat(long $this$toFloat) {
        return this.$orientation == Orientation.Horizontal ? Offset.m3505getXimpl($this$toFloat) : Offset.m3506getYimpl($this$toFloat);
    }
}
