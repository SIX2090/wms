...
final class DefaultRadioButtonColors implements RadioButtonColors {
    ...
    public boolean equals(Object other) {
        ...
        if (Color.m3747equalsimpl0(this.selectedColor, ((DefaultRadioButtonColors) other).selectedColor) && Color.m3747equalsimpl0(this.unselectedColor, ((DefaultRadioButtonColors) other).unselectedColor) && Color.m3747equalsimpl0(this.disabledColor, ((DefaultRadioButtonColors) other).disabledColor)) {
            return true;
        }
        return false;
    }
    ...
    public int hashCode() {
        ...
        return (((result * 31) + Color.m3753hashCodeimpl(this.unselectedColor)) * 31) + Color.m3753hashCodeimpl(this.disabledColor);
    }
}
