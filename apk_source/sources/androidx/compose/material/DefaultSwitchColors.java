...
final class DefaultSwitchColors implements SwitchColors {
    ...
    public boolean equals(Object other) {
        ...
        if (Color.m3747equalsimpl0(this.checkedThumbColor, ((DefaultSwitchColors) other).checkedThumbColor) && Color.m3747equalsimpl0(this.checkedTrackColor, ((DefaultSwitchColors) other).checkedTrackColor) && Color.m3747equalsimpl0(this.uncheckedThumbColor, ((DefaultSwitchColors) other).uncheckedThumbColor) && Color.m3747equalsimpl0(this.uncheckedTrackColor, ((DefaultSwitchColors) other).uncheckedTrackColor) && Color.m3747equalsimpl0(this.disabledCheckedThumbColor, ((DefaultSwitchColors) other).disabledCheckedThumbColor) && Color.m3747equalsimpl0(this.disabledCheckedTrackColor, ((DefaultSwitchColors) other).disabledCheckedTrackColor) && Color.m3747equalsimpl0(this.disabledUncheckedThumbColor, ((DefaultSwitchColors) other).disabledUncheckedThumbColor) && Color.m3747equalsimpl0(this.disabledUncheckedTrackColor, ((DefaultSwitchColors) other).disabledUncheckedTrackColor)) {
            return true;
        }
        return false;
    }
    ...
    public int hashCode() {
        ...
        return (((((((((((((result * 31) + Color.m3753hashCodeimpl(this.checkedTrackColor)) * 31) + Color.m3753hashCodeimpl(this.uncheckedThumbColor)) * 31) + Color.m3753hashCodeimpl(this.uncheckedTrackColor)) * 31) + Color.m3753hashCodeimpl(this.disabledCheckedThumbColor)) * 31) + Color.m3753hashCodeimpl(this.disabledCheckedTrackColor)) * 31) + Color.m3753hashCodeimpl(this.disabledUncheckedThumbColor)) * 31) + Color.m3753hashCodeimpl(this.disabledUncheckedTrackColor);
    }
}
