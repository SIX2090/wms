...
public final class DividerKt {
    ...
    public static final void m1327DivideroMI9zvI(Modifier modifier, long color, float thickness, float startIndent, Composer $composer, final int $changed, final int i) {
        Modifier modifier2;
        long j;
        float f;
        float f2;
        ...
        if (($dirty & 5851) == 1170 && $composer2.getSkipping()) {
            ...
            if (($changed & 1) == 0 || $composer2.getDefaultsInvalid()) {
                ...
                if ((i & 2) != 0) {
                    color2 = Color.m3744copywmQWz5c(r12, (r12 & 1) != 0 ? Color.m3748getAlphaimpl(r12) : 0.12f, (r12 & 2) != 0 ? Color.m3752getRedimpl(r12) : 0.0f, (r12 & 4) != 0 ? Color.m3751getGreenimpl(r12) : 0.0f, (r12 & 8) != 0 ? Color.m3749getBlueimpl(MaterialTheme.INSTANCE.getColors($composer2, 6).m1285getOnSurface0d7_KjU()) : 0.0f);
                    $dirty &= -113;
                } else {
                    color2 = j;
                }
                thickness2 = i4 != 0 ? Dp.m6094constructorimpl(1) : f;
                startIndent2 = i5 != 0 ? Dp.m6094constructorimpl(0) : f2;
            } else {
                $composer2.skipToGroupEnd();
                if ((i & 2) != 0) {
                    $dirty &= -113;
            ...
            Modifier.Companion indentMod = !((startIndent2 > 0.0f ? 1 : (startIndent2 == 0.0f ? 0 : -1)) == 0) ? PaddingKt.m566paddingqDBjuR0$default(Modifier.INSTANCE, startIndent2, 0.0f, 0.0f, 0.0f, 14, null) : Modifier.INSTANCE;
            ...
            BoxKt.Box(BackgroundKt.m210backgroundbw27NRU$default(SizeKt.m597height3ABfNKs(SizeKt.fillMaxWidth$default(modifier3.then(indentMod), 0.0f, 1, null), targetThickness), color2, null, 2, null), $composer2, 0);
            if (ComposerKt.isTraceInProgress()) {
        ...
        if (endRestartGroup != null) {
            ...
            endRestartGroup.updateScope(new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.material.DividerKt$Divider$1
                ...
                public final void invoke(Composer composer, int i6) {
                    DividerKt.m1327DivideroMI9zvI(Modifier.this, j2, f3, f4, composer, RecomposeScopeImplKt.updateChangedFlags($changed | 1), i);
                }
            });
        }
    }
