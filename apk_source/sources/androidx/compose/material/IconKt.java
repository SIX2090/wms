...
public final class IconKt {
    private static final Modifier DefaultIconSizeModifier = SizeKt.m611size3ABfNKs(Modifier.INSTANCE, Dp.m6094constructorimpl(24));
    ...
    public static final void m1376Iconww6aTOc(ImageVector imageVector, String contentDescription, Modifier modifier, long tint, Composer $composer, int $changed, int i) {
        ...
        if ((i & 8) != 0) {
            ...
            ComposerKt.sourceInformationMarkerEnd($composer);
            m3744copywmQWz5c = Color.m3744copywmQWz5c(m3756unboximpl, (r12 & 1) != 0 ? Color.m3748getAlphaimpl(m3756unboximpl) : ((Number) consume2).floatValue(), (r12 & 2) != 0 ? Color.m3752getRedimpl(m3756unboximpl) : 0.0f, (r12 & 4) != 0 ? Color.m3751getGreenimpl(m3756unboximpl) : 0.0f, (r12 & 8) != 0 ? Color.m3749getBlueimpl(m3756unboximpl) : 0.0f);
            tint2 = m3744copywmQWz5c;
        } else {
            tint2 = tint;
        }
    ...
    public static final void m1375Iconww6aTOc(final Painter painter, final String contentDescription, Modifier modifier, long tint, Composer $composer, final int $changed, final int i) {
        ...
        if ((i & 8) != 0) {
            ...
            ComposerKt.sourceInformationMarkerEnd($composer2);
            tint3 = Color.m3744copywmQWz5c(m3756unboximpl, (r12 & 1) != 0 ? Color.m3748getAlphaimpl(m3756unboximpl) : ((Number) consume2).floatValue(), (r12 & 2) != 0 ? Color.m3752getRedimpl(m3756unboximpl) : 0.0f, (r12 & 4) != 0 ? Color.m3751getGreenimpl(m3756unboximpl) : 0.0f, (r12 & 8) != 0 ? Color.m3749getBlueimpl(m3756unboximpl) : 0.0f);
        ...
        Object key1$iv = Color.m3736boximpl(tint2);
        int i2 = ($dirty >> 9) & 14;
        ...
        if (invalid$iv$iv || value$iv$iv == Composer.INSTANCE.getEmpty()) {
            if (!Color.m3747equalsimpl0(tint2, Color.INSTANCE.m3782getUnspecified0d7_KjU())) {
                colorFilter = ColorFilter.Companion.m3787tintxETnrds$default(ColorFilter.INSTANCE, tint2, 0, 2, null);
            }
            value$iv$iv = colorFilter;
            $composer2.updateRememberedValue(value$iv$iv);
        }
        $composer2.endReplaceableGroup();
        ColorFilter colorFilter2 = (ColorFilter) value$iv$iv;
        ...
        paint = PainterModifierKt.paint(defaultSizeFor(GraphicsLayerModifierKt.toolingGraphicsLayer(modifier2), painter), painter, (r14 & 2) != 0, (r14 & 4) != 0 ? Alignment.INSTANCE.getCenter() : null, (r14 & 8) != 0 ? ContentScale.INSTANCE.getInside() : ContentScale.INSTANCE.getFit(), (r14 & 16) != 0 ? 1.0f : 0.0f, (r14 & 32) != 0 ? null : colorFilter2);
        ...
        if (endRestartGroup != null) {
            ...
            endRestartGroup.updateScope(new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.material.IconKt$Icon$1
                ...
                public final void invoke(Composer composer, int i3) {
                    IconKt.m1375Iconww6aTOc(Painter.this, contentDescription, modifier3, j, composer, RecomposeScopeImplKt.updateChangedFlags($changed | 1), i);
                }
            });
        }
    }
    ...
    private static final Modifier defaultSizeFor(Modifier $this$defaultSizeFor, Painter painter) {
        Modifier.Companion companion;
        if (Size.m3570equalsimpl0(painter.getIntrinsicSize(), Size.INSTANCE.m3582getUnspecifiedNHjbRc()) || m1377isInfiniteuvyYCjk(painter.getIntrinsicSize())) {
