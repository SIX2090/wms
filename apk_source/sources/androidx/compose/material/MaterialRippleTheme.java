...
final class MaterialRippleTheme implements RippleTheme {
    ...
    public long mo1380defaultColorWaAFU9c(Composer $composer, int $changed) {
        ...
        long m1555defaultRippleColor5vOe2sY = companion.m1555defaultRippleColor5vOe2sY(((Color) consume).m3756unboximpl(), MaterialTheme.INSTANCE.getColors($composer, 6).isLight());
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventEnd();
        }
        $composer.endReplaceableGroup();
        return m1555defaultRippleColor5vOe2sY;
    }
    ...
    public RippleAlpha rippleAlpha(Composer $composer, int $changed) {
        ...
        Object consume = $composer.consume(localContentColor);
        ComposerKt.sourceInformationMarkerEnd($composer);
        RippleAlpha m1554defaultRippleAlphaDxMtmZc = companion.m1554defaultRippleAlphaDxMtmZc(((Color) consume).m3756unboximpl(), MaterialTheme.INSTANCE.getColors($composer, 6).isLight());
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventEnd();
        }
        $composer.endReplaceableGroup();
        return m1554defaultRippleAlphaDxMtmZc;
    }
}
