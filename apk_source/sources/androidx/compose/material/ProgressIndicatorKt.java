...
public final class ProgressIndicatorKt {
    ...
    private static final float CircularIndicatorDiameter = Dp.m6094constructorimpl(40);
    ...
    public static final Modifier increaseSemanticsBounds(Modifier $this$increaseSemanticsBounds) {
        final float padding = Dp.m6094constructorimpl(10);
    ...
    */
    ...
    /*
        ...
        To view partially-correct add '--show-bad-code' argument
    */
    public static final void m1413LinearProgressIndicator2cYBFYY(androidx.compose.ui.Modifier r29, long r30, long r32, int r34, androidx.compose.runtime.Composer r35, final int r36, final int r37) {
        /*
            Method dump skipped, instructions count: 699
            To view this dump add '--comments-level debug' option
        */
        throw new UnsupportedOperationException("Method not decompiled: androidx.compose.material.ProgressIndicatorKt.m1413LinearProgressIndicator2cYBFYY(androidx.compose.ui.Modifier, long, long, int, androidx.compose.runtime.Composer, int, int):void");
    }
    ...
    public static final /* synthetic */ void m1416LinearProgressIndicatoreaDK9VM(final float progress, Modifier modifier, long color, long backgroundColor, Composer $composer, final int $changed, final int i) {
        ...
        if (($dirty & 5851) == 1170 && $composer2.getSkipping()) {
            ...
            if (($changed & 1) == 0 || $composer2.getDefaultsInvalid()) {
                ...
                if ((i & 8) != 0) {
                    backgroundColor2 = Color.m3744copywmQWz5c(r12, (r12 & 1) != 0 ? Color.m3748getAlphaimpl(r12) : 0.24f, (r12 & 2) != 0 ? Color.m3752getRedimpl(r12) : 0.0f, (r12 & 4) != 0 ? Color.m3751getGreenimpl(r12) : 0.0f, (r12 & 8) != 0 ? Color.m3749getBlueimpl(color2) : 0.0f);
                    $dirty &= -7169;
                } else {
                    backgroundColor2 = j2;
                }
            ...
            m1415LinearProgressIndicator_5eSRE(progress, modifier3, color2, backgroundColor2, StrokeCap.INSTANCE.m4098getButtKaPHkGw(), $composer2, ($dirty & 14) | ($dirty & 112) | ($dirty & 896) | ($dirty & 7168), 0);
            if (ComposerKt.isTraceInProgress()) {
        ...
        if (endRestartGroup != null) {
            ...
            endRestartGroup.updateScope(new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.material.ProgressIndicatorKt$LinearProgressIndicator$5
                ...
                public final void invoke(Composer composer, int i5) {
                    ProgressIndicatorKt.m1416LinearProgressIndicatoreaDK9VM(progress, modifier5, j3, j4, composer, RecomposeScopeImplKt.updateChangedFlags($changed | 1), i);
                }
            });
        }
    }
    ...
    public static final /* synthetic */ void m1414LinearProgressIndicatorRIQooxk(Modifier modifier, long color, long backgroundColor, Composer $composer, final int $changed, final int i) {
        ...
        if (($dirty & 731) == 146 && $composer2.getSkipping()) {
            ...
            if (($changed & 1) == 0 || $composer2.getDefaultsInvalid()) {
                ...
                if ((i & 4) != 0) {
                    backgroundColor2 = Color.m3744copywmQWz5c(r11, (r12 & 1) != 0 ? Color.m3748getAlphaimpl(r11) : 0.24f, (r12 & 2) != 0 ? Color.m3752getRedimpl(r11) : 0.0f, (r12 & 4) != 0 ? Color.m3751getGreenimpl(r11) : 0.0f, (r12 & 8) != 0 ? Color.m3749getBlueimpl(color2) : 0.0f);
                    $dirty &= -897;
                } else {
                    backgroundColor2 = j2;
                }
            ...
            m1413LinearProgressIndicator2cYBFYY(modifier3, color2, backgroundColor2, StrokeCap.INSTANCE.m4098getButtKaPHkGw(), $composer2, ($dirty & 14) | ($dirty & 112) | ($dirty & 896), 0);
            if (ComposerKt.isTraceInProgress()) {
                ComposerKt.traceEventEnd();
            }
            modifier4 = modifier3;
        ...
        if (endRestartGroup != null) {
            ...
            endRestartGroup.updateScope(new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.material.ProgressIndicatorKt$LinearProgressIndicator$6
                ...
                public final void invoke(Composer composer, int i5) {
                    ProgressIndicatorKt.m1414LinearProgressIndicatorRIQooxk(Modifier.this, j3, j4, composer, RecomposeScopeImplKt.updateChangedFlags($changed | 1), i);
                }
            });
        }
    }
    ...
    public static final void m1409CircularProgressIndicatorDUhRLBM(final float progress, Modifier modifier, long color, float strokeWidth, long backgroundColor, int strokeCap, Composer $composer, final int $changed, final int i) {
        ...
        if ((374491 & $dirty2) == 74898 && $composer2.getSkipping()) {
            ...
            if (($changed & 1) == 0 || $composer2.getDefaultsInvalid()) {
                ...
                if (i7 != 0) {
                    backgroundColor2 = Color.INSTANCE.m3781getTransparent0d7_KjU();
                }
                if ((i & 32) != 0) {
                    $dirty = $dirty2 & (-458753);
                    strokeCap2 = StrokeCap.INSTANCE.m4098getButtKaPHkGw();
                    backgroundColor3 = backgroundColor2;
                    color3 = color2;
    ...
    public static final void m1410CircularProgressIndicatorLxG7B9w(Modifier modifier, long color, float strokeWidth, long backgroundColor, int strokeCap, Composer $composer, final int $changed, final int i) {
        ...
        if ((46811 & $dirty2) == 9362 && $composer2.getSkipping()) {
            ...
            if (($changed & 1) == 0 || $composer2.getDefaultsInvalid()) {
                ...
                if ((i & 16) != 0) {
                    ...
                    modifier3 = modifier4;
                    color3 = color2;
                    strokeCap2 = StrokeCap.INSTANCE.m4100getSquareKaPHkGw();
                    backgroundColor3 = backgroundColor2;
                    strokeWidth3 = strokeWidth2;
                } else {
                    $dirty = $dirty2;
            ...
            final State baseRotation$delegate = InfiniteTransitionKt.animateFloat(transition, 0.0f, BaseRotationAngle, AnimationSpecKt.m127infiniteRepeatable9IiC70o$default(AnimationSpecKt.tween$default(RotationDuration, 0, EasingKt.getLinearEasing(), 2, null), null, 0L, 6, null), null, $composer2, InfiniteTransition.$stable | 432 | (InfiniteRepeatableSpec.$stable << 9), 8);
            ...
            CanvasKt.Canvas(SizeKt.m611size3ABfNKs(ProgressSemanticsKt.progressSemantics(modifier3), CircularIndicatorDiameter), new Function1<DrawScope, Unit>() { // from class: androidx.compose.material.ProgressIndicatorKt$CircularProgressIndicator$3
                ...
                public final void invoke2(DrawScope $this$Canvas) {
                    ...
                    ProgressIndicatorKt.m1425drawIndeterminateCircularIndicatorhrjfTZI($this$Canvas, CircularProgressIndicator_LxG7B9w$lambda$112 + offset, strokeWidth5, sweep, j3, stroke);
                }
            }, $composer2, 0);
            if (ComposerKt.isTraceInProgress()) {
                ComposerKt.traceEventEnd();
        ...
        if (endRestartGroup != null) {
            ...
            endRestartGroup.updateScope(new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.material.ProgressIndicatorKt$CircularProgressIndicator$4
                ...
                public final void invoke(Composer composer, int i9) {
                    ProgressIndicatorKt.m1410CircularProgressIndicatorLxG7B9w(Modifier.this, j4, f, j5, i8, composer, RecomposeScopeImplKt.updateChangedFlags($changed | 1), i);
                }
            });
        }
    }
    ...
    public static final /* synthetic */ void m1411CircularProgressIndicatorMBs18nI(final float progress, Modifier modifier, long color, float strokeWidth, Composer $composer, final int $changed, final int i) {
        ...
        if (($dirty & 5851) == 1170 && $composer2.getSkipping()) {
            ...
            m1409CircularProgressIndicatorDUhRLBM(progress, modifier3, color2, strokeWidth2, Color.INSTANCE.m3781getTransparent0d7_KjU(), StrokeCap.INSTANCE.m4098getButtKaPHkGw(), $composer2, ($dirty & 14) | 24576 | ($dirty & 112) | ($dirty & 896) | ($dirty & 7168), 0);
            if (ComposerKt.isTraceInProgress()) {
                ComposerKt.traceEventEnd();
            }
            modifier4 = modifier3;
    ...
    public static final /* synthetic */ void m1412CircularProgressIndicatoraMcp0Q(Modifier modifier, long color, float strokeWidth, Composer $composer, final int $changed, final int i) {
        ...
        if (($dirty & 731) == 146 && $composer2.getSkipping()) {
            ...
            m1410CircularProgressIndicatorLxG7B9w(modifier3, color2, strokeWidth2, Color.INSTANCE.m3781getTransparent0d7_KjU(), StrokeCap.INSTANCE.m4100getSquareKaPHkGw(), $composer2, ($dirty & 14) | 3072 | ($dirty & 112) | ($dirty & 896), 0);
            if (ComposerKt.isTraceInProgress()) {
                ComposerKt.traceEventEnd();
            }
            modifier4 = modifier3;
        ...
        if (endRestartGroup != null) {
            ...
            endRestartGroup.updateScope(new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.material.ProgressIndicatorKt$CircularProgressIndicator$6
                ...
                public final void invoke(Composer composer, int i5) {
                    ProgressIndicatorKt.m1412CircularProgressIndicatoraMcp0Q(Modifier.this, j2, f2, composer, RecomposeScopeImplKt.updateChangedFlags($changed | 1), i);
                }
            });
        }
    }
    ...
    private static final void m1422drawCircularIndicator42QJj7c(DrawScope $this$drawCircularIndicator_u2d42QJj7c, float startAngle, float sweep, long color, Stroke stroke) {
        ...
        DrawScope.m4275drawArcyD3GUKo$default($this$drawCircularIndicator_u2d42QJj7c, color, startAngle, sweep, false, OffsetKt.Offset(diameterOffset, diameterOffset), androidx.compose.ui.geometry.SizeKt.Size(arcDimen, arcDimen), 0.0f, stroke, null, 0, 832, null);
    }
