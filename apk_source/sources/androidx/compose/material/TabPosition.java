...
public final class TabPosition {
    ...
    public final float m1487getRightD9Ej5fM() {
    ...
    public boolean equals(Object other) {
        ...
        return (other instanceof TabPosition) && Dp.m6099equalsimpl0(this.left, ((TabPosition) other).left) && Dp.m6099equalsimpl0(this.width, ((TabPosition) other).width);
    }

    public int hashCode() {
        int result = Dp.m6100hashCodeimpl(this.left);
        return (result * 31) + Dp.m6100hashCodeimpl(this.width);
    }

    public String toString() {
        return "TabPosition(left=" + ((Object) Dp.m6105toStringimpl(this.left)) + ", right=" + ((Object) Dp.m6105toStringimpl(m1487getRightD9Ej5fM())) + ", width=" + ((Object) Dp.m6105toStringimpl(this.width)) + ')';
    }
}
