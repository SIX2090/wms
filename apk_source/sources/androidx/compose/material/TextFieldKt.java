...
public final class TextFieldKt {
    private static final float FirstBaselineOffset = Dp.m6094constructorimpl(20);
    private static final float TextFieldBottomPadding = Dp.m6094constructorimpl(10);
    private static final float TextFieldTopPadding = Dp.m6094constructorimpl(2);
    ...
    */
    ...
    /* JADX WARN: Removed duplicated region for block: B:157:0x086c  */
    /* JADX WARN: Removed duplicated region for block: B:159:0x07d2 A[ADDED_TO_REGION] */
    ...
    */
    ...
    public static final int m1522calculateWidthVsPV1Ek(int leadingWidth, int trailingWidth, int textFieldWidth, int labelWidth, int placeholderWidth, long constraints) {
    ...
    public static final int m1521calculateHeightO3s9Psw(int textFieldHeight, boolean hasLabel, int labelBaseline, int leadingHeight, int trailingHeight, int placeholderHeight, long constraints, float density, PaddingValues paddingValues) {
        ...
        return Math.max(MathKt.roundToInt(middleSectionHeight), Math.max(Math.max(leadingHeight, trailingHeight), Constraints.m6051getMinHeightimpl(constraints)));
    }
