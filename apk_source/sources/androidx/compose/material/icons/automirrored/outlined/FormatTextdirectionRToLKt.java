...
public final class FormatTextdirectionRToLKt {
    ...
    public static final ImageVector getFormatTextdirectionRToL(Icons.AutoMirrored.Outlined $this$FormatTextdirectionRToL) {
        ...
        ImageVector.Builder $this$_get_FormatTextdirectionRToL__u24lambda_u241 = new ImageVector.Builder("AutoMirrored.Outlined.FormatTextdirectionRToL", Dp.m6094constructorimpl(24.0f), Dp.m6094constructorimpl(24.0f), 24.0f, 24.0f, 0L, 0, true, 96, null);
        ...
        $this$PathData_u24lambda_u240$iv$iv$iv.verticalLineToRelative(-3.0f);
        $this$PathData_u24lambda_u240$iv$iv$iv.close();
        _formatTextdirectionRToL = ImageVector.Builder.m4379addPathoIyEayM$default($this$_get_FormatTextdirectionRToL__u24lambda_u241, $this$PathData_u24lambda_u240$iv$iv$iv.getNodes(), pathFillType$iv, "", fill$iv$iv, 1.0f, null, 1.0f, 1.0f, strokeLineCap$iv$iv, strokeLineJoin$iv$iv, 1.0f, 0.0f, 0.0f, 0.0f, 14336, null).build();
