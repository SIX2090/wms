...
public final class _3mpKt {
    ...
    public static final ImageVector get_3mp(Icons.Filled $this$_3mp) {
        ...
        ImageVector.Builder $this$_get__3mp__u24lambda_u241 = new ImageVector.Builder("Filled._3mp", Dp.m6094constructorimpl(24.0f), Dp.m6094constructorimpl(24.0f), 24.0f, 24.0f, 0L, 0, false, 96, null);
        ...
        $this$PathData_u24lambda_u240$iv$iv$iv.horizontalLineToRelative(-1.5f);
        $this$PathData_u24lambda_u240$iv$iv$iv.close();
        __3mp = ImageVector.Builder.m4379addPathoIyEayM$default($this$_get__3mp__u24lambda_u241, $this$PathData_u24lambda_u240$iv$iv$iv.getNodes(), pathFillType$iv, "", fill$iv$iv, 1.0f, null, 1.0f, 1.0f, strokeLineCap$iv$iv, strokeLineJoin$iv$iv, 1.0f, 0.0f, 0.0f, 0.0f, 14336, null).build();
