...
public final class AutoModeKt {
    ...
    public static final ImageVector getAutoMode(Icons.Outlined $this$AutoMode) {
        ...
        ImageVector.Builder $this$_get_AutoMode__u24lambda_u246 = new ImageVector.Builder("Outlined.AutoMode", Dp.m6094constructorimpl(24.0f), Dp.m6094constructorimpl(24.0f), 24.0f, 24.0f, 0L, 0, false, 96, null);
        ...
        ImageVector.Builder.m4379addPathoIyEayM$default($this$_get_AutoMode__u24lambda_u246, $this$PathData_u24lambda_u240$iv$iv$iv.getNodes(), pathFillType$iv, "", fill$iv$iv, 1.0f, null, 1.0f, 1.0f, strokeLineCap$iv$iv, strokeLineJoin$iv$iv, 1.0f, 0.0f, 0.0f, 0.0f, 14336, null);
        ...
        ImageVector.Builder.m4379addPathoIyEayM$default($this$_get_AutoMode__u24lambda_u246, $this$PathData_u24lambda_u240$iv$iv$iv2.getNodes(), pathFillType$iv2, "", fill$iv$iv2, 1.0f, null, 1.0f, 1.0f, strokeLineCap$iv$iv2, strokeLineJoin$iv$iv2, 1.0f, 0.0f, 0.0f, 0.0f, 14336, null);
        ...
        ImageVector.Builder.m4379addPathoIyEayM$default($this$_get_AutoMode__u24lambda_u246, $this$PathData_u24lambda_u240$iv$iv$iv3.getNodes(), pathFillType$iv3, "", fill$iv$iv3, 1.0f, null, 1.0f, 1.0f, strokeLineCap$iv$iv3, strokeLineJoin$iv$iv3, 1.0f, 0.0f, 0.0f, 0.0f, 14336, null);
        ...
        ImageVector.Builder.m4379addPathoIyEayM$default($this$_get_AutoMode__u24lambda_u246, $this$PathData_u24lambda_u240$iv$iv$iv4.getNodes(), pathFillType$iv4, "", fill$iv$iv4, 1.0f, null, 1.0f, 1.0f, strokeLineCap$iv$iv4, strokeLineJoin$iv$iv4, 1.0f, 0.0f, 0.0f, 0.0f, 14336, null);
        ...
        ImageVector.Builder.m4379addPathoIyEayM$default($this$_get_AutoMode__u24lambda_u246, $this$PathData_u24lambda_u240$iv$iv$iv5.getNodes(), pathFillType$iv5, "", fill$iv$iv5, 1.0f, null, 1.0f, 1.0f, strokeLineCap$iv$iv5, strokeLineJoin$iv$iv5, 1.0f, 0.0f, 0.0f, 0.0f, 14336, null);
        ...
        _autoMode = ImageVector.Builder.m4379addPathoIyEayM$default($this$_get_AutoMode__u24lambda_u246, $this$PathData_u24lambda_u240$iv$iv$iv6.getNodes(), pathFillType$iv6, "", fill$iv$iv6, 1.0f, null, 1.0f, 1.0f, strokeLineCap$iv$iv6, strokeLineJoin$iv$iv6, 1.0f, 0.0f, 0.0f, 0.0f, 14336, null).build();
