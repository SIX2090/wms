...
public final class CameraKt {
    ...
    public static final ImageVector getCamera(Icons.Outlined $this$Camera) {
        ...
        ImageVector.Builder $this$_get_Camera__u24lambda_u241 = new ImageVector.Builder("Outlined.Camera", Dp.m6094constructorimpl(24.0f), Dp.m6094constructorimpl(24.0f), 24.0f, 24.0f, 0L, 0, false, 96, null);
        ...
        $this$PathData_u24lambda_u240$iv$iv$iv.curveToRelative(0.0f, 1.85f, -0.64f, 3.55f, -1.7f, 4.91f);
        $this$PathData_u24lambda_u240$iv$iv$iv.close();
        _camera = ImageVector.Builder.m4379addPathoIyEayM$default($this$_get_Camera__u24lambda_u241, $this$PathData_u24lambda_u240$iv$iv$iv.getNodes(), pathFillType$iv, "", fill$iv$iv, 1.0f, null, 1.0f, 1.0f, strokeLineCap$iv$iv, strokeLineJoin$iv$iv, 1.0f, 0.0f, 0.0f, 0.0f, 14336, null).build();
