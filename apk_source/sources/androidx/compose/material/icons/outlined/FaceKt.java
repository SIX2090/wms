...
public final class FaceKt {
    ...
    public static final ImageVector getFace(Icons.Outlined $this$Face) {
        ...
        ImageVector.Builder $this$_get_Face__u24lambda_u241 = new ImageVector.Builder("Outlined.Face", Dp.m6094constructorimpl(24.0f), Dp.m6094constructorimpl(24.0f), 24.0f, 24.0f, 0L, 0, false, 96, null);
        ...
        $this$PathData_u24lambda_u240$iv$iv$iv.close();
        _face = ImageVector.Builder.m4379addPathoIyEayM$default($this$_get_Face__u24lambda_u241, $this$PathData_u24lambda_u240$iv$iv$iv.getNodes(), pathFillType$iv, "", fill$iv$iv, 1.0f, null, 1.0f, 1.0f, strokeLineCap$iv$iv, strokeLineJoin$iv$iv, 1.0f, 0.0f, 0.0f, 0.0f, 14336, null).build();
