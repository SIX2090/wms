...
public final class LocalMallKt {
    ...
    public static final ImageVector getLocalMall(Icons.Outlined $this$LocalMall) {
        ...
        ImageVector.Builder $this$_get_LocalMall__u24lambda_u241 = new ImageVector.Builder("Outlined.LocalMall", Dp.m6094constructorimpl(24.0f), Dp.m6094constructorimpl(24.0f), 24.0f, 24.0f, 0L, 0, false, 96, null);
        ...
        $this$PathData_u24lambda_u240$iv$iv$iv.curveToRelative(0.0f, 1.66f, -1.34f, 3.0f, -3.0f, 3.0f);
        $this$PathData_u24lambda_u240$iv$iv$iv.close();
        _localMall = ImageVector.Builder.m4379addPathoIyEayM$default($this$_get_LocalMall__u24lambda_u241, $this$PathData_u24lambda_u240$iv$iv$iv.getNodes(), pathFillType$iv, "", fill$iv$iv, 1.0f, null, 1.0f, 1.0f, strokeLineCap$iv$iv, strokeLineJoin$iv$iv, 1.0f, 0.0f, 0.0f, 0.0f, 14336, null).build();
