...
public final class ZoomOutKt {
    ...
    public static final ImageVector getZoomOut(Icons.Outlined $this$ZoomOut) {
        ...
        ImageVector.Builder $this$_get_ZoomOut__u24lambda_u241 = new ImageVector.Builder("Outlined.ZoomOut", Dp.m6094constructorimpl(24.0f), Dp.m6094constructorimpl(24.0f), 24.0f, 24.0f, 0L, 0, false, 96, null);
        ...
        $this$PathData_u24lambda_u240$iv$iv$iv.close();
        _zoomOut = ImageVector.Builder.m4379addPathoIyEayM$default($this$_get_ZoomOut__u24lambda_u241, $this$PathData_u24lambda_u240$iv$iv$iv.getNodes(), pathFillType$iv, "", fill$iv$iv, 1.0f, null, 1.0f, 1.0f, strokeLineCap$iv$iv, strokeLineJoin$iv$iv, 1.0f, 0.0f, 0.0f, 0.0f, 14336, null).build();
