...
public final class PullRefreshIndicatorKt {
    ...
    private static final float IndicatorSize = Dp.m6094constructorimpl(40);
    private static final RoundedCornerShape SpinnerShape = RoundedCornerShapeKt.getCircleShape();
    private static final float ArcRadius = Dp.m6094constructorimpl((float) 7.5d);
    ...
    private static final float Elevation = Dp.m6094constructorimpl(6);
    ...
    */
    ...
    public static final void m1538CircularArrowIndicatoriJQMabo(final PullRefreshState state, final long color, final Modifier modifier, Composer $composer, final int $changed) {
        ...
        if (it$iv$iv == Composer.INSTANCE.getEmpty()) {
            ...
            $this$CircularArrowIndicator_iJQMabo_u24lambda_u244_u24lambda_u243.mo3639setFillTypeoQ8Xj4U(PathFillType.INSTANCE.m4028getEvenOddRgk1Os());
        ...
        CanvasKt.Canvas(SemanticsModifierKt.semantics$default(modifier, false, new Function1<SemanticsPropertyReceiver, Unit>() { // from class: androidx.compose.material.pullrefresh.PullRefreshIndicatorKt$CircularArrowIndicator$1
            ...
            public final void invoke2(DrawScope $this$Canvas) {
                ...
                float f4 = $this$Canvas.mo313toPx0680j_4(f);
                f2 = PullRefreshIndicatorKt.StrokeWidth;
                float arcRadius = f4 + ($this$Canvas.mo313toPx0680j_4(f2) / 2.0f);
                Rect arcBounds = new Rect(Offset.m3505getXimpl(SizeKt.m3584getCenteruvyYCjk($this$Canvas.mo4295getSizeNHjbRc())) - arcRadius, Offset.m3506getYimpl(SizeKt.m3584getCenteruvyYCjk($this$Canvas.mo4295getSizeNHjbRc())) - arcRadius, Offset.m3505getXimpl(SizeKt.m3584getCenteruvyYCjk($this$Canvas.mo4295getSizeNHjbRc())) + arcRadius, Offset.m3506getYimpl(SizeKt.m3584getCenteruvyYCjk($this$Canvas.mo4295getSizeNHjbRc())) + arcRadius);
                float startAngle = values.getStartAngle();
                float endAngle = values.getEndAngle() - values.getStartAngle();
                long m3540getTopLeftF1C5BW0 = arcBounds.m3540getTopLeftF1C5BW0();
                long m3538getSizeNHjbRc = arcBounds.m3538getSizeNHjbRc();
                f3 = PullRefreshIndicatorKt.StrokeWidth;
                DrawScope.m4275drawArcyD3GUKo$default($this$Canvas, j, startAngle, endAngle, false, m3540getTopLeftF1C5BW0, m3538getSizeNHjbRc, alpha, new Stroke($this$Canvas.mo313toPx0680j_4(f3), 0.0f, StrokeCap.INSTANCE.m4100getSquareKaPHkGw(), 0, null, 26, null), null, 0, 768, null);
        ...
        if (endRestartGroup != null) {
            endRestartGroup.updateScope(new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.material.pullrefresh.PullRefreshIndicatorKt$CircularArrowIndicator$3
                ...
                public final void invoke(Composer composer, int i) {
                    PullRefreshIndicatorKt.m1538CircularArrowIndicatoriJQMabo(PullRefreshState.this, color, modifier, composer, RecomposeScopeImplKt.updateChangedFlags($changed | 1));
                }
            });
        }
    }
    ...
    public static final void m1542drawArrowBx497Mc(DrawScope $this$drawArrow_u2dBx497Mc, Path arrow, Rect bounds, long color, float alpha, ArrowValues values) {
        ...
        arrow.mo3641translatek4lQ0M(OffsetKt.Offset((Offset.m3505getXimpl(bounds.m3535getCenterF1C5BW0()) + radius) - inset, Offset.m3506getYimpl(bounds.m3535getCenterF1C5BW0()) + ($this$drawArrow_u2dBx497Mc.mo313toPx0680j_4(StrokeWidth) / 2.0f)));
        arrow.close();
        float degrees$iv = values.getEndAngle();
        long pivot$iv = $this$drawArrow_u2dBx497Mc.mo4294getCenterF1C5BW0();
        DrawContext $this$withTransform_u24lambda_u246$iv$iv = $this$drawArrow_u2dBx497Mc.getDrawContext();
        long previousSize$iv$iv = $this$withTransform_u24lambda_u246$iv$iv.mo4220getSizeNHjbRc();
        $this$withTransform_u24lambda_u246$iv$iv.getCanvas().save();
        DrawTransform $this$rotate_Rg1IO4c_u24lambda_u240$iv = $this$withTransform_u24lambda_u246$iv$iv.getTransform();
        $this$rotate_Rg1IO4c_u24lambda_u240$iv.mo4226rotateUv8p0NA(degrees$iv, pivot$iv);
        DrawScope.m4286drawPathLG529CI$default($this$drawArrow_u2dBx497Mc, arrow, color, alpha, null, null, 0, 56, null);
        $this$withTransform_u24lambda_u246$iv$iv.getCanvas().restore();
        $this$withTransform_u24lambda_u246$iv$iv.mo4221setSizeuvyYCjk(previousSize$iv$iv);
    }
}
