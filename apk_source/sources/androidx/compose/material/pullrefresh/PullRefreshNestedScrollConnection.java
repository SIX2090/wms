...
final class PullRefreshNestedScrollConnection implements NestedScrollConnection {
    ...
    public long mo401onPreScrollOzD1aCk(long available, int source) {
        return !this.enabled ? Offset.INSTANCE.m3521getZeroF1C5BW0() : (!NestedScrollSource.m4779equalsimpl0(source, NestedScrollSource.INSTANCE.m4784getDragWNlRxjI()) || Offset.m3506getYimpl(available) >= 0.0f) ? Offset.INSTANCE.m3521getZeroF1C5BW0() : OffsetKt.Offset(0.0f, this.onPull.invoke(Float.valueOf(Offset.m3506getYimpl(available))).floatValue());
    }
    ...
    */
    public java.lang.Object mo641onPreFlingQWom1Mo(long r8, kotlin.coroutines.Continuation<? super androidx.compose.ui.unit.Velocity> r10) {
        ...
        L51:
            ...
            return r8
        */
        throw new UnsupportedOperationException("Method not decompiled: androidx.compose.material.pullrefresh.PullRefreshNestedScrollConnection.mo641onPreFlingQWom1Mo(long, kotlin.coroutines.Continuation):java.lang.Object");
    }
}
