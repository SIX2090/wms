...
public final class AndroidRippleIndicationInstance extends RippleIndicationInstance implements RememberObserver {
    ...
    private AndroidRippleIndicationInstance(boolean bounded, float radius, State<Color> state, State<RippleAlpha> state2, ViewGroup view) {
        ...
        this.rippleSize = Size.INSTANCE.m3583getZeroNHjbRc();
        this.rippleRadius = -1;
    ...
    public void drawIndication(ContentDrawScope $this$drawIndication) {
        int i;
        this.rippleSize = $this$drawIndication.mo4295getSizeNHjbRc();
        float $this$isUnspecified$iv = this.radius;
        if (Float.isNaN($this$isUnspecified$iv)) {
            i = MathKt.roundToInt(RippleAnimationKt.m1547getRippleEndRadiuscSwnlzA($this$drawIndication, this.bounded, $this$drawIndication.mo4295getSizeNHjbRc()));
        } else {
            i = $this$drawIndication.mo307roundToPx0680j_4(this.radius);
        }
        this.rippleRadius = i;
        long color = this.color.getValue().m3756unboximpl();
        ...
        if ($this$drawIndication_u24lambda_u241_u24lambda_u240 != null) {
            $this$drawIndication_u24lambda_u241_u24lambda_u240.m1551updateRipplePropertiesbiQXAtU($this$drawIndication.mo4295getSizeNHjbRc(), this.rippleRadius, color, alpha);
    ...
    public void addRipple(PressInteraction.Press interaction, CoroutineScope scope) {
        ...
        $this$addRipple_u24lambda_u243_u24lambda_u242.m1550addRippleKOepWvA(interaction, this.bounded, this.rippleSize, this.rippleRadius, this.color.getValue().m3756unboximpl(), this.rippleAlpha.getValue().getPressedAlpha(), this.onInvalidateRipple);
