...
public final class CommonRippleIndicationInstance extends RippleIndicationInstance implements RememberObserver {
    ...
    public void drawIndication(ContentDrawScope $this$drawIndication) {
        ...
        m1545drawRipples4WTKRHQ($this$drawIndication, color);
    }
    ...
    public void addRipple(PressInteraction.Press interaction, CoroutineScope scope) {
        ...
        Offset origin = this.bounded ? Offset.m3494boximpl(interaction.getPressPosition()) : null;
    ...
    private final void m1545drawRipples4WTKRHQ(DrawScope $this$drawRipples_u2d4WTKRHQ, long color) {
        ...
        for (Map.Entry element$iv : $this$forEach$iv.entrySet()) {
            ...
            if (!(alpha == 0.0f)) {
                m3744copywmQWz5c = Color.m3744copywmQWz5c(color, (r12 & 1) != 0 ? Color.m3748getAlphaimpl(color) : alpha, (r12 & 2) != 0 ? Color.m3752getRedimpl(color) : 0.0f, (r12 & 4) != 0 ? Color.m3751getGreenimpl(color) : 0.0f, (r12 & 8) != 0 ? Color.m3749getBlueimpl(color) : 0.0f);
                ripple.m1546draw4WTKRHQ($this$drawRipples_u2d4WTKRHQ, m3744copywmQWz5c);
            }
        }
    }
