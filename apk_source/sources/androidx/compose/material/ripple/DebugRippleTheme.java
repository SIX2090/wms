...
final class DebugRippleTheme implements RippleTheme {
    ...
    public long mo1380defaultColorWaAFU9c(Composer $composer, int $changed) {
        ...
        long m1555defaultRippleColor5vOe2sY = RippleTheme.INSTANCE.m1555defaultRippleColor5vOe2sY(Color.INSTANCE.m3772getBlack0d7_KjU(), true);
        if (ComposerKt.isTraceInProgress()) {
    ...
    public RippleAlpha rippleAlpha(Composer $composer, int $changed) {
        ...
        RippleAlpha m1554defaultRippleAlphaDxMtmZc = RippleTheme.INSTANCE.m1554defaultRippleAlphaDxMtmZc(Color.INSTANCE.m3772getBlack0d7_KjU(), true);
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventEnd();
        }
        $composer.endReplaceableGroup();
