    ...
    */
    ...
    public final void m1546draw4WTKRHQ(DrawScope $this$draw_u2d4WTKRHQ, long color) {
        ...
        if (this.startRadius == null) {
            this.startRadius = Float.valueOf(RippleAnimationKt.m1548getRippleStartRadiusuvyYCjk($this$draw_u2d4WTKRHQ.mo4295getSizeNHjbRc()));
        }
        if (this.targetRadius == null) {
            float $this$isUnspecified$iv = this.radius;
            this.targetRadius = Float.isNaN($this$isUnspecified$iv) ? Float.valueOf(RippleAnimationKt.m1547getRippleEndRadiuscSwnlzA($this$draw_u2d4WTKRHQ, this.bounded, $this$draw_u2d4WTKRHQ.mo4295getSizeNHjbRc())) : Float.valueOf($this$draw_u2d4WTKRHQ.mo313toPx0680j_4(this.radius));
        }
        if (this.origin == null) {
            this.origin = Offset.m3494boximpl($this$draw_u2d4WTKRHQ.mo4294getCenterF1C5BW0());
        }
        if (this.targetCenter == null) {
            this.targetCenter = Offset.m3494boximpl(OffsetKt.Offset(Size.m3574getWidthimpl($this$draw_u2d4WTKRHQ.mo4295getSizeNHjbRc()) / 2.0f, Size.m3571getHeightimpl($this$draw_u2d4WTKRHQ.mo4295getSizeNHjbRc()) / 2.0f));
        }
        ...
        float m3505getXimpl = Offset.m3505getXimpl(offset.getPackedValue());
        Offset offset2 = this.targetCenter;
        Intrinsics.checkNotNull(offset2);
        float lerp = MathHelpersKt.lerp(m3505getXimpl, Offset.m3505getXimpl(offset2.getPackedValue()), this.animatedCenterPercent.getValue().floatValue());
        Offset offset3 = this.origin;
        Intrinsics.checkNotNull(offset3);
        float m3506getYimpl = Offset.m3506getYimpl(offset3.getPackedValue());
        Offset offset4 = this.targetCenter;
        Intrinsics.checkNotNull(offset4);
        long centerOffset = OffsetKt.Offset(lerp, MathHelpersKt.lerp(m3506getYimpl, Offset.m3506getYimpl(offset4.getPackedValue()), this.animatedCenterPercent.getValue().floatValue()));
        modulatedColor = Color.m3744copywmQWz5c(color, (r12 & 1) != 0 ? Color.m3748getAlphaimpl(color) : Color.m3748getAlphaimpl(color) * alpha, (r12 & 2) != 0 ? Color.m3752getRedimpl(color) : 0.0f, (r12 & 4) != 0 ? Color.m3751getGreenimpl(color) : 0.0f, (r12 & 8) != 0 ? Color.m3749getBlueimpl(color) : 0.0f);
        if (!this.bounded) {
            DrawScope.m4277drawCircleVaOC9Bg$default($this$draw_u2d4WTKRHQ, modulatedColor, radius, centerOffset, 0.0f, null, null, 0, 120, null);
            return;
        }
        float right$iv = Size.m3574getWidthimpl($this$draw_u2d4WTKRHQ.mo4295getSizeNHjbRc());
        float bottom$iv = Size.m3571getHeightimpl($this$draw_u2d4WTKRHQ.mo4295getSizeNHjbRc());
