...
public final class RippleKt {
    ...
    public static final Indication m1553rememberRipple9IZ8Weo(boolean bounded, float radius, long color, Composer $composer, int $changed, int i) {
        Object value$iv$iv;
        ...
        float radius2 = (i & 2) != 0 ? Dp.INSTANCE.m6114getUnspecifiedD9Ej5fM() : radius;
        long color2 = (i & 4) != 0 ? Color.INSTANCE.m3782getUnspecified0d7_KjU() : color;
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventStart(1635163520, $changed, -1, "androidx.compose.material.ripple.rememberRipple (Ripple.kt:80)");
        }
        State colorState = SnapshotStateKt.rememberUpdatedState(Color.m3736boximpl(color2), $composer, ($changed >> 6) & 14);
        Object key1$iv = Boolean.valueOf(bounded2);
        Object key2$iv = Dp.m6092boximpl(radius2);
