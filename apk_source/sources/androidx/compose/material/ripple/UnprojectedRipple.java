...
final class UnprojectedRipple extends RippleDrawable {
    ...
    public final void m1558setColorDxMtmZc(long color, float alpha) {
        long newColor = m1557calculateRippleColor5vOe2sY(color, alpha);
        Color color2 = this.rippleColor;
        if (!(color2 == null ? false : Color.m3747equalsimpl0(color2.m3756unboximpl(), newColor))) {
            this.rippleColor = Color.m3736boximpl(newColor);
            setColor(ColorStateList.valueOf(ColorKt.m3800toArgb8_81llA(newColor)));
        }
    }
    ...
    private final long m1557calculateRippleColor5vOe2sY(long color, float alpha) {
        float f;
        ...
        m3744copywmQWz5c = Color.m3744copywmQWz5c(color, (r12 & 1) != 0 ? Color.m3748getAlphaimpl(color) : transformedAlpha, (r12 & 2) != 0 ? Color.m3752getRedimpl(color) : 0.0f, (r12 & 4) != 0 ? Color.m3751getGreenimpl(color) : 0.0f, (r12 & 8) != 0 ? Color.m3749getBlueimpl(color) : 0.0f);
