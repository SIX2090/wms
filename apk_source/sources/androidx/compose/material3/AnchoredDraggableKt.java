...
public final class AnchoredDraggableKt {
    ...
    public static final <T> Modifier anchoredDraggable(Modifier $this$anchoredDraggable, AnchoredDraggableState<T> anchoredDraggableState, Orientation orientation, boolean enabled, boolean reverseDirection, MutableInteractionSource interactionSource) {
        Modifier draggable;
        draggable = DraggableKt.draggable($this$anchoredDraggable, anchoredDraggableState.getDraggableState(), orientation, (r20 & 4) != 0 ? true : enabled, (r20 & 8) != 0 ? null : interactionSource, (r20 & 16) != 0 ? false : anchoredDraggableState.isAnimationRunning(), (r20 & 32) != 0 ? new DraggableKt$draggable$1(null) : null, (r20 & 64) != 0 ? new DraggableKt$draggable$2(null) : new AnchoredDraggableKt$anchoredDraggable$1(anchoredDraggableState, null), (r20 & 128) != 0 ? false : reverseDirection);
        return draggable;
    }
    ...
    */
    public static final <I> java.lang.Object restartable(kotlin.jvm.functions.Function0<? extends I> r4, kotlin.jvm.functions.Function2<? super I, ? super kotlin.coroutines.Continuation<? super kotlin.Unit>, ? extends java.lang.Object> r5, kotlin.coroutines.Continuation<? super kotlin.Unit> r6) {
        ...
        L25:
            ...
            throw r4
        L2e:
            kotlin.ResultKt.throwOnFailure(r0)     // Catch: androidx.compose.material3.AnchoredDragFinishedSignal -> L32
            goto L4a
        L32:
            r4 = move-exception
            goto L4b
        L34:
            ...
            androidx.compose.material3.AnchoredDraggableKt$restartable$2 r2 = new androidx.compose.material3.AnchoredDraggableKt$restartable$2     // Catch: androidx.compose.material3.AnchoredDragFinishedSignal -> L32
            r3 = 0
            r2.<init>(r4, r5, r3)     // Catch: androidx.compose.material3.AnchoredDragFinishedSignal -> L32
            kotlin.jvm.functions.Function2 r2 = (kotlin.jvm.functions.Function2) r2     // Catch: androidx.compose.material3.AnchoredDragFinishedSignal -> L32
            r3 = 1
            r6.label = r3     // Catch: androidx.compose.material3.AnchoredDragFinishedSignal -> L32
            java.lang.Object r2 = kotlinx.coroutines.CoroutineScopeKt.coroutineScope(r2, r6)     // Catch: androidx.compose.material3.AnchoredDragFinishedSignal -> L32
            if (r2 != r1) goto L4a
            return r1
        L4a:
        L4b:
