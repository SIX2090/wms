...
public final /* data */ class CaretProperties {
    ...
    public boolean equals(Object other) {
        ...
        return Dp.m6099equalsimpl0(this.caretHeight, caretProperties.caretHeight) && Dp.m6099equalsimpl0(this.caretWidth, caretProperties.caretWidth);
    }

    public int hashCode() {
        return (Dp.m6100hashCodeimpl(this.caretHeight) * 31) + Dp.m6100hashCodeimpl(this.caretWidth);
    }

    public String toString() {
        return "CaretProperties(caretHeight=" + ((Object) Dp.m6105toStringimpl(this.caretHeight)) + ", caretWidth=" + ((Object) Dp.m6105toStringimpl(this.caretWidth)) + ')';
    }
