...
public final class DisplayMode {
    ...
    private static final int Picker = m1854constructorimpl(0);
    private static final int Input = m1854constructorimpl(1);

    /* renamed from: box-impl, reason: not valid java name */
    public static final /* synthetic */ DisplayMode m1853boximpl(int i) {
        return new DisplayMode(i);
    }

    /* renamed from: constructor-impl, reason: not valid java name */
    public static int m1854constructorimpl(int i) {
        return i;
    }

    /* renamed from: equals-impl, reason: not valid java name */
    public static boolean m1855equalsimpl(int i, Object obj) {
        return (obj instanceof DisplayMode) && i == ((DisplayMode) obj).getValue();
    }

    /* renamed from: equals-impl0, reason: not valid java name */
    public static final boolean m1856equalsimpl0(int i, int i2) {
        return i == i2;
    }

    /* renamed from: hashCode-impl, reason: not valid java name */
    public static int m1857hashCodeimpl(int i) {
        return Integer.hashCode(i);
    }

    public boolean equals(Object obj) {
        return m1855equalsimpl(this.value, obj);
    }

    public int hashCode() {
        return m1857hashCodeimpl(this.value);
    }
    ...
    public static final class Companion {
        ...
        public final int m1861getPickerjFl4v0() {
            return DisplayMode.Picker;
        }

        /* renamed from: getInput-jFl-4v0, reason: not valid java name */
        public final int m1860getInputjFl4v0() {
            return DisplayMode.Input;
        }
    }

    /* renamed from: toString-impl, reason: not valid java name */
    public static String m1858toStringimpl(int arg0) {
        return m1856equalsimpl0(arg0, Picker) ? "Picker" : m1856equalsimpl0(arg0, Input) ? "Input" : "Unknown";
    }

    public String toString() {
        return m1858toStringimpl(this.value);
    }
}
