...
public final class EnterAlwaysScrollBehavior$nestedScrollConnection$1 implements NestedScrollConnection {
    ...
    public long mo401onPreScrollOzD1aCk(long available, int source) {
        ...
        this.this$0.getState().setHeightOffset(this.this$0.getState().getHeightOffset() + Offset.m3506getYimpl(available));
        if (!(prevHeightOffset == this.this$0.getState().getHeightOffset())) {
            return Offset.m3499copydBAh8RU$default(available, 0.0f, 0.0f, 2, null);
        }
        return Offset.INSTANCE.m3521getZeroF1C5BW0();
    }
    ...
    */
    public long mo400onPostScrollDzOQY0M(long r6, long r8, int r10) {
        /*
            r5 = this;
        ...
        L19:
            ...
            float r2 = androidx.compose.ui.geometry.Offset.m3506getYimpl(r6)
            float r1 = r1 + r2
        ...
        L5c:
            if (r0 == 0) goto L7b
        L5e:
            float r0 = androidx.compose.ui.geometry.Offset.m3506getYimpl(r6)
            int r0 = (r0 > r1 ? 1 : (r0 == r1 ? 0 : -1))
            if (r0 != 0) goto L67
            goto L68
        L67:
        ...
        L68:
            if (r2 == 0) goto L7b
            float r0 = androidx.compose.ui.geometry.Offset.m3506getYimpl(r8)
            int r0 = (r0 > r1 ? 1 : (r0 == r1 ? 0 : -1))
            if (r0 <= 0) goto L7b
            androidx.compose.material3.EnterAlwaysScrollBehavior r0 = r5.this$0
            androidx.compose.material3.TopAppBarState r0 = r0.getState()
        ...
        L7b:
            ...
            return r0
        */
        throw new UnsupportedOperationException("Method not decompiled: androidx.compose.material3.EnterAlwaysScrollBehavior$nestedScrollConnection$1.mo400onPostScrollDzOQY0M(long, long, int):long");
    }
    ...
    /*
        ...
        To view partially-correct add '--show-bad-code' argument
    */
    public java.lang.Object mo399onPostFlingRZ2iAVY(long r10, long r12, kotlin.coroutines.Continuation<? super androidx.compose.ui.unit.Velocity> r14) {
        /*
            r9 = this;
        ...
        L42:
            ...
            r3 = r10
            r5 = r14
            java.lang.Object r12 = super.mo399onPostFlingRZ2iAVY(r1, r3, r5)
            if (r12 != r7) goto L59
            return r7
        L59:
            ...
            androidx.compose.material3.TopAppBarState r0 = r0.getState()
            float r10 = androidx.compose.ui.unit.Velocity.m6330getYimpl(r10)
        ...
        L85:
            ...
            long r10 = androidx.compose.ui.unit.Velocity.m6333plusAH228Gc(r12, r10)
            androidx.compose.ui.unit.Velocity r10 = androidx.compose.ui.unit.Velocity.m6320boximpl(r10)
            return r10
        */
        throw new UnsupportedOperationException("Method not decompiled: androidx.compose.material3.EnterAlwaysScrollBehavior$nestedScrollConnection$1.mo399onPostFlingRZ2iAVY(long, long, kotlin.coroutines.Continuation):java.lang.Object");
    }
}
