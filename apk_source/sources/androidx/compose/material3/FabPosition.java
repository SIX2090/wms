...
public final class FabPosition {
    ...
    private static final int Start = m1889constructorimpl(0);
    private static final int Center = m1889constructorimpl(1);
    private static final int End = m1889constructorimpl(2);
    private static final int EndOverlay = m1889constructorimpl(3);

    /* renamed from: box-impl, reason: not valid java name */
    public static final /* synthetic */ FabPosition m1888boximpl(int i) {
        return new FabPosition(i);
    }

    /* renamed from: constructor-impl, reason: not valid java name */
    public static int m1889constructorimpl(int i) {
        return i;
    }
    ...
    public static String m1893toStringimpl(int arg0) {
        return m1891equalsimpl0(arg0, Start) ? "FabPosition.Start" : m1891equalsimpl0(arg0, Center) ? "FabPosition.Center" : m1891equalsimpl0(arg0, End) ? "FabPosition.End" : "FabPosition.EndOverlay";
    }
}
