...
public final class IconButtonColors {
    ...
    public final IconButtonColors m1922copyjRlVdoo(long containerColor, long contentColor, long disabledContainerColor, long disabledContentColor) {
        return new IconButtonColors((containerColor > Color.INSTANCE.m3782getUnspecified0d7_KjU() ? 1 : (containerColor == Color.INSTANCE.m3782getUnspecified0d7_KjU() ? 0 : -1)) != 0 ? containerColor : this.containerColor, (contentColor > Color.INSTANCE.m3782getUnspecified0d7_KjU() ? 1 : (contentColor == Color.INSTANCE.m3782getUnspecified0d7_KjU() ? 0 : -1)) != 0 ? contentColor : this.contentColor, (disabledContainerColor > Color.INSTANCE.m3782getUnspecified0d7_KjU() ? 1 : (disabledContainerColor == Color.INSTANCE.m3782getUnspecified0d7_KjU() ? 0 : -1)) != 0 ? disabledContainerColor : this.disabledContainerColor, disabledContentColor != Color.INSTANCE.m3782getUnspecified0d7_KjU() ? disabledContentColor : this.disabledContentColor, null);
    }

    /* renamed from: containerColor-vNxB06k$material3_release, reason: not valid java name */
    public final long m1920containerColorvNxB06k$material3_release(boolean enabled) {
    ...
    public final long m1921contentColorvNxB06k$material3_release(boolean enabled) {
    ...
    public boolean equals(Object other) {
        ...
        if (other != null && (other instanceof IconButtonColors) && Color.m3747equalsimpl0(this.containerColor, ((IconButtonColors) other).containerColor) && Color.m3747equalsimpl0(this.contentColor, ((IconButtonColors) other).contentColor) && Color.m3747equalsimpl0(this.disabledContainerColor, ((IconButtonColors) other).disabledContainerColor) && Color.m3747equalsimpl0(this.disabledContentColor, ((IconButtonColors) other).disabledContentColor)) {
            return true;
        }
        return false;
    }
    ...
    public int hashCode() {
        ...
        return (((((result * 31) + Color.m3753hashCodeimpl(this.contentColor)) * 31) + Color.m3753hashCodeimpl(this.disabledContainerColor)) * 31) + Color.m3753hashCodeimpl(this.disabledContentColor);
    }
}
