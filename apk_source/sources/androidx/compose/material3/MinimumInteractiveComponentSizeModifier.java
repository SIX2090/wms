...
final class MinimumInteractiveComponentSizeModifier implements LayoutModifier {
    ...
    public MeasureResult mo64measure3p2s80s(MeasureScope $this$measure_u2d3p2s80s, Measurable measurable, long constraints) {
        ...
        final int width = Math.max(placeable.getWidth(), $this$measure_u2d3p2s80s.mo307roundToPx0680j_4(DpSize.m6192getWidthD9Ej5fM(this.size)));
        final int height = Math.max(placeable.getHeight(), $this$measure_u2d3p2s80s.mo307roundToPx0680j_4(DpSize.m6190getHeightD9Ej5fM(this.size)));
    ...
    public boolean equals(Object other) {
        ...
        return DpSize.m6189equalsimpl0(this.size, otherModifier.size);
    }

    public int hashCode() {
        return DpSize.m6194hashCodeimpl(this.size);
    }
}
