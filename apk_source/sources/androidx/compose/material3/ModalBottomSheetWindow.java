...
final class ModalBottomSheetWindow extends AbstractComposeView implements ViewTreeObserver.OnGlobalLayoutListener, ViewRootForInspector {
    ...
    public ModalBottomSheetWindow(ModalBottomSheetProperties properties, Function0<Unit> function0, View composeView, UUID saveId) {
        ...
        SecureFlagPolicy securePolicy = this.properties.getSecurePolicy();
        isFlagSecureEnabled = ModalBottomSheet_androidKt.isFlagSecureEnabled(this.composeView);
        secureFlagEnabled = ModalBottomSheet_androidKt.shouldApplySecureFlag(securePolicy, isFlagSecureEnabled);
        ...
        this.content = SnapshotStateKt__SnapshotStateKt.mutableStateOf$default(ComposableSingletons$ModalBottomSheet_androidKt.INSTANCE.m1766getLambda2$material3_release(), null, 2, null);
    }
