...
public final class NavigationRailItemColors {
    ...
    public final long m2053getSelectedIndicatorColor0d7_KjU() {
    ...
    public boolean equals(Object other) {
        ...
        if (other != null && (other instanceof NavigationRailItemColors) && Color.m3747equalsimpl0(this.selectedIconColor, ((NavigationRailItemColors) other).selectedIconColor) && Color.m3747equalsimpl0(this.unselectedIconColor, ((NavigationRailItemColors) other).unselectedIconColor) && Color.m3747equalsimpl0(this.selectedTextColor, ((NavigationRailItemColors) other).selectedTextColor) && Color.m3747equalsimpl0(this.unselectedTextColor, ((NavigationRailItemColors) other).unselectedTextColor) && Color.m3747equalsimpl0(this.selectedIndicatorColor, ((NavigationRailItemColors) other).selectedIndicatorColor) && Color.m3747equalsimpl0(this.disabledIconColor, ((NavigationRailItemColors) other).disabledIconColor) && Color.m3747equalsimpl0(this.disabledTextColor, ((NavigationRailItemColors) other).disabledTextColor)) {
            return true;
        }
        return false;
    }
