...
public final class ProgressIndicatorDefaults {
    ...
    private static final int LinearStrokeCap = StrokeCap.INSTANCE.m4098getButtKaPHkGw();
    private static final int CircularDeterminateStrokeCap = StrokeCap.INSTANCE.m4098getButtKaPHkGw();
    private static final int CircularIndeterminateStrokeCap = StrokeCap.INSTANCE.m4100getSquareKaPHkGw();
    ...
    public final long getCircularTrackColor(Composer $composer, int $changed) {
        ...
        $composer.endReplaceableGroup();
        return m3781getTransparent0d7_KjU;
    }
