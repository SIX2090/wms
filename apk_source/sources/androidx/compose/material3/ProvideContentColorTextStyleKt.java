...
public final class ProvideContentColorTextStyleKt {
    ...
    public static final void m2103ProvideContentColorTextStyle3JVO9M(final long contentColor, final TextStyle textStyle, final Function2<? super Composer, ? super Integer, Unit> function2, Composer $composer, final int $changed) {
        ...
        if (($dirty & 147) != 146 || !$composer2.getSkipping()) {
            ...
            CompositionLocalKt.CompositionLocalProvider((ProvidedValue<?>[]) new ProvidedValue[]{ContentColorKt.getLocalContentColor().provides(Color.m3736boximpl(contentColor)), TextKt.getLocalTextStyle().provides(mergedStyle)}, function2, $composer2, ($dirty >> 3) & 112);
            if (ComposerKt.isTraceInProgress()) {
