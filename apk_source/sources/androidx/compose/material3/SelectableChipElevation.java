...
public final class SelectableChipElevation {
    ...
    public final float m2178tonalElevationu2uoSUM$material3_release(boolean enabled) {
    ...
    private final State<Dp> animateElevation(boolean enabled, InteractionSource interactionSource, Composer $composer, int $changed) {
        ...
        if (it$iv4 == Composer.INSTANCE.getEmpty()) {
            value$iv4 = new Animatable(Dp.m6092boximpl(target), VectorConvertersKt.getVectorConverter(Dp.INSTANCE), null, null, 12, null);
        ...
        $composer.endReplaceableGroup();
        Dp m6092boximpl = Dp.m6092boximpl(target);
    ...
    public boolean equals(Object other) {
        ...
        if (other != null && (other instanceof SelectableChipElevation) && Dp.m6099equalsimpl0(this.elevation, ((SelectableChipElevation) other).elevation) && Dp.m6099equalsimpl0(this.pressedElevation, ((SelectableChipElevation) other).pressedElevation) && Dp.m6099equalsimpl0(this.focusedElevation, ((SelectableChipElevation) other).focusedElevation) && Dp.m6099equalsimpl0(this.hoveredElevation, ((SelectableChipElevation) other).hoveredElevation) && Dp.m6099equalsimpl0(this.disabledElevation, ((SelectableChipElevation) other).disabledElevation)) {
            return true;
        }
        return false;
    }
    ...
    public int hashCode() {
        int result = Dp.m6100hashCodeimpl(this.elevation);
        return (((((((result * 31) + Dp.m6100hashCodeimpl(this.pressedElevation)) * 31) + Dp.m6100hashCodeimpl(this.focusedElevation)) * 31) + Dp.m6100hashCodeimpl(this.hoveredElevation)) * 31) + Dp.m6100hashCodeimpl(this.disabledElevation);
    }
}
