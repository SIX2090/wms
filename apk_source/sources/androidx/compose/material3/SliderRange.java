...
public final class SliderRange {
    ...
    public static final /* synthetic */ SliderRange m2218boximpl(long j) {
        return new SliderRange(j);
    }

    /* renamed from: constructor-impl, reason: not valid java name */
    public static long m2219constructorimpl(long j) {
        return j;
    }

    /* renamed from: equals-impl, reason: not valid java name */
    public static boolean m2220equalsimpl(long j, Object obj) {
        return (obj instanceof SliderRange) && j == ((SliderRange) obj).m2226unboximpl();
    }
    ...
    public static int m2224hashCodeimpl(long j) {
        return Long.hashCode(j);
    }

    public boolean equals(Object obj) {
        return m2220equalsimpl(this.packedValue, obj);
    }

    public int hashCode() {
        return m2224hashCodeimpl(this.packedValue);
    }

    /* renamed from: unbox-impl, reason: not valid java name */
    public final /* synthetic */ long m2226unboximpl() {
    ...
    public static final float m2223getStartimpl(long arg0) {
        if (!(arg0 != Unspecified)) {
    ...
    public static final float m2222getEndInclusiveimpl(long arg0) {
        if (!(arg0 != Unspecified)) {
            throw new IllegalStateException("SliderRange is unspecified".toString());
        }
        FloatCompanionObject floatCompanionObject = FloatCompanionObject.INSTANCE;
    ...
    public static final class Companion {
        ...
        public static /* synthetic */ void m2227getUnspecifiedFYbKRX4$annotations() {
        }
        ...
        public final long m2228getUnspecifiedFYbKRX4() {
            return SliderRange.Unspecified;
        }
    }

    /* renamed from: toString-impl, reason: not valid java name */
    public static String m2225toStringimpl(long arg0) {
        if (SliderKt.m2212isSpecifiedIf1S1O4(arg0)) {
            return m2223getStartimpl(arg0) + ".." + m2222getEndInclusiveimpl(arg0);
        }
        return "FloatRange.Unspecified";
    }

    public String toString() {
        return m2225toStringimpl(this.packedValue);
    }
}
