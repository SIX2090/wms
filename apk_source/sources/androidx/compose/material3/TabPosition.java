...
public final class TabPosition {
    ...
    public final float m2359getRightD9Ej5fM() {
    ...
    public boolean equals(Object other) {
        ...
        return (other instanceof TabPosition) && Dp.m6099equalsimpl0(this.left, ((TabPosition) other).left) && Dp.m6099equalsimpl0(this.width, ((TabPosition) other).width) && Dp.m6099equalsimpl0(this.contentWidth, ((TabPosition) other).contentWidth);
    }

    public int hashCode() {
        int result = Dp.m6100hashCodeimpl(this.left);
        return (((result * 31) + Dp.m6100hashCodeimpl(this.width)) * 31) + Dp.m6100hashCodeimpl(this.contentWidth);
    }

    public String toString() {
        return "TabPosition(left=" + ((Object) Dp.m6105toStringimpl(this.left)) + ", right=" + ((Object) Dp.m6105toStringimpl(m2359getRightD9Ej5fM())) + ", width=" + ((Object) Dp.m6105toStringimpl(this.width)) + ", contentWidth=" + ((Object) Dp.m6105toStringimpl(this.contentWidth)) + ')';
    }
}
