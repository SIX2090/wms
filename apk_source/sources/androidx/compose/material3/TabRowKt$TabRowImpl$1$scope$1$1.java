    ...
    public Modifier tabIndicatorLayout(Modifier $this$tabIndicatorLayout, final Function4<? super MeasureScope, ? super Measurable, ? super Constraints, ? super List<TabPosition>, ? extends MeasureResult> function4) {
        return LayoutModifierKt.layout($this$tabIndicatorLayout, new Function3<MeasureScope, Measurable, Constraints, MeasureResult>() { // from class: androidx.compose.material3.TabRowKt$TabRowImpl$1$scope$1$1$tabIndicatorLayout$1
            ...
            public /* bridge */ /* synthetic */ MeasureResult invoke(MeasureScope measureScope, Measurable measurable, Constraints constraints) {
                return m2378invoke3p2s80s(measureScope, measurable, constraints.getValue());
            }

            /* renamed from: invoke-3p2s80s, reason: not valid java name */
            public final MeasureResult m2378invoke3p2s80s(MeasureScope $this$layout, Measurable measurable, long constraints) {
                return function4.invoke($this$layout, measurable, Constraints.m6038boximpl(constraints), this.getTabPositions().getValue());
            }
        });
    }
