...
public final class TimePickerLayoutType {
    ...
    private static final int Horizontal = m2503constructorimpl(0);
    private static final int Vertical = m2503constructorimpl(1);
    private final int value;

    /* renamed from: box-impl, reason: not valid java name */
    public static final /* synthetic */ TimePickerLayoutType m2502boximpl(int i) {
    ...
    public static final class Companion {
        ...
        public final int m2509getHorizontalQJTpgSE() {
            return TimePickerLayoutType.Horizontal;
        }

        /* renamed from: getVertical-QJTpgSE, reason: not valid java name */
        public final int m2510getVerticalQJTpgSE() {
            return TimePickerLayoutType.Vertical;
        }
    }

    /* renamed from: toString-impl, reason: not valid java name */
    public static String m2507toStringimpl(int arg0) {
        return m2505equalsimpl0(arg0, Horizontal) ? "Horizontal" : m2505equalsimpl0(arg0, Vertical) ? "Vertical" : "Unknown";
    }
