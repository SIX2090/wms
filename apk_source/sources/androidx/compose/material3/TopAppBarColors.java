...
public final class TopAppBarColors {
    ...
    public final TopAppBarColors m2613copyt635Npw(long containerColor, long scrolledContainerColor, long navigationIconContentColor, long titleContentColor, long actionIconContentColor) {
        return new TopAppBarColors((containerColor > Color.INSTANCE.m3782getUnspecified0d7_KjU() ? 1 : (containerColor == Color.INSTANCE.m3782getUnspecified0d7_KjU() ? 0 : -1)) != 0 ? containerColor : this.containerColor, (scrolledContainerColor > Color.INSTANCE.m3782getUnspecified0d7_KjU() ? 1 : (scrolledContainerColor == Color.INSTANCE.m3782getUnspecified0d7_KjU() ? 0 : -1)) != 0 ? scrolledContainerColor : this.scrolledContainerColor, (navigationIconContentColor > Color.INSTANCE.m3782getUnspecified0d7_KjU() ? 1 : (navigationIconContentColor == Color.INSTANCE.m3782getUnspecified0d7_KjU() ? 0 : -1)) != 0 ? navigationIconContentColor : this.navigationIconContentColor, (titleContentColor > Color.INSTANCE.m3782getUnspecified0d7_KjU() ? 1 : (titleContentColor == Color.INSTANCE.m3782getUnspecified0d7_KjU() ? 0 : -1)) != 0 ? titleContentColor : this.titleContentColor, actionIconContentColor != Color.INSTANCE.m3782getUnspecified0d7_KjU() ? actionIconContentColor : this.actionIconContentColor, null);
    }

    /* renamed from: containerColor-vNxB06k$material3_release, reason: not valid java name */
    public final long m2612containerColorvNxB06k$material3_release(float colorTransitionFraction) {
        return ColorKt.m3797lerpjxsXWHM(this.containerColor, this.scrolledContainerColor, EasingKt.getFastOutLinearInEasing().transform(colorTransitionFraction));
    }
    ...
    public boolean equals(Object other) {
        ...
        if (other != null && (other instanceof TopAppBarColors) && Color.m3747equalsimpl0(this.containerColor, ((TopAppBarColors) other).containerColor) && Color.m3747equalsimpl0(this.scrolledContainerColor, ((TopAppBarColors) other).scrolledContainerColor) && Color.m3747equalsimpl0(this.navigationIconContentColor, ((TopAppBarColors) other).navigationIconContentColor) && Color.m3747equalsimpl0(this.titleContentColor, ((TopAppBarColors) other).titleContentColor) && Color.m3747equalsimpl0(this.actionIconContentColor, ((TopAppBarColors) other).actionIconContentColor)) {
            return true;
        }
        return false;
    }
    ...
    public int hashCode() {
        ...
        return (((((((result * 31) + Color.m3753hashCodeimpl(this.scrolledContainerColor)) * 31) + Color.m3753hashCodeimpl(this.navigationIconContentColor)) * 31) + Color.m3753hashCodeimpl(this.titleContentColor)) * 31) + Color.m3753hashCodeimpl(this.actionIconContentColor);
    }
}
