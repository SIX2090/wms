...
public final class CircularProgressIndicatorTokens {
    ...
    private static final float ActiveIndicatorWidth = Dp.m6094constructorimpl((float) 4.0d);
    ...
    private static final float Size = Dp.m6094constructorimpl((float) 48.0d);
    ...
    public final float m2674getActiveIndicatorWidthD9Ej5fM() {
    ...
    public final float m2675getSizeD9Ej5fM() {
        return Size;
    }
}
