...
public final class FabPrimaryLargeTokens {
    ...
    private static final float ContainerHeight = Dp.m6094constructorimpl((float) 96.0d);
    private static final ShapeKeyTokens ContainerShape = ShapeKeyTokens.CornerExtraLarge;
    private static final float ContainerWidth = Dp.m6094constructorimpl((float) 96.0d);
    ...
    private static final float IconSize = Dp.m6094constructorimpl((float) 36.0d);
