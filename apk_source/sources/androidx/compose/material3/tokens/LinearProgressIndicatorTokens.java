...
public final class LinearProgressIndicatorTokens {
    ...
    private static final float ActiveIndicatorHeight = Dp.m6094constructorimpl((float) 4.0d);
    ...
    private static final float TrackHeight = Dp.m6094constructorimpl((float) 4.0d);
    ...
    public final float m2941getTrackHeightD9Ej5fM() {
        return TrackHeight;
    }
