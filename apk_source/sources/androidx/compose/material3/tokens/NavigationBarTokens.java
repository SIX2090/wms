...
public final class NavigationBarTokens {
    ...
    private static final float ActiveIndicatorWidth = Dp.m6094constructorimpl((float) 64.0d);
    ...
    private static final float ContainerHeight = Dp.m6094constructorimpl((float) 80.0d);
    ...
    public final float m2959getActiveIndicatorHeightD9Ej5fM() {
    ...
    public final float m2960getActiveIndicatorWidthD9Ej5fM() {
