...
public final class NavigationDrawerTokens {
    ...
    private static final float ActiveIndicatorHeight = Dp.m6094constructorimpl((float) 56.0d);
    private static final ShapeKeyTokens ActiveIndicatorShape = ShapeKeyTokens.CornerFull;
    private static final float ActiveIndicatorWidth = Dp.m6094constructorimpl((float) 336.0d);
    ...
    private static final float ModalContainerElevation = ElevationTokens.INSTANCE.m2812getLevel1D9Ej5fM();
    private static final float StandardContainerElevation = ElevationTokens.INSTANCE.m2811getLevel0D9Ej5fM();
    ...
    public final float m2964getActiveIndicatorHeightD9Ej5fM() {
    ...
    public final float m2965getActiveIndicatorWidthD9Ej5fM() {
    ...
    public final float m2966getContainerWidthD9Ej5fM() {
    ...
    public final float m2967getIconSizeD9Ej5fM() {
        return IconSize;
    }
    ...
    public final float m2968getModalContainerElevationD9Ej5fM() {
        return ModalContainerElevation;
    }

    /* renamed from: getStandardContainerElevation-D9Ej5fM, reason: not valid java name */
    public final float m2969getStandardContainerElevationD9Ej5fM() {
