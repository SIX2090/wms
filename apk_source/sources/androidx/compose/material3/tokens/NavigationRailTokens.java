...
public final class NavigationRailTokens {
    ...
    private static final float ActiveIndicatorHeight = Dp.m6094constructorimpl((float) 32.0d);
    private static final ShapeKeyTokens ActiveIndicatorShape = ShapeKeyTokens.CornerFull;
    private static final float ActiveIndicatorWidth = Dp.m6094constructorimpl((float) 56.0d);
    ...
    private static final float ContainerWidth = Dp.m6094constructorimpl((float) 80.0d);
    ...
    private static final float MenuIconSize = Dp.m6094constructorimpl((float) 24.0d);
    private static final ColorSchemeKeyTokens MenuPressedIconColor = ColorSchemeKeyTokens.OnSurface;
    private static final float NoLabelActiveIndicatorHeight = Dp.m6094constructorimpl((float) 56.0d);
    ...
    public final float m2970getActiveIndicatorHeightD9Ej5fM() {
    ...
    public final float m2971getActiveIndicatorWidthD9Ej5fM() {
    ...
    public final float m2972getContainerElevationD9Ej5fM() {
    ...
    public final float m2973getContainerWidthD9Ej5fM() {
    ...
    public final float m2975getMenuIconSizeD9Ej5fM() {
        return MenuIconSize;
    }
    ...
    public final float m2976getNoLabelActiveIndicatorHeightD9Ej5fM() {
