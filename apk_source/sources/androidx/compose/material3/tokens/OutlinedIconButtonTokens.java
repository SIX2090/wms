...
public final class OutlinedIconButtonTokens {
    ...
    private static final float ContainerSize = Dp.m6094constructorimpl((float) 40.0d);
    ...
    private static final float Size = Dp.m6094constructorimpl((float) 24.0d);
    ...
    public final float m2998getContainerSizeD9Ej5fM() {
    ...
    public final float m2999getSizeD9Ej5fM() {
        return Size;
    }
    ...
    public final float m3000getUnselectedOutlineWidthD9Ej5fM() {
