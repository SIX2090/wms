...
public final class SliderTokens {
    ...
    private static final float ActiveTrackHeight = Dp.m6094constructorimpl((float) 4.0d);
    ...
    private static final float DisabledHandleElevation = ElevationTokens.INSTANCE.m2811getLevel0D9Ej5fM();
    ...
    private static final float HandleElevation = ElevationTokens.INSTANCE.m2812getLevel1D9Ej5fM();
    private static final float HandleHeight = Dp.m6094constructorimpl((float) 20.0d);
    private static final ShapeKeyTokens HandleShape = ShapeKeyTokens.CornerFull;
    private static final float HandleWidth = Dp.m6094constructorimpl((float) 20.0d);
    ...
    private static final float InactiveTrackHeight = Dp.m6094constructorimpl((float) 4.0d);
    ...
    private static final float LabelContainerElevation = ElevationTokens.INSTANCE.m2811getLevel0D9Ej5fM();
    private static final float LabelContainerHeight = Dp.m6094constructorimpl((float) 28.0d);
    ...
    private static final float TrackElevation = ElevationTokens.INSTANCE.m2811getLevel0D9Ej5fM();
    private static final ColorSchemeKeyTokens OverlapHandleOutlineColor = ColorSchemeKeyTokens.OnPrimary;
    private static final float OverlapHandleOutlineWidth = Dp.m6094constructorimpl((float) 1.0d);
    ...
    private static final float TickMarksContainerSize = Dp.m6094constructorimpl((float) 2.0d);
    ...
    public final float m3124getActiveTrackHeightD9Ej5fM() {
    ...
    public final float m3125getDisabledHandleElevationD9Ej5fM() {
    ...
    public final float m3126getHandleElevationD9Ej5fM() {
        return HandleElevation;
    }

    /* renamed from: getHandleHeight-D9Ej5fM, reason: not valid java name */
    public final float m3127getHandleHeightD9Ej5fM() {
        return HandleHeight;
    }
    ...
    public final float m3128getHandleWidthD9Ej5fM() {
        return HandleWidth;
    }
    ...
    public final float m3129getInactiveTrackHeightD9Ej5fM() {
    ...
    public final float m3130getLabelContainerElevationD9Ej5fM() {
        return LabelContainerElevation;
    }

    /* renamed from: getLabelContainerHeight-D9Ej5fM, reason: not valid java name */
    public final float m3131getLabelContainerHeightD9Ej5fM() {
    ...
    public final float m3135getTrackElevationD9Ej5fM() {
    ...
    public final float m3132getOverlapHandleOutlineWidthD9Ej5fM() {
    ...
    public final float m3134getTickMarksContainerSizeD9Ej5fM() {
