...
public final /* data */ class BiasAbsoluteAlignment implements Alignment {
    ...
    public long mo3382alignKFBX0sM(long size, long space, LayoutDirection layoutDirection) {
        long remaining = IntSizeKt.IntSize(IntSize.m6264getWidthimpl(space) - IntSize.m6264getWidthimpl(size), IntSize.m6263getHeightimpl(space) - IntSize.m6263getHeightimpl(size));
        float centerX = IntSize.m6264getWidthimpl(remaining) / 2.0f;
        float centerY = IntSize.m6263getHeightimpl(remaining) / 2.0f;
        float f = 1;
