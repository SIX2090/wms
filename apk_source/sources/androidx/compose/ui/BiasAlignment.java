...
public final /* data */ class BiasAlignment implements Alignment {
    ...
    public long mo3382alignKFBX0sM(long size, long space, LayoutDirection layoutDirection) {
        ...
        float centerX = (IntSize.m6264getWidthimpl(space) - IntSize.m6264getWidthimpl(size)) / 2.0f;
        float centerY = (IntSize.m6263getHeightimpl(space) - IntSize.m6263getHeightimpl(size)) / 2.0f;
