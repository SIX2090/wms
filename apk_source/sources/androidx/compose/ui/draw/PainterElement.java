...
final /* data */ class PainterElement extends ModifierNodeElement<PainterModifier> {
    ...
    public void update(PainterModifier node) {
        boolean intrinsicsChanged = node.getSizeToIntrinsics() != this.sizeToIntrinsics || (this.sizeToIntrinsics && !Size.m3570equalsimpl0(node.getPainter().mo4365getIntrinsicSizeNHjbRc(), this.painter.mo4365getIntrinsicSizeNHjbRc()));
