        ...
        public final void invoke2() {
            ...
            while (true) {
                ...
                if (!it7.hasNext()) {
                    ...
                    while (it8.hasNext()) {
                        ...
                        if (focusEventNode.getNode().getIsAttached()) {
                            ...
                            int m5222constructorimpl = NodeKind.m5222constructorimpl(i);
                            ...
                            while (node != null) {
                                ...
                                if (node instanceof FocusTargetNode) {
                                    ...
                                    if (((this_$iv$iv$iv4.getKindSet() & m5222constructorimpl) != 0) && (node instanceof DelegatingNode)) {
                                        int count$iv$iv5 = 0;
                            ...
                            it = it8;
                            int mask$iv$iv = m5222constructorimpl;
                                        ...
                                        if ((node$iv$iv.getKindSet() & mask$iv$iv) != 0) {
                                            ...
                                            while (node2 != null) {
                                                ...
                                                if (node2 instanceof FocusTargetNode) {
                                                    ...
                                                    if (((this_$iv$iv$iv7.getKindSet() & m5222constructorimpl) != 0) && (node2 instanceof DelegatingNode)) {
                                                        int count$iv$iv6 = 0;
                                                        ...
                                                        while (node$iv$iv$iv2 != null) {
                                                            ...
                                                            if ((next$iv$iv2.getKindSet() & m5222constructorimpl) != 0) {
                                                                count$iv$iv6++;
                ...
                if (it12.getNode().getIsAttached()) {
                    ...
                    int type$iv = NodeKind.m5222constructorimpl(1024);
