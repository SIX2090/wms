...
public final class FocusRequester {
    ...
    public final boolean focus$ui_release() {
        ...
        boolean success$iv;
        boolean m3466findChildCorrespondingToFocusEnterOMvw8;
        ...
        if (size$iv$iv > 0) {
            ...
            while (true) {
                ...
                while (true) {
                    ...
                    if ((branch$iv$iv$iv3.getAggregateChildKindSet() & m5222constructorimpl) != 0) {
                                ...
                                while (node != null) {
                                    ...
                                    if (node instanceof FocusTargetNode) {
                                        ...
                                        if (focusProperties.getCanFocus()) {
                                            ...
                                            m3466findChildCorrespondingToFocusEnterOMvw8 = FocusTransactionsKt.requestFocus(it$iv);
                                            success$iv = success$iv2;
                                        } else {
                                            child$iv$iv$iv = child$iv$iv$iv2;
                                            success$iv = success$iv2;
                                            m3466findChildCorrespondingToFocusEnterOMvw8 = TwoDimensionalFocusSearchKt.m3466findChildCorrespondingToFocusEnterOMvw8(it$iv, FocusDirection.INSTANCE.m3432getEnterdhqQ8s(), new Function1<FocusTargetNode, Boolean>() { // from class: androidx.compose.ui.focus.FocusRequester$focus$1$1
                                        ...
                                        if (m3466findChildCorrespondingToFocusEnterOMvw8) {
                                            success$iv2 = true;
                                            i = 0;
                                            break;
                                        }
                                        ...
                                        if (((this_$iv$iv$iv$iv3.getKindSet() & m5222constructorimpl) != 0) && (node instanceof DelegatingNode)) {
                                            ...
                                            while (node$iv$iv$iv$iv != null) {
                                                ...
                                                if ((next$iv$iv$iv.getKindSet() & m5222constructorimpl) != 0) {
                                                    count$iv$iv$iv2++;
                        ...
                        DelegatableNodeKt.addLayoutNodeChildren(branches$iv$iv$iv, branch$iv$iv$iv3);
                    }
                }
                i$iv$iv++;
        ...
        if (size$iv > 0) {
            ...
            while (true) {
                ...
                while (true) {
                    ...
                    if ((branch$iv$iv3.getAggregateChildKindSet() & m5222constructorimpl) != 0) {
                            ...
                            if ((node$iv$iv.getKindSet() & m5222constructorimpl) != 0) {
                                ...
                                while (node2 != null) {
                                    ...
                                    if (node2 instanceof FocusTargetNode) {
                                        ...
                                        if (((this_$iv$iv$iv2.getKindSet() & m5222constructorimpl) != 0) && (node2 instanceof DelegatingNode)) {
                                            int count$iv$iv2 = 0;
