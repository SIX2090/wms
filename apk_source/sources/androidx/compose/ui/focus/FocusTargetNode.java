...
public final class FocusTargetNode extends Modifier.Node implements CompositionLocalConsumerModifierNode, FocusTargetModifierNode, ObserverModifierNode, ModifierLocalModifierNode {
    ...
    public final FocusProperties fetchFocusProperties$ui_release() {
        ...
        int type$iv4 = NodeKind.m5222constructorimpl(2048);
        int untilType$iv3 = NodeKind.m5222constructorimpl(1024);
        int i4 = 0;
    ...
    public final void m3451fetchCustomEnteraToIllA$ui_release(int focusDirection, Function1<? super FocusRequester, Unit> block) {
        if (!this.isProcessingCustomEnter) {
            this.isProcessingCustomEnter = true;
            try {
                FocusRequester it = fetchFocusProperties$ui_release().getEnter().invoke(FocusDirection.m3422boximpl(focusDirection));
    ...
    public final void m3452fetchCustomExitaToIllA$ui_release(int focusDirection, Function1<? super FocusRequester, Unit> block) {
        if (!this.isProcessingCustomExit) {
            this.isProcessingCustomExit = true;
            try {
                FocusRequester it = fetchFocusProperties$ui_release().getExit().invoke(FocusDirection.m3422boximpl(focusDirection));
                if (it != FocusRequester.INSTANCE.getDefault()) {
                    block.invoke(it);
                }
            } finally {
    ...
    public final void scheduleInvalidationForFocusEvents$ui_release() {
        ...
        int m5222constructorimpl = NodeKind.m5222constructorimpl(4096);
        MutableVector mutableVector2 = null;
        ...
        int i2 = 1024;
        int mask$iv4 = NodeKind.m5222constructorimpl(4096) | NodeKind.m5222constructorimpl(1024);
            ...
            if ((head$iv.getAggregateChildKindSet() & mask$iv4) != 0) {
                while (node$iv != null) {
                    if ((node$iv.getKindSet() & mask$iv4) != 0) {
                        ...
                        if (((it.getKindSet() & NodeKind.m5222constructorimpl(i2)) != 0 ? 1 : $this$visitAncestors_u24default$iv) == 0 && it.getIsAttached()) {
                            int m5222constructorimpl2 = NodeKind.m5222constructorimpl(4096);
                            ...
                            while (node2 != null) {
                                if (node2 instanceof FocusEventModifierNode) {
                                    ...
                                    if (((this_$iv$iv4.getKindSet() & m5222constructorimpl2) != 0 ? 1 : $this$visitAncestors_u24default$iv) == 0 || !(node2 instanceof DelegatingNode)) {
                                        $this$visitAncestors_u24default$iv4 = $this$visitAncestors_u24default$iv8;
                                        mask$iv2 = mask$iv4;
                                        includeSelf$iv2 = includeSelf$iv4;
                                        $this$visitAncestors_u24default$iv5 = $this$visitAncestors_u24default$iv;
                                        ...
                                        while (node$iv$iv2 != null) {
                                            ...
                                            if (((next$iv2.getKindSet() & m5222constructorimpl2) != 0 ? 1 : $this$visitAncestors_u24default$iv) != 0) {
                                                count$iv2++;
                                                if (count$iv2 == 1) {
                                                    node2 = next$iv2;
