...
public final class OneDimensionalFocusSearchKt {
    ...
    public static final boolean m3461oneDimensionalFocusSearchOMvw8(FocusTargetNode $this$oneDimensionalFocusSearch_u2d_u2dOM_u2dvw8, int direction, Function1<? super FocusTargetNode, Boolean> function1) {
        if (FocusDirection.m3425equalsimpl0(direction, FocusDirection.INSTANCE.m3435getNextdhqQ8s())) {
            return forwardFocusSearch($this$oneDimensionalFocusSearch_u2d_u2dOM_u2dvw8, function1);
        }
        if (FocusDirection.m3425equalsimpl0(direction, FocusDirection.INSTANCE.m3436getPreviousdhqQ8s())) {
        ...
        switch (WhenMappings.$EnumSwitchMapping$0[$this$forwardFocusSearch.getFocusState().ordinal()]) {
            case 1:
                ...
                if (focusedChild != null) {
                    return forwardFocusSearch(focusedChild, function1) || m3460generateAndSearchChildren4C6V_qg($this$forwardFocusSearch, focusedChild, FocusDirection.INSTANCE.m3435getNextdhqQ8s(), function1);
                }
        ...
        switch (WhenMappings.$EnumSwitchMapping$0[$this$backwardFocusSearch.getFocusState().ordinal()]) {
            case 1:
                ...
                switch (WhenMappings.$EnumSwitchMapping$0[focusedChild.getFocusState().ordinal()]) {
                    case 1:
                        if (backwardFocusSearch(focusedChild, function1) || m3460generateAndSearchChildren4C6V_qg($this$backwardFocusSearch, focusedChild, FocusDirection.INSTANCE.m3436getPreviousdhqQ8s(), function1)) {
                            return true;
                        }
                        return focusedChild.fetchFocusProperties$ui_release().getCanFocus() && function1.invoke(focusedChild).booleanValue();
                    case 2:
                    case 3:
                        return m3460generateAndSearchChildren4C6V_qg($this$backwardFocusSearch, focusedChild, FocusDirection.INSTANCE.m3436getPreviousdhqQ8s(), function1);
                    case 4:
                        throw new IllegalStateException(NoActiveChild.toString());
                    default:
                        throw new NoWhenBranchMatchedException();
    ...
    private static final boolean m3460generateAndSearchChildren4C6V_qg(final FocusTargetNode $this$generateAndSearchChildren_u2d4C6V_qg, final FocusTargetNode focusedItem, final int direction, final Function1<? super FocusTargetNode, Boolean> function1) {
        if (m3462searchChildren4C6V_qg($this$generateAndSearchChildren_u2d4C6V_qg, focusedItem, direction, function1)) {
            return true;
        }
        Boolean bool = (Boolean) BeyondBoundsLayoutKt.m3421searchBeyondBoundsOMvw8($this$generateAndSearchChildren_u2d4C6V_qg, direction, new Function1<BeyondBoundsLayout.BeyondBoundsScope, Boolean>() { // from class: androidx.compose.ui.focus.OneDimensionalFocusSearchKt$generateAndSearchChildren$1
            ...
            public final Boolean invoke(BeyondBoundsLayout.BeyondBoundsScope $this$searchBeyondBounds) {
                boolean m3462searchChildren4C6V_qg;
                m3462searchChildren4C6V_qg = OneDimensionalFocusSearchKt.m3462searchChildren4C6V_qg(FocusTargetNode.this, focusedItem, direction, function1);
                Boolean valueOf = Boolean.valueOf(m3462searchChildren4C6V_qg);
    ...
    public static final boolean m3462searchChildren4C6V_qg(FocusTargetNode $this$searchChildren_u2d4C6V_qg, FocusTargetNode focusedItem, int direction, Function1<? super FocusTargetNode, Boolean> function1) {
        ...
        if (FocusDirection.m3425equalsimpl0(direction, FocusDirection.INSTANCE.m3435getNextdhqQ8s()) || !$this$searchChildren_u2d4C6V_qg.fetchFocusProperties$ui_release().getCanFocus() || isRoot($this$searchChildren_u2d4C6V_qg)) {
            return false;
        }
                    ...
                    if ((node$iv$iv.getKindSet() & m5222constructorimpl) != 0) {
                        ...
                        while (node != null) {
                            if (node instanceof FocusTargetNode) {
                                ...
                                if (((this_$iv$iv$iv.getKindSet() & m5222constructorimpl) != 0) && (node instanceof DelegatingNode)) {
                                    int count$iv$iv = 0;
