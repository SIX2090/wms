...
public final class CornerRadiusKt {
    public static final long CornerRadius(float x, float y) {
        ...
        return CornerRadius.m3474constructorimpl((v1$iv << 32) | (4294967295L & v2$iv));
    }
    ...
    public static final long m3491lerp3Ry4LBc(long start, long stop, float fraction) {
        return CornerRadius(MathHelpersKt.lerp(CornerRadius.m3480getXimpl(start), CornerRadius.m3480getXimpl(stop), fraction), MathHelpersKt.lerp(CornerRadius.m3481getYimpl(start), CornerRadius.m3481getYimpl(stop), fraction));
    }
}
