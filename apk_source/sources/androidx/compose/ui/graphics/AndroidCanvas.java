...
public final class AndroidCanvas implements Canvas {
    ...
    public void mo3601concat58bKbWc(float[] matrix) {
        if (!MatrixKt.m4001isIdentity58bKbWc(matrix)) {
            android.graphics.Matrix frameworkMatrix = new android.graphics.Matrix();
            AndroidMatrixConversions_androidKt.m3616setFromEL8BTi8(frameworkMatrix, matrix);
    ...
    public void mo3600clipRectN_I0leg(float left, float top, float right, float bottom, int clipOp) {
        this.internalCanvas.clipRect(left, top, right, bottom, m3609toRegionOp7u2Bmg(clipOp));
    }

    @Override // androidx.compose.ui.graphics.Canvas
    /* renamed from: clipPath-mtrdD-E, reason: not valid java name */
    public void mo3599clipPathmtrdDE(Path path, int clipOp) {
        android.graphics.Canvas canvas = this.internalCanvas;
        if (path instanceof AndroidPath) {
            canvas.clipPath(((AndroidPath) path).getInternalPath(), m3609toRegionOp7u2Bmg(clipOp));
            return;
        }
    ...
    public final Region.Op m3609toRegionOp7u2Bmg(int $this$toRegionOp_u2d_u2d7u2Bmg) {
        return ClipOp.m3730equalsimpl0($this$toRegionOp_u2d_u2d7u2Bmg, ClipOp.INSTANCE.m3734getDifferencertfAjoo()) ? Region.Op.DIFFERENCE : Region.Op.INTERSECT;
    }

    @Override // androidx.compose.ui.graphics.Canvas
    /* renamed from: drawLine-Wko1d7g, reason: not valid java name */
    public void mo3605drawLineWko1d7g(long p1, long p2, Paint paint) {
        this.internalCanvas.drawLine(Offset.m3505getXimpl(p1), Offset.m3506getYimpl(p1), Offset.m3505getXimpl(p2), Offset.m3506getYimpl(p2), paint.getInternalPaint());
    }
    ...
    public void mo3602drawCircle9KIMszo(long center, float radius, Paint paint) {
        this.internalCanvas.drawCircle(Offset.m3505getXimpl(center), Offset.m3506getYimpl(center), radius, paint.getInternalPaint());
    }
    ...
    public void mo3603drawImaged4ec7I(ImageBitmap image, long topLeftOffset, Paint paint) {
        this.internalCanvas.drawBitmap(AndroidImageBitmap_androidKt.asAndroidBitmap(image), Offset.m3505getXimpl(topLeftOffset), Offset.m3506getYimpl(topLeftOffset), paint.getInternalPaint());
    }

    @Override // androidx.compose.ui.graphics.Canvas
    /* renamed from: drawImageRect-HPBpro0, reason: not valid java name */
    public void mo3604drawImageRectHPBpro0(ImageBitmap image, long srcOffset, long srcSize, long dstOffset, long dstSize, Paint paint) {
        ...
        $this$drawImageRect_HPBpro0_u24lambda_u240.left = IntOffset.m6222getXimpl(srcOffset);
        $this$drawImageRect_HPBpro0_u24lambda_u240.top = IntOffset.m6223getYimpl(srcOffset);
        $this$drawImageRect_HPBpro0_u24lambda_u240.right = IntOffset.m6222getXimpl(srcOffset) + IntSize.m6264getWidthimpl(srcSize);
        $this$drawImageRect_HPBpro0_u24lambda_u240.bottom = IntOffset.m6223getYimpl(srcOffset) + IntSize.m6263getHeightimpl(srcSize);
        ...
        $this$drawImageRect_HPBpro0_u24lambda_u241.left = IntOffset.m6222getXimpl(dstOffset);
        $this$drawImageRect_HPBpro0_u24lambda_u241.top = IntOffset.m6223getYimpl(dstOffset);
        $this$drawImageRect_HPBpro0_u24lambda_u241.right = IntOffset.m6222getXimpl(dstOffset) + IntSize.m6264getWidthimpl(dstSize);
        $this$drawImageRect_HPBpro0_u24lambda_u241.bottom = IntOffset.m6223getYimpl(dstOffset) + IntSize.m6263getHeightimpl(dstSize);
    ...
    public void mo3606drawPointsO7TthRY(int pointMode, List<Offset> points, Paint paint) {
        if (!PointMode.m4046equalsimpl0(pointMode, PointMode.INSTANCE.m4050getLinesr_lszbg())) {
            if (!PointMode.m4046equalsimpl0(pointMode, PointMode.INSTANCE.m4052getPolygonr_lszbg())) {
                if (PointMode.m4046equalsimpl0(pointMode, PointMode.INSTANCE.m4051getPointsr_lszbg())) {
    ...
    private final void drawPoints(List<Offset> points, Paint paint) {
        ...
        for (int index$iv = 0; index$iv < size; index$iv++) {
            ...
            this.internalCanvas.drawPoint(Offset.m3505getXimpl(point), Offset.m3506getYimpl(point), paint.getInternalPaint());
        }
    }
    ...
    private final void drawLines(List<Offset> points, Paint paint, int stepBy) {
        if (points.size() >= 2) {
            ...
            while (i < points.size() - 1) {
                ...
                this.internalCanvas.drawLine(Offset.m3505getXimpl(p1), Offset.m3506getYimpl(p1), Offset.m3505getXimpl(p2), Offset.m3506getYimpl(p2), frameworkPaint);
                i += stepBy;
            }
        }
    }
    ...
    public void mo3607drawRawPointsO7TthRY(int pointMode, float[] points, Paint paint) {
    ...
    public void mo3608drawVerticesTPEHhCM(Vertices vertices, int blendMode, Paint paint) {
        this.internalCanvas.drawVertices(AndroidVertexMode_androidKt.m3652toAndroidVertexModeJOOmi9M(vertices.getVertexMode()), vertices.getPositions().length, vertices.getPositions(), 0, vertices.getTextureCoordinates(), 0, vertices.getColors(), 0, vertices.getIndices(), 0, vertices.getIndices().length, paint.getInternalPaint());
    }
}
