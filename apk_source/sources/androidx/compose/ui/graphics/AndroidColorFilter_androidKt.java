...
public final class AndroidColorFilter_androidKt {
    ...
    public static final android.graphics.ColorFilter m3612actualTintColorFilterxETnrds(long color, int blendMode) {
        if (Build.VERSION.SDK_INT >= 29) {
            android.graphics.ColorFilter androidColorFilter = BlendModeColorFilterHelper.INSTANCE.m3692BlendModeColorFilterxETnrds(color, blendMode);
            return androidColorFilter;
        }
        android.graphics.ColorFilter androidColorFilter2 = new PorterDuffColorFilter(ColorKt.m3800toArgb8_81llA(color), AndroidBlendMode_androidKt.m3598toPorterDuffModes9anfk8(blendMode));
        return androidColorFilter2;
    }

    /* renamed from: actualColorMatrixColorFilter-jHG-Opc, reason: not valid java name */
    public static final android.graphics.ColorFilter m3610actualColorMatrixColorFilterjHGOpc(float[] colorMatrix) {
        return new android.graphics.ColorMatrixColorFilter(colorMatrix);
    }

    /* renamed from: actualLightingColorFilter--OWjLjI, reason: not valid java name */
    public static final android.graphics.ColorFilter m3611actualLightingColorFilterOWjLjI(long multiply, long add) {
        return new android.graphics.LightingColorFilter(ColorKt.m3800toArgb8_81llA(multiply), ColorKt.m3800toArgb8_81llA(add));
    }
    ...
    public static final float[] actualColorMatrixFromFilter(android.graphics.ColorFilter filter) {
        if ((filter instanceof android.graphics.ColorMatrixColorFilter) && supportsColorMatrixQuery()) {
            return ColorMatrixFilterHelper.INSTANCE.m3826getColorMatrix8unuwjk((android.graphics.ColorMatrixColorFilter) filter);
        }
