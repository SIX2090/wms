...
public final class AndroidPaint implements Paint {
    ...
    public AndroidPaint(android.graphics.Paint internalPaint) {
        ...
        this._blendMode = BlendMode.INSTANCE.m3688getSrcOver0nO6VwU();
    }
    ...
    public long mo3619getColor0d7_KjU() {
        return AndroidPaint_androidKt.getNativeColor(this.internalPaint);
    }

    @Override // androidx.compose.ui.graphics.Paint
    /* renamed from: setColor-8_81llA, reason: not valid java name */
    public void mo3625setColor8_81llA(long color) {
        AndroidPaint_androidKt.m3631setNativeColor4WTKRHQ(this.internalPaint, color);
    }
    ...
    public void mo3624setBlendModes9anfk8(int value) {
        if (!BlendMode.m3657equalsimpl0(this._blendMode, value)) {
            this._blendMode = value;
            AndroidPaint_androidKt.m3630setNativeBlendModeGB0RdKg(this.internalPaint, value);
        }
    }

    @Override // androidx.compose.ui.graphics.Paint
    /* renamed from: getStyle-TiuSbCo, reason: not valid java name */
    public int mo3623getStyleTiuSbCo() {
        return AndroidPaint_androidKt.getNativeStyle(this.internalPaint);
    }

    @Override // androidx.compose.ui.graphics.Paint
    /* renamed from: setStyle-k9PVt8s, reason: not valid java name */
    public void mo3629setStylek9PVt8s(int value) {
        AndroidPaint_androidKt.m3635setNativeStyle5YerkU(this.internalPaint, value);
    }
    ...
    public int mo3621getStrokeCapKaPHkGw() {
        return AndroidPaint_androidKt.getNativeStrokeCap(this.internalPaint);
    }

    @Override // androidx.compose.ui.graphics.Paint
    /* renamed from: setStrokeCap-BeK7IIE, reason: not valid java name */
    public void mo3627setStrokeCapBeK7IIE(int value) {
        AndroidPaint_androidKt.m3633setNativeStrokeCapCSYIeUk(this.internalPaint, value);
    }

    @Override // androidx.compose.ui.graphics.Paint
    /* renamed from: getStrokeJoin-LxFBmk8, reason: not valid java name */
    public int mo3622getStrokeJoinLxFBmk8() {
        return AndroidPaint_androidKt.getNativeStrokeJoin(this.internalPaint);
    }

    @Override // androidx.compose.ui.graphics.Paint
    /* renamed from: setStrokeJoin-Ww9F2mQ, reason: not valid java name */
    public void mo3628setStrokeJoinWw9F2mQ(int value) {
        AndroidPaint_androidKt.m3634setNativeStrokeJoinkLtJ_vA(this.internalPaint, value);
    }
    ...
    public int mo3620getFilterQualityfv9h1I() {
        return AndroidPaint_androidKt.getNativeFilterQuality(this.internalPaint);
    }

    @Override // androidx.compose.ui.graphics.Paint
    /* renamed from: setFilterQuality-vDHp3xo, reason: not valid java name */
    public void mo3626setFilterQualityvDHp3xo(int value) {
        AndroidPaint_androidKt.m3632setNativeFilterQuality50PEsBU(this.internalPaint, value);
    }
