...
public final class AndroidPath implements Path {
    ...
    public int mo3637getFillTypeRgk1Os() {
        if (this.internalPath.getFillType() == Path.FillType.EVEN_ODD) {
            return PathFillType.INSTANCE.m4028getEvenOddRgk1Os();
        }
        return PathFillType.INSTANCE.m4029getNonZeroRgk1Os();
    }

    @Override // androidx.compose.ui.graphics.Path
    /* renamed from: setFillType-oQ8Xj4U, reason: not valid java name */
    public void mo3639setFillTypeoQ8Xj4U(int value) {
        Path.FillType fillType;
        android.graphics.Path path = this.internalPath;
        if (PathFillType.m4024equalsimpl0(value, PathFillType.INSTANCE.m4028getEvenOddRgk1Os())) {
    ...
    public void addRoundRect(RoundRect roundRect) {
        ...
        Intrinsics.checkNotNull($this$addRoundRect_u24lambda_u242);
        $this$addRoundRect_u24lambda_u242[0] = CornerRadius.m3480getXimpl(roundRect.m3555getTopLeftCornerRadiuskKHJgLs());
        $this$addRoundRect_u24lambda_u242[1] = CornerRadius.m3481getYimpl(roundRect.m3555getTopLeftCornerRadiuskKHJgLs());
        $this$addRoundRect_u24lambda_u242[2] = CornerRadius.m3480getXimpl(roundRect.m3556getTopRightCornerRadiuskKHJgLs());
        $this$addRoundRect_u24lambda_u242[3] = CornerRadius.m3481getYimpl(roundRect.m3556getTopRightCornerRadiuskKHJgLs());
        $this$addRoundRect_u24lambda_u242[4] = CornerRadius.m3480getXimpl(roundRect.m3554getBottomRightCornerRadiuskKHJgLs());
        $this$addRoundRect_u24lambda_u242[5] = CornerRadius.m3481getYimpl(roundRect.m3554getBottomRightCornerRadiuskKHJgLs());
        $this$addRoundRect_u24lambda_u242[6] = CornerRadius.m3480getXimpl(roundRect.m3553getBottomLeftCornerRadiuskKHJgLs());
        $this$addRoundRect_u24lambda_u242[7] = CornerRadius.m3481getYimpl(roundRect.m3553getBottomLeftCornerRadiuskKHJgLs());
        android.graphics.Path path = this.internalPath;
        RectF rectF2 = this.rectF;
        Intrinsics.checkNotNull(rectF2);
    ...
    public void mo3636addPathUv8p0NA(Path path, long offset) {
        android.graphics.Path path2 = this.internalPath;
        if (path instanceof AndroidPath) {
            path2.addPath(((AndroidPath) path).getInternalPath(), Offset.m3505getXimpl(offset), Offset.m3506getYimpl(offset));
            return;
        }
    ...
    public void mo3641translatek4lQ0M(long offset) {
        ...
        matrix2.setTranslate(Offset.m3505getXimpl(offset), Offset.m3506getYimpl(offset));
        android.graphics.Path path = this.internalPath;
    ...
    public void mo3640transform58bKbWc(float[] matrix) {
        if (this.mMatrix == null) {
            this.mMatrix = new android.graphics.Matrix();
        }
        android.graphics.Matrix matrix2 = this.mMatrix;
        Intrinsics.checkNotNull(matrix2);
        AndroidMatrixConversions_androidKt.m3616setFromEL8BTi8(matrix2, matrix);
        android.graphics.Path path = this.internalPath;
        android.graphics.Matrix matrix3 = this.mMatrix;
        Intrinsics.checkNotNull(matrix3);
        path.transform(matrix3);
    ...
    public Rect getBounds() {
        ...
        RectF $this$getBounds_u24lambda_u243 = this.rectF;
        Intrinsics.checkNotNull($this$getBounds_u24lambda_u243);
    ...
    public boolean mo3638opN5in7k0(Path path1, Path path2, int operation) {
        Path.Op op;
        if (PathOperation.m4033equalsimpl0(operation, PathOperation.INSTANCE.m4037getDifferenceb3I0S0c())) {
            op = Path.Op.DIFFERENCE;
        } else if (PathOperation.m4033equalsimpl0(operation, PathOperation.INSTANCE.m4038getIntersectb3I0S0c())) {
            op = Path.Op.INTERSECT;
        } else if (PathOperation.m4033equalsimpl0(operation, PathOperation.INSTANCE.m4039getReverseDifferenceb3I0S0c())) {
            op = Path.Op.REVERSE_DIFFERENCE;
        } else {
            op = PathOperation.m4033equalsimpl0(operation, PathOperation.INSTANCE.m4040getUnionb3I0S0c()) ? Path.Op.UNION : Path.Op.XOR;
        }
        android.graphics.Path path = this.internalPath;
