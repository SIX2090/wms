...
public final class BlendModeColorFilter extends ColorFilter {
    ...
    private BlendModeColorFilter(long color, int blendMode) {
        this(color, blendMode, AndroidColorFilter_androidKt.m3612actualTintColorFilterxETnrds(color, blendMode), null);
    }
    ...
    public boolean equals(Object other) {
        ...
        return (other instanceof BlendModeColorFilter) && Color.m3747equalsimpl0(this.color, ((BlendModeColorFilter) other).color) && BlendMode.m3657equalsimpl0(this.blendMode, ((BlendModeColorFilter) other).blendMode);
    }

    public int hashCode() {
        int result = Color.m3753hashCodeimpl(this.color);
        return (result * 31) + BlendMode.m3658hashCodeimpl(this.blendMode);
    }

    public String toString() {
        return "BlendModeColorFilter(color=" + ((Object) Color.m3754toStringimpl(this.color)) + ", blendMode=" + ((Object) BlendMode.m3659toStringimpl(this.blendMode)) + ')';
    }
}
