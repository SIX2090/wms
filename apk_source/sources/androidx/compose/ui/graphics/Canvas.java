...
public interface Canvas {
    ...
    void mo3599clipPathmtrdDE(Path path, int clipOp);

    /* renamed from: clipRect-N_I0leg */
    void mo3600clipRectN_I0leg(float left, float top, float right, float bottom, int clipOp);

    /* renamed from: concat-58bKbWc */
    void mo3601concat58bKbWc(float[] matrix);
    ...
    void mo3602drawCircle9KIMszo(long center, float radius, Paint paint);

    /* renamed from: drawImage-d-4ec7I */
    void mo3603drawImaged4ec7I(ImageBitmap image, long topLeftOffset, Paint paint);

    /* renamed from: drawImageRect-HPBpro0 */
    void mo3604drawImageRectHPBpro0(ImageBitmap image, long srcOffset, long srcSize, long dstOffset, long dstSize, Paint paint);

    /* renamed from: drawLine-Wko1d7g */
    void mo3605drawLineWko1d7g(long p1, long p2, Paint paint);
    ...
    void mo3606drawPointsO7TthRY(int pointMode, List<Offset> points, Paint paint);

    /* renamed from: drawRawPoints-O7TthRY */
    void mo3607drawRawPointsO7TthRY(int pointMode, float[] points, Paint paint);
    ...
    void mo3608drawVerticesTPEHhCM(Vertices vertices, int blendMode, Paint paint);
    ...
    public static final class DefaultImpls {
        ...
        public static void m3724clipRectmtrdDE(Canvas $this, Rect rect, int clipOp) {
            Canvas.super.m3721clipRectmtrdDE(rect, clipOp);
        }
    ...
    static /* synthetic */ void m3719clipRectmtrdDE$default(Canvas canvas, Rect rect, int i, int i2, Object obj) {
        if (obj != null) {
            throw new UnsupportedOperationException("Super calls with default arguments not supported in this target, function: clipRect-mtrdD-E");
        }
        if ((i2 & 2) != 0) {
            i = ClipOp.INSTANCE.m3735getIntersectrtfAjoo();
        }
        canvas.m3721clipRectmtrdDE(rect, i);
    }

    /* renamed from: clipRect-mtrdD-E, reason: not valid java name */
    default void m3721clipRectmtrdDE(Rect rect, int clipOp) {
        mo3600clipRectN_I0leg(rect.getLeft(), rect.getTop(), rect.getRight(), rect.getBottom(), clipOp);
    }

    /* renamed from: clipRect-N_I0leg$default, reason: not valid java name */
    static /* synthetic */ void m3718clipRectN_I0leg$default(Canvas canvas, float f, float f2, float f3, float f4, int i, int i2, Object obj) {
        int i3;
        if (obj != null) {
        ...
        if ((i2 & 16) == 0) {
            ...
            i3 = ClipOp.INSTANCE.m3735getIntersectrtfAjoo();
        }
        canvas.mo3600clipRectN_I0leg(f, f2, f3, f4, i3);
    }

    /* renamed from: clipPath-mtrdD-E$default, reason: not valid java name */
    static /* synthetic */ void m3717clipPathmtrdDE$default(Canvas canvas, Path path, int i, int i2, Object obj) {
        if (obj != null) {
        ...
        canvas.mo3599clipPathmtrdDE(path, i);
    }
    ...
    static /* synthetic */ void m3720drawImageRectHPBpro0$default(Canvas canvas, ImageBitmap imageBitmap, long j, long j2, long j3, long j4, Paint paint, int i, Object obj) {
        if (obj != null) {
            throw new UnsupportedOperationException("Super calls with default arguments not supported in this target, function: drawImageRect-HPBpro0");
        }
        long m6232getZeronOccac = (i & 2) != 0 ? IntOffset.INSTANCE.m6232getZeronOccac() : j;
        long IntSize = (i & 4) != 0 ? IntSizeKt.IntSize(imageBitmap.getWidth(), imageBitmap.getHeight()) : j2;
        canvas.mo3604drawImageRectHPBpro0(imageBitmap, m6232getZeronOccac, IntSize, (i & 8) != 0 ? IntOffset.INSTANCE.m6232getZeronOccac() : j3, (i & 16) != 0 ? IntSize : j4, paint);
    }
}
