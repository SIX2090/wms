...
public final class Color {
    ...
    public static final /* synthetic */ Color m3736boximpl(long j) {
        return new Color(j);
    }

    /* renamed from: constructor-impl, reason: not valid java name */
    public static long m3742constructorimpl(long j) {
        return j;
    }

    /* renamed from: equals-impl, reason: not valid java name */
    public static boolean m3746equalsimpl(long j, Object obj) {
        return (obj instanceof Color) && j == ((Color) obj).m3756unboximpl();
    }

    /* renamed from: equals-impl0, reason: not valid java name */
    public static final boolean m3747equalsimpl0(long j, long j2) {
        return ULong.m6659equalsimpl0(j, j2);
    }
    ...
    public static int m3753hashCodeimpl(long j) {
        return ULong.m6664hashCodeimpl(j);
    }
    ...
    public static final ColorSpace m3750getColorSpaceimpl(long arg0) {
        ColorSpaces this_$iv = ColorSpaces.INSTANCE;
        int id$iv = (int) ULong.m6652constructorimpl(63 & arg0);
        return this_$iv.getColorSpacesArray$ui_graphics_release()[id$iv];
    }

    /* renamed from: convert-vNxB06k, reason: not valid java name */
    public static final long m3743convertvNxB06k(long arg0, ColorSpace colorSpace) {
        ColorSpace thisColorSpace = m3750getColorSpaceimpl(arg0);
        if (Intrinsics.areEqual(colorSpace, thisColorSpace)) {
            return arg0;
        }
        Connector connector = ColorSpaceKt.m4164connectYBCOT_4$default(thisColorSpace, colorSpace, 0, 2, null);
        return connector.mo4166transformToColorwmQWz5c$ui_graphics_release(m3752getRedimpl(arg0), m3751getGreenimpl(arg0), m3749getBlueimpl(arg0), m3748getAlphaimpl(arg0));
    }

    /* renamed from: getRed-impl, reason: not valid java name */
    public static final float m3752getRedimpl(long arg0) {
        if (ULong.m6652constructorimpl(63 & arg0) == 0) {
            return ((float) UnsignedKt.ulongToDouble(ULong.m6652constructorimpl(ULong.m6652constructorimpl(arg0 >>> 48) & 255))) / 255.0f;
        }
        return Float16.m3871toFloatimpl(Float16.m3855constructorimpl((short) ULong.m6652constructorimpl(ULong.m6652constructorimpl(arg0 >>> 48) & WebSocketProtocol.PAYLOAD_SHORT_MAX)));
    }

    /* renamed from: getGreen-impl, reason: not valid java name */
    public static final float m3751getGreenimpl(long arg0) {
        if (ULong.m6652constructorimpl(63 & arg0) == 0) {
            return ((float) UnsignedKt.ulongToDouble(ULong.m6652constructorimpl(ULong.m6652constructorimpl(arg0 >>> 40) & 255))) / 255.0f;
        }
        return Float16.m3871toFloatimpl(Float16.m3855constructorimpl((short) ULong.m6652constructorimpl(ULong.m6652constructorimpl(arg0 >>> 32) & WebSocketProtocol.PAYLOAD_SHORT_MAX)));
    }

    /* renamed from: getBlue-impl, reason: not valid java name */
    public static final float m3749getBlueimpl(long arg0) {
        if (ULong.m6652constructorimpl(63 & arg0) == 0) {
            return ((float) UnsignedKt.ulongToDouble(ULong.m6652constructorimpl(ULong.m6652constructorimpl(arg0 >>> 32) & 255))) / 255.0f;
        }
        return Float16.m3871toFloatimpl(Float16.m3855constructorimpl((short) ULong.m6652constructorimpl(ULong.m6652constructorimpl(arg0 >>> 16) & WebSocketProtocol.PAYLOAD_SHORT_MAX)));
    }

    /* renamed from: getAlpha-impl, reason: not valid java name */
    public static final float m3748getAlphaimpl(long arg0) {
        if (ULong.m6652constructorimpl(63 & arg0) == 0) {
            return ((float) UnsignedKt.ulongToDouble(ULong.m6652constructorimpl(ULong.m6652constructorimpl(arg0 >>> 56) & 255))) / 255.0f;
        }
        return ((float) UnsignedKt.ulongToDouble(ULong.m6652constructorimpl(ULong.m6652constructorimpl(arg0 >>> 6) & 1023))) / 1023.0f;
    }

    /* renamed from: component1-impl, reason: not valid java name */
    public static final float m3737component1impl(long arg0) {
        return m3752getRedimpl(arg0);
    }

    /* renamed from: component2-impl, reason: not valid java name */
    public static final float m3738component2impl(long arg0) {
        return m3751getGreenimpl(arg0);
    }

    /* renamed from: component3-impl, reason: not valid java name */
    public static final float m3739component3impl(long arg0) {
        return m3749getBlueimpl(arg0);
    }

    /* renamed from: component4-impl, reason: not valid java name */
    public static final float m3740component4impl(long arg0) {
        return m3748getAlphaimpl(arg0);
    }

    /* renamed from: component5-impl, reason: not valid java name */
    public static final ColorSpace m3741component5impl(long arg0) {
        return m3750getColorSpaceimpl(arg0);
    }

    /* renamed from: copy-wmQWz5c, reason: not valid java name */
    public static final long m3744copywmQWz5c(long arg0, float alpha, float red, float green, float blue) {
        return ColorKt.Color(red, green, blue, alpha, m3750getColorSpaceimpl(arg0));
    }
    ...
    public static String m3754toStringimpl(long arg0) {
        return "Color(" + m3752getRedimpl(arg0) + ", " + m3751getGreenimpl(arg0) + ", " + m3749getBlueimpl(arg0) + ", " + m3748getAlphaimpl(arg0) + ", " + m3750getColorSpaceimpl(arg0).getName() + ')';
    }
    ...
    public static final class Companion {
        ...
        public final long m3772getBlack0d7_KjU() {
            return Color.Black;
        }

        /* renamed from: getDarkGray-0d7_KjU, reason: not valid java name */
        public final long m3775getDarkGray0d7_KjU() {
            return Color.DarkGray;
        }

        /* renamed from: getGray-0d7_KjU, reason: not valid java name */
        public final long m3776getGray0d7_KjU() {
            return Color.Gray;
        }

        /* renamed from: getLightGray-0d7_KjU, reason: not valid java name */
        public final long m3778getLightGray0d7_KjU() {
            return Color.LightGray;
        }

        /* renamed from: getWhite-0d7_KjU, reason: not valid java name */
        public final long m3783getWhite0d7_KjU() {
            return Color.White;
        }

        /* renamed from: getRed-0d7_KjU, reason: not valid java name */
        public final long m3780getRed0d7_KjU() {
            return Color.Red;
        }

        /* renamed from: getGreen-0d7_KjU, reason: not valid java name */
        public final long m3777getGreen0d7_KjU() {
            return Color.Green;
        }

        /* renamed from: getBlue-0d7_KjU, reason: not valid java name */
        public final long m3773getBlue0d7_KjU() {
            return Color.Blue;
        }

        /* renamed from: getYellow-0d7_KjU, reason: not valid java name */
        public final long m3784getYellow0d7_KjU() {
            return Color.Yellow;
        }

        /* renamed from: getCyan-0d7_KjU, reason: not valid java name */
        public final long m3774getCyan0d7_KjU() {
            return Color.Cyan;
        }

        /* renamed from: getMagenta-0d7_KjU, reason: not valid java name */
        public final long m3779getMagenta0d7_KjU() {
        ...
        public final long m3782getUnspecified0d7_KjU() {
            return Color.Unspecified;
        }

        /* renamed from: hsv-JlNiLsg$default, reason: not valid java name */
        public static /* synthetic */ long m3771hsvJlNiLsg$default(Companion companion, float f, float f2, float f3, float f4, Rgb rgb, int i, Object obj) {
            float f5;
            Rgb rgb2;
            if ((i & 8) == 0) {
                f5 = f4;
            ...
            return companion.m3786hsvJlNiLsg(f, f2, f3, f5, rgb2);
        }

        /* renamed from: hsv-JlNiLsg, reason: not valid java name */
        public final long m3786hsvJlNiLsg(float hue, float saturation, float value, float alpha, Rgb colorSpace) {
            boolean z = false;
        ...
        public static /* synthetic */ long m3770hslJlNiLsg$default(Companion companion, float f, float f2, float f3, float f4, Rgb rgb, int i, Object obj) {
            float f5;
            Rgb rgb2;
            if ((i & 8) == 0) {
                f5 = f4;
            ...
            return companion.m3785hslJlNiLsg(f, f2, f3, f5, rgb2);
        }
        ...
        */
        public final long m3785hslJlNiLsg(float r6, float r7, float r8, float r9, androidx.compose.ui.graphics.colorspace.Rgb r10) {
            /*
                r5 = this;
                r0 = 0
            ...
            L49:
                ...
                throw r1
            */
            throw new UnsupportedOperationException("Method not decompiled: androidx.compose.ui.graphics.Color.Companion.m3785hslJlNiLsg(float, float, float, float, androidx.compose.ui.graphics.colorspace.Rgb):long");
        }
