...
public final class CompositingStrategy {
    ...
    private static final int Auto = m3829constructorimpl(0);
    private static final int Offscreen = m3829constructorimpl(1);
    private static final int ModulateAlpha = m3829constructorimpl(2);

    /* renamed from: box-impl, reason: not valid java name */
    public static final /* synthetic */ CompositingStrategy m3828boximpl(int i) {
        return new CompositingStrategy(i);
    }

    /* renamed from: constructor-impl, reason: not valid java name */
    public static int m3829constructorimpl(int i) {
        return i;
    }

    /* renamed from: equals-impl, reason: not valid java name */
    public static boolean m3830equalsimpl(int i, Object obj) {
    ...
    public static String m3833toStringimpl(int i) {
