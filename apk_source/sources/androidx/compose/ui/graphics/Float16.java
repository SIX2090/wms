...
public final class Float16 implements Comparable<Float16> {
    ...
    private static final short Epsilon = m3855constructorimpl((short) 5120);
    private static final short LowestValue = m3855constructorimpl((short) -1025);
    private static final short MaxValue = m3855constructorimpl((short) 31743);
    private static final short MinNormal = m3855constructorimpl((short) 1024);
    private static final short MinValue = m3855constructorimpl((short) 1);
    private static final short NaN = m3855constructorimpl((short) 32256);
    private static final short NegativeInfinity = m3855constructorimpl((short) -1024);
    private static final short NegativeZero = m3855constructorimpl(ShortCompanionObject.MIN_VALUE);
    private static final short PositiveInfinity = m3855constructorimpl((short) 31744);
    private static final short PositiveZero = m3855constructorimpl((short) 0);
    private static final short One = m3854constructorimpl(1.0f);
    private static final short NegativeOne = m3854constructorimpl(-1.0f);

    /* renamed from: box-impl, reason: not valid java name */
    public static final /* synthetic */ Float16 m3850boximpl(short s) {
        return new Float16(s);
    }

    /* renamed from: constructor-impl, reason: not valid java name */
    public static short m3855constructorimpl(short s) {
        return s;
    }

    /* renamed from: equals-impl, reason: not valid java name */
    public static boolean m3856equalsimpl(short s, Object obj) {
        return (obj instanceof Float16) && s == ((Float16) obj).m3881unboximpl();
    }

    /* renamed from: equals-impl0, reason: not valid java name */
    public static final boolean m3857equalsimpl0(short s, short s2) {
        return s == s2;
    }

    /* renamed from: hashCode-impl, reason: not valid java name */
    public static int m3862hashCodeimpl(short s) {
        return Short.hashCode(s);
    }

    public boolean equals(Object obj) {
        return m3856equalsimpl(this.halfValue, obj);
    }

    public int hashCode() {
        return m3862hashCodeimpl(this.halfValue);
    }

    /* renamed from: unbox-impl, reason: not valid java name */
    public final /* synthetic */ short m3881unboximpl() {
        return this.halfValue;
    }

    @Override // java.lang.Comparable
    public /* bridge */ /* synthetic */ int compareTo(Float16 float16) {
        return m3880compareTo41bOqos(float16.m3881unboximpl());
    }
    ...
    /* renamed from: constructor-impl, reason: not valid java name */
    public static short m3854constructorimpl(float value) {
        return m3855constructorimpl(INSTANCE.floatToHalf(value));
    }

    /* renamed from: constructor-impl, reason: not valid java name */
    public static short m3853constructorimpl(double value) {
        return m3854constructorimpl((float) value);
    }

    /* renamed from: toByte-impl, reason: not valid java name */
    public static final byte m3869toByteimpl(short arg0) {
        return (byte) m3871toFloatimpl(arg0);
    }

    /* renamed from: toShort-impl, reason: not valid java name */
    public static final short m3876toShortimpl(short arg0) {
        return (short) m3871toFloatimpl(arg0);
    }

    /* renamed from: toInt-impl, reason: not valid java name */
    public static final int m3873toIntimpl(short arg0) {
        return (int) m3871toFloatimpl(arg0);
    }

    /* renamed from: toLong-impl, reason: not valid java name */
    public static final long m3874toLongimpl(short arg0) {
        return (long) m3871toFloatimpl(arg0);
    }

    /* renamed from: toFloat-impl, reason: not valid java name */
    public static final float m3871toFloatimpl(short arg0) {
        int bits = 65535 & arg0;
        int s = 32768 & bits;
        int e = (bits >>> 10) & 31;
    ...
    public static final double m3870toDoubleimpl(short arg0) {
        return m3871toFloatimpl(arg0);
    }

    /* renamed from: toBits-impl, reason: not valid java name */
    public static final int m3868toBitsimpl(short arg0) {
        if (m3865isNaNimpl(arg0)) {
            return NaN;
        }
        return 65535 & arg0;
    }
    ...
    public static final int m3875toRawBitsimpl(short arg0) {
        return 65535 & arg0;
    }

    public String toString() {
        return m3877toStringimpl(this.halfValue);
    }

    /* renamed from: toString-impl, reason: not valid java name */
    public static String m3877toStringimpl(short arg0) {
        return String.valueOf(m3871toFloatimpl(arg0));
    }

    /* renamed from: compareTo-41bOqos, reason: not valid java name */
    public int m3880compareTo41bOqos(short other) {
        return m3852compareTo41bOqos(this.halfValue, other);
    }

    /* renamed from: compareTo-41bOqos, reason: not valid java name */
    public static int m3852compareTo41bOqos(short s, short s2) {
        if (m3865isNaNimpl(s)) {
            return !m3865isNaNimpl(s2) ? 1 : 0;
        }
        if (m3865isNaNimpl(s2)) {
            return -1;
        }
    ...
    public static final short m3860getSignslo4al4(short arg0) {
        if (m3865isNaNimpl(arg0)) {
            return NaN;
        }
        return m3852compareTo41bOqos(arg0, NegativeZero) < 0 ? NegativeOne : m3852compareTo41bOqos(arg0, PositiveZero) > 0 ? One : arg0;
    }

    /* renamed from: withSign-qCeQghg, reason: not valid java name */
    public static final short m3879withSignqCeQghg(short arg0, short sign) {
        return m3855constructorimpl((short) ((32768 & sign) | (arg0 & ShortCompanionObject.MAX_VALUE)));
    }

    /* renamed from: absoluteValue-slo4al4, reason: not valid java name */
    public static final short m3849absoluteValueslo4al4(short arg0) {
        return m3855constructorimpl((short) (arg0 & ShortCompanionObject.MAX_VALUE));
    }

    /* renamed from: round-slo4al4, reason: not valid java name */
    public static final short m3867roundslo4al4(short arg0) {
        ...
        return m3855constructorimpl((short) result);
    }

    /* renamed from: ceil-slo4al4, reason: not valid java name */
    public static final short m3851ceilslo4al4(short arg0) {
        int bits = 65535 & arg0;
        int e = bits & 32767;
        int result = bits;
        if (e < 15360) {
    ...
    public static final short m3858floorslo4al4(short arg0) {
        int bits = arg0 & UShort.MAX_VALUE;
        int e = bits & 32767;
        int result = bits;
        if (e < 15360) {
    ...
    public static final short m3878truncslo4al4(short arg0) {
        int bits = 65535 & arg0;
        int e = bits & 32767;
        int result = bits;
        if (e < 15360) {
    ...
    public static final int m3859getExponentimpl(short arg0) {
        return ((arg0 >>> 10) & 31) - 15;
    }

    /* renamed from: getSignificand-impl, reason: not valid java name */
    public static final int m3861getSignificandimpl(short arg0) {
        return arg0 & 1023;
    }

    /* renamed from: isNaN-impl, reason: not valid java name */
    public static final boolean m3865isNaNimpl(short arg0) {
        return (arg0 & ShortCompanionObject.MAX_VALUE) > FP16_EXPONENT_MAX;
    }

    /* renamed from: isInfinite-impl, reason: not valid java name */
    public static final boolean m3864isInfiniteimpl(short arg0) {
        return (arg0 & ShortCompanionObject.MAX_VALUE) == FP16_EXPONENT_MAX;
    }

    /* renamed from: isFinite-impl, reason: not valid java name */
    public static final boolean m3863isFiniteimpl(short arg0) {
        return (arg0 & ShortCompanionObject.MAX_VALUE) != FP16_EXPONENT_MAX;
    }

    /* renamed from: isNormalized-impl, reason: not valid java name */
    public static final boolean m3866isNormalizedimpl(short arg0) {
        return ((arg0 & 31744) == 0 || (arg0 & 31744) == FP16_EXPONENT_MAX) ? false : true;
    }

    /* renamed from: toHexString-impl, reason: not valid java name */
    public static final String m3872toHexStringimpl(short arg0) {
