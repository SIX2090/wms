...
public final class LightingColorFilter extends ColorFilter {
    ...
    private LightingColorFilter(long multiply, long add) {
        this(multiply, add, AndroidColorFilter_androidKt.m3611actualLightingColorFilterOWjLjI(multiply, add), null);
    }
    ...
    public boolean equals(Object other) {
        ...
        return (other instanceof LightingColorFilter) && Color.m3747equalsimpl0(this.multiply, ((LightingColorFilter) other).multiply) && Color.m3747equalsimpl0(this.add, ((LightingColorFilter) other).add);
    }

    public int hashCode() {
        int result = Color.m3753hashCodeimpl(this.multiply);
        return (result * 31) + Color.m3753hashCodeimpl(this.add);
    }

    public String toString() {
        return "LightingColorFilter(multiply=" + ((Object) Color.m3754toStringimpl(this.multiply)) + ", add=" + ((Object) Color.m3754toStringimpl(this.add)) + ')';
    }
}
