...
public final class MatrixKt {
    ...
    public static final float m4000dotp89u6pk(float[] m1, int row, float[] m2, int column) {
    ...
    public static final boolean m4001isIdentity58bKbWc(float[] $this$isIdentity_u2d58bKbWc) {
        int row = 0;
        while (row < 4) {
            int column = 0;
            while (column < 4) {
