...
public final class PaintingStyle {
    ...
    private static final int Fill = m4007constructorimpl(0);
    private static final int Stroke = m4007constructorimpl(1);
    private final int value;

    /* renamed from: box-impl, reason: not valid java name */
    public static final /* synthetic */ PaintingStyle m4006boximpl(int i) {
    ...
    public static final class Companion {
        ...
        public final int m4013getFillTiuSbCo() {
            return PaintingStyle.Fill;
        }

        /* renamed from: getStroke-TiuSbCo, reason: not valid java name */
        public final int m4014getStrokeTiuSbCo() {
    ...
    public static String m4011toStringimpl(int arg0) {
        return m4009equalsimpl0(arg0, Fill) ? "Fill" : m4009equalsimpl0(arg0, Stroke) ? "Stroke" : "Unknown";
    }
