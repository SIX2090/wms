...
public interface Path {
    ...
    void mo3636addPathUv8p0NA(Path path, long offset);
    ...
    boolean mo3638opN5in7k0(Path path1, Path path2, int operation);
    ...
    void mo3639setFillTypeoQ8Xj4U(int i);

    /* renamed from: translate-k-4lQ0M */
    void mo3641translatek4lQ0M(long offset);
    ...
    public static final class DefaultImpls {
        ...
        public static void m4019transform58bKbWc(Path $this, float[] matrix) {
            Path.super.mo3640transform58bKbWc(matrix);
        }
    }
    ...
    static /* synthetic */ void m4016addPathUv8p0NA$default(Path path, Path path2, long j, int i, Object obj) {
        if (obj != null) {
            throw new UnsupportedOperationException("Super calls with default arguments not supported in this target, function: addPath-Uv8p0NA");
        }
        if ((i & 2) != 0) {
            j = Offset.INSTANCE.m3521getZeroF1C5BW0();
        }
        path.mo3636addPathUv8p0NA(path2, j);
    }
    ...
    default void mo3640transform58bKbWc(float[] matrix) {
    }
    ...
    public static final class Companion {
        ...
        public final Path m4017combinexh6zSI8(int operation, Path path1, Path path2) {
            Path path = AndroidPath_androidKt.Path();
            if (path.mo3638opN5in7k0(path1, path2, operation)) {
                return path;
            }
