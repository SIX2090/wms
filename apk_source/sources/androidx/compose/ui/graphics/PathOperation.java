...
public final class PathOperation {
    ...
    private static final int Difference = m4031constructorimpl(0);
    private static final int Intersect = m4031constructorimpl(1);
    private static final int Union = m4031constructorimpl(2);
    private static final int Xor = m4031constructorimpl(3);
    private static final int ReverseDifference = m4031constructorimpl(4);

    /* renamed from: box-impl, reason: not valid java name */
    public static final /* synthetic */ PathOperation m4030boximpl(int i) {
        return new PathOperation(i);
    }

    /* renamed from: constructor-impl, reason: not valid java name */
    public static int m4031constructorimpl(int i) {
        return i;
    }
    ...
    public static final class Companion {
        ...
        public final int m4037getDifferenceb3I0S0c() {
            return PathOperation.Difference;
        }

        /* renamed from: getIntersect-b3I0S0c, reason: not valid java name */
        public final int m4038getIntersectb3I0S0c() {
            return PathOperation.Intersect;
        }

        /* renamed from: getUnion-b3I0S0c, reason: not valid java name */
        public final int m4040getUnionb3I0S0c() {
            return PathOperation.Union;
        }

        /* renamed from: getXor-b3I0S0c, reason: not valid java name */
        public final int m4041getXorb3I0S0c() {
            return PathOperation.Xor;
        }

        /* renamed from: getReverseDifference-b3I0S0c, reason: not valid java name */
        public final int m4039getReverseDifferenceb3I0S0c() {
    ...
    public static String m4035toStringimpl(int arg0) {
        return m4033equalsimpl0(arg0, Difference) ? "Difference" : m4033equalsimpl0(arg0, Intersect) ? "Intersect" : m4033equalsimpl0(arg0, Union) ? "Union" : m4033equalsimpl0(arg0, Xor) ? "Xor" : m4033equalsimpl0(arg0, ReverseDifference) ? "ReverseDifference" : "Unknown";
    }
