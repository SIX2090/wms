...
public final class PointMode {
    ...
    private static final int Points = m4044constructorimpl(0);
    private static final int Lines = m4044constructorimpl(1);
    private static final int Polygon = m4044constructorimpl(2);

    /* renamed from: box-impl, reason: not valid java name */
    public static final /* synthetic */ PointMode m4043boximpl(int i) {
    ...
    public static boolean m4045equalsimpl(int i, Object obj) {
    ...
    public boolean equals(Object obj) {
        return m4045equalsimpl(this.value, obj);
    }

    public int hashCode() {
        return m4047hashCodeimpl(this.value);
    }
    ...
    public static final class Companion {
        ...
        public final int m4051getPointsr_lszbg() {
            return PointMode.Points;
        }

        /* renamed from: getLines-r_lszbg, reason: not valid java name */
        public final int m4050getLinesr_lszbg() {
            return PointMode.Lines;
        }

        /* renamed from: getPolygon-r_lszbg, reason: not valid java name */
        public final int m4052getPolygonr_lszbg() {
    ...
    public static String m4048toStringimpl(int arg0) {
        return m4046equalsimpl0(arg0, Points) ? "Points" : m4046equalsimpl0(arg0, Lines) ? "Lines" : m4046equalsimpl0(arg0, Polygon) ? "Polygon" : "Unknown";
    }

    public String toString() {
        return m4048toStringimpl(this.value);
    }
}
