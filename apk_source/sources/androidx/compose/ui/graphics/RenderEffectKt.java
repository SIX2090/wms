...
public final class RenderEffectKt {
    ...
    public static /* synthetic */ BlurEffect m4054BlurEffect3YTHUZs$default(float f, float f2, int i, int i2, Object obj) {
        if ((i2 & 4) != 0) {
            i = TileMode.INSTANCE.m4118getClamp3opZhB0();
        }
        return m4053BlurEffect3YTHUZs(f, f2, i);
    }

    /* renamed from: BlurEffect-3YTHUZs, reason: not valid java name */
    public static final BlurEffect m4053BlurEffect3YTHUZs(float radiusX, float radiusY, int edgeTreatment) {
