...
public final class ReusableGraphicsLayerScope implements GraphicsLayerScope {
    ...
    private int compositingStrategy = CompositingStrategy.INSTANCE.m3835getAutoNrFUSI();
    private long size = Size.INSTANCE.m3582getUnspecifiedNHjbRc();
    ...
    public void mo3936setAmbientShadowColor8_81llA(long value) {
        if (!Color.m3747equalsimpl0(this.ambientShadowColor, value)) {
    ...
    public void mo3938setSpotShadowColor8_81llA(long value) {
        if (!Color.m3747equalsimpl0(this.spotShadowColor, value)) {
    ...
    public void mo3939setTransformOrigin__ExYCQ(long value) {
        if (!TransformOrigin.m4130equalsimpl0(this.transformOrigin, value)) {
    ...
    public void mo3937setCompositingStrategyaDBOjCE(int value) {
        if (!CompositingStrategy.m3831equalsimpl0(this.compositingStrategy, value)) {
    ...
    public void m4057setSizeuvyYCjk(long j) {
        this.size = j;
    }
    ...
    public final void reset() {
        ...
        mo3936setAmbientShadowColor8_81llA(GraphicsLayerScopeKt.getDefaultShadowColor());
        mo3938setSpotShadowColor8_81llA(GraphicsLayerScopeKt.getDefaultShadowColor());
        setRotationX(0.0f);
        setRotationY(0.0f);
        setRotationZ(0.0f);
        setCameraDistance(8.0f);
        mo3939setTransformOrigin__ExYCQ(TransformOrigin.INSTANCE.m4136getCenterSzJe1aQ());
        setShape(RectangleShapeKt.getRectangleShape());
        setClip(false);
        setRenderEffect(null);
        mo3937setCompositingStrategyaDBOjCE(CompositingStrategy.INSTANCE.m3835getAutoNrFUSI());
        m4057setSizeuvyYCjk(Size.INSTANCE.m3582getUnspecifiedNHjbRc());
