...
public abstract class ShaderBrush extends Brush {
    ...
    public abstract Shader mo3715createShaderuvyYCjk(long size);

    public ShaderBrush() {
        super(null);
        this.createdSize = Size.INSTANCE.m3582getUnspecifiedNHjbRc();
    }

    @Override // androidx.compose.ui.graphics.Brush
    /* renamed from: applyTo-Pq9zytI */
    public final void mo3693applyToPq9zytI(long size, Paint p, float alpha) {
        Shader shader = this.internalShader;
        if (shader == null || !Size.m3570equalsimpl0(this.createdSize, size)) {
            if (Size.m3576isEmptyimpl(size)) {
                shader = null;
                this.internalShader = null;
                this.createdSize = Size.INSTANCE.m3582getUnspecifiedNHjbRc();
            } else {
                Shader it = mo3715createShaderuvyYCjk(size);
                this.internalShader = it;
                shader = it;
                this.createdSize = size;
            }
        }
        if (!Color.m3747equalsimpl0(p.mo3619getColor0d7_KjU(), Color.INSTANCE.m3772getBlack0d7_KjU())) {
            p.mo3625setColor8_81llA(Color.INSTANCE.m3772getBlack0d7_KjU());
        }
