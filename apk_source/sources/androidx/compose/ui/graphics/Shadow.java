...
public final class Shadow {
    ...
    public static /* synthetic */ void m4067getColor0d7_KjU$annotations() {
    }

    /* renamed from: getOffset-F1C5BW0$annotations, reason: not valid java name */
    public static /* synthetic */ void m4068getOffsetF1C5BW0$annotations() {
    }
    ...
    public /* synthetic */ Shadow(long j, long j2, float f, int i, DefaultConstructorMarker defaultConstructorMarker) {
        this((i & 1) != 0 ? ColorKt.Color(4278190080L) : j, (i & 2) != 0 ? Offset.INSTANCE.m3521getZeroF1C5BW0() : j2, (i & 4) != 0 ? 0.0f : f, null);
    }
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Shadow) && Color.m3747equalsimpl0(this.color, ((Shadow) other).color) && Offset.m3502equalsimpl0(this.offset, ((Shadow) other).offset)) {
    ...
    public int hashCode() {
        int result = Color.m3753hashCodeimpl(this.color);
        return (((result * 31) + Offset.m3507hashCodeimpl(this.offset)) * 31) + Float.hashCode(this.blurRadius);
    }

    public String toString() {
        return "Shadow(color=" + ((Object) Color.m3754toStringimpl(this.color)) + ", offset=" + ((Object) Offset.m3513toStringimpl(this.offset)) + ", blurRadius=" + this.blurRadius + ')';
    }

    /* renamed from: copy-qcb84PM, reason: not valid java name */
    public final Shadow m4069copyqcb84PM(long color, long offset, float blurRadius) {
