...
final class SimpleGraphicsLayerModifier extends Modifier.Node implements LayoutModifierNode {
    ...
    */
    ...
    public final void m4079setTransformOrigin__ExYCQ(long j) {
    ...
    public final void m4076setAmbientShadowColor8_81llA(long j) {
    ...
    public final void m4078setSpotShadowColor8_81llA(long j) {
    ...
    public final void m4077setCompositingStrategyaDBOjCE(int i) {
    ...
    private SimpleGraphicsLayerModifier(float scaleX, float scaleY, float alpha, float translationX, float translationY, float shadowElevation, float rotationX, float rotationY, float rotationZ, float cameraDistance, long transformOrigin, Shape shape, boolean clip, RenderEffect renderEffect, long ambientShadowColor, long spotShadowColor, int compositingStrategy) {
        ...
        this.layerBlock = new Function1<GraphicsLayerScope, Unit>() { // from class: androidx.compose.ui.graphics.SimpleGraphicsLayerModifier$layerBlock$1
            ...
            public final void invoke2(GraphicsLayerScope $this$null) {
                ...
                $this$null.mo3939setTransformOrigin__ExYCQ(SimpleGraphicsLayerModifier.this.getTransformOrigin());
                ...
                $this$null.mo3936setAmbientShadowColor8_81llA(SimpleGraphicsLayerModifier.this.getAmbientShadowColor());
                $this$null.mo3938setSpotShadowColor8_81llA(SimpleGraphicsLayerModifier.this.getSpotShadowColor());
                $this$null.mo3937setCompositingStrategyaDBOjCE(SimpleGraphicsLayerModifier.this.getCompositingStrategy());
            }
        };
    }
    ...
    public final void invalidateLayerBlock() {
        NodeCoordinator wrapped = DelegatableNodeKt.m5119requireCoordinator64DMado(this, NodeKind.m5222constructorimpl(2)).getWrapped();
        if (wrapped != null) {
    ...
    public MeasureResult mo90measure3p2s80s(MeasureScope $this$measure_u2d3p2s80s, Measurable measurable, long constraints) {
        ...
        return MeasureScope.layout$default($this$measure_u2d3p2s80s, placeable.getWidth(), placeable.getHeight(), null, new Function1<Placeable.PlacementScope, Unit>() { // from class: androidx.compose.ui.graphics.SimpleGraphicsLayerModifier$measure$1
            ...
            public final void invoke2(Placeable.PlacementScope $this$layout) {
                ...
                Placeable.PlacementScope.placeWithLayer$default($this$layout, placeable2, 0, 0, 0.0f, function1, 4, null);
            }
        }, 4, null);
    }
