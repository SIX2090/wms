...
public final class SolidColor extends Brush {
    ...
    public void mo3693applyToPq9zytI(long size, Paint p, float alpha) {
        long j;
        p.setAlpha(1.0f);
        if (!(alpha == 1.0f)) {
            j = Color.m3744copywmQWz5c(r1, (r12 & 1) != 0 ? Color.m3748getAlphaimpl(r1) : Color.m3748getAlphaimpl(this.value) * alpha, (r12 & 2) != 0 ? Color.m3752getRedimpl(r1) : 0.0f, (r12 & 4) != 0 ? Color.m3751getGreenimpl(r1) : 0.0f, (r12 & 8) != 0 ? Color.m3749getBlueimpl(this.value) : 0.0f);
        } else {
            j = this.value;
        }
        p.mo3625setColor8_81llA(j);
        if (p.getShader() != null) {
            p.setShader(null);
        }
    }
    ...
    public boolean equals(Object other) {
        ...
        return (other instanceof SolidColor) && Color.m3747equalsimpl0(this.value, ((SolidColor) other).value);
    }
    ...
    public String toString() {
        return "SolidColor(value=" + ((Object) Color.m3754toStringimpl(this.value)) + ')';
    }
}
