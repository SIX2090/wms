...
public final class StampedPathEffectStyle {
    ...
    private static final int Translate = m4082constructorimpl(0);
    private static final int Rotate = m4082constructorimpl(1);
    private static final int Morph = m4082constructorimpl(2);

    /* renamed from: box-impl, reason: not valid java name */
    public static final /* synthetic */ StampedPathEffectStyle m4081boximpl(int i) {
        return new StampedPathEffectStyle(i);
    }

    /* renamed from: constructor-impl, reason: not valid java name */
    public static int m4082constructorimpl(int i) {
        return i;
    }

    /* renamed from: equals-impl, reason: not valid java name */
    public static boolean m4083equalsimpl(int i, Object obj) {
        return (obj instanceof StampedPathEffectStyle) && i == ((StampedPathEffectStyle) obj).getValue();
    }

    /* renamed from: equals-impl0, reason: not valid java name */
    public static final boolean m4084equalsimpl0(int i, int i2) {
        return i == i2;
    }

    /* renamed from: hashCode-impl, reason: not valid java name */
    public static int m4085hashCodeimpl(int i) {
        return Integer.hashCode(i);
    }

    public boolean equals(Object obj) {
        return m4083equalsimpl(this.value, obj);
    }
    ...
    public static final class Companion {
        ...
        public final int m4090getTranslateYpspkwk() {
            return StampedPathEffectStyle.Translate;
        }

        /* renamed from: getRotate-Ypspkwk, reason: not valid java name */
        public final int m4089getRotateYpspkwk() {
            return StampedPathEffectStyle.Rotate;
        }

        /* renamed from: getMorph-Ypspkwk, reason: not valid java name */
        public final int m4088getMorphYpspkwk() {
            return StampedPathEffectStyle.Morph;
        }
    }

    /* renamed from: toString-impl, reason: not valid java name */
    public static String m4086toStringimpl(int arg0) {
        return m4084equalsimpl0(arg0, Translate) ? "Translate" : m4084equalsimpl0(arg0, Rotate) ? "Rotate" : m4084equalsimpl0(arg0, Morph) ? "Morph" : "Unknown";
    }
