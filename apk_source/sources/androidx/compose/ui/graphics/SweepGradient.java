    ...
    */
    ...
    public Shader mo3715createShaderuvyYCjk(long size) {
        ...
        if (OffsetKt.m3526isUnspecifiedk4lQ0M(this.center)) {
            Offset = SizeKt.m3584getCenteruvyYCjk(size);
        } else {
            Offset = OffsetKt.Offset((Offset.m3505getXimpl(this.center) > Float.POSITIVE_INFINITY ? 1 : (Offset.m3505getXimpl(this.center) == Float.POSITIVE_INFINITY ? 0 : -1)) == 0 ? Size.m3574getWidthimpl(size) : Offset.m3505getXimpl(this.center), Offset.m3506getYimpl(this.center) == Float.POSITIVE_INFINITY ? Size.m3571getHeightimpl(size) : Offset.m3506getYimpl(this.center));
        }
        return ShaderKt.m4064SweepGradientShader9KIMszo(Offset, this.colors, this.stops);
    }
    ...
    public boolean equals(Object other) {
        ...
        return (other instanceof SweepGradient) && Offset.m3502equalsimpl0(this.center, ((SweepGradient) other).center) && Intrinsics.areEqual(this.colors, ((SweepGradient) other).colors) && Intrinsics.areEqual(this.stops, ((SweepGradient) other).stops);
    }

    public int hashCode() {
        int result = Offset.m3507hashCodeimpl(this.center);
