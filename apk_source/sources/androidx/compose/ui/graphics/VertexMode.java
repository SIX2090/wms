...
public final class VertexMode {
    ...
    private static final int Triangles = m4138constructorimpl(0);
    private static final int TriangleStrip = m4138constructorimpl(1);
    private static final int TriangleFan = m4138constructorimpl(2);

    /* renamed from: box-impl, reason: not valid java name */
    public static final /* synthetic */ VertexMode m4137boximpl(int i) {
        return new VertexMode(i);
    }

    /* renamed from: constructor-impl, reason: not valid java name */
    public static int m4138constructorimpl(int i) {
        return i;
    }

    /* renamed from: equals-impl, reason: not valid java name */
    public static boolean m4139equalsimpl(int i, Object obj) {
        return (obj instanceof VertexMode) && i == ((VertexMode) obj).getValue();
    }

    /* renamed from: equals-impl0, reason: not valid java name */
    public static final boolean m4140equalsimpl0(int i, int i2) {
        return i == i2;
    }

    /* renamed from: hashCode-impl, reason: not valid java name */
    public static int m4141hashCodeimpl(int i) {
    ...
    public static final class Companion {
        ...
        public final int m4146getTrianglesc2xauaI() {
            return VertexMode.Triangles;
        }

        /* renamed from: getTriangleStrip-c2xauaI, reason: not valid java name */
        public final int m4145getTriangleStripc2xauaI() {
            return VertexMode.TriangleStrip;
        }

        /* renamed from: getTriangleFan-c2xauaI, reason: not valid java name */
        public final int m4144getTriangleFanc2xauaI() {
            return VertexMode.TriangleFan;
        }
    }

    /* renamed from: toString-impl, reason: not valid java name */
    public static String m4142toStringimpl(int arg0) {
        return m4140equalsimpl0(arg0, Triangles) ? "Triangles" : m4140equalsimpl0(arg0, TriangleStrip) ? "TriangleStrip" : m4140equalsimpl0(arg0, TriangleFan) ? "TriangleFan" : "Unknown";
    }
