...
public final class ColorSpaceKt {
    ...
    public static /* synthetic */ Connector m4164connectYBCOT_4$default(ColorSpace colorSpace, ColorSpace colorSpace2, int i, int i2, Object obj) {
        if ((i2 & 1) != 0) {
            colorSpace2 = ColorSpaces.INSTANCE.getSrgb();
        }
        if ((i2 & 2) != 0) {
            i = RenderIntent.INSTANCE.m4178getPerceptualuksYyKA();
        }
        return m4163connectYBCOT_4(colorSpace, colorSpace2, i);
    }

    /* renamed from: connect-YBCOT_4, reason: not valid java name */
    public static final Connector m4163connectYBCOT_4(ColorSpace $this$connect_u2dYBCOT_4, ColorSpace destination, int intent) {
        if ($this$connect_u2dYBCOT_4 == ColorSpaces.INSTANCE.getSrgb()) {
            ...
            if (destination == ColorSpaces.INSTANCE.getOklab() && RenderIntent.m4173equalsimpl0(intent, RenderIntent.INSTANCE.m4178getPerceptualuksYyKA())) {
                return Connector.INSTANCE.getSrgbToOklabPerceptual$ui_graphics_release();
            }
        } else if ($this$connect_u2dYBCOT_4 == ColorSpaces.INSTANCE.getOklab() && destination == ColorSpaces.INSTANCE.getSrgb() && RenderIntent.m4173equalsimpl0(intent, RenderIntent.INSTANCE.m4178getPerceptualuksYyKA())) {
            return Connector.INSTANCE.getOklabToSrgbPerceptual$ui_graphics_release();
        }
        if ($this$connect_u2dYBCOT_4 == destination) {
            return Connector.INSTANCE.identity$ui_graphics_release($this$connect_u2dYBCOT_4);
        }
        DefaultConstructorMarker defaultConstructorMarker = null;
        if (ColorModel.m4152equalsimpl0($this$connect_u2dYBCOT_4.getModel(), ColorModel.INSTANCE.m4159getRgbxdoWZVw()) && ColorModel.m4152equalsimpl0(destination.getModel(), ColorModel.INSTANCE.m4159getRgbxdoWZVw())) {
            Intrinsics.checkNotNull($this$connect_u2dYBCOT_4, "null cannot be cast to non-null type androidx.compose.ui.graphics.colorspace.Rgb");
            Intrinsics.checkNotNull(destination, "null cannot be cast to non-null type androidx.compose.ui.graphics.colorspace.Rgb");
            return new Connector.RgbConnector((Rgb) $this$connect_u2dYBCOT_4, (Rgb) destination, intent, defaultConstructorMarker);
        }
        return new Connector($this$connect_u2dYBCOT_4, destination, intent, defaultConstructorMarker);
    }
    ...
    public static final ColorSpace adapt(ColorSpace $this$adapt, WhitePoint whitePoint, Adaptation adaptation) {
        if (ColorModel.m4152equalsimpl0($this$adapt.getModel(), ColorModel.INSTANCE.m4159getRgbxdoWZVw())) {
