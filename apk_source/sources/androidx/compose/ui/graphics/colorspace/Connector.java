    ...
    */
    private Connector(androidx.compose.ui.graphics.colorspace.ColorSpace r12, androidx.compose.ui.graphics.colorspace.ColorSpace r13, int r14) {
        /*
            ...
            long r2 = r2.m4159getRgbxdoWZVw()
            boolean r0 = androidx.compose.ui.graphics.colorspace.ColorModel.m4152equalsimpl0(r0, r2)
            r1 = 2
            r2 = 0
            if (r0 == 0) goto L20
        ...
        L21:
            ...
            long r7 = r0.m4159getRgbxdoWZVw()
            boolean r0 = androidx.compose.ui.graphics.colorspace.ColorModel.m4152equalsimpl0(r3, r7)
            if (r0 == 0) goto L3d
            androidx.compose.ui.graphics.colorspace.Illuminant r0 = androidx.compose.ui.graphics.colorspace.Illuminant.INSTANCE
            androidx.compose.ui.graphics.colorspace.WhitePoint r0 = r0.getD50()
        ...
        L3e:
            ...
            float[] r9 = androidx.compose.ui.graphics.colorspace.Connector.Companion.m4167access$computeTransformYBCOT_4(r0, r12, r13, r14)
            r10 = 0
            r3 = r11
            r4 = r12
            r5 = r13
    ...
    public long mo4166transformToColorwmQWz5c$ui_graphics_release(float r, float g, float b, float a) {
        ...
        return this.transformDestination.mo4162xyzaToColorJlNiLsg$ui_graphics_release(x, y, z, a, this.destination);
    }
    ...
    public static final class RgbConnector extends Connector {
        ...
        private RgbConnector(Rgb mSource, Rgb mDestination, int intent) {
            ...
            this.mTransform = m4169computeTransformYBCOT_4(this.mSource, this.mDestination, intent);
        }
        ...
        private final float[] m4169computeTransformYBCOT_4(Rgb source, Rgb destination, int intent) {
            ...
            if (RenderIntent.m4173equalsimpl0(intent, RenderIntent.INSTANCE.m4177getAbsoluteuksYyKA())) {
    ...
    public static final class Companion {
        ...
        /* renamed from: computeTransform-YBCOT_4, reason: not valid java name */
        public final float[] m4168computeTransformYBCOT_4(ColorSpace source, ColorSpace destination, int intent) {
            if (!RenderIntent.m4173equalsimpl0(intent, RenderIntent.INSTANCE.m4177getAbsoluteuksYyKA())) {
                return null;
            }
            boolean srcRGB = ColorModel.m4152equalsimpl0(source.getModel(), ColorModel.INSTANCE.m4159getRgbxdoWZVw());
            boolean dstRGB = ColorModel.m4152equalsimpl0(destination.getModel(), ColorModel.INSTANCE.m4159getRgbxdoWZVw());
            if (srcRGB && dstRGB) {
                return null;
            }
            if (!srcRGB && !dstRGB) {
        ...
        public final Connector identity$ui_graphics_release(final ColorSpace source) {
            final int m4179getRelativeuksYyKA = RenderIntent.INSTANCE.m4179getRelativeuksYyKA();
            return new Connector(source, m4179getRelativeuksYyKA) { // from class: androidx.compose.ui.graphics.colorspace.Connector$Companion$identity$1
                {
                    super(source, source, m4179getRelativeuksYyKA, null);
                }
    ...
    static {
        ...
        SrgbToOklabPerceptual = new Connector(ColorSpaces.INSTANCE.getSrgb(), ColorSpaces.INSTANCE.getOklab(), RenderIntent.INSTANCE.m4178getPerceptualuksYyKA(), defaultConstructorMarker);
        OklabToSrgbPerceptual = new Connector(ColorSpaces.INSTANCE.getOklab(), ColorSpaces.INSTANCE.getSrgb(), RenderIntent.INSTANCE.m4178getPerceptualuksYyKA(), defaultConstructorMarker);
    }
}
