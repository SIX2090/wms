...
public final class BitmapPainter extends Painter {
    ...
    */
    ...
    private BitmapPainter(ImageBitmap image, long srcOffset, long srcSize) {
        ...
        this.filterQuality = FilterQuality.INSTANCE.m3846getLowfv9h1I();
        this.size = m4363validateSizeN5eqBDc(this.srcOffset, this.srcSize);
        this.alpha = 1.0f;
    }
    ...
    public final void m4366setFilterQualityvDHp3xo$ui_graphics_release(int i) {
        this.filterQuality = i;
    }

    @Override // androidx.compose.ui.graphics.painter.Painter
    protected void onDraw(DrawScope $this$onDraw) {
        DrawScope.m4279drawImageAZ2fEMs$default($this$onDraw, this.image, this.srcOffset, this.srcSize, 0L, IntSizeKt.IntSize(MathKt.roundToInt(Size.m3574getWidthimpl($this$onDraw.mo4295getSizeNHjbRc())), MathKt.roundToInt(Size.m3571getHeightimpl($this$onDraw.mo4295getSizeNHjbRc()))), this.alpha, null, this.colorFilter, 0, this.filterQuality, 328, null);
    }

    @Override // androidx.compose.ui.graphics.painter.Painter
    /* renamed from: getIntrinsicSize-NH-jbRc, reason: not valid java name */
    public long mo4365getIntrinsicSizeNHjbRc() {
        return IntSizeKt.m6274toSizeozmzZPI(this.size);
    }
    ...
    private final long m4363validateSizeN5eqBDc(long srcOffset, long srcSize) {
        if (!(IntOffset.m6222getXimpl(srcOffset) >= 0 && IntOffset.m6223getYimpl(srcOffset) >= 0 && IntSize.m6264getWidthimpl(srcSize) >= 0 && IntSize.m6263getHeightimpl(srcSize) >= 0 && IntSize.m6264getWidthimpl(srcSize) <= this.image.getWidth() && IntSize.m6263getHeightimpl(srcSize) <= this.image.getHeight())) {
    ...
    public boolean equals(Object other) {
        ...
        return (other instanceof BitmapPainter) && Intrinsics.areEqual(this.image, ((BitmapPainter) other).image) && IntOffset.m6221equalsimpl0(this.srcOffset, ((BitmapPainter) other).srcOffset) && IntSize.m6262equalsimpl0(this.srcSize, ((BitmapPainter) other).srcSize) && FilterQuality.m3841equalsimpl0(this.filterQuality, ((BitmapPainter) other).filterQuality);
    }

    public int hashCode() {
        int result = this.image.hashCode();
        return (((((result * 31) + IntOffset.m6224hashCodeimpl(this.srcOffset)) * 31) + IntSize.m6265hashCodeimpl(this.srcSize)) * 31) + FilterQuality.m3842hashCodeimpl(this.filterQuality);
    }

    public String toString() {
        return "BitmapPainter(image=" + this.image + ", srcOffset=" + ((Object) IntOffset.m6229toStringimpl(this.srcOffset)) + ", srcSize=" + ((Object) IntSize.m6267toStringimpl(this.srcSize)) + ", filterQuality=" + ((Object) FilterQuality.m3843toStringimpl(this.filterQuality)) + ')';
    }
}
