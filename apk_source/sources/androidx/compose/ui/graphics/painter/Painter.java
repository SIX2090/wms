...
public abstract class Painter {
    ...
    public abstract long mo4365getIntrinsicSizeNHjbRc();
    ...
    public static /* synthetic */ void m4370drawx_KDEd0$default(Painter painter, DrawScope drawScope, long j, float f, ColorFilter colorFilter, int i, Object obj) {
        float f2;
        ...
        painter.m4371drawx_KDEd0(drawScope, j, f2, colorFilter2);
    }

    /* renamed from: draw-x_KDEd0, reason: not valid java name */
    public final void m4371drawx_KDEd0(DrawScope $this$draw_u2dx_KDEd0, long size, float alpha, ColorFilter colorFilter) {
        configureAlpha(alpha);
        configureColorFilter(colorFilter);
        configureLayoutDirection($this$draw_u2dx_KDEd0.getLayoutDirection());
        float right$iv = Size.m3574getWidthimpl($this$draw_u2dx_KDEd0.mo4295getSizeNHjbRc()) - Size.m3574getWidthimpl(size);
        float bottom$iv = Size.m3571getHeightimpl($this$draw_u2dx_KDEd0.mo4295getSizeNHjbRc()) - Size.m3571getHeightimpl(size);
        $this$draw_u2dx_KDEd0.getDrawContext().getTransform().inset(0.0f, 0.0f, right$iv, bottom$iv);
        if (alpha > 0.0f && Size.m3574getWidthimpl(size) > 0.0f && Size.m3571getHeightimpl(size) > 0.0f) {
            if (this.useLayer) {
                Rect layerRect = RectKt.m3545Recttz77jQw(Offset.INSTANCE.m3521getZeroF1C5BW0(), SizeKt.Size(Size.m3574getWidthimpl(size), Size.m3571getHeightimpl(size)));
