...
public final class GroupComponent extends VNode {
    ...
    public GroupComponent() {
        ...
        this.tintColor = Color.INSTANCE.m3782getUnspecified0d7_KjU();
    ...
    private final void markTintForBrush(Brush brush) {
        if (this.isTintable && brush != null) {
            if (brush instanceof SolidColor) {
                m4373markTintForColor8_81llA(((SolidColor) brush).getValue());
            } else {
                markNotTintable();
            }
        }
    ...
    private final void m4373markTintForColor8_81llA(long color) {
        if (!this.isTintable) {
            return;
        }
        if (color != Color.INSTANCE.m3782getUnspecified0d7_KjU()) {
            long $this$isUnspecified$iv = this.tintColor;
            if ($this$isUnspecified$iv == Color.INSTANCE.m3782getUnspecified0d7_KjU()) {
                this.tintColor = color;
            } else if (!VectorKt.m4396rgbEqualOWjLjI(this.tintColor, color)) {
                markNotTintable();
            }
        }
    }
    ...
    public final void markTintForVNode(VNode node) {
        if (node instanceof PathComponent) {
            ...
            if (((GroupComponent) node).isTintable && this.isTintable) {
                m4373markTintForColor8_81llA(((GroupComponent) node).tintColor);
            } else {
                markNotTintable();
            }
        }
    ...
    private final void updateMatrix() {
        ...
        if (target == null) {
            matrix = Matrix.m3977constructorimpl$default(null, 1, null);
            this.groupMatrix = matrix;
        } else {
            matrix = target;
            Matrix.m3986resetimpl(matrix);
        }
        Matrix.m3997translateimpl$default(matrix, this.pivotX + this.translationX, this.pivotY + this.translationY, 0.0f, 4, null);
        Matrix.m3989rotateZimpl(matrix, this.rotation);
        Matrix.m3990scaleimpl(matrix, this.scaleX, this.scaleY, 1.0f);
        Matrix.m3997translateimpl$default(matrix, -this.pivotX, -this.pivotY, 0.0f, 4, null);
    }
    ...
    public void draw(DrawScope $this$draw) {
        ...
        if (fArr != null) {
            float[] it = (fArr != null ? Matrix.m3975boximpl(fArr) : null).m3998unboximpl();
            $this$draw_u24lambda_u244.mo4228transform58bKbWc(it);
        }
        Path targetClip = this.clipPath;
        if (getWillClipPath() && targetClip != null) {
            DrawTransform.m4346clipPathmtrdDE$default($this$draw_u24lambda_u244, targetClip, 0, 2, null);
        }
        ...
        while (index$iv < size) {
            ...
            node.draw($this$draw);
            index$iv++;
            $this$withTransform$iv = $this$withTransform$iv;
        }
