...
public final class VectorKt {
    ...
    private static final int DefaultStrokeLineCap = StrokeCap.INSTANCE.m4098getButtKaPHkGw();
    private static final int DefaultStrokeLineJoin = StrokeJoin.INSTANCE.m4109getMiterLxFBmk8();
    private static final int DefaultTintBlendMode = BlendMode.INSTANCE.m3686getSrcIn0nO6VwU();
    private static final long DefaultTintColor = Color.INSTANCE.m3781getTransparent0d7_KjU();
    private static final int DefaultFillType = PathFillType.INSTANCE.m4029getNonZeroRgk1Os();
    ...
    public static final boolean m4396rgbEqualOWjLjI(long $this$rgbEqual_u2d_u2dOWjLjI, long other) {
        if (Color.m3752getRedimpl($this$rgbEqual_u2d_u2dOWjLjI) == Color.m3752getRedimpl(other)) {
            if (Color.m3751getGreenimpl($this$rgbEqual_u2d_u2dOWjLjI) == Color.m3751getGreenimpl(other)) {
                if (Color.m3749getBlueimpl($this$rgbEqual_u2d_u2dOWjLjI) == Color.m3749getBlueimpl(other)) {
                    return true;
                }
            }
        }
    ...
    public static final boolean tintableWithAlphaMask(ColorFilter $this$tintableWithAlphaMask) {
        return $this$tintableWithAlphaMask instanceof BlendModeColorFilter ? BlendMode.m3657equalsimpl0(((BlendModeColorFilter) $this$tintableWithAlphaMask).getBlendMode(), BlendMode.INSTANCE.m3686getSrcIn0nO6VwU()) || BlendMode.m3657equalsimpl0(((BlendModeColorFilter) $this$tintableWithAlphaMask).getBlendMode(), BlendMode.INSTANCE.m3688getSrcOver0nO6VwU()) : $this$tintableWithAlphaMask == null;
    }
}
