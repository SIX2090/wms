...
public final class XmlVectorParser_androidKt {
    ...
    static /* synthetic */ int m4414getStrokeLineCapCSYIeUk$default(int i, int i2, int i3, Object obj) {
        if ((i3 & 2) != 0) {
            i2 = StrokeCap.INSTANCE.m4098getButtKaPHkGw();
        }
        return m4413getStrokeLineCapCSYIeUk(i, i2);
    }

    /* renamed from: getStrokeLineCap-CSYIeUk, reason: not valid java name */
    private static final int m4413getStrokeLineCapCSYIeUk(int id, int defValue) {
        switch (id) {
            case 0:
                return StrokeCap.INSTANCE.m4098getButtKaPHkGw();
            case 1:
                return StrokeCap.INSTANCE.m4099getRoundKaPHkGw();
            case 2:
                return StrokeCap.INSTANCE.m4100getSquareKaPHkGw();
            default:
                return defValue;
        }
    }
    ...
    static /* synthetic */ int m4416getStrokeLineJoinkLtJ_vA$default(int i, int i2, int i3, Object obj) {
        if ((i3 & 2) != 0) {
            i2 = StrokeJoin.INSTANCE.m4109getMiterLxFBmk8();
        }
        return m4415getStrokeLineJoinkLtJ_vA(i, i2);
    }

    /* renamed from: getStrokeLineJoin-kLtJ_vA, reason: not valid java name */
    private static final int m4415getStrokeLineJoinkLtJ_vA(int id, int defValue) {
        switch (id) {
            case 0:
                return StrokeJoin.INSTANCE.m4109getMiterLxFBmk8();
            case 1:
                return StrokeJoin.INSTANCE.m4110getRoundLxFBmk8();
            case 2:
                return StrokeJoin.INSTANCE.m4108getBevelLxFBmk8();
            default:
                return defValue;
        }
    }
    ...
    public static final ImageVector.Builder createVectorImageBuilder(AndroidVectorParser $this$createVectorImageBuilder, Resources res, Resources.Theme theme, AttributeSet attrs) {
        ...
        if (vectorAttrs.hasValue(AndroidVectorResources.INSTANCE.getSTYLEABLE_VECTOR_DRAWABLE_TINT())) {
            ...
            if (value.type != 2) {
                ...
                if (tintColorStateList != null) {
                    ...
                    tintColor = Color.INSTANCE.m3782getUnspecified0d7_KjU();
                }
            } else {
                tintColor = Color.INSTANCE.m3782getUnspecified0d7_KjU();
            }
        ...
        if (blendModeValue != -1) {
            switch (blendModeValue) {
                case 3:
                    tintBlendMode = BlendMode.INSTANCE.m3688getSrcOver0nO6VwU();
                    break;
                case 5:
                    tintBlendMode = BlendMode.INSTANCE.m3686getSrcIn0nO6VwU();
                    break;
                case 9:
                    tintBlendMode = BlendMode.INSTANCE.m3685getSrcAtop0nO6VwU();
                    break;
                case 14:
                    tintBlendMode = BlendMode.INSTANCE.m3677getModulate0nO6VwU();
                    break;
                case 15:
                    tintBlendMode = BlendMode.INSTANCE.m3682getScreen0nO6VwU();
                    break;
                case 16:
                    tintBlendMode = BlendMode.INSTANCE.m3680getPlus0nO6VwU();
                    break;
                default:
                    tintBlendMode = BlendMode.INSTANCE.m3686getSrcIn0nO6VwU();
                    break;
        ...
        float defaultWidthDp = Dp.m6094constructorimpl($this$dp$iv);
        float $this$dp$iv2 = defaultHeight / res.getDisplayMetrics().density;
        float defaultHeightDp = Dp.m6094constructorimpl($this$dp$iv2);
        vectorAttrs.recycle();
    ...
    public static final void parsePath(AndroidVectorParser $this$parsePath, Resources res, Resources.Theme theme, AttributeSet attrs, ImageVector.Builder builder) throws IllegalArgumentException {
        ...
        int strokeLineCap = m4413getStrokeLineCapCSYIeUk(lineCap, StrokeCap.INSTANCE.m4098getButtKaPHkGw());
        ...
        int strokeLineJoin = m4415getStrokeLineJoinkLtJ_vA(lineJoin, StrokeJoin.INSTANCE.m4108getBevelLxFBmk8());
        ...
        int lineJoin2 = fillRule == 0 ? companion.m4029getNonZeroRgk1Os() : companion.m4028getEvenOddRgk1Os();
        builder.m4380addPathoIyEayM(pathData, lineJoin2, name, fillBrush, fillAlpha, strokeBrush, strokeAlpha, strokeLineWidth, strokeLineCap, strokeLineJoin, strokeMiterLimit, trimPathStart, trimPathEnd, trimPathOffset);
    }
