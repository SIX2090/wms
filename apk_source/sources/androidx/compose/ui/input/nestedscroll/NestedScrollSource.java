...
public final class NestedScrollSource {
    ...
    private static final int Drag = m4777constructorimpl(1);
    private static final int Fling = m4777constructorimpl(2);
    private static final int Relocate = m4777constructorimpl(3);
    private static final int Wheel = m4777constructorimpl(4);
    private final int value;

    /* renamed from: box-impl, reason: not valid java name */
    public static final /* synthetic */ NestedScrollSource m4776boximpl(int i) {
        return new NestedScrollSource(i);
    }

    /* renamed from: constructor-impl, reason: not valid java name */
    public static int m4777constructorimpl(int i) {
        return i;
    }

    /* renamed from: equals-impl, reason: not valid java name */
    public static boolean m4778equalsimpl(int i, Object obj) {
        return (obj instanceof NestedScrollSource) && i == ((NestedScrollSource) obj).getValue();
    }

    /* renamed from: equals-impl0, reason: not valid java name */
    public static final boolean m4779equalsimpl0(int i, int i2) {
        return i == i2;
    }

    /* renamed from: hashCode-impl, reason: not valid java name */
    public static int m4780hashCodeimpl(int i) {
    ...
    public static String m4781toStringimpl(int arg0) {
        if (m4779equalsimpl0(arg0, Drag)) {
            return "Drag";
        }
        if (m4779equalsimpl0(arg0, Fling)) {
            return "Fling";
        }
        if (m4779equalsimpl0(arg0, Relocate)) {
            return "Relocate";
        }
        return m4779equalsimpl0(arg0, Wheel) ? "Wheel" : "Invalid";
    }
    ...
    public static final class Companion {
        ...
        public static /* synthetic */ void m4783getRelocateWNlRxjI$annotations() {
        }
        ...
        public final int m4784getDragWNlRxjI() {
            return NestedScrollSource.Drag;
        }

        /* renamed from: getFling-WNlRxjI, reason: not valid java name */
        public final int m4785getFlingWNlRxjI() {
            return NestedScrollSource.Fling;
        }

        /* renamed from: getRelocate-WNlRxjI, reason: not valid java name */
        public final int m4786getRelocateWNlRxjI() {
            return NestedScrollSource.Relocate;
        }

        /* renamed from: getWheel-WNlRxjI, reason: not valid java name */
        public final int m4787getWheelWNlRxjI() {
