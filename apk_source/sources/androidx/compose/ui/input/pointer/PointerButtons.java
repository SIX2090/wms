...
public final class PointerButtons {
    ...
    public static final /* synthetic */ PointerButtons m4822boximpl(int i) {
    ...
    public static String m4827toStringimpl(int i) {
        return "PointerButtons(packedValue=" + i + ')';
    }

    public boolean equals(Object obj) {
        return m4824equalsimpl(this.packedValue, obj);
    }

    public int hashCode() {
        return m4826hashCodeimpl(this.packedValue);
    }
