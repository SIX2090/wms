...
public final class PointerInputChange {
    ...
    private PointerInputChange(long id, long uptimeMillis, long position, boolean pressed, float pressure, long previousUptimeMillis, long previousPosition, boolean previousPressed, boolean isInitiallyConsumed, int type, long scrollDelta) {
        ...
        this.originalEventPosition = Offset.INSTANCE.m3521getZeroF1C5BW0();
    ...
    */
    public /* synthetic */ PointerInputChange(long r22, long r24, long r26, boolean r28, float r29, long r30, long r32, boolean r34, boolean r35, int r36, long r37, int r39, kotlin.jvm.internal.DefaultConstructorMarker r40) {
        /*
            ...
            int r1 = r1.m4969getTouchT8wyACA()
            r17 = r1
            goto L11
        Lf:
            r17 = r36
        L11:
            ...
            long r0 = r0.m3521getZeroF1C5BW0()
            r18 = r0
            goto L20
        L1e:
            r18 = r37
    ...
    */
    public /* synthetic */ PointerInputChange(long r18, long r20, long r22, boolean r24, long r25, long r27, boolean r29, androidx.compose.ui.input.pointer.ConsumedData r30, int r31, int r32, kotlin.jvm.internal.DefaultConstructorMarker r33) {
        /*
            ...
            int r0 = r0.m4969getTouchT8wyACA()
            r15 = r0
            goto L10
        Le:
            r15 = r31
    ...
    private PointerInputChange(long id, long uptimeMillis, long position, boolean pressed, long previousUptimeMillis, long previousPosition, boolean previousPressed, ConsumedData consumed, int type) {
        this(id, uptimeMillis, position, pressed, 1.0f, previousUptimeMillis, previousPosition, previousPressed, consumed.getDownChange() || consumed.getPositionChange(), type, Offset.INSTANCE.m3521getZeroF1C5BW0(), (DefaultConstructorMarker) null);
    }
    ...
    public final void m4894setOriginalEventPositionk4lQ0M$ui_release(long j) {
    ...
    public final /* synthetic */ PointerInputChange m4884copyEzrO64(long id, long currentTime, long currentPosition, boolean currentPressed, long previousTime, long previousPosition, boolean previousPressed, ConsumedData consumed, int type) {
    ...
    public static /* synthetic */ PointerInputChange m4879copyJKmWfYY$default(PointerInputChange pointerInputChange, long j, long j2, long j3, boolean z, long j4, long j5, boolean z2, int i, long j6, int i2, Object obj) {
        int i3;
        long j7;
        ...
        return pointerInputChange.m4885copyJKmWfYY(j8, j9, j10, z3, j11, j12, z4, i3, j7);
    }

    /* renamed from: copy-JKmWfYY, reason: not valid java name */
    public final PointerInputChange m4885copyJKmWfYY(long id, long currentTime, long currentPosition, boolean currentPressed, long previousTime, long previousPosition, boolean previousPressed, int type, long scrollDelta) {
        return m4877copy8H9lfAM$default(this, id, currentTime, currentPosition, 0L, currentPressed, this.pressure, previousTime, previousPosition, previousPressed, type, getHistorical(), scrollDelta, 8, null);
    }

    /* renamed from: copy-0GkPj7c$default, reason: not valid java name */
    public static /* synthetic */ PointerInputChange m4876copy0GkPj7c$default(PointerInputChange pointerInputChange, long j, long j2, long j3, boolean z, long j4, long j5, boolean z2, ConsumedData consumedData, int i, long j6, int i2, Object obj) {
        int i3;
        long j7;
        long j8 = (i2 & 1) != 0 ? pointerInputChange.id : j;
        long j9 = (i2 & 2) != 0 ? pointerInputChange.uptimeMillis : j2;
        ...
        return pointerInputChange.m4882copy0GkPj7c(j8, j9, j10, z3, j11, j12, z4, consumedData, i3, j7);
    }
    ...
    public final PointerInputChange m4882copy0GkPj7c(long id, long currentTime, long currentPosition, boolean currentPressed, long previousTime, long previousPosition, boolean previousPressed, ConsumedData consumed, int type, long scrollDelta) {
    ...
    public static /* synthetic */ PointerInputChange m4881copyTn9QgHE$default(PointerInputChange pointerInputChange, long j, long j2, long j3, boolean z, float f, long j4, long j5, boolean z2, int i, long j6, int i2, Object obj) {
        boolean z3;
        int i3;
        long j7;
        long j8 = (i2 & 1) != 0 ? pointerInputChange.id : j;
        ...
        return pointerInputChange.m4887copyTn9QgHE(j8, j9, j10, z4, f2, j11, j12, z3, i3, j7);
    }

    /* renamed from: copy-Tn9QgHE, reason: not valid java name */
    public final PointerInputChange m4887copyTn9QgHE(long id, long currentTime, long currentPosition, boolean currentPressed, float pressure, long previousTime, long previousPosition, boolean previousPressed, int type, long scrollDelta) {
    ...
    public static /* synthetic */ PointerInputChange m4880copyOHpmEuE$default(PointerInputChange pointerInputChange, long j, long j2, long j3, boolean z, long j4, long j5, boolean z2, int i, List list, long j6, int i2, Object obj) {
        int i3;
        long j7;
        long j8 = (i2 & 1) != 0 ? pointerInputChange.id : j;
        long j9 = (i2 & 2) != 0 ? pointerInputChange.uptimeMillis : j2;
        ...
        return pointerInputChange.m4886copyOHpmEuE(j8, j9, j10, z3, j11, j12, z4, i3, list, j7);
    }

    /* renamed from: copy-OHpmEuE, reason: not valid java name */
    public final PointerInputChange m4886copyOHpmEuE(long id, long currentTime, long currentPosition, boolean currentPressed, long previousTime, long previousPosition, boolean previousPressed, int type, List<HistoricalChange> historical, long scrollDelta) {
        return m4877copy8H9lfAM$default(this, id, currentTime, currentPosition, 0L, currentPressed, this.pressure, previousTime, previousPosition, previousPressed, type, historical, scrollDelta, 8, null);
    }

    /* renamed from: copy-8H9lfAM$default, reason: not valid java name */
    public static /* synthetic */ PointerInputChange m4877copy8H9lfAM$default(PointerInputChange pointerInputChange, long j, long j2, long j3, long j4, boolean z, float f, long j5, long j6, boolean z2, int i, List list, long j7, int i2, Object obj) {
        boolean z3;
        List list2;
        long j8;
        ...
        boolean z4 = (i2 & 16) != 0 ? pointerInputChange.pressed : z;
        ...
        boolean z5 = (i2 & 256) != 0 ? pointerInputChange.previousPressed : z2;
        ...
        return pointerInputChange.m4883copy8H9lfAM(j9, j10, j11, j12, z4, f2, j13, j14, z3, i3, list2, j8);
    }

    /* renamed from: copy-8H9lfAM, reason: not valid java name */
    public final PointerInputChange m4883copy8H9lfAM(long id, long currentTime, long currentPosition, long originalEventPosition, boolean currentPressed, float pressure, long previousTime, long previousPosition, boolean previousPressed, int type, List<HistoricalChange> historical, long scrollDelta) {
        PointerInputChange it = new PointerInputChange(id, currentTime, currentPosition, currentPressed, pressure, previousTime, previousPosition, previousPressed, false, type, historical, scrollDelta, originalEventPosition, null);
        it.consumed = this.consumed;
        return it;
    }
    ...
    public String toString() {
        ...
        sb.append("PointerInputChange(id=").append((Object) PointerId.m4874toStringimpl(this.id)).append(", uptimeMillis=").append(this.uptimeMillis).append(", position=").append((Object) Offset.m3513toStringimpl(this.position)).append(", pressed=").append(this.pressed).append(", pressure=").append(this.pressure).append(", previousUptimeMillis=").append(this.previousUptimeMillis).append(", previousPosition=").append((Object) Offset.m3513toStringimpl(this.previousPosition)).append(", previousPressed=").append(this.previousPressed).append(", isConsumed=").append(isConsumed()).append(", type=").append((Object) PointerType.m4964toStringimpl(this.type)).append(", historical=").append(getHistorical()).append(",scrollDelta=");
        sb.append((Object) Offset.m3513toStringimpl(this.scrollDelta)).append(')');
        return sb.toString();
    }
}
