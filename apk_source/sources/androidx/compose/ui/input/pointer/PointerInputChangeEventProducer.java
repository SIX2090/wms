...
final class PointerInputChangeEventProducer {
    ...
    public final InternalPointerEvent produce(PointerInputEvent pointerInputEvent, PositionCalculator positionCalculator) {
        ...
        while (index$iv < size) {
            ...
            PointerInputData previousData = this.previousPointerInputData.get(it.m4905getIdJ3iCeTQ());
            if (previousData == null) {
                previousTime = it.getUptime();
                previousPosition = it.m4907getPositionF1C5BW0();
                previousDown = false;
            } else {
                previousTime = previousData.getUptime();
                previousDown = previousData.getDown();
                previousPosition = positionCalculator.mo4973screenToLocalMKHz9U(previousData.getPositionOnScreen());
            }
            changes.put(it.m4905getIdJ3iCeTQ(), new PointerInputChange(it.m4905getIdJ3iCeTQ(), it.getUptime(), it.m4907getPositionF1C5BW0(), it.getDown(), it.getPressure(), previousTime, previousPosition, previousDown, false, it.m4910getTypeT8wyACA(), it.getHistorical(), it.m4909getScrollDeltaF1C5BW0(), it.m4906getOriginalEventPositionF1C5BW0(), null));
            if (!it.getDown()) {
                this.previousPointerInputData.remove(it.m4905getIdJ3iCeTQ());
            } else {
                this.previousPointerInputData.put(it.m4905getIdJ3iCeTQ(), new PointerInputData(it.getUptime(), it.m4908getPositionOnScreenF1C5BW0(), it.getDown(), it.m4910getTypeT8wyACA(), null));
            }
            index$iv++;
