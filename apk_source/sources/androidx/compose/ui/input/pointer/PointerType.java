...
public final class PointerType {
    ...
    private static final int Unknown = m4960constructorimpl(0);
    private static final int Touch = m4960constructorimpl(1);
    private static final int Mouse = m4960constructorimpl(2);
    private static final int Stylus = m4960constructorimpl(3);
    private static final int Eraser = m4960constructorimpl(4);

    /* renamed from: box-impl, reason: not valid java name */
    public static final /* synthetic */ PointerType m4959boximpl(int i) {
        return new PointerType(i);
    }

    /* renamed from: constructor-impl, reason: not valid java name */
    private static int m4960constructorimpl(int i) {
        return i;
    }
    ...
    public static String m4964toStringimpl(int arg0) {
        switch (arg0) {
            case 1:
                return "Touch";
            case 2:
