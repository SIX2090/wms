...
public final class SuspendingPointerInputModifierNodeImpl extends Modifier.Node implements SuspendingPointerInputModifierNode, PointerInputScope, Density {
    ...
    public SuspendingPointerInputModifierNodeImpl(Function2<? super PointerInputScope, ? super Continuation<? super Unit>, ? extends Object> function2) {
        ...
        this.boundsSize = IntSize.INSTANCE.m6269getZeroYbymL2g();
    }
    ...
    public long mo304getExtendedTouchPaddingNHjbRc() {
        long minimumTouchTargetSize = mo314toSizeXkaWNTQ(getViewConfiguration().mo5149getMinimumTouchTargetSizeMYxV2XQ());
        long size = getBoundsSize();
        float horizontal = Math.max(0.0f, Size.m3574getWidthimpl(minimumTouchTargetSize) - IntSize.m6264getWidthimpl(size)) / 2.0f;
        float vertical = Math.max(0.0f, Size.m3571getHeightimpl(minimumTouchTargetSize) - IntSize.m6263getHeightimpl(size)) / 2.0f;
    ...
    public <R> Object awaitPointerEventScope(Function2<? super AwaitPointerEventScope, ? super Continuation<? super R>, ? extends Object> function2, Continuation<? super R> continuation) {
        ...
        synchronized (lock$iv) {
            ...
            createCoroutine.resumeWith(Result.m6478constructorimpl(Unit.INSTANCE));
    ...
    final class PointerEventHandlerCoroutine<R> implements AwaitPointerEventScope, Density, Continuation<R> {
        ...
        @Override // androidx.compose.ui.input.pointer.AwaitPointerEventScope
        /* renamed from: getExtendedTouchPadding-NH-jbRc */
        public long mo4801getExtendedTouchPaddingNHjbRc() {
            return SuspendingPointerInputModifierNodeImpl.this.mo304getExtendedTouchPaddingNHjbRc();
        }
        ...
        public final void offerPointerEvent(PointerEvent event, PointerEventPass pass) {
            ...
            if (pass == this.awaitPass && ($this$offerPointerEvent_u24lambda_u240 = this.pointerAwaiter) != null) {
                ...
                Result.Companion companion = Result.INSTANCE;
                $this$offerPointerEvent_u24lambda_u240.resumeWith(Result.m6478constructorimpl(event));
            }
        }
        ...
        */
        public <T> java.lang.Object withTimeout(long r11, kotlin.jvm.functions.Function2<? super androidx.compose.ui.input.pointer.AwaitPointerEventScope, ? super kotlin.coroutines.Continuation<? super T>, ? extends java.lang.Object> r13, kotlin.coroutines.Continuation<? super T> r14) {
            ...
            L39:
                ...
                java.lang.Object r4 = kotlin.Result.m6478constructorimpl(r4)
                r3.resumeWith(r4)
            L5d:
