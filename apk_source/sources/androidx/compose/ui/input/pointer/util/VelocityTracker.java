...
public final class VelocityTracker {
    ...
    private long currentPointerPositionAccumulator = Offset.INSTANCE.m3521getZeroF1C5BW0();
    ...
    public final void m4992setCurrentPointerPositionAccumulatork4lQ0M$ui_release(long j) {
    ...
    public final void m4988addPositionUv8p0NA(long timeMillis, long position) {
        this.xVelocityTracker.addDataPoint(timeMillis, Offset.m3505getXimpl(position));
        this.yVelocityTracker.addDataPoint(timeMillis, Offset.m3506getYimpl(position));
    }

    /* renamed from: calculateVelocity-9UxMQ8M, reason: not valid java name */
    public final long m4989calculateVelocity9UxMQ8M() {
        return m4990calculateVelocityAH228Gc(VelocityKt.Velocity(Float.MAX_VALUE, Float.MAX_VALUE));
    }

    /* renamed from: calculateVelocity-AH228Gc, reason: not valid java name */
    public final long m4990calculateVelocityAH228Gc(long maximumVelocity) {
        if (!(Velocity.m6329getXimpl(maximumVelocity) > 0.0f && Velocity.m6330getYimpl(maximumVelocity) > 0.0f)) {
            throw new IllegalStateException(("maximumVelocity should be a positive value. You specified=" + ((Object) Velocity.m6336toStringimpl(maximumVelocity))).toString());
        }
        float velocityX = this.xVelocityTracker.calculateVelocity(Velocity.m6329getXimpl(maximumVelocity));
        float velocityY = this.yVelocityTracker.calculateVelocity(Velocity.m6330getYimpl(maximumVelocity));
