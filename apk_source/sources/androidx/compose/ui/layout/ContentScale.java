...
public interface ContentScale {
    ...
    long mo5007computeScaleFactorH7hwNQA(long srcSize, long dstSize);
    ...
    public static final class Companion {
        ...
        private static final ContentScale Crop = new ContentScale() { // from class: androidx.compose.ui.layout.ContentScale$Companion$Crop$1
            ...
            public long mo5007computeScaleFactorH7hwNQA(long srcSize, long dstSize) {
                float it;
                it = ContentScaleKt.m5013computeFillMaxDimensioniLBOSCw(srcSize, dstSize);
        ...
        private static final ContentScale Fit = new ContentScale() { // from class: androidx.compose.ui.layout.ContentScale$Companion$Fit$1
            ...
            public long mo5007computeScaleFactorH7hwNQA(long srcSize, long dstSize) {
                float it;
                it = ContentScaleKt.m5014computeFillMinDimensioniLBOSCw(srcSize, dstSize);
                return ScaleFactorKt.ScaleFactor(it, it);
            }
        };
        private static final ContentScale FillHeight = new ContentScale() { // from class: androidx.compose.ui.layout.ContentScale$Companion$FillHeight$1
            ...
            public long mo5007computeScaleFactorH7hwNQA(long srcSize, long dstSize) {
                float it;
                it = ContentScaleKt.m5012computeFillHeightiLBOSCw(srcSize, dstSize);
                return ScaleFactorKt.ScaleFactor(it, it);
            }
        };
        private static final ContentScale FillWidth = new ContentScale() { // from class: androidx.compose.ui.layout.ContentScale$Companion$FillWidth$1
            ...
            public long mo5007computeScaleFactorH7hwNQA(long srcSize, long dstSize) {
                float it;
                it = ContentScaleKt.m5015computeFillWidthiLBOSCw(srcSize, dstSize);
                return ScaleFactorKt.ScaleFactor(it, it);
            }
        };
        private static final ContentScale Inside = new ContentScale() { // from class: androidx.compose.ui.layout.ContentScale$Companion$Inside$1
            ...
            public long mo5007computeScaleFactorH7hwNQA(long srcSize, long dstSize) {
                float it;
                if (Size.m3574getWidthimpl(srcSize) > Size.m3574getWidthimpl(dstSize) || Size.m3571getHeightimpl(srcSize) > Size.m3571getHeightimpl(dstSize)) {
                    it = ContentScaleKt.m5014computeFillMinDimensioniLBOSCw(srcSize, dstSize);
                    return ScaleFactorKt.ScaleFactor(it, it);
                }
        ...
        private static final ContentScale FillBounds = new ContentScale() { // from class: androidx.compose.ui.layout.ContentScale$Companion$FillBounds$1
            ...
            /* renamed from: computeScaleFactor-H7hwNQA */
            public long mo5007computeScaleFactorH7hwNQA(long srcSize, long dstSize) {
                float m5015computeFillWidthiLBOSCw;
                float m5012computeFillHeightiLBOSCw;
                m5015computeFillWidthiLBOSCw = ContentScaleKt.m5015computeFillWidthiLBOSCw(srcSize, dstSize);
                m5012computeFillHeightiLBOSCw = ContentScaleKt.m5012computeFillHeightiLBOSCw(srcSize, dstSize);
                return ScaleFactorKt.ScaleFactor(m5015computeFillWidthiLBOSCw, m5012computeFillHeightiLBOSCw);
            }
        };
