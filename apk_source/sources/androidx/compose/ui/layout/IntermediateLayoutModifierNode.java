...
public final class IntermediateLayoutModifierNode extends Modifier.Node implements LayoutModifierNode {
    ...
    private final LookaheadScopeImpl localLookaheadScope = new LookaheadScopeImpl(new Function0<LayoutCoordinates>() { // from class: androidx.compose.ui.layout.IntermediateLayoutModifierNode$localLookaheadScope$1
        {
            super(0);
        }
    ...
    private LookaheadScope closestLookaheadScope = this.localLookaheadScope;
    private boolean isIntermediateChangeActive = true;
    ...
    public void onAttach() {
        ...
        LookaheadLayoutCoordinates coordinates;
        LayoutNode closestLookaheadRoot;
        int i;
        NodeChain nodes;
        LookaheadLayoutCoordinates coordinates2;
        LayoutNode closestLookaheadRoot2;
        int i2;
        LookaheadLayoutCoordinates coordinates3;
        LayoutNode closestLookaheadRoot3;
        MutableVector mutableVector;
        LookaheadDelegate lookaheadDelegate;
        NodeCoordinator coordinator$ui_release = getCoordinator();
        LookaheadLayoutCoordinates coordinates4 = (coordinator$ui_release == null || (lookaheadDelegate = coordinator$ui_release.getLookaheadDelegate()) == null) ? null : lookaheadDelegate.getLookaheadLayoutCoordinates();
        if (coordinates4 == null) {
            throw new IllegalStateException("could not fetch lookahead coordinates".toString());
        }
        final LayoutNode closestLookaheadRoot4 = DelegatableNodeKt.requireLayoutNode(this).getLookaheadRoot();
        int i3 = 1;
        if (closestLookaheadRoot4 != null && closestLookaheadRoot4.getIsVirtualLookaheadRoot()) {
            ...
            int m5222constructorimpl = NodeKind.m5222constructorimpl(512);
            ...
            while (layout$iv$iv != null) {
                ...
                if ((head$iv$iv.getAggregateChildKindSet() & m5222constructorimpl) != 0) {
                    while (node$iv$iv != null) {
                        if ((node$iv$iv.getKindSet() & m5222constructorimpl) != 0) {
                            ...
                            while (node != null) {
                                if (node instanceof IntermediateLayoutModifierNode) {
                                    ...
                                    closestLookaheadRoot2 = closestLookaheadRoot4;
                                    i2 = i3;
                                } else {
                                    Modifier.Node this_$iv$iv$iv = node;
                                    if (((this_$iv$iv$iv.getKindSet() & m5222constructorimpl) != 0 ? i3 : 0) == 0 || !(node instanceof DelegatingNode)) {
                                        coordinates2 = coordinates4;
                                        closestLookaheadRoot2 = closestLookaheadRoot4;
                                        i2 = i3;
                                    } else {
                                        ...
                                        while (node$iv$iv$iv != null) {
                                            ...
                                            if (((next$iv$iv.getKindSet() & m5222constructorimpl) != 0 ? i3 : 0) != 0) {
                                                count$iv$iv++;
                                                if (count$iv$iv == i3) {
                                                    node = next$iv$iv;
                                                    coordinates3 = coordinates4;
                                                    closestLookaheadRoot3 = closestLookaheadRoot4;
                                                } else {
                                            ...
                                            closestLookaheadRoot4 = closestLookaheadRoot3;
                                            i3 = 1;
                                        }
                                        coordinates2 = coordinates4;
                                        closestLookaheadRoot2 = closestLookaheadRoot4;
                                        ...
                                        if (count$iv$iv == 1) {
                                            ...
                                            closestLookaheadRoot4 = closestLookaheadRoot2;
                                        }
                                    }
                                }
                        ...
                        closestLookaheadRoot4 = closestLookaheadRoot4;
                    }
                    coordinates = coordinates4;
                    closestLookaheadRoot = closestLookaheadRoot4;
                    i = i3;
                } else {
                    coordinates = coordinates4;
                    closestLookaheadRoot = closestLookaheadRoot4;
                ...
                closestLookaheadRoot4 = closestLookaheadRoot;
            }
    ...
    public MeasureResult mo90measure3p2s80s(MeasureScope $this$measure_u2d3p2s80s, Measurable measurable, long constraints) {
        final Placeable $this$measure_3p2s80s_u24lambda_u242 = measurable.mo5016measureBRTryo0(constraints);
        return MeasureScope.layout$default($this$measure_u2d3p2s80s, $this$measure_3p2s80s_u24lambda_u242.getWidth(), $this$measure_3p2s80s_u24lambda_u242.getHeight(), null, new Function1<Placeable.PlacementScope, Unit>() { // from class: androidx.compose.ui.layout.IntermediateLayoutModifierNode$measure$1$1
            {
                super(1);
            }
    ...
    public final MeasureResult m5018intermediateMeasureTeuZzU(MeasureScope $this$intermediateMeasure_u2dTe_u2duZzU, Measurable measurable, long constraints, long lookaheadSize, long lookaheadConstraints) {
        this.intermediateMeasureScope.m5020setLookaheadSizeozmzZPI(lookaheadSize);
        this.lookaheadConstraints = Constraints.m6038boximpl(lookaheadConstraints);
        IntermediateMeasurablePlaceable wrappedMeasurable = this.intermediateMeasurable;
        if (wrappedMeasurable == null) {
            wrappedMeasurable = new IntermediateMeasurablePlaceable(measurable);
        }
        IntermediateMeasurablePlaceable $this$intermediateMeasure_Te_uZzU_u24lambda_u243 = wrappedMeasurable;
        this.intermediateMeasurable = $this$intermediateMeasure_Te_uZzU_u24lambda_u243;
        $this$intermediateMeasure_Te_uZzU_u24lambda_u243.setWrappedMeasurable(measurable);
        return this.measureBlock.invoke(this.intermediateMeasureScope, wrappedMeasurable, Constraints.m6038boximpl(constraints));
    }
    ...
    public final int minIntermediateIntrinsicWidth$ui_release(IntrinsicMeasureScope $this$minIntermediateIntrinsicWidth, IntrinsicMeasurable measurable, int height) {
        return NodeMeasuringIntrinsics.INSTANCE.minWidth$ui_release(new NodeMeasuringIntrinsics.MeasureBlock() { // from class: androidx.compose.ui.layout.IntermediateLayoutModifierNode$minIntermediateIntrinsicWidth$1
            ...
            /* renamed from: measure-3p2s80s */
            public final MeasureResult mo5021measure3p2s80s(MeasureScope $this$minWidth, Measurable intrinsicMeasurable, long constraints) {
                return IntermediateLayoutModifierNode.this.getMeasureBlock$ui_release().invoke(IntermediateLayoutModifierNode.this.intermediateMeasureScope, intrinsicMeasurable, Constraints.m6038boximpl(constraints));
            }
    ...
    public final int minIntermediateIntrinsicHeight$ui_release(IntrinsicMeasureScope $this$minIntermediateIntrinsicHeight, IntrinsicMeasurable measurable, int width) {
        return NodeMeasuringIntrinsics.INSTANCE.minHeight$ui_release(new NodeMeasuringIntrinsics.MeasureBlock() { // from class: androidx.compose.ui.layout.IntermediateLayoutModifierNode$minIntermediateIntrinsicHeight$1
            @Override // androidx.compose.ui.node.NodeMeasuringIntrinsics.MeasureBlock
            /* renamed from: measure-3p2s80s */
            public final MeasureResult mo5021measure3p2s80s(MeasureScope $this$minHeight, Measurable intrinsicMeasurable, long constraints) {
                return IntermediateLayoutModifierNode.this.getMeasureBlock$ui_release().invoke(IntermediateLayoutModifierNode.this.intermediateMeasureScope, intrinsicMeasurable, Constraints.m6038boximpl(constraints));
            }
    ...
    public final int maxIntermediateIntrinsicWidth$ui_release(IntrinsicMeasureScope $this$maxIntermediateIntrinsicWidth, IntrinsicMeasurable measurable, int height) {
        return NodeMeasuringIntrinsics.INSTANCE.maxWidth$ui_release(new NodeMeasuringIntrinsics.MeasureBlock() { // from class: androidx.compose.ui.layout.IntermediateLayoutModifierNode$maxIntermediateIntrinsicWidth$1
            @Override // androidx.compose.ui.node.NodeMeasuringIntrinsics.MeasureBlock
            /* renamed from: measure-3p2s80s */
            public final MeasureResult mo5021measure3p2s80s(MeasureScope $this$maxWidth, Measurable intrinsicMeasurable, long constraints) {
                return IntermediateLayoutModifierNode.this.getMeasureBlock$ui_release().invoke(IntermediateLayoutModifierNode.this.intermediateMeasureScope, intrinsicMeasurable, Constraints.m6038boximpl(constraints));
            }
    ...
    public final int maxIntermediateIntrinsicHeight$ui_release(IntrinsicMeasureScope $this$maxIntermediateIntrinsicHeight, IntrinsicMeasurable measurable, int width) {
        return NodeMeasuringIntrinsics.INSTANCE.maxHeight$ui_release(new NodeMeasuringIntrinsics.MeasureBlock() { // from class: androidx.compose.ui.layout.IntermediateLayoutModifierNode$maxIntermediateIntrinsicHeight$1
            ...
            public final MeasureResult mo5021measure3p2s80s(MeasureScope $this$maxHeight, Measurable intrinsicMeasurable, long constraints) {
                return IntermediateLayoutModifierNode.this.getMeasureBlock$ui_release().invoke(IntermediateLayoutModifierNode.this.intermediateMeasureScope, intrinsicMeasurable, Constraints.m6038boximpl(constraints));
            }
    ...
    private final class IntermediateMeasurablePlaceable extends Placeable implements Measurable {
        ...
        public IntermediateMeasurablePlaceable(Measurable wrappedMeasurable) {
        ...
        public Placeable mo5016measureBRTryo0(long constraints) {
            Placeable it;
            long lookaheadSize;
            if (IntermediateLayoutModifierNode.this.getIsIntermediateChangeActive()) {
                it = this.wrappedMeasurable.mo5016measureBRTryo0(constraints);
                m5066setMeasurementConstraintsBRTryo0(constraints);
                m5065setMeasuredSizeozmzZPI(IntSizeKt.IntSize(it.getWidth(), it.getHeight()));
            } else {
                ...
                it = measurable.mo5016measureBRTryo0(constraints2.getValue());
                ...
                m5066setMeasurementConstraintsBRTryo0(constraints3.getValue());
                ...
                m5065setMeasuredSizeozmzZPI(lookaheadSize);
            }
        ...
        public void mo5017placeAtf8xVGno(long position, float zIndex, Function1<? super GraphicsLayerScope, Unit> layerBlock) {
            Unit unit;
            long offset = IntermediateLayoutModifierNode.this.getIsIntermediateChangeActive() ? position : IntOffset.INSTANCE.m6232getZeronOccac();
            NodeCoordinator coordinator = IntermediateLayoutModifierNode.this.getNode().getCoordinator();
            Intrinsics.checkNotNull(coordinator);
            Placeable.PlacementScope $this$placeAt_f8xVGno_u24lambda_u243 = coordinator.getPlacementScope();
            if (layerBlock != null) {
                Placeable placeable = this.wrappedPlaceable;
                if (placeable != null) {
                    $this$placeAt_f8xVGno_u24lambda_u243.m5076placeWithLayeraW9wM(placeable, offset, zIndex, layerBlock);
                    unit = Unit.INSTANCE;
                } else {
                    unit = null;
                }
            ...
            if (placeable2 != null) {
                $this$placeAt_f8xVGno_u24lambda_u243.m5071place70tqf50(placeable2, offset, zIndex);
    ...
    final class IntermediateMeasureScopeImpl implements IntermediateMeasureScope, CoroutineScope {
        private long lookaheadSize = IntSize.INSTANCE.m6269getZeroYbymL2g();
        ...
        public void m5020setLookaheadSizeozmzZPI(long j) {
