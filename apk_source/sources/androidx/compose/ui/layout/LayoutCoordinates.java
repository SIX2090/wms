...
public interface LayoutCoordinates {
    ...
    long mo5024localPositionOfR5De75A(LayoutCoordinates sourceCoordinates, long relativeToSource);

    /* renamed from: localToRoot-MK-Hz9U, reason: not valid java name */
    long mo5025localToRootMKHz9U(long relativeToLocal);

    /* renamed from: localToWindow-MK-Hz9U, reason: not valid java name */
    long mo5026localToWindowMKHz9U(long relativeToLocal);

    /* renamed from: windowToLocal-MK-Hz9U, reason: not valid java name */
    long mo5028windowToLocalMKHz9U(long relativeToWindow);
    ...
    public static final class DefaultImpls {
        ...
        public static void m5029transformFromEL8BTi8(LayoutCoordinates $this, LayoutCoordinates sourceCoordinates, float[] matrix) {
            LayoutCoordinates.super.mo5027transformFromEL8BTi8(sourceCoordinates, matrix);
        }
    }
    ...
    /* renamed from: transformFrom-EL8BTi8, reason: not valid java name */
    default void mo5027transformFromEL8BTi8(LayoutCoordinates sourceCoordinates, float[] matrix) {
