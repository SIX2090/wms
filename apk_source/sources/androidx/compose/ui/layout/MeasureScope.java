...
public interface MeasureScope extends IntrinsicMeasureScope {
    ...
    public static final class DefaultImpls {
        ...
        public static int m5047roundToPxR2X_6o(MeasureScope $this, long $receiver) {
            return MeasureScope.super.mo306roundToPxR2X_6o($receiver);
        }

        @Deprecated
        /* renamed from: roundToPx-0680j_4, reason: not valid java name */
        public static int m5048roundToPx0680j_4(MeasureScope $this, float $receiver) {
            return MeasureScope.super.mo307roundToPx0680j_4($receiver);
        }

        @Deprecated
        /* renamed from: toDp-GaN1DYA, reason: not valid java name */
        public static float m5049toDpGaN1DYA(MeasureScope $this, long $receiver) {
            return MeasureScope.super.mo308toDpGaN1DYA($receiver);
        }

        @Deprecated
        /* renamed from: toDp-u2uoSUM, reason: not valid java name */
        public static float m5050toDpu2uoSUM(MeasureScope $this, float $receiver) {
            return MeasureScope.super.mo309toDpu2uoSUM($receiver);
        }

        @Deprecated
        /* renamed from: toDp-u2uoSUM, reason: not valid java name */
        public static float m5051toDpu2uoSUM(MeasureScope $this, int $receiver) {
            return MeasureScope.super.mo310toDpu2uoSUM($receiver);
        }

        @Deprecated
        /* renamed from: toDpSize-k-rfVVM, reason: not valid java name */
        public static long m5052toDpSizekrfVVM(MeasureScope $this, long $receiver) {
            return MeasureScope.super.mo311toDpSizekrfVVM($receiver);
        }

        @Deprecated
        /* renamed from: toPx--R2X_6o, reason: not valid java name */
        public static float m5053toPxR2X_6o(MeasureScope $this, long $receiver) {
            return MeasureScope.super.mo312toPxR2X_6o($receiver);
        }

        @Deprecated
        /* renamed from: toPx-0680j_4, reason: not valid java name */
        public static float m5054toPx0680j_4(MeasureScope $this, float $receiver) {
        ...
        public static long m5055toSizeXkaWNTQ(MeasureScope $this, long $receiver) {
            return MeasureScope.super.mo314toSizeXkaWNTQ($receiver);
        }

        @Deprecated
        /* renamed from: toSp-0xMU5do, reason: not valid java name */
        public static long m5056toSp0xMU5do(MeasureScope $this, float $receiver) {
            return MeasureScope.super.mo315toSp0xMU5do($receiver);
        }

        @Deprecated
        /* renamed from: toSp-kPz2Gy4, reason: not valid java name */
        public static long m5057toSpkPz2Gy4(MeasureScope $this, float $receiver) {
            return MeasureScope.super.mo316toSpkPz2Gy4($receiver);
        }

        @Deprecated
        /* renamed from: toSp-kPz2Gy4, reason: not valid java name */
        public static long m5058toSpkPz2Gy4(MeasureScope $this, int $receiver) {
