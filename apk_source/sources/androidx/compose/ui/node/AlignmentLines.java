...
public abstract class AlignmentLines {
    ...
    protected abstract long mo5104calculatePositionInParentR5De75A(NodeCoordinator nodeCoordinator, long j);
    ...
    public final void addAlignmentLine(AlignmentLine alignmentLine, int initialPosition, NodeCoordinator initialCoordinator) {
        ...
        while (true) {
            position = mo5104calculatePositionInParentR5De75A(coordinator, position);
        ...
        if (alignmentLine instanceof HorizontalAlignmentLine) {
            positionInContainer = MathKt.roundToInt(Offset.m3506getYimpl(position));
        } else {
            positionInContainer = MathKt.roundToInt(Offset.m3505getXimpl(position));
        }
