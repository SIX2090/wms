...
final class DistanceAndInLayer {
    ...
    public static final /* synthetic */ DistanceAndInLayer m5129boximpl(long j) {
        return new DistanceAndInLayer(j);
    }

    /* renamed from: constructor-impl, reason: not valid java name */
    public static long m5131constructorimpl(long j) {
        return j;
    }

    /* renamed from: equals-impl, reason: not valid java name */
    public static boolean m5132equalsimpl(long j, Object obj) {
        return (obj instanceof DistanceAndInLayer) && j == ((DistanceAndInLayer) obj).m5138unboximpl();
    }
    ...
    public static int m5135hashCodeimpl(long j) {
        return Long.hashCode(j);
    }

    /* renamed from: toString-impl, reason: not valid java name */
    public static String m5137toStringimpl(long j) {
        return "DistanceAndInLayer(packedValue=" + j + ')';
    }

    public boolean equals(Object obj) {
        return m5132equalsimpl(this.packedValue, obj);
    }

    public int hashCode() {
        return m5135hashCodeimpl(this.packedValue);
    }

    public String toString() {
        return m5137toStringimpl(this.packedValue);
    }

    /* renamed from: unbox-impl, reason: not valid java name */
    public final /* synthetic */ long m5138unboximpl() {
    ...
    public static final float m5134getDistanceimpl(long arg0) {
        FloatCompanionObject floatCompanionObject = FloatCompanionObject.INSTANCE;
        return Float.intBitsToFloat((int) (arg0 >> 32));
    }

    /* renamed from: isInLayer-impl, reason: not valid java name */
    public static final boolean m5136isInLayerimpl(long arg0) {
        return ((int) (4294967295L & arg0)) != 0;
    }

    /* renamed from: compareTo-S_HNhKs, reason: not valid java name */
    public static final int m5130compareToS_HNhKs(long arg0, long other) {
        boolean thisIsInLayer = m5136isInLayerimpl(arg0);
        boolean otherIsInLayer = m5136isInLayerimpl(other);
        if (thisIsInLayer != otherIsInLayer) {
            return thisIsInLayer ? -1 : 1;
        }
        float distanceDiff = m5134getDistanceimpl(arg0) - m5134getDistanceimpl(other);
