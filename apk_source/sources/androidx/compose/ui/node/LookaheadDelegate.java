...
public abstract class LookaheadDelegate extends LookaheadCapablePlaceable implements Measurable {
    ...
    public void m5175setPositiongyyYBs(long j) {
        this.position = j;
    }
    ...
    public final void set_measureResult(MeasureResult result) {
        Unit unit;
        if (result != null) {
            m5065setMeasuredSizeozmzZPI(IntSizeKt.IntSize(result.getWidth(), result.getHeight()));
            unit = Unit.INSTANCE;
        } else {
            unit = null;
        }
        if (unit == null) {
            ...
            $this$_set__measureResult__u24lambda_u241.m5065setMeasuredSizeozmzZPI(IntSize.INSTANCE.m6269getZeroYbymL2g());
        }
    ...
    public void replace$ui_release() {
        mo5017placeAtf8xVGno(getPosition(), 0.0f, null);
    }

    /* JADX INFO: Access modifiers changed from: protected */
    @Override // androidx.compose.ui.layout.Placeable
    /* renamed from: placeAt-f8xVGno */
    public final void mo5017placeAtf8xVGno(long position, float zIndex, Function1<? super GraphicsLayerScope, Unit> layerBlock) {
        m5171placeSelfgyyYBs(position);
    ...
    private final void m5171placeSelfgyyYBs(long position) {
        if (!IntOffset.m6221equalsimpl0(getPosition(), position)) {
            m5175setPositiongyyYBs(position);
    ...
    public final void m5173placeSelfApparentToRealOffsetgyyYBs$ui_release(long position) {
        long other$iv = getApparentToRealOffset();
        m5171placeSelfgyyYBs(IntOffsetKt.IntOffset(IntOffset.m6222getXimpl(position) + IntOffset.m6222getXimpl(other$iv), IntOffset.m6223getYimpl(position) + IntOffset.m6223getYimpl(other$iv)));
    }
    ...
    public final Placeable m5172performingMeasureK40F9xA(long constraints, Function0<? extends MeasureResult> block) {
    ...
    public final long m5174positionInBjo55l4$ui_release(LookaheadDelegate ancestor) {
        long aggregatedOffset = IntOffset.INSTANCE.m6232getZeronOccac();
        ...
        while (!Intrinsics.areEqual(lookaheadDelegate, ancestor)) {
            ...
            aggregatedOffset = IntOffsetKt.IntOffset(IntOffset.m6222getXimpl(aggregatedOffset) + IntOffset.m6222getXimpl(other$iv), IntOffset.m6223getYimpl(aggregatedOffset) + IntOffset.m6223getYimpl(other$iv));
