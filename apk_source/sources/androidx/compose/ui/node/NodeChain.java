...
public final class NodeChain {
    ...
    */
    ...
    public final void resetState$ui_release() {
        ...
        MutableVector elements = this.current;
        if (elements != null && (size$iv = elements.getSize()) > 0) {
            int i$iv = 0;
            Object[] content$iv = elements.getContent();
            do {
                Modifier.Element element = (Modifier.Element) content$iv[i$iv];
                int i = i$iv;
                if (element instanceof SuspendPointerInputElement) {
                    elements.set(i, new ForceUpdateElement((ModifierNodeElement) element));
                }
                i$iv++;
            } while (i$iv < size$iv);
        }
    ...
    public final void propagateCoordinator(Modifier.Node start, NodeCoordinator coordinator) {
        ...
        for (Modifier.Node node = start.getParent(); node != null; node = node.getParent()) {
            ...
            if (node == nodeChainKt$SentinelHead$1) {
                ...
                if (!((this_$iv.getKindSet() & NodeKind.m5222constructorimpl(2)) != 0)) {
                    node.updateCoordinator$ui_release(coordinator);
                } else {
                    return;
                }
    ...
    private final class Differ implements DiffCallback {
        ...
        public void remove(int atIndex, int oldIndex) {
            ...
            if ((toRemove.getKindSet() & NodeKind.m5222constructorimpl(2)) != 0) {
    ...
    public final /* synthetic */ <T> T m5184firstFromHeadaLcG6gQ$ui_release(int type, Function1<? super T, Boolean> block) {
        int i;
        NodeChain nodeChain;
        int i2;
    ...
    public final /* synthetic */ <T> void m5187headToTailaLcG6gQ$ui_release(int type, Function1<? super T, Unit> block) {
        int i;
        NodeChain this_$iv;
    ...
    public final /* synthetic */ <T> void m5189tailToHeadaLcG6gQ$ui_release(int type, Function1<? super T, Unit> block) {
        int mask$iv;
        NodeChain this_$iv;
    ...
    public final /* synthetic */ <T> T m5188tailH91voCI$ui_release(int type) {
        int i;
        int i2;
        NodeChain nodeChain;
        int i3;
    ...
    public final /* synthetic */ <T> T m5186headH91voCI$ui_release(int type) {
        int i;
        NodeChain nodeChain;
        int i2;
        NodeChain nodeChain2;
    ...
    public final boolean m5185hasH91voCI$ui_release(int type) {
    ...
    public String toString() {
        StringBuilder $this$toString_u24lambda_u2432 = new StringBuilder();
        $this$toString_u24lambda_u2432.append("[");
        if (this.head == this.tail) {
            ...
            while (true) {
                ...
                Modifier.Node it = node$iv;
                $this$toString_u24lambda_u2432.append(String.valueOf(it));
        ...
        String sb = $this$toString_u24lambda_u2432.toString();
