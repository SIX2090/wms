...
public final class NodeChainKt {
    ...
    public static final int actionForModifiers(Modifier.Element prev, Modifier.Element next) {
        ...
        if (Actual_jvmKt.areObjectsOfSameType(prev, next) || ((prev instanceof ForceUpdateElement) && Actual_jvmKt.areObjectsOfSameType(((ForceUpdateElement) prev).getOriginal(), next))) {
            return 1;
        }
        return 0;
    }
