...
public abstract class NodeCoordinator extends LookaheadCapablePlaceable implements Measurable, LayoutCoordinates, OwnerScope {
    ...
    private static final float[] tmpMatrix = Matrix.m3977constructorimpl$default(null, 1, null);
    private static final HitTestSource PointerInputSource = new HitTestSource() { // from class: androidx.compose.ui.node.NodeCoordinator$Companion$PointerInputSource$1
        ...
        public int mo5218entityTypeOLwlOKw() {
            return NodeKind.m5222constructorimpl(16);
        }
        ...
        public void mo5217childHitTestYqVAtuI(LayoutNode layoutNode, long pointerPosition, HitTestResult hitTestResult, boolean isTouchEvent, boolean isInLayer) {
            layoutNode.m5145hitTestM_7yMNQ$ui_release(pointerPosition, hitTestResult, isTouchEvent, isInLayer);
        }
    };
    private static final HitTestSource SemanticsSource = new HitTestSource() { // from class: androidx.compose.ui.node.NodeCoordinator$Companion$SemanticsSource$1
        ...
        public int mo5218entityTypeOLwlOKw() {
            return NodeKind.m5222constructorimpl(8);
        }
        ...
        public void mo5217childHitTestYqVAtuI(LayoutNode layoutNode, long pointerPosition, HitTestResult hitTestResult, boolean isTouchEvent, boolean isInLayer) {
            layoutNode.m5146hitTestSemanticsM_7yMNQ$ui_release(pointerPosition, hitTestResult, isTouchEvent, isInLayer);
        }
    };
    private Density layerDensity = getLayoutNode().getDensity();
    private LayoutDirection layerLayoutDirection = getLayoutNode().getLayoutDirection();
    private float lastLayerAlpha = 0.8f;
    private long position = IntOffset.INSTANCE.m6232getZeronOccac();
    ...
    public interface HitTestSource {
        /* renamed from: childHitTest-YqVAtuI */
        void mo5217childHitTestYqVAtuI(LayoutNode layoutNode, long pointerPosition, HitTestResult hitTestResult, boolean isTouchEvent, boolean isInLayer);

        /* renamed from: entityType-OLwlOKw */
        int mo5218entityTypeOLwlOKw();
    ...
    public final /* synthetic */ <T> void m5215visitNodesaLcG6gQ(int type, Function1<? super T, Unit> block) {
        int i;
        ...
        Object obj;
        int i3 = 0;
        boolean includeTail$iv4 = NodeKindKt.m5231getIncludeSelfInTraversalH91voCI(type);
    ...
    private final boolean m5195hasNodeH91voCI(int type) {
        Modifier.Node headNode = headNode(NodeKindKt.m5231getIncludeSelfInTraversalH91voCI(type));
        return headNode != null && DelegatableNodeKt.m5117has64DMado(headNode, type);
    }

    /* renamed from: head-H91voCI, reason: not valid java name */
    public final Modifier.Node m5208headH91voCI(int type) {
        boolean includeTail$iv = NodeKindKt.m5231getIncludeSelfInTraversalH91voCI(type);
    ...
    public final long mo5023getSizeYbymL2g() {
    ...
    public void replace$ui_release() {
        mo5017placeAtf8xVGno(getPosition(), this.zIndex, this.layerBlock);
    }
    ...
    protected void onMeasureResultChanged(int width, int height) {
        ...
        if (layer4 != null) {
            layer4.mo5273resizeozmzZPI(IntSizeKt.IntSize(width, height));
        } else {
            NodeCoordinator nodeCoordinator = this.wrappedBy;
            if (nodeCoordinator != null) {
        ...
        m5065setMeasuredSizeozmzZPI(IntSizeKt.IntSize(width, height));
        NodeCoordinator nodeCoordinator2 = null;
        updateLayerParameters(false);
        int type$iv4 = NodeKind.m5222constructorimpl(4);
        NodeCoordinator this_$iv5 = this;
        boolean includeTail$iv$iv = NodeKindKt.m5231getIncludeSelfInTraversalH91voCI(type$iv4);
    ...
    protected void m5213setPositiongyyYBs(long j) {
        this.position = j;
    }
    ...
    public Object getParentData() {
        ...
        MutableVector mutableVector;
        int i3 = 64;
        if (!getLayoutNode().getNodes().m5185hasH91voCI$ui_release(NodeKind.m5222constructorimpl(64))) {
            return null;
        }
        ...
        while (node$iv != null) {
            ...
            int i4 = 0;
            int kind$iv = (node.getKindSet() & NodeKind.m5222constructorimpl(i3)) != 0 ? 1 : 0;
            if (kind$iv != 0) {
                int m5222constructorimpl = NodeKind.m5222constructorimpl(i3);
                MutableVector mutableVector2 = null;
                Modifier.Node node2 = node;
                while (node2 != null) {
                    if (node2 instanceof ParentDataModifierNode) {
                        ...
                        Modifier.Node this_$iv$iv = node2;
                        if (((this_$iv$iv.getKindSet() & m5222constructorimpl) != 0) && (node2 instanceof DelegatingNode)) {
                            int count$iv2 = 0;
                            DelegatingNode this_$iv$iv2 = (DelegatingNode) node2;
                            Modifier.Node node$iv$iv = this_$iv$iv2.getDelegate();
                            while (node$iv$iv != null) {
                                Modifier.Node next$iv = node$iv$iv;
                                if ((next$iv.getKindSet() & m5222constructorimpl) != 0) {
                                    count$iv2++;
                                    this_$iv3 = this_$iv4;
                                    if (count$iv2 == 1) {
                                        node2 = next$iv;
    ...
    public final long m5206getLastMeasurementConstraintsmsEJaDk$ui_release() {
        return getMeasurementConstraints();
    }

    /* renamed from: performingMeasure-K40F9xA, reason: not valid java name */
    protected final Placeable m5211performingMeasureK40F9xA(long constraints, Function0<? extends Placeable> block) {
        m5066setMeasurementConstraintsBRTryo0(constraints);
        return block.invoke();
    }
    ...
    public final void onMeasured() {
        ...
        MutableVector mutableVector;
        if (!m5195hasNodeH91voCI(NodeKind.m5222constructorimpl(128))) {
            return;
        }
        ...
        try {
            try {
                int type$iv4 = NodeKind.m5222constructorimpl(128);
                NodeCoordinator this_$iv5 = this;
                int i3 = 0;
                boolean includeTail$iv$iv = NodeKindKt.m5231getIncludeSelfInTraversalH91voCI(type$iv4);
    ...
    protected void mo5017placeAtf8xVGno(long position, float zIndex, Function1<? super GraphicsLayerScope, Unit> layerBlock) {
        m5199placeSelff8xVGno(position, zIndex, layerBlock);
    }

    /* renamed from: placeSelf-f8xVGno, reason: not valid java name */
    private final void m5199placeSelff8xVGno(long position, float zIndex, Function1<? super GraphicsLayerScope, Unit> layerBlock) {
        updateLayerBlock$default(this, layerBlock, false, 2, null);
        if (!IntOffset.m6221equalsimpl0(getPosition(), position)) {
            m5213setPositiongyyYBs(position);
            ...
            if (layer != null) {
                layer.mo5272movegyyYBs(position);
            } else {
                NodeCoordinator nodeCoordinator = this.wrappedBy;
                if (nodeCoordinator != null) {
                    nodeCoordinator.invalidateLayer();
    ...
    public final void m5212placeSelfApparentToRealOffsetf8xVGno(long position, float zIndex, Function1<? super GraphicsLayerScope, Unit> layerBlock) {
        long other$iv = getApparentToRealOffset();
        m5199placeSelff8xVGno(IntOffsetKt.IntOffset(IntOffset.m6222getXimpl(position) + IntOffset.m6222getXimpl(other$iv), IntOffset.m6223getYimpl(position) + IntOffset.m6223getYimpl(other$iv)), zIndex, layerBlock);
    }
    ...
    public final void draw(Canvas canvas) {
        ...
        float x = IntOffset.m6222getXimpl(getPosition());
        float y = IntOffset.m6223getYimpl(getPosition());
    ...
    public final void drawContainedDrawModifiers(Canvas canvas) {
        Modifier.Node head = m5208headH91voCI(NodeKind.m5222constructorimpl(4));
        if (head == null) {
            performDraw(canvas);
        } else {
            LayoutNodeDrawScope drawScope = getLayoutNode().getMDrawScope$ui_release();
            drawScope.m5155drawx_KDEd0$ui_release(canvas, IntSizeKt.m6274toSizeozmzZPI(mo5023getSizeYbymL2g()), this, head);
        }
    }
    ...
    public final void updateLayerBlock(Function1<? super GraphicsLayerScope, Unit> layerBlock, boolean forceUpdateLayerParameters) {
        ...
        if (layoutNode.isAttached() && layerBlock != null) {
            if (this.layer == null) {
                ...
                $this$updateLayerBlock_u24lambda_u2413.mo5273resizeozmzZPI(getMeasuredSize());
                $this$updateLayerBlock_u24lambda_u2413.mo5272movegyyYBs(getPosition());
    ...
    private final void updateLayerParameters(boolean invokeOnLayoutChange) {
        ...
        if (layer != null) {
            ...
            graphicsLayerScope.m4057setSizeuvyYCjk(IntSizeKt.m6274toSizeozmzZPI(mo5023getSizeYbymL2g()));
    ...
    public final long m5207getMinimumTouchTargetSizeNHjbRc() {
        Density $this$getMinimumTouchTargetSize_NH_jbRc_u24lambda_u2418 = this.layerDensity;
        return $this$getMinimumTouchTargetSize_NH_jbRc_u24lambda_u2418.mo314toSizeXkaWNTQ(getLayoutNode().getViewConfiguration().mo5149getMinimumTouchTargetSizeMYxV2XQ());
    }

    /* renamed from: hitTest-YqVAtuI, reason: not valid java name */
    public final void m5209hitTestYqVAtuI(HitTestSource hitTestSource, long pointerPosition, HitTestResult hitTestResult, boolean isTouchEvent, boolean isInLayer) {
        Modifier.Node head = m5208headH91voCI(hitTestSource.mo5218entityTypeOLwlOKw());
        if (!m5216withinLayerBoundsk4lQ0M(pointerPosition)) {
            if (isTouchEvent) {
                float distanceFromEdge = m5204distanceInMinimumTouchTargettz77jQw(pointerPosition, m5207getMinimumTouchTargetSizeNHjbRc());
                if (((Float.isInfinite(distanceFromEdge) || Float.isNaN(distanceFromEdge)) ? false : true) && hitTestResult.isHitInMinimumTouchTargetBetter(distanceFromEdge, false)) {
                    m5197hitNearJHbHoSQ(head, hitTestSource, pointerPosition, hitTestResult, isTouchEvent, false, distanceFromEdge);
                    return;
                }
                return;
            }
        ...
        if (head == null) {
            mo5140hitTestChildYqVAtuI(hitTestSource, pointerPosition, hitTestResult, isTouchEvent, isInLayer);
            return;
        }
        if (m5210isPointerInBoundsk4lQ0M(pointerPosition)) {
            m5196hit1hIXUjU(head, hitTestSource, pointerPosition, hitTestResult, isTouchEvent, isInLayer);
            return;
        }
        float distanceFromEdge2 = !isTouchEvent ? Float.POSITIVE_INFINITY : m5204distanceInMinimumTouchTargettz77jQw(pointerPosition, m5207getMinimumTouchTargetSizeNHjbRc());
        if (((Float.isInfinite(distanceFromEdge2) || Float.isNaN(distanceFromEdge2)) ? false : true) && hitTestResult.isHitInMinimumTouchTargetBetter(distanceFromEdge2, isInLayer)) {
            m5197hitNearJHbHoSQ(head, hitTestSource, pointerPosition, hitTestResult, isTouchEvent, isInLayer, distanceFromEdge2);
            return;
        }
        m5200speculativeHitJHbHoSQ(head, hitTestSource, pointerPosition, hitTestResult, isTouchEvent, isInLayer, distanceFromEdge2);
    }

    /* JADX INFO: Access modifiers changed from: private */
    /* renamed from: hit-1hIXUjU, reason: not valid java name */
    public final void m5196hit1hIXUjU(final Modifier.Node $this$hit_u2d1hIXUjU, final HitTestSource hitTestSource, final long pointerPosition, final HitTestResult hitTestResult, final boolean isTouchEvent, final boolean isInLayer) {
        if ($this$hit_u2d1hIXUjU == null) {
            ...
            hitTestResult.hit($this$hit_u2d1hIXUjU, isInLayer, new Function0<Unit>() { // from class: androidx.compose.ui.node.NodeCoordinator$hit$1
                ...
                /* renamed from: invoke, reason: avoid collision after fix types in other method */
                public final void invoke2() {
                    Modifier.Node m5220nextUntilhw7D004;
                    NodeCoordinator nodeCoordinator = NodeCoordinator.this;
                    m5220nextUntilhw7D004 = NodeCoordinatorKt.m5220nextUntilhw7D004($this$hit_u2d1hIXUjU, hitTestSource.mo5218entityTypeOLwlOKw(), NodeKind.m5222constructorimpl(2));
                    nodeCoordinator.m5196hit1hIXUjU(m5220nextUntilhw7D004, hitTestSource, pointerPosition, hitTestResult, isTouchEvent, isInLayer);
                }
            });
        }
    }
    ...
    public final void m5197hitNearJHbHoSQ(final Modifier.Node $this$hitNear_u2dJHbHoSQ, final HitTestSource hitTestSource, final long pointerPosition, final HitTestResult hitTestResult, final boolean isTouchEvent, final boolean isInLayer, final float distanceFromEdge) {
        if ($this$hitNear_u2dJHbHoSQ == null) {
            ...
            hitTestResult.hitInMinimumTouchTarget($this$hitNear_u2dJHbHoSQ, distanceFromEdge, isInLayer, new Function0<Unit>() { // from class: androidx.compose.ui.node.NodeCoordinator$hitNear$1
                ...
                public final void invoke2() {
                    Modifier.Node m5220nextUntilhw7D004;
                    NodeCoordinator nodeCoordinator = NodeCoordinator.this;
                    m5220nextUntilhw7D004 = NodeCoordinatorKt.m5220nextUntilhw7D004($this$hitNear_u2dJHbHoSQ, hitTestSource.mo5218entityTypeOLwlOKw(), NodeKind.m5222constructorimpl(2));
                    nodeCoordinator.m5197hitNearJHbHoSQ(m5220nextUntilhw7D004, hitTestSource, pointerPosition, hitTestResult, isTouchEvent, isInLayer, distanceFromEdge);
                }
            });
        }
    }
    ...
    public final void m5200speculativeHitJHbHoSQ(final Modifier.Node $this$speculativeHit_u2dJHbHoSQ, final HitTestSource hitTestSource, final long pointerPosition, final HitTestResult hitTestResult, final boolean isTouchEvent, final boolean isInLayer, final float distanceFromEdge) {
        Modifier.Node m5220nextUntilhw7D004;
        if ($this$speculativeHit_u2dJHbHoSQ != null) {
            if (!hitTestSource.interceptOutOfBoundsChildEvents($this$speculativeHit_u2dJHbHoSQ)) {
                m5220nextUntilhw7D004 = NodeCoordinatorKt.m5220nextUntilhw7D004($this$speculativeHit_u2dJHbHoSQ, hitTestSource.mo5218entityTypeOLwlOKw(), NodeKind.m5222constructorimpl(2));
                m5200speculativeHitJHbHoSQ(m5220nextUntilhw7D004, hitTestSource, pointerPosition, hitTestResult, isTouchEvent, isInLayer, distanceFromEdge);
                return;
            } else {
                hitTestResult.speculativeHit($this$speculativeHit_u2dJHbHoSQ, distanceFromEdge, isInLayer, new Function0<Unit>() { // from class: androidx.compose.ui.node.NodeCoordinator$speculativeHit$1
                    ...
                    /* renamed from: invoke, reason: avoid collision after fix types in other method */
                    public final void invoke2() {
                        Modifier.Node m5220nextUntilhw7D0042;
                        NodeCoordinator nodeCoordinator = NodeCoordinator.this;
                        m5220nextUntilhw7D0042 = NodeCoordinatorKt.m5220nextUntilhw7D004($this$speculativeHit_u2dJHbHoSQ, hitTestSource.mo5218entityTypeOLwlOKw(), NodeKind.m5222constructorimpl(2));
                        nodeCoordinator.m5200speculativeHitJHbHoSQ(m5220nextUntilhw7D0042, hitTestSource, pointerPosition, hitTestResult, isTouchEvent, isInLayer, distanceFromEdge);
                    }
                });
                return;
            }
    ...
    public void mo5140hitTestChildYqVAtuI(HitTestSource hitTestSource, long pointerPosition, HitTestResult hitTestResult, boolean isTouchEvent, boolean isInLayer) {
        NodeCoordinator wrapped = this.wrapped;
        if (wrapped != null) {
            long positionInWrapped = wrapped.m5205fromParentPositionMKHz9U(pointerPosition);
            wrapped.m5209hitTestYqVAtuI(hitTestSource, positionInWrapped, hitTestResult, isTouchEvent, isInLayer);
        }
    }
    ...
    public final Rect touchBoundsInRoot() {
        ...
        long padding = m5203calculateMinimumTouchTargetPaddingE7KxVPU(m5207getMinimumTouchTargetSizeNHjbRc());
        bounds.setLeft(-Size.m3574getWidthimpl(padding));
        bounds.setTop(-Size.m3571getHeightimpl(padding));
        bounds.setRight(getMeasuredWidth() + Size.m3574getWidthimpl(padding));
        bounds.setBottom(getMeasuredHeight() + Size.m3571getHeightimpl(padding));
    ...
    public long mo5028windowToLocalMKHz9U(long relativeToWindow) {
        if (!isAttached()) {
            throw new IllegalStateException(ExpectAttachedLayoutCoordinates.toString());
        }
        LayoutCoordinates root = LayoutCoordinatesKt.findRootCoordinates(this);
        long positionInRoot = Offset.m3509minusMKHz9U(LayoutNodeKt.requireOwner(getLayoutNode()).mo5275calculateLocalPositionMKHz9U(relativeToWindow), LayoutCoordinatesKt.positionInRoot(root));
        return mo5024localPositionOfR5De75A(root, positionInRoot);
    }

    @Override // androidx.compose.ui.layout.LayoutCoordinates
    /* renamed from: localToWindow-MK-Hz9U */
    public long mo5026localToWindowMKHz9U(long relativeToLocal) {
        long positionInRoot = mo5025localToRootMKHz9U(relativeToLocal);
        Owner owner = LayoutNodeKt.requireOwner(getLayoutNode());
        return owner.mo5276calculatePositionInWindowMKHz9U(positionInRoot);
    }
    ...
    public long mo5024localPositionOfR5De75A(LayoutCoordinates sourceCoordinates, long relativeToSource) {
        if (sourceCoordinates instanceof LookaheadLayoutCoordinates) {
            return Offset.m3514unaryMinusF1C5BW0(sourceCoordinates.mo5024localPositionOfR5De75A(this, Offset.m3514unaryMinusF1C5BW0(relativeToSource)));
        }
        ...
        while (coordinator != commonAncestor) {
            position = coordinator.m5214toParentPositionMKHz9U(position);
            NodeCoordinator nodeCoordinator2 = coordinator.wrappedBy;
            Intrinsics.checkNotNull(nodeCoordinator2);
            coordinator = nodeCoordinator2;
        }
        return m5194ancestorToLocalR5De75A(commonAncestor, position);
    }

    @Override // androidx.compose.ui.layout.LayoutCoordinates
    /* renamed from: transformFrom-EL8BTi8 */
    public void mo5027transformFromEL8BTi8(LayoutCoordinates sourceCoordinates, float[] matrix) {
        ...
        Matrix.m3986resetimpl(matrix);
        coordinator.m5202transformToAncestorEL8BTi8(commonAncestor, matrix);
        m5201transformFromAncestorEL8BTi8(commonAncestor, matrix);
    }

    /* renamed from: transformToAncestor-EL8BTi8, reason: not valid java name */
    private final void m5202transformToAncestorEL8BTi8(NodeCoordinator ancestor, float[] matrix) {
        NodeCoordinator wrapper = this;
        while (!Intrinsics.areEqual(wrapper, ancestor)) {
            OwnedLayer ownedLayer = wrapper.layer;
            if (ownedLayer != null) {
                ownedLayer.mo5274transform58bKbWc(matrix);
            }
            long position = wrapper.getPosition();
            if (!IntOffset.m6221equalsimpl0(position, IntOffset.INSTANCE.m6232getZeronOccac())) {
                Matrix.m3986resetimpl(tmpMatrix);
                Matrix.m3997translateimpl$default(tmpMatrix, IntOffset.m6222getXimpl(position), IntOffset.m6223getYimpl(position), 0.0f, 4, null);
                Matrix.m3994timesAssign58bKbWc(matrix, tmpMatrix);
            }
    ...
    private final void m5201transformFromAncestorEL8BTi8(NodeCoordinator ancestor, float[] matrix) {
        if (!Intrinsics.areEqual(ancestor, this)) {
            NodeCoordinator nodeCoordinator = this.wrappedBy;
            Intrinsics.checkNotNull(nodeCoordinator);
            nodeCoordinator.m5201transformFromAncestorEL8BTi8(ancestor, matrix);
            if (!IntOffset.m6221equalsimpl0(getPosition(), IntOffset.INSTANCE.m6232getZeronOccac())) {
                Matrix.m3986resetimpl(tmpMatrix);
                Matrix.m3997translateimpl$default(tmpMatrix, -IntOffset.m6222getXimpl(getPosition()), -IntOffset.m6223getYimpl(getPosition()), 0.0f, 4, null);
                Matrix.m3994timesAssign58bKbWc(matrix, tmpMatrix);
            }
            OwnedLayer ownedLayer = this.layer;
            if (ownedLayer != null) {
                ownedLayer.mo5269inverseTransform58bKbWc(matrix);
            }
        }
    }
    ...
    public Rect localBoundingBoxOf(LayoutCoordinates sourceCoordinates, boolean clipBounds) {
        ...
        bounds.setLeft(0.0f);
        bounds.setTop(0.0f);
        bounds.setRight(IntSize.m6264getWidthimpl(sourceCoordinates.mo5023getSizeYbymL2g()));
        bounds.setBottom(IntSize.m6263getHeightimpl(sourceCoordinates.mo5023getSizeYbymL2g()));
    ...
    private final long m5194ancestorToLocalR5De75A(NodeCoordinator ancestor, long offset) {
        if (ancestor == this) {
            return offset;
        }
        NodeCoordinator wrappedBy = this.wrappedBy;
        if (wrappedBy == null || Intrinsics.areEqual(ancestor, wrappedBy)) {
            return m5205fromParentPositionMKHz9U(offset);
        }
        return m5205fromParentPositionMKHz9U(wrappedBy.m5194ancestorToLocalR5De75A(ancestor, offset));
    }
    ...
    public long mo5025localToRootMKHz9U(long relativeToLocal) {
        if (!isAttached()) {
            throw new IllegalStateException(ExpectAttachedLayoutCoordinates.toString());
        }
        onCoordinatesUsed$ui_release();
    ...
    public long m5214toParentPositionMKHz9U(long position) {
        OwnedLayer layer = this.layer;
        long targetPosition = layer != null ? layer.mo5271mapOffset8S9VItk(position, false) : position;
        return IntOffsetKt.m6236plusNvtHpc(targetPosition, getPosition());
    }

    /* renamed from: fromParentPosition-MK-Hz9U, reason: not valid java name */
    public long m5205fromParentPositionMKHz9U(long position) {
        long relativeToPosition = IntOffsetKt.m6234minusNvtHpc(position, getPosition());
        OwnedLayer layer = this.layer;
        return layer != null ? layer.mo5271mapOffset8S9VItk(relativeToPosition, true) : relativeToPosition;
    }

    protected final void drawBorder(Canvas canvas, Paint paint) {
        Rect rect = new Rect(0.5f, 0.5f, IntSize.m6264getWidthimpl(getMeasuredSize()) - 0.5f, IntSize.m6263getHeightimpl(getMeasuredSize()) - 0.5f);
    ...
    public final void rectInParent$ui_release(MutableRect bounds, boolean clipBounds, boolean clipToMinimumTouchTargetSize) {
        ...
        if (layer != null) {
            if (this.isClipping) {
                if (clipToMinimumTouchTargetSize) {
                    long minTouch = m5207getMinimumTouchTargetSizeNHjbRc();
                    float horz = Size.m3574getWidthimpl(minTouch) / 2.0f;
                    float vert = Size.m3571getHeightimpl(minTouch) / 2.0f;
                    bounds.intersect(-horz, -vert, IntSize.m6264getWidthimpl(mo5023getSizeYbymL2g()) + horz, IntSize.m6263getHeightimpl(mo5023getSizeYbymL2g()) + vert);
                } else if (clipBounds) {
                    bounds.intersect(0.0f, 0.0f, IntSize.m6264getWidthimpl(mo5023getSizeYbymL2g()), IntSize.m6263getHeightimpl(mo5023getSizeYbymL2g()));
                }
                if (bounds.isEmpty()) {
                    return;
                }
        ...
        int x = IntOffset.m6222getXimpl(getPosition());
        bounds.setLeft(bounds.getLeft() + x);
        bounds.setRight(bounds.getRight() + x);
        int y = IntOffset.m6223getYimpl(getPosition());
    ...
    protected final boolean m5216withinLayerBoundsk4lQ0M(long pointerPosition) {
        if (!OffsetKt.m3522isFinitek4lQ0M(pointerPosition)) {
            return false;
        }
        OwnedLayer layer = this.layer;
        return layer == null || !this.isClipping || layer.mo5270isInLayerk4lQ0M(pointerPosition);
    }

    /* renamed from: isPointerInBounds-k-4lQ0M, reason: not valid java name */
    protected final boolean m5210isPointerInBoundsk4lQ0M(long pointerPosition) {
        float x = Offset.m3505getXimpl(pointerPosition);
        float y = Offset.m3506getYimpl(pointerPosition);
    ...
    public final NodeCoordinator findCommonAncestor$ui_release(NodeCoordinator other) {
        ...
        if (ancestor1 == ancestor2) {
            ...
            int m5222constructorimpl = NodeKind.m5222constructorimpl(2);
    ...
    public final boolean shouldSharePointerInputWithSiblings() {
        ...
        int count$iv$iv;
        MutableVector mutableVector;
        Modifier.Node start = headNode(NodeKindKt.m5231getIncludeSelfInTraversalH91voCI(NodeKind.m5222constructorimpl(16)));
        if (start != null && start.getIsAttached()) {
            Modifier.Node $this$visitLocalDescendants_u2d6rFNWt0$iv = start;
            int type$iv3 = NodeKind.m5222constructorimpl(16);
    ...
    private final long m5198offsetFromEdgeMKHz9U(long pointerPosition) {
        float x = Offset.m3505getXimpl(pointerPosition);
    ...
    protected final long m5203calculateMinimumTouchTargetPaddingE7KxVPU(long minimumTouchTargetSize) {
        float widthDiff = Size.m3574getWidthimpl(minimumTouchTargetSize) - getMeasuredWidth();
        float heightDiff = Size.m3571getHeightimpl(minimumTouchTargetSize) - getMeasuredHeight();
        return SizeKt.Size(Math.max(0.0f, widthDiff / 2.0f), Math.max(0.0f, heightDiff / 2.0f));
    }

    /* renamed from: distanceInMinimumTouchTarget-tz77jQw, reason: not valid java name */
    protected final float m5204distanceInMinimumTouchTargettz77jQw(long pointerPosition, long minimumTouchTargetSize) {
        if (getMeasuredWidth() >= Size.m3574getWidthimpl(minimumTouchTargetSize) && getMeasuredHeight() >= Size.m3571getHeightimpl(minimumTouchTargetSize)) {
            return Float.POSITIVE_INFINITY;
        }
        long m5203calculateMinimumTouchTargetPaddingE7KxVPU = m5203calculateMinimumTouchTargetPaddingE7KxVPU(minimumTouchTargetSize);
        float width = Size.m3574getWidthimpl(m5203calculateMinimumTouchTargetPaddingE7KxVPU);
        float height = Size.m3571getHeightimpl(m5203calculateMinimumTouchTargetPaddingE7KxVPU);
        long offsetFromEdge = m5198offsetFromEdgeMKHz9U(pointerPosition);
        if ((width > 0.0f || height > 0.0f) && Offset.m3505getXimpl(offsetFromEdge) <= width && Offset.m3506getYimpl(offsetFromEdge) <= height) {
            return Offset.m3504getDistanceSquaredimpl(offsetFromEdge);
        }
        return Float.POSITIVE_INFINITY;
    }
