...
public final class NodeMeasuringIntrinsics {
    ...
    public interface MeasureBlock {
        ...
        MeasureResult mo5021measure3p2s80s(MeasureScope measureScope, Measurable measurable, long j);
    }
    ...
    public final int minWidth$ui_release(MeasureBlock measureBlock, IntrinsicMeasureScope intrinsicMeasureScope, IntrinsicMeasurable intrinsicMeasurable, int h) {
        ...
        MeasureResult layoutResult = measureBlock.mo5021measure3p2s80s(new IntrinsicsMeasureScope(intrinsicMeasureScope, intrinsicMeasureScope.getLayoutDirection()), measurable, constraints);
        ...
        public Placeable mo5016measureBRTryo0(long constraints) {
            ...
            if (intrinsicWidthHeight == intrinsicWidthHeight2) {
                if (this.minMax == IntrinsicMinMax.Max) {
                    width = this.measurable.maxIntrinsicWidth(Constraints.m6049getMaxHeightimpl(constraints));
                } else {
                    width = this.measurable.minIntrinsicWidth(Constraints.m6049getMaxHeightimpl(constraints));
                }
                if (Constraints.m6045getHasBoundedHeightimpl(constraints)) {
                    i = Constraints.m6049getMaxHeightimpl(constraints);
                }
                int height2 = i;
                return new EmptyPlaceable(width, height2);
            }
            if (this.minMax == IntrinsicMinMax.Max) {
                height = this.measurable.maxIntrinsicHeight(Constraints.m6050getMaxWidthimpl(constraints));
            } else {
                height = this.measurable.minIntrinsicHeight(Constraints.m6050getMaxWidthimpl(constraints));
            }
