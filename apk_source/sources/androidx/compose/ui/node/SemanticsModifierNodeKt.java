...
public final class SemanticsModifierNodeKt {
    ...
    public static final Rect touchBoundsInRoot(Modifier.Node $this$touchBoundsInRoot, boolean useMinimumTouchTarget) {
        ...
        if (!useMinimumTouchTarget) {
            return LayoutCoordinatesKt.boundsInRoot(DelegatableNodeKt.m5119requireCoordinator64DMado($this$touchBoundsInRoot, NodeKind.m5222constructorimpl(8)));
        }
        return DelegatableNodeKt.m5119requireCoordinator64DMado($this$touchBoundsInRoot, NodeKind.m5222constructorimpl(8)).touchBoundsInRoot();
    }
}
