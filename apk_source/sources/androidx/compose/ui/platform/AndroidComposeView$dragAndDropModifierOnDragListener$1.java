...
/* synthetic */ class AndroidComposeView$dragAndDropModifierOnDragListener$1 extends FunctionReferenceImpl implements Function3<DragAndDropTransferData, Size, Function1<? super DrawScope, ? extends Unit>, Boolean> {
    ...
    public /* bridge */ /* synthetic */ Boolean invoke(DragAndDropTransferData dragAndDropTransferData, Size size, Function1<? super DrawScope, ? extends Unit> function1) {
        return m5308invoke12SF9DM(dragAndDropTransferData, size.getPackedValue(), function1);
    }

    /* renamed from: invoke-12SF9DM, reason: not valid java name */
    public final Boolean m5308invoke12SF9DM(DragAndDropTransferData p0, long p1, Function1<? super DrawScope, Unit> function1) {
        boolean m5306startDrag12SF9DM;
        m5306startDrag12SF9DM = ((AndroidComposeView) this.receiver).m5306startDrag12SF9DM(p0, p1, function1);
        return Boolean.valueOf(m5306startDrag12SF9DM);
    }
}
