...
public final class LayerMatrixCache<T> {
    ...
    public final float[] m5349calculateMatrixGrdbGEg(T target) {
        float[] it = this.matrixCache;
        if (it == null) {
            it = androidx.compose.ui.graphics.Matrix.m3977constructorimpl$default(null, 1, null);
            this.matrixCache = it;
        }
        if (!this.isDirty) {
            return it;
        ...
        if (prevMatrix == null || !Intrinsics.areEqual(it2, prevMatrix)) {
            AndroidMatrixConversions_androidKt.m3617setFromtUYjHk(it, it2);
    ...
    public final float[] m5348calculateInverseMatrixbWbORWo(T target) {
        ...
        if (this.isInverseDirty) {
            float[] normalMatrix = m5349calculateMatrixGrdbGEg(target);
            this.isInverseValid = InvertMatrixKt.m5346invertToJiSxe2E(normalMatrix, it);
