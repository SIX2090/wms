...
public final class NestedScrollInteropConnection implements NestedScrollConnection {
    ...
    public long mo401onPreScrollOzD1aCk(long available, int source) {
        int m5367getScrollAxesk4lQ0M;
        int m5369toViewTypeGyEprt8;
        int m5369toViewTypeGyEprt82;
        long m5368toOffsetUv8p0NA;
        NestedScrollingChildHelper nestedScrollingChildHelper = this.nestedScrollChildHelper;
        m5367getScrollAxesk4lQ0M = NestedScrollInteropConnectionKt.m5367getScrollAxesk4lQ0M(available);
        m5369toViewTypeGyEprt8 = NestedScrollInteropConnectionKt.m5369toViewTypeGyEprt8(source);
        if (!nestedScrollingChildHelper.startNestedScroll(m5367getScrollAxesk4lQ0M, m5369toViewTypeGyEprt8)) {
        ...
        int composeToViewOffset = NestedScrollInteropConnectionKt.composeToViewOffset(Offset.m3505getXimpl(available));
        int composeToViewOffset2 = NestedScrollInteropConnectionKt.composeToViewOffset(Offset.m3506getYimpl(available));
        int[] iArr = this.consumedScrollCache;
        m5369toViewTypeGyEprt82 = NestedScrollInteropConnectionKt.m5369toViewTypeGyEprt8(source);
        nestedScrollingChildHelper2.dispatchNestedPreScroll(composeToViewOffset, composeToViewOffset2, iArr, null, m5369toViewTypeGyEprt82);
        m5368toOffsetUv8p0NA = NestedScrollInteropConnectionKt.m5368toOffsetUv8p0NA(this.consumedScrollCache, available);
        return m5368toOffsetUv8p0NA;
    }
    ...
    public long mo400onPostScrollDzOQY0M(long consumed, long available, int source) {
        ...
        ArraysKt.fill$default(this.consumedScrollCache, 0, 0, 0, 6, (Object) null);
        NestedScrollingChildHelper nestedScrollingChildHelper2 = this.nestedScrollChildHelper;
        int composeToViewOffset = NestedScrollInteropConnectionKt.composeToViewOffset(Offset.m3505getXimpl(consumed));
        int composeToViewOffset2 = NestedScrollInteropConnectionKt.composeToViewOffset(Offset.m3506getYimpl(consumed));
        int composeToViewOffset3 = NestedScrollInteropConnectionKt.composeToViewOffset(Offset.m3505getXimpl(available));
        int composeToViewOffset4 = NestedScrollInteropConnectionKt.composeToViewOffset(Offset.m3506getYimpl(available));
        m5369toViewTypeGyEprt82 = NestedScrollInteropConnectionKt.m5369toViewTypeGyEprt8(source);
        nestedScrollingChildHelper2.dispatchNestedScroll(composeToViewOffset, composeToViewOffset2, composeToViewOffset3, composeToViewOffset4, null, m5369toViewTypeGyEprt82, this.consumedScrollCache);
        m5368toOffsetUv8p0NA = NestedScrollInteropConnectionKt.m5368toOffsetUv8p0NA(this.consumedScrollCache, available);
        return m5368toOffsetUv8p0NA;
    }
    ...
    public Object mo641onPreFlingQWom1Mo(long available, Continuation<? super Velocity> continuation) {
        float viewVelocity;
        float viewVelocity2;
        long result;
        NestedScrollingChildHelper nestedScrollingChildHelper = this.nestedScrollChildHelper;
        viewVelocity = NestedScrollInteropConnectionKt.toViewVelocity(Velocity.m6329getXimpl(available));
        viewVelocity2 = NestedScrollInteropConnectionKt.toViewVelocity(Velocity.m6330getYimpl(available));
        if (nestedScrollingChildHelper.dispatchNestedPreFling(viewVelocity, viewVelocity2)) {
            result = available;
        } else {
            result = Velocity.INSTANCE.m6340getZero9UxMQ8M();
        }
        interruptOngoingScrolls();
        return Velocity.m6320boximpl(result);
    }
