...
public final class RenderNodeApi23 implements DeviceRenderNode {
    ...
    private int internalCompositingStrategy = CompositingStrategy.INSTANCE.m3835getAutoNrFUSI();
    private int left;
    ...
    public void mo5334setCompositingStrategyaDBOjCE(int value) {
        if (CompositingStrategy.m3831equalsimpl0(value, CompositingStrategy.INSTANCE.m3837getOffscreenNrFUSI())) {
            this.renderNode.setLayerType(2);
            this.renderNode.setHasOverlappingRendering(true);
        } else if (CompositingStrategy.m3831equalsimpl0(value, CompositingStrategy.INSTANCE.m3836getModulateAlphaNrFUSI())) {
            this.renderNode.setLayerType(0);
    ...
    public final int getLayerType$ui_release() {
        return CompositingStrategy.m3831equalsimpl0(this.internalCompositingStrategy, CompositingStrategy.INSTANCE.m3837getOffscreenNrFUSI()) ? 2 : 0;
    }
    ...
    public void record(CanvasHolder canvasHolder, Path clipPath, Function1<? super Canvas, Unit> drawBlock) {
        ...
        if (clipPath != null) {
            ...
            Canvas.m3717clipPathmtrdDE$default($this$record_u24lambda_u240, clipPath, 0, 2, null);
        }
