...
public final class ViewLayer extends View implements OwnedLayer, GraphicLayerInfo {
    ...
    public ViewLayer(AndroidComposeView ownerView, DrawChildContainer container, Function1<? super Canvas, Unit> function1, Function0<Unit> function0) {
        ...
        this.mTransformOrigin = TransformOrigin.INSTANCE.m4136getCenterSzJe1aQ();
    ...
    public void updateLayerProperties(ReusableGraphicsLayerScope scope, LayoutDirection layoutDirection, Density density) {
        ...
        if ((maybeChangedFields & 4096) != 0) {
            ...
            setPivotX(TransformOrigin.m4131getPivotFractionXimpl(this.mTransformOrigin) * getWidth());
            setPivotY(TransformOrigin.m4132getPivotFractionYimpl(this.mTransformOrigin) * getHeight());
        }
        ...
        if (Build.VERSION.SDK_INT >= 28) {
            if ((maybeChangedFields & 64) != 0) {
                ViewLayerVerificationHelper28.INSTANCE.setOutlineAmbientShadowColor(this, ColorKt.m3800toArgb8_81llA(scope.getAmbientShadowColor()));
            }
            if ((maybeChangedFields & 128) != 0) {
                ViewLayerVerificationHelper28.INSTANCE.setOutlineSpotShadowColor(this, ColorKt.m3800toArgb8_81llA(scope.getSpotShadowColor()));
            }
        }
        ...
        if ((32768 & maybeChangedFields) != 0) {
            ...
            if (CompositingStrategy.m3831equalsimpl0(compositingStrategy, CompositingStrategy.INSTANCE.m3837getOffscreenNrFUSI())) {
                setLayerType(2, null);
                z = true;
            } else if (CompositingStrategy.m3831equalsimpl0(compositingStrategy, CompositingStrategy.INSTANCE.m3836getModulateAlphaNrFUSI())) {
                setLayerType(0, null);
            } else {
                setLayerType(0, null);
                z = true;
    ...
    public void mo5273resizeozmzZPI(long size) {
        ...
        if (width != getWidth() || height != getHeight()) {
            setPivotX(TransformOrigin.m4131getPivotFractionXimpl(this.mTransformOrigin) * width);
            setPivotY(TransformOrigin.m4132getPivotFractionYimpl(this.mTransformOrigin) * height);
    ...
    public void mo5272movegyyYBs(long position) {
        int left = IntOffset.m6222getXimpl(position);
        if (left != getLeft()) {
            offsetLeftAndRight(left - getLeft());
            this.matrixCache.invalidate();
        }
        int top = IntOffset.m6223getYimpl(position);
        if (top != getTop()) {
    ...
    public long mo5271mapOffset8S9VItk(long point, boolean inverse) {
        if (inverse) {
            float[] m5348calculateInverseMatrixbWbORWo = this.matrixCache.m5348calculateInverseMatrixbWbORWo(this);
        ...
        return androidx.compose.ui.graphics.Matrix.m3983mapMKHz9U(this.matrixCache.m5349calculateMatrixGrdbGEg(this), point);
    }

    @Override // androidx.compose.ui.node.OwnedLayer
    public void mapBounds(MutableRect rect, boolean inverse) {
        if (inverse) {
            float[] matrix = this.matrixCache.m5348calculateInverseMatrixbWbORWo(this);
            if (matrix != null) {
        ...
        androidx.compose.ui.graphics.Matrix.m3985mapimpl(this.matrixCache.m5349calculateMatrixGrdbGEg(this), rect);
    }
    ...
    public void mo5274transform58bKbWc(float[] matrix) {
        androidx.compose.ui.graphics.Matrix.m3994timesAssign58bKbWc(matrix, this.matrixCache.m5349calculateMatrixGrdbGEg(this));
    }

    @Override // androidx.compose.ui.node.OwnedLayer
    /* renamed from: inverseTransform-58bKbWc */
    public void mo5269inverseTransform58bKbWc(float[] matrix) {
        float[] inverse = this.matrixCache.m5348calculateInverseMatrixbWbORWo(this);
        if (inverse != null) {
