...
public final class WindowInfoImpl implements WindowInfo {
    ...
    private static final MutableState<PointerKeyboardModifiers> GlobalKeyboardModifiers = SnapshotStateKt__SnapshotStateKt.mutableStateOf$default(PointerKeyboardModifiers.m4952boximpl(PointerEvent_androidKt.EmptyPointerKeyboardModifiers()), null, 2, null);
    ...
    public static /* synthetic */ void m5380getKeyboardModifiersk7X9c1A$annotations() {
    }
    ...
    public int mo5379getKeyboardModifiersk7X9c1A() {
        return GlobalKeyboardModifiers.getValue().getPackedValue();
    }

    /* renamed from: setKeyboardModifiers-5xRPYO0, reason: not valid java name */
    public void m5381setKeyboardModifiers5xRPYO0(int value) {
        GlobalKeyboardModifiers.setValue(PointerKeyboardModifiers.m4952boximpl(value));
    }
