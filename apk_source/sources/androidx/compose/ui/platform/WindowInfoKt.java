...
public final class WindowInfoKt {
    public static final void WindowFocusObserver(final Function1<? super Boolean, Unit> function1, Composer $composer, final int $changed) {
        ...
        ComposerKt.sourceInformation($composer2, "C(WindowFocusObserver)54@2046L7,55@2073L42,56@2120L117:WindowInfo.kt#itgzvw");
        int $dirty = $changed;
        if (($changed & 14) == 0) {
        ...
        if (($dirty & 11) != 2 || !$composer2.getSkipping()) {
            ...
            $composer2.startReplaceableGroup(-994777444);
            ...
            EffectsKt.LaunchedEffect(windowInfo, (Function2<? super CoroutineScope, ? super Continuation<? super Unit>, ? extends Object>) value$iv, $composer2, 64);
            if (ComposerKt.isTraceInProgress()) {
