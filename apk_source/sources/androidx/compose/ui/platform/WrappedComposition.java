...
final class WrappedComposition implements Composition, LifecycleEventObserver, CompositionServices {
    ...
    private Function2<? super Composer, ? super Integer, Unit> lastContent = ComposableSingletons$Wrapper_androidKt.INSTANCE.m5326getLambda1$ui_release();
                    ...
                    if (lifecycle == null) {
                        ...
                        original.setContent(ComposableLambdaKt.composableLambdaInstance(-2000640158, true, new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.ui.platform.WrappedComposition$setContent$1.1
                            ...
                            public final void invoke(Composer $composer, int $changed) {
                                ...
                                if (($changed & 11) != 2 || !$composer.getSkipping()) {
                                    if (ComposerKt.isTraceInProgress()) {
                                        ComposerKt.traceEventStart(-2000640158, $changed, -1, "androidx.compose.ui.platform.WrappedComposition.setContent.<anonymous>.<anonymous> (Wrapper.android.kt:124)");
                                    }
                                    ...
                                    EffectsKt.LaunchedEffect(WrappedComposition.this.getOwner(), new C00711(WrappedComposition.this, null), $composer, 72);
                                    ...
                                    CompositionLocalKt.CompositionLocalProvider(provides, ComposableLambdaKt.composableLambda($composer, -1193460702, true, new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.ui.platform.WrappedComposition.setContent.1.1.2
                                        ...
                                        public final void invoke(Composer $composer2, int $changed2) {
                                            ...
                                            if (ComposerKt.isTraceInProgress()) {
                                                ComposerKt.traceEventStart(-1193460702, $changed2, -1, "androidx.compose.ui.platform.WrappedComposition.setContent.<anonymous>.<anonymous>.<anonymous> (Wrapper.android.kt:138)");
                                            }
                            ...
                            static final class C00711 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
                                ...
                                /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
                                C00711(WrappedComposition wrappedComposition, Continuation<? super C00711> continuation) {
