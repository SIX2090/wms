...
public final class PainterResources_androidKt {
    ...
    public static final Painter painterResource(int id, Composer $composer, int $changed) {
        ...
        if (z) {
            ...
            ImageVector imageVector = loadVectorResource(context.getTheme(), res, id, value.changingConfigurations, $composer, (($changed << 6) & 896) | 72);
            ...
            value$iv$iv2 = loadImageBitmapResource(path, res, id);
    ...
    private static final ImageVector loadVectorResource(Resources.Theme theme, Resources res, int id, int changingConfigurations, Composer $composer, int $changed) {
        ...
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventStart(21855625, $changed, -1, "androidx.compose.ui.res.loadVectorResource (PainterResources.android.kt:86)");
        }
    ...
    public static final ImageBitmap loadImageBitmapResource(CharSequence path, Resources res, int id) {
        try {
