...
public final class LiveRegionMode {
    ...
    private static final int Polite = m5384constructorimpl(0);
    private static final int Assertive = m5384constructorimpl(1);

    /* renamed from: box-impl, reason: not valid java name */
    public static final /* synthetic */ LiveRegionMode m5383boximpl(int i) {
        return new LiveRegionMode(i);
    }

    /* renamed from: constructor-impl, reason: not valid java name */
    private static int m5384constructorimpl(int i) {
        return i;
    }

    /* renamed from: equals-impl, reason: not valid java name */
    public static boolean m5385equalsimpl(int i, Object obj) {
        return (obj instanceof LiveRegionMode) && i == ((LiveRegionMode) obj).getValue();
    }

    /* renamed from: equals-impl0, reason: not valid java name */
    public static final boolean m5386equalsimpl0(int i, int i2) {
        return i == i2;
    }

    /* renamed from: hashCode-impl, reason: not valid java name */
    public static int m5387hashCodeimpl(int i) {
        return Integer.hashCode(i);
    }

    public boolean equals(Object obj) {
        return m5385equalsimpl(this.value, obj);
    }

    public int hashCode() {
        return m5387hashCodeimpl(this.value);
    }
    ...
    public static String m5388toStringimpl(int arg0) {
        return m5386equalsimpl0(arg0, Polite) ? "Polite" : m5386equalsimpl0(arg0, Assertive) ? "Assertive" : "Unknown";
    }

    public String toString() {
        return m5388toStringimpl(this.value);
    }
}
