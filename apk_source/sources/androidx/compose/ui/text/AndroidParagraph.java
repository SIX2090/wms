...
public final class AndroidParagraph implements Paragraph {
    ...
    private AndroidParagraph(AndroidParagraphIntrinsics paragraphIntrinsics, int maxLines, boolean ellipsis, long constraints) {
        ...
        if (!(Constraints.m6051getMinHeightimpl(this.constraints) == 0 && Constraints.m6052getMinWidthimpl(this.constraints) == 0)) {
        ...
        shouldAttachIndentationFixSpan = AndroidParagraph_androidKt.shouldAttachIndentationFixSpan(style, this.ellipsis);
        ...
        alignment = AndroidParagraph_androidKt.m5429toLayoutAlignaXe7zB0(style.m5612getTextAligne0LSkKk());
        int justificationMode = TextAlign.m5960equalsimpl0(style.m5612getTextAligne0LSkKk(), TextAlign.INSTANCE.m5966getJustifye0LSkKk()) ? 1 : 0;
        hyphens = AndroidParagraph_androidKt.m5431toLayoutHyphenationFrequency3fSNIE(style.getParagraphStyle().getHyphens());
        breakStrategy = AndroidParagraph_androidKt.m5430toLayoutBreakStrategyxImikfE(LineBreak.m5884getStrategyfcGXIks(style.m5609getLineBreakrAG3T2k()));
        lineBreakStyle = AndroidParagraph_androidKt.m5432toLayoutLineBreakStylehpcqdu8(LineBreak.m5885getStrictnessusljTpc(style.m5609getLineBreakrAG3T2k()));
        lineBreakWordStyle = AndroidParagraph_androidKt.m5433toLayoutLineBreakWordStylewPN0Rpw(LineBreak.m5886getWordBreakjp8hJ3c(style.m5609getLineBreakrAG3T2k()));
        if (this.ellipsis) {
        ...
        if (this.ellipsis && firstLayout.getHeight() > Constraints.m6049getMaxHeightimpl(this.constraints) && this.maxLines > 1) {
            calculatedMaxLines = AndroidParagraph_androidKt.numberOfLinesThatFitMaxHeight(firstLayout, Constraints.m6049getMaxHeightimpl(this.constraints));
        ...
        getTextPaint$ui_text_release().m5828setBrush12SF9DM(style.getBrush(), SizeKt.Size(getWidth(), getHeight()), style.getAlpha());
        ShaderBrushSpan[] shaderBrushSpans = getShaderBrushSpans(this.layout);
        int length = shaderBrushSpans.length;
        for (int i3 = i; i3 < length; i3++) {
            shaderBrushSpans[i3].m5847setSizeuvyYCjk(SizeKt.Size(getWidth(), getHeight()));
        }
    ...
    public float getWidth() {
        return Constraints.m6050getMaxWidthimpl(this.constraints);
    }
    ...
    public int mo5419getOffsetForPositionk4lQ0M(long position) {
        int line = this.layout.getLineForVertical((int) Offset.m3506getYimpl(position));
        return this.layout.getOffsetForHorizontal(line, Offset.m3505getXimpl(position));
    }
    ...
    public void mo5417fillBoundingBoxes8ffj60Q(long range, float[] array, int arrayStart) {
        this.layout.fillBoundingBoxes(TextRange.m5569getMinimpl(range), TextRange.m5568getMaximpl(range), array, arrayStart);
    }
    ...
    public long mo5420getWordBoundaryjx7JFs(int offset) {
    ...
    public void mo5422paintRPmYEkk(Canvas canvas, long color, Shadow shadow, TextDecoration textDecoration) {
        AndroidTextPaint $this$paint_RPmYEkk_u24lambda_u2411 = getTextPaint$ui_text_release();
        $this$paint_RPmYEkk_u24lambda_u2411.m5829setColor8_81llA(color);
    ...
    public void mo5421paintLG529CI(Canvas canvas, long color, Shadow shadow, TextDecoration textDecoration, DrawStyle drawStyle, int blendMode) {
        int currBlendMode = getTextPaint$ui_text_release().m5826getBlendMode0nO6VwU();
        AndroidTextPaint $this$paint_LG529CI_u24lambda_u2412 = getTextPaint$ui_text_release();
        $this$paint_LG529CI_u24lambda_u2412.m5829setColor8_81llA(color);
        ...
        $this$paint_LG529CI_u24lambda_u2412.m5827setBlendModes9anfk8(blendMode);
        paint(canvas);
        getTextPaint$ui_text_release().m5827setBlendModes9anfk8(currBlendMode);
    }

    @Override // androidx.compose.ui.text.Paragraph
    /* renamed from: paint-hn5TExg, reason: not valid java name */
    public void mo5423painthn5TExg(Canvas canvas, Brush brush, float alpha, Shadow shadow, TextDecoration textDecoration, DrawStyle drawStyle, int blendMode) {
        int currBlendMode = getTextPaint$ui_text_release().m5826getBlendMode0nO6VwU();
        AndroidTextPaint $this$paint_hn5TExg_u24lambda_u2413 = getTextPaint$ui_text_release();
        $this$paint_hn5TExg_u24lambda_u2413.m5828setBrush12SF9DM(brush, SizeKt.Size(getWidth(), getHeight()), alpha);
        ...
        $this$paint_hn5TExg_u24lambda_u2413.m5827setBlendModes9anfk8(blendMode);
        paint(canvas);
        getTextPaint$ui_text_release().m5827setBlendModes9anfk8(currBlendMode);
    }
