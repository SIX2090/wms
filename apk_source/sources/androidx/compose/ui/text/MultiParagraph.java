...
public final class MultiParagraph {
    ...
    private MultiParagraph(MultiParagraphIntrinsics intrinsics, long constraints, int maxLines, boolean ellipsis) {
        ...
        Rect it;
        int m6049getMaxHeightimpl;
        this.intrinsics = intrinsics;
        this.maxLines = maxLines;
        int i = 0;
        if (!(Constraints.m6052getMinWidthimpl(constraints) == 0 && Constraints.m6051getMinHeightimpl(constraints) == 0)) {
        ...
        while (index < size) {
            ...
            int m6050getMaxWidthimpl = Constraints.m6050getMaxWidthimpl(constraints);
            if (Constraints.m6045getHasBoundedHeightimpl(constraints)) {
                m6049getMaxHeightimpl = RangesKt.coerceAtLeast(Constraints.m6049getMaxHeightimpl(constraints) - ParagraphKt.ceilToInt(currentHeight), i);
            } else {
                m6049getMaxHeightimpl = Constraints.m6049getMaxHeightimpl(constraints);
            }
            Paragraph paragraph = ParagraphKt.m5464Paragraph_EkL_Y(intrinsics2, ConstraintsKt.Constraints$default(0, m6050getMaxWidthimpl, 0, m6049getMaxHeightimpl, 5, null), this.maxLines - currentLineCount2, ellipsis);
        ...
        this.width = Constraints.m6050getMaxWidthimpl(constraints);
    ...
    */
    ...
    public final /* synthetic */ void m5451paintRPmYEkk(Canvas canvas, long color, Shadow shadow, TextDecoration decoration) {
        canvas.save();
        ...
        for (int index$iv = 0; index$iv < size; index$iv++) {
            ...
            it.getParagraph().mo5422paintRPmYEkk(canvas, color, shadow, decoration);
    ...
    public final void m5450paintLG529CI(Canvas canvas, long color, Shadow shadow, TextDecoration decoration, DrawStyle drawStyle, int blendMode) {
        canvas.save();
        List $this$fastForEach$iv = this.paragraphInfoList;
        int size = $this$fastForEach$iv.size();
        for (int index$iv = 0; index$iv < size; index$iv++) {
            Object item$iv = $this$fastForEach$iv.get(index$iv);
            ParagraphInfo it = (ParagraphInfo) item$iv;
            it.getParagraph().mo5421paintLG529CI(canvas, color, shadow, decoration, drawStyle, blendMode);
            canvas.translate(0.0f, it.getParagraph().getHeight());
        }
        canvas.restore();
    }
    ...
    public final void m5452painthn5TExg(Canvas canvas, Brush brush, float alpha, Shadow shadow, TextDecoration decoration, DrawStyle drawStyle, int blendMode) {
        AndroidMultiParagraphDraw_androidKt.m5816drawMultiParagraph7AXcY_I(this, canvas, brush, alpha, shadow, decoration, drawStyle, blendMode);
    }
    ...
    public final Path getPathForRange(final int start, final int end) {
        ...
        MultiParagraphKt.m5453findParagraphsByRangeSbBc2M(this.paragraphInfoList, TextRangeKt.TextRange(start, end), new Function1<ParagraphInfo, Unit>() { // from class: androidx.compose.ui.text.MultiParagraph$getPathForRange$2
            ...
            public final void invoke2(ParagraphInfo paragraphInfo) {
                Path.m4016addPathUv8p0NA$default(Path.this, paragraphInfo.toGlobal(paragraphInfo.getParagraph().getPathForRange(paragraphInfo.toLocalIndex(start), paragraphInfo.toLocalIndex(end))), 0L, 2, null);
            }
        });
        return path;
    }
    ...
    public final int m5448getOffsetForPositionk4lQ0M(long position) {
        int paragraphIndex;
        if (Offset.m3506getYimpl(position) <= 0.0f) {
            paragraphIndex = 0;
        } else {
            paragraphIndex = Offset.m3506getYimpl(position) >= this.height ? CollectionsKt.getLastIndex(this.paragraphInfoList) : MultiParagraphKt.findParagraphByY(this.paragraphInfoList, Offset.m3506getYimpl(position));
        }
        ...
        return $this$getOffsetForPosition_k_4lQ0M_u24lambda_u2411.toGlobalIndex($this$getOffsetForPosition_k_4lQ0M_u24lambda_u2411.getParagraph().mo5419getOffsetForPositionk4lQ0M($this$getOffsetForPosition_k_4lQ0M_u24lambda_u2411.m5461toLocalMKHz9U(position)));
    }
    ...
    public final Rect getBoundingBox(int offset) {
        ...
        ParagraphInfo $this$getBoundingBox_u24lambda_u2412 = this.paragraphInfoList.get(paragraphIndex);
        return $this$getBoundingBox_u24lambda_u2412.toGlobal($this$getBoundingBox_u24lambda_u2412.getParagraph().getBoundingBox($this$getBoundingBox_u24lambda_u2412.toLocalIndex(offset)));
    }

    /* renamed from: fillBoundingBoxes-8ffj60Q, reason: not valid java name */
    public final float[] m5447fillBoundingBoxes8ffj60Q(final long range, final float[] array, int arrayStart) {
        requireIndexInRange(TextRange.m5569getMinimpl(range));
        requireIndexInRangeInclusiveEnd(TextRange.m5568getMaximpl(range));
        ...
        MultiParagraphKt.m5453findParagraphsByRangeSbBc2M(this.paragraphInfoList, range, new Function1<ParagraphInfo, Unit>() { // from class: androidx.compose.ui.text.MultiParagraph$fillBoundingBoxes$1
            /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
            {
                super(1);
            }
            ...
            public final void invoke2(ParagraphInfo paragraphInfo) {
                ...
                int paragraphStart = paragraphInfo.getStartIndex() > TextRange.m5569getMinimpl(j) ? paragraphInfo.getStartIndex() : TextRange.m5569getMinimpl(j);
                int paragraphEnd = paragraphInfo.getEndIndex() < TextRange.m5568getMaximpl(j) ? paragraphInfo.getEndIndex() : TextRange.m5568getMaximpl(j);
                long finalRange = TextRangeKt.TextRange(paragraphInfo.toLocalIndex(paragraphStart), paragraphInfo.toLocalIndex(paragraphEnd));
                paragraphInfo.getParagraph().mo5417fillBoundingBoxes8ffj60Q(finalRange, fArr, intRef.element);
                int currentArrayEnd = intRef.element + (TextRange.m5567getLengthimpl(finalRange) * 4);
    ...
    public final float getHorizontalPosition(int offset, boolean usePrimaryDirection) {
        ...
        ParagraphInfo $this$getHorizontalPosition_u24lambda_u2413 = this.paragraphInfoList.get(paragraphIndex);
        return $this$getHorizontalPosition_u24lambda_u2413.getParagraph().getHorizontalPosition($this$getHorizontalPosition_u24lambda_u2413.toLocalIndex(offset), usePrimaryDirection);
    }
    ...
    public final ResolvedTextDirection getParagraphDirection(int offset) {
        ...
        ParagraphInfo $this$getParagraphDirection_u24lambda_u2414 = this.paragraphInfoList.get(paragraphIndex);
        return $this$getParagraphDirection_u24lambda_u2414.getParagraph().getParagraphDirection($this$getParagraphDirection_u24lambda_u2414.toLocalIndex(offset));
    }
    ...
    public final ResolvedTextDirection getBidiRunDirection(int offset) {
        ...
        ParagraphInfo $this$getBidiRunDirection_u24lambda_u2415 = this.paragraphInfoList.get(paragraphIndex);
        return $this$getBidiRunDirection_u24lambda_u2415.getParagraph().getBidiRunDirection($this$getBidiRunDirection_u24lambda_u2415.toLocalIndex(offset));
    }

    /* renamed from: getWordBoundary--jx7JFs, reason: not valid java name */
    public final long m5449getWordBoundaryjx7JFs(int offset) {
        int paragraphIndex;
        requireIndexInRangeInclusiveEnd(offset);
        if (offset == getAnnotatedString().length()) {
            paragraphIndex = CollectionsKt.getLastIndex(this.paragraphInfoList);
        ...
        ParagraphInfo $this$getWordBoundary__jx7JFs_u24lambda_u2416 = this.paragraphInfoList.get(paragraphIndex);
        return $this$getWordBoundary__jx7JFs_u24lambda_u2416.m5460toGlobalGEjPoXI($this$getWordBoundary__jx7JFs_u24lambda_u2416.getParagraph().mo5420getWordBoundaryjx7JFs($this$getWordBoundary__jx7JFs_u24lambda_u2416.toLocalIndex(offset)));
    }
    ...
    public final Rect getCursorRect(int offset) {
        ...
        ParagraphInfo $this$getCursorRect_u24lambda_u2417 = this.paragraphInfoList.get(paragraphIndex);
        return $this$getCursorRect_u24lambda_u2417.toGlobal($this$getCursorRect_u24lambda_u2417.getParagraph().getCursorRect($this$getCursorRect_u24lambda_u2417.toLocalIndex(offset)));
    }
    ...
    public final int getLineForOffset(int offset) {
        ...
        ParagraphInfo $this$getLineForOffset_u24lambda_u2418 = this.paragraphInfoList.get(paragraphIndex);
        return $this$getLineForOffset_u24lambda_u2418.toGlobalLineIndex($this$getLineForOffset_u24lambda_u2418.getParagraph().getLineForOffset($this$getLineForOffset_u24lambda_u2418.toLocalIndex(offset)));
    }
    ...
    public final float getLineLeft(int lineIndex) {
        ...
        ParagraphInfo $this$getLineLeft_u24lambda_u2419 = this.paragraphInfoList.get(paragraphIndex);
        return $this$getLineLeft_u24lambda_u2419.getParagraph().getLineLeft($this$getLineLeft_u24lambda_u2419.toLocalLineIndex(lineIndex));
    }

    public final float getLineRight(int lineIndex) {
        requireLineIndexInRange(lineIndex);
        int paragraphIndex = MultiParagraphKt.findParagraphByLineIndex(this.paragraphInfoList, lineIndex);
        ParagraphInfo $this$getLineRight_u24lambda_u2420 = this.paragraphInfoList.get(paragraphIndex);
        return $this$getLineRight_u24lambda_u2420.getParagraph().getLineRight($this$getLineRight_u24lambda_u2420.toLocalLineIndex(lineIndex));
    }

    public final float getLineTop(int lineIndex) {
        requireLineIndexInRange(lineIndex);
        int paragraphIndex = MultiParagraphKt.findParagraphByLineIndex(this.paragraphInfoList, lineIndex);
        ParagraphInfo $this$getLineTop_u24lambda_u2421 = this.paragraphInfoList.get(paragraphIndex);
        return $this$getLineTop_u24lambda_u2421.toGlobalYPosition($this$getLineTop_u24lambda_u2421.getParagraph().getLineTop($this$getLineTop_u24lambda_u2421.toLocalLineIndex(lineIndex)));
    }

    public final float getLineBottom(int lineIndex) {
        requireLineIndexInRange(lineIndex);
        int paragraphIndex = MultiParagraphKt.findParagraphByLineIndex(this.paragraphInfoList, lineIndex);
        ParagraphInfo $this$getLineBottom_u24lambda_u2422 = this.paragraphInfoList.get(paragraphIndex);
        return $this$getLineBottom_u24lambda_u2422.toGlobalYPosition($this$getLineBottom_u24lambda_u2422.getParagraph().getLineBottom($this$getLineBottom_u24lambda_u2422.toLocalLineIndex(lineIndex)));
    }

    public final float getLineHeight(int lineIndex) {
        requireLineIndexInRange(lineIndex);
        int paragraphIndex = MultiParagraphKt.findParagraphByLineIndex(this.paragraphInfoList, lineIndex);
        ParagraphInfo $this$getLineHeight_u24lambda_u2423 = this.paragraphInfoList.get(paragraphIndex);
        return $this$getLineHeight_u24lambda_u2423.getParagraph().getLineHeight($this$getLineHeight_u24lambda_u2423.toLocalLineIndex(lineIndex));
    }

    public final float getLineWidth(int lineIndex) {
        requireLineIndexInRange(lineIndex);
        int paragraphIndex = MultiParagraphKt.findParagraphByLineIndex(this.paragraphInfoList, lineIndex);
        ParagraphInfo $this$getLineWidth_u24lambda_u2424 = this.paragraphInfoList.get(paragraphIndex);
        return $this$getLineWidth_u24lambda_u2424.getParagraph().getLineWidth($this$getLineWidth_u24lambda_u2424.toLocalLineIndex(lineIndex));
    }

    public final int getLineStart(int lineIndex) {
        requireLineIndexInRange(lineIndex);
        int paragraphIndex = MultiParagraphKt.findParagraphByLineIndex(this.paragraphInfoList, lineIndex);
        ParagraphInfo $this$getLineStart_u24lambda_u2425 = this.paragraphInfoList.get(paragraphIndex);
        return $this$getLineStart_u24lambda_u2425.toGlobalIndex($this$getLineStart_u24lambda_u2425.getParagraph().getLineStart($this$getLineStart_u24lambda_u2425.toLocalLineIndex(lineIndex)));
    }
    ...
    public final int getLineEnd(int lineIndex, boolean visibleEnd) {
        requireLineIndexInRange(lineIndex);
        int paragraphIndex = MultiParagraphKt.findParagraphByLineIndex(this.paragraphInfoList, lineIndex);
        ParagraphInfo $this$getLineEnd_u24lambda_u2426 = this.paragraphInfoList.get(paragraphIndex);
        return $this$getLineEnd_u24lambda_u2426.toGlobalIndex($this$getLineEnd_u24lambda_u2426.getParagraph().getLineEnd($this$getLineEnd_u24lambda_u2426.toLocalLineIndex(lineIndex), visibleEnd));
    }

    public final boolean isLineEllipsized(int lineIndex) {
        requireLineIndexInRange(lineIndex);
        int paragraphIndex = MultiParagraphKt.findParagraphByLineIndex(this.paragraphInfoList, lineIndex);
        ParagraphInfo $this$isLineEllipsized_u24lambda_u2427 = this.paragraphInfoList.get(paragraphIndex);
        return $this$isLineEllipsized_u24lambda_u2427.getParagraph().isLineEllipsized(lineIndex);
    }
