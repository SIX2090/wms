...
public final /* data */ class ParagraphInfo {
    ...
    public final long m5461toLocalMKHz9U(long $this$toLocal_u2dMK_u2dHz9U) {
        return OffsetKt.Offset(Offset.m3505getXimpl($this$toLocal_u2dMK_u2dHz9U), Offset.m3506getYimpl($this$toLocal_u2dMK_u2dHz9U) - this.top);
    }

    public final Rect toGlobal(Rect $this$toGlobal) {
        return $this$toGlobal.m3542translatek4lQ0M(OffsetKt.Offset(0.0f, this.top));
    }

    public final Path toGlobal(Path $this$toGlobal) {
        $this$toGlobal.mo3641translatek4lQ0M(OffsetKt.Offset(0.0f, this.top));
        return $this$toGlobal;
    }

    /* renamed from: toGlobal-GEjPoXI, reason: not valid java name */
    public final long m5460toGlobalGEjPoXI(long $this$toGlobal_u2dGEjPoXI) {
        return TextRangeKt.TextRange(toGlobalIndex(TextRange.m5571getStartimpl($this$toGlobal_u2dGEjPoXI)), toGlobalIndex(TextRange.m5566getEndimpl($this$toGlobal_u2dGEjPoXI)));
    }
}
