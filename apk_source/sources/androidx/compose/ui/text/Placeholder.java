...
public final class Placeholder {
    ...
    private Placeholder(long width, long height, int placeholderVerticalAlign) {
        ...
        if (TextUnitKt.m6303isUnspecifiedR2X_6o(this.width)) {
            throw new IllegalArgumentException("width cannot be TextUnit.Unspecified".toString());
        }
        if (TextUnitKt.m6303isUnspecifiedR2X_6o(this.height)) {
    ...
    public final Placeholder m5491copyK8Q__8(long width, long height, int placeholderVerticalAlign) {
    ...
    public boolean equals(Object other) {
        ...
        return (other instanceof Placeholder) && TextUnit.m6282equalsimpl0(this.width, ((Placeholder) other).width) && TextUnit.m6282equalsimpl0(this.height, ((Placeholder) other).height) && PlaceholderVerticalAlign.m5498equalsimpl0(this.placeholderVerticalAlign, ((Placeholder) other).placeholderVerticalAlign);
    }

    public int hashCode() {
        int result = TextUnit.m6286hashCodeimpl(this.width);
        return (((result * 31) + TextUnit.m6286hashCodeimpl(this.height)) * 31) + PlaceholderVerticalAlign.m5499hashCodeimpl(this.placeholderVerticalAlign);
    }

    public String toString() {
        return "Placeholder(width=" + ((Object) TextUnit.m6292toStringimpl(this.width)) + ", height=" + ((Object) TextUnit.m6292toStringimpl(this.height)) + ", placeholderVerticalAlign=" + ((Object) PlaceholderVerticalAlign.m5500toStringimpl(this.placeholderVerticalAlign)) + ')';
    }
}
