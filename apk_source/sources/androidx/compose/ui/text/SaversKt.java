...
public final class SaversKt {
        ...
        public final AnnotatedString.Range<? extends Object> invoke(Object it) {
            ...
            switch (WhenMappings.$EnumSwitchMapping$0[marker.ordinal()]) {
                case 1:
                    ...
                    if ((!Intrinsics.areEqual(value$iv5, (Object) false) || (saver$iv3 instanceof NonNullValueClassSaver)) && value$iv5 != null) {
                ...
                case 2:
                    ...
                    if ((!Intrinsics.areEqual(value$iv6, (Object) false) || (saver$iv4 instanceof NonNullValueClassSaver)) && value$iv6 != null) {
    ...
    private static final Saver<ParagraphStyle, Object> ParagraphStyleSaver = SaverKt.Saver(new Function2<SaverScope, ParagraphStyle, Object>() { // from class: androidx.compose.ui.text.SaversKt$ParagraphStyleSaver$1
        ...
        public final Object invoke(SaverScope $this$Saver, ParagraphStyle it) {
            return CollectionsKt.arrayListOf(SaversKt.save(TextAlign.m5957boximpl(it.getTextAlign())), SaversKt.save(TextDirection.m5971boximpl(it.getTextDirection())), SaversKt.save(TextUnit.m6275boximpl(it.getLineHeight()), SaversKt.getSaver(TextUnit.INSTANCE), $this$Saver), SaversKt.save(it.getTextIndent(), SaversKt.getSaver(TextIndent.INSTANCE), $this$Saver));
        }
        ...
        public final ParagraphStyle invoke(Object it) {
            ...
            return new ParagraphStyle(value, value2, packedValue, restore2, (PlatformParagraphStyle) null, (LineHeightStyle) null, 0, 0, (TextMotion) null, 496, (DefaultConstructorMarker) null);
        }
    });
    private static final Saver<SpanStyle, Object> SpanStyleSaver = SaverKt.Saver(new Function2<SaverScope, SpanStyle, Object>() { // from class: androidx.compose.ui.text.SaversKt$SpanStyleSaver$1
        ...
        public final SpanStyle invoke(Object it) {
            ...
            Intrinsics.checkNotNull(restore);
            long m3756unboximpl = restore.m3756unboximpl();
            Object value$iv2 = list.get(1);
            ...
            if (!Intrinsics.areEqual(value$iv7, (Object) false) || (saver$iv4 instanceof NonNullValueClassSaver)) {
            ...
            if (!Intrinsics.areEqual(value$iv8, (Object) false) || (saver$iv5 instanceof NonNullValueClassSaver)) {
            ...
            if (!Intrinsics.areEqual(value$iv9, (Object) false) || ($this$restore_u24lambda_u243_u24lambda_u242$iv instanceof NonNullValueClassSaver)) {
            ...
            if (!Intrinsics.areEqual(value$iv10, (Object) false) || ($this$restore_u24lambda_u243_u24lambda_u242$iv2 instanceof NonNullValueClassSaver)) {
            ...
            if (!Intrinsics.areEqual(value$iv11, (Object) false) || ($this$restore_u24lambda_u243_u24lambda_u242$iv3 instanceof NonNullValueClassSaver)) {
            ...
            long m3756unboximpl2 = restore8.m3756unboximpl();
            ...
            if (!Intrinsics.areEqual(value$iv12, (Object) false) || ($this$restore_u24lambda_u243_u24lambda_u242$iv4 instanceof NonNullValueClassSaver)) {
            ...
            if (!Intrinsics.areEqual(value$iv13, (Object) false) || (saver$iv6 instanceof NonNullValueClassSaver)) {
                restore10 = value$iv13 != null ? saver$iv6.restore(value$iv13) : null;
            } else {
                restore10 = null;
            }
            return new SpanStyle(m3756unboximpl, packedValue, restore3, fontStyle, fontSynthesis, (FontFamily) null, str, packedValue2, restore5, restore6, restore7, m3756unboximpl2, restore9, restore10, (PlatformSpanStyle) null, (DrawStyle) null, 49184, (DefaultConstructorMarker) null);
        }
    });
    ...
    private static final Saver<TextIndent, Object> TextIndentSaver = SaverKt.Saver(new Function2<SaverScope, TextIndent, Object>() { // from class: androidx.compose.ui.text.SaversKt$TextIndentSaver$1
        ...
        public final Object invoke(SaverScope $this$Saver, TextIndent it) {
            return CollectionsKt.arrayListOf(SaversKt.save(TextUnit.m6275boximpl(it.getFirstLine()), SaversKt.getSaver(TextUnit.INSTANCE), $this$Saver), SaversKt.save(TextUnit.m6275boximpl(it.getRestLine()), SaversKt.getSaver(TextUnit.INSTANCE), $this$Saver));
        }
    ...
    private static final Saver<BaselineShift, Object> BaselineShiftSaver = SaverKt.Saver(new Function2<SaverScope, BaselineShift, Object>() { // from class: androidx.compose.ui.text.SaversKt$BaselineShiftSaver$1
        ...
        public /* bridge */ /* synthetic */ Object invoke(SaverScope saverScope, BaselineShift baselineShift) {
            return m5510invoke8a2Sb4w(saverScope, baselineShift.m5854unboximpl());
        }

        /* renamed from: invoke-8a2Sb4w, reason: not valid java name */
        public final Object m5510invoke8a2Sb4w(SaverScope $this$Saver, float it) {
        ...
        public final BaselineShift invoke(Object it) {
            ...
            return BaselineShift.m5848boximpl(BaselineShift.m5849constructorimpl(((Float) it).floatValue()));
        }
    });
    private static final Saver<TextRange, Object> TextRangeSaver = SaverKt.Saver(new Function2<SaverScope, TextRange, Object>() { // from class: androidx.compose.ui.text.SaversKt$TextRangeSaver$1
        ...
        public /* bridge */ /* synthetic */ Object invoke(SaverScope saverScope, TextRange textRange) {
            return m5516invokeFDrldGo(saverScope, textRange.getPackedValue());
        }

        /* JADX WARN: Multi-variable type inference failed */
        /* renamed from: invoke-FDrldGo, reason: not valid java name */
        public final Object m5516invokeFDrldGo(SaverScope $this$Saver, long it) {
            return CollectionsKt.arrayListOf(SaversKt.save(Integer.valueOf(TextRange.m5571getStartimpl(it))), SaversKt.save(Integer.valueOf(TextRange.m5566getEndimpl(it))));
        }
        ...
        public final TextRange invoke(Object it) {
            ...
            Intrinsics.checkNotNull(it$iv2);
            return TextRange.m5559boximpl(TextRangeKt.TextRange(intValue, ((Number) it$iv2).intValue()));
        }
    });
    private static final Saver<Shadow, Object> ShadowSaver = SaverKt.Saver(new Function2<SaverScope, Shadow, Object>() { // from class: androidx.compose.ui.text.SaversKt$ShadowSaver$1
        ...
        public final Object invoke(SaverScope $this$Saver, Shadow it) {
            return CollectionsKt.arrayListOf(SaversKt.save(Color.m3736boximpl(it.getColor()), SaversKt.getSaver(Color.INSTANCE), $this$Saver), SaversKt.save(Offset.m3494boximpl(it.getOffset()), SaversKt.getSaver(Offset.INSTANCE), $this$Saver), SaversKt.save(Float.valueOf(it.getBlurRadius())));
        }
        ...
        public final Shadow invoke(Object it) {
            ...
            return new Shadow(m3756unboximpl, packedValue, f.floatValue(), null);
        }
    });
    private static final NonNullValueClassSaver<Color, Object> ColorSaver = NonNullValueClassSaver(new Function2<SaverScope, Color, Object>() { // from class: androidx.compose.ui.text.SaversKt$ColorSaver$1
        ...
        public /* bridge */ /* synthetic */ Object invoke(SaverScope saverScope, Color color) {
            return m5512invoke4WTKRHQ(saverScope, color.m3756unboximpl());
        }

        /* renamed from: invoke-4WTKRHQ, reason: not valid java name */
        public final Object m5512invoke4WTKRHQ(SaverScope $this$NonNullValueClassSaver, long it) {
            if (it == Color.INSTANCE.m3782getUnspecified0d7_KjU()) {
                return false;
            }
            return Integer.valueOf(ColorKt.m3800toArgb8_81llA(it));
        }
        ...
        public final Color invoke(Object it) {
            ...
            if (Intrinsics.areEqual(it, (Object) false)) {
                Color = Color.INSTANCE.m3782getUnspecified0d7_KjU();
            } else {
                Intrinsics.checkNotNull(it, "null cannot be cast to non-null type kotlin.Int");
                Color = ColorKt.Color(((Integer) it).intValue());
            }
            return Color.m3736boximpl(Color);
        }
    });
    private static final NonNullValueClassSaver<TextUnit, Object> TextUnitSaver = NonNullValueClassSaver(new Function2<SaverScope, TextUnit, Object>() { // from class: androidx.compose.ui.text.SaversKt$TextUnitSaver$1
        ...
        public /* bridge */ /* synthetic */ Object invoke(SaverScope saverScope, TextUnit textUnit) {
            return m5518invokempE4wyQ(saverScope, textUnit.getPackedValue());
        }

        /* renamed from: invoke-mpE4wyQ, reason: not valid java name */
        public final Object m5518invokempE4wyQ(SaverScope $this$NonNullValueClassSaver, long it) {
            if (TextUnit.m6282equalsimpl0(it, TextUnit.INSTANCE.m6296getUnspecifiedXSAIIZE())) {
                return (Serializable) false;
            }
            return CollectionsKt.arrayListOf(SaversKt.save(Float.valueOf(TextUnit.m6285getValueimpl(it))), SaversKt.save(TextUnitType.m6310boximpl(TextUnit.m6284getTypeUIouoOA(it))));
        }
        ...
        public final TextUnit invoke(Object it) {
            if (Intrinsics.areEqual(it, (Object) false)) {
                return TextUnit.m6275boximpl(TextUnit.INSTANCE.m6296getUnspecifiedXSAIIZE());
            }
            Intrinsics.checkNotNull(it, "null cannot be cast to non-null type kotlin.collections.List<kotlin.Any>");
            List list = (List) it;
            Object value$iv = list.get(0);
            ...
            return TextUnit.m6275boximpl(TextUnitKt.m6297TextUnitanM5pPY(floatValue, textUnitType.getType()));
        }
    });
    private static final NonNullValueClassSaver<Offset, Object> OffsetSaver = NonNullValueClassSaver(new Function2<SaverScope, Offset, Object>() { // from class: androidx.compose.ui.text.SaversKt$OffsetSaver$1
        ...
        public /* bridge */ /* synthetic */ Object invoke(SaverScope saverScope, Offset offset) {
            return m5514invokeUv8p0NA(saverScope, offset.getPackedValue());
        }

        /* JADX WARN: Multi-variable type inference failed */
        /* renamed from: invoke-Uv8p0NA, reason: not valid java name */
        public final Object m5514invokeUv8p0NA(SaverScope $this$NonNullValueClassSaver, long it) {
            return Offset.m3502equalsimpl0(it, Offset.INSTANCE.m3520getUnspecifiedF1C5BW0()) ? (Serializable) false : CollectionsKt.arrayListOf(SaversKt.save(Float.valueOf(Offset.m3505getXimpl(it))), SaversKt.save(Float.valueOf(Offset.m3506getYimpl(it))));
        }
        ...
        public final Offset invoke(Object it) {
            if (Intrinsics.areEqual(it, (Object) false)) {
                return Offset.m3494boximpl(Offset.INSTANCE.m3520getUnspecifiedF1C5BW0());
            }
            Intrinsics.checkNotNull(it, "null cannot be cast to non-null type kotlin.collections.List<kotlin.Any?>");
            List list = (List) it;
            Object value$iv = list.get(0);
            ...
            Intrinsics.checkNotNull(it$iv2);
            return Offset.m3494boximpl(OffsetKt.Offset(floatValue, ((Number) it$iv2).floatValue()));
        }
    });
