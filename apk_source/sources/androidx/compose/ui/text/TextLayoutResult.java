...
public final class TextLayoutResult {
    ...
    public final boolean getDidOverflowHeight() {
        return this.multiParagraph.getDidExceedMaxLines() || ((float) IntSize.m6263getHeightimpl(this.size)) < this.multiParagraph.getHeight();
    }

    public final boolean getDidOverflowWidth() {
        return ((float) IntSize.m6264getWidthimpl(this.size)) < this.multiParagraph.getWidth();
    }
    ...
    public final int m5543getOffsetForPositionk4lQ0M(long position) {
        return this.multiParagraph.m5448getOffsetForPositionk4lQ0M(position);
    }
    ...
    public final long m5545getWordBoundaryjx7JFs(int offset) {
        return this.multiParagraph.m5449getWordBoundaryjx7JFs(offset);
    }
    ...
    public static /* synthetic */ TextLayoutResult m5541copyO0kMr_c$default(TextLayoutResult textLayoutResult, TextLayoutInput textLayoutInput, long j, int i, Object obj) {
        if ((i & 1) != 0) {
        ...
        return textLayoutResult.m5542copyO0kMr_c(textLayoutInput, j);
    }

    /* renamed from: copy-O0kMr_c, reason: not valid java name */
    public final TextLayoutResult m5542copyO0kMr_c(TextLayoutInput layoutInput, long size) {
    ...
    public boolean equals(Object other) {
        ...
        if (!(other instanceof TextLayoutResult) || !Intrinsics.areEqual(this.layoutInput, ((TextLayoutResult) other).layoutInput) || !Intrinsics.areEqual(this.multiParagraph, ((TextLayoutResult) other).multiParagraph) || !IntSize.m6262equalsimpl0(this.size, ((TextLayoutResult) other).size)) {
            return false;
        }
    ...
    public int hashCode() {
        ...
        return (((((((((result * 31) + this.multiParagraph.hashCode()) * 31) + IntSize.m6265hashCodeimpl(this.size)) * 31) + Float.hashCode(this.firstBaseline)) * 31) + Float.hashCode(this.lastBaseline)) * 31) + this.placeholderRects.hashCode();
    }

    public String toString() {
        return "TextLayoutResult(layoutInput=" + this.layoutInput + ", multiParagraph=" + this.multiParagraph + ", size=" + ((Object) IntSize.m6267toStringimpl(this.size)) + ", firstBaseline=" + this.firstBaseline + ", lastBaseline=" + this.lastBaseline + ", placeholderRects=" + this.placeholderRects + ')';
    }
}
