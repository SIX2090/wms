...
public final class AndroidFontUtils_androidKt {
    ...
    public static final int m5634getAndroidTypefaceStyleFO1MlWM(FontWeight fontWeight, int fontStyle) {
        boolean isBold = fontWeight.compareTo(getAndroidBold(FontWeight.INSTANCE)) >= 0;
        boolean isItalic = FontStyle.m5680equalsimpl0(fontStyle, FontStyle.INSTANCE.m5686getItalic_LCdwA());
