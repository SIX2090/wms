...
public final class FontFamilyResolver_androidKt {
    ...
    public static /* synthetic */ State m5657resolveAsTypefaceWqqsr6A$default(FontFamily.Resolver resolver, FontFamily fontFamily, FontWeight fontWeight, int i, int i2, int i3, Object obj) {
        if ((i3 & 1) != 0) {
            fontFamily = null;
        }
        if ((i3 & 2) != 0) {
        ...
        if ((i3 & 8) != 0) {
            i2 = FontSynthesis.INSTANCE.m5697getAllGVVA2EU();
        }
        return m5656resolveAsTypefaceWqqsr6A(resolver, fontFamily, fontWeight, i, i2);
    }

    /* renamed from: resolveAsTypeface-Wqqsr6A, reason: not valid java name */
    public static final State<android.graphics.Typeface> m5656resolveAsTypefaceWqqsr6A(FontFamily.Resolver $this$resolveAsTypeface_u2dWqqsr6A, FontFamily fontFamily, FontWeight fontWeight, int fontStyle, int fontSynthesis) {
        State mo5655resolveDPcqOEQ = $this$resolveAsTypeface_u2dWqqsr6A.mo5655resolveDPcqOEQ(fontFamily, fontWeight, fontStyle, fontSynthesis);
        Intrinsics.checkNotNull(mo5655resolveDPcqOEQ, "null cannot be cast to non-null type androidx.compose.runtime.State<android.graphics.Typeface>");
        return mo5655resolveDPcqOEQ;
    }
}
