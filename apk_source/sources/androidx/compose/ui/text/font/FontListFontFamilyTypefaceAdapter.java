...
public final class FontListFontFamilyTypefaceAdapter implements FontFamilyTypefaceAdapter {
    ...
    public final Object preload(FontFamily family, PlatformFontLoader resourceLoader, Continuation<? super Unit> continuation) {
        ...
        while (index$iv$iv < size) {
            ...
            int $i$f$fastFilter3 = FontLoadingStrategy.INSTANCE.m5671getAsyncPKNRLFQ();
            if (FontLoadingStrategy.m5667equalsimpl0(loadingStrategy, $i$f$fastFilter3)) {
                target$iv.add(it);
            }
            index$iv$iv++;
        ...
        while (index$iv$iv2 < size2) {
            ...
            target$iv2.add(TuplesKt.to(it2.getWeight(), FontStyle.m5677boximpl(it2.getStyle())));
            index$iv$iv2++;
        ...
        while (index$iv < size4) {
            ...
            int fontStyle = ((FontStyle) pair.component2()).m5683unboximpl();
            List matched = fontMatcher.m5676matchFontRetOiIg((List<? extends Font>) allFonts, fontWeight, fontStyle);
            int index$iv2 = index$iv;
            TypefaceRequest typeRequest = new TypefaceRequest(family, fontWeight, fontStyle, FontSynthesis.INSTANCE.m5697getAllGVVA2EU(), resourceLoader.getCacheKey(), null);
    ...
    public TypefaceResult resolve(TypefaceRequest typefaceRequest, PlatformFontLoader platformFontLoader, Function1<? super TypefaceResult.Immutable, Unit> onAsyncCompletion, Function1<? super TypefaceRequest, ? extends Object> createDefaultTypeface) {
        ...
        List matched = fontMatcher.m5676matchFontRetOiIg(((FontListFontFamily) typefaceRequest.getFontFamily()).getFonts(), typefaceRequest.getFontWeight(), typefaceRequest.m5725getFontStyle_LCdwA());
