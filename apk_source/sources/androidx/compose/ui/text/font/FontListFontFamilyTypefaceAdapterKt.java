...
public final class FontListFontFamilyTypefaceAdapterKt {
    ...
    public static final Pair<List<Font>, Object> firstImmediatelyAvailable(List<? extends Font> list, TypefaceRequest typefaceRequest, AsyncTypefaceCache asyncTypefaceCache, PlatformFontLoader platformFontLoader, Function1<? super TypefaceRequest, ? extends Object> function1) {
        ...
        for (int idx = 0; idx < size; idx++) {
            ...
            if (!FontLoadingStrategy.m5667equalsimpl0(loadingStrategy, FontLoadingStrategy.INSTANCE.m5672getBlockingPKNRLFQ())) {
                if (!FontLoadingStrategy.m5667equalsimpl0(loadingStrategy, FontLoadingStrategy.INSTANCE.m5673getOptionalLocalPKNRLFQ())) {
                    if (!FontLoadingStrategy.m5667equalsimpl0(loadingStrategy, FontLoadingStrategy.INSTANCE.m5671getAsyncPKNRLFQ())) {
                        throw new IllegalStateException("Unknown font type " + font);
                    }
                    AsyncTypefaceCache.AsyncTypefaceResult cacheResult = asyncTypefaceCache.m5636get1ASDuI8(font, platformFontLoader);
                    if (cacheResult == null) {
                    ...
                    } else if (!AsyncTypefaceCache.AsyncTypefaceResult.m5642isPermanentFailureimpl(cacheResult.m5644unboximpl()) && cacheResult.m5644unboximpl() != null) {
                        return TuplesKt.to(asyncFontsToLoad, FontSynthesis_androidKt.m5701synthesizeTypefaceFxwP2eA(typefaceRequest.m5726getFontSynthesisGVVA2EU(), cacheResult.m5644unboximpl(), font, typefaceRequest.getFontWeight(), typefaceRequest.m5725getFontStyle_LCdwA()));
                    }
                } else {
                    ...
                    synchronized (lock$iv$iv) {
                        ...
                        if (priorResult$iv == null) {
                            ...
                            try {
                                ...
                                it$iv = Result.m6478constructorimpl(platformFontLoader.loadBlocking(font));
                            } catch (Throwable th) {
                                Result.Companion companion2 = Result.INSTANCE;
                                it$iv = Result.m6478constructorimpl(ResultKt.createFailure(th));
                            }
                            if (Result.m6484isFailureimpl(it$iv)) {
                                it$iv = null;
                            }
                            AsyncTypefaceCache.put$default(asyncTypefaceCache, font, platformFontLoader, it$iv, false, 8, null);
                            obj = it$iv;
                        } else {
                            obj = priorResult$iv.m5644unboximpl();
                        }
                    }
                    Object result2 = obj;
                    if (result2 != null) {
                        return TuplesKt.to(asyncFontsToLoad, FontSynthesis_androidKt.m5701synthesizeTypefaceFxwP2eA(typefaceRequest.m5726getFontSynthesisGVVA2EU(), result2, font, typefaceRequest.getFontWeight(), typefaceRequest.m5725getFontStyle_LCdwA()));
                    }
                }
            } else {
                ...
                synchronized (lock$iv$iv2) {
                    ...
                    if (priorResult$iv2 == null) {
                        ...
                        result = priorResult$iv2.m5644unboximpl();
                    }
                }
                if (result == null) {
                    throw new IllegalStateException("Unable to load font " + font);
                }
                return TuplesKt.to(asyncFontsToLoad, FontSynthesis_androidKt.m5701synthesizeTypefaceFxwP2eA(typefaceRequest.m5726getFontSynthesisGVVA2EU(), result, font, typefaceRequest.getFontWeight(), typefaceRequest.m5725getFontStyle_LCdwA()));
            }
        }
