...
public final class EditingBuffer {
    ...
    private EditingBuffer(AnnotatedString text, long selection) {
        ...
        this.selectionStart = TextRange.m5569getMinimpl(selection);
        this.selectionEnd = TextRange.m5568getMaximpl(selection);
    ...
    public final TextRange m5729getCompositionMzsxiRA$ui_text_release() {
    ...
    public final long m5730getSelectiond9O1mEE$ui_text_release() {
    ...
    public final void delete$ui_text_release(int start, int end) {
        ...
        long newSelection = EditingBufferKt.m5731updateRangeAfterDeletepWDy79M(TextRangeKt.TextRange(this.selectionStart, this.selectionEnd), deleteRange);
        setSelectionStart(TextRange.m5569getMinimpl(newSelection));
        setSelectionEnd(TextRange.m5568getMaximpl(newSelection));
        if (hasComposition$ui_text_release()) {
            long compositionRange = TextRangeKt.TextRange(this.compositionStart, this.compositionEnd);
            long newComposition = EditingBufferKt.m5731updateRangeAfterDeletepWDy79M(compositionRange, deleteRange);
