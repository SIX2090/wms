...
public final class InputState_androidKt {
    public static final ExtractedText toExtractedText(TextFieldValue textFieldValue) {
        ...
        extractedText.selectionStart = TextRange.m5569getMinimpl(textFieldValue.getSelection());
        extractedText.selectionEnd = TextRange.m5568getMaximpl(textFieldValue.getSelection());
