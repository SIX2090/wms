...
public final class TextFieldValue {
    ...
    private static final Saver<TextFieldValue, Object> Saver = SaverKt.Saver(new Function2<SaverScope, TextFieldValue, Object>() { // from class: androidx.compose.ui.text.input.TextFieldValue$Companion$Saver$1
        ...
        public final Object invoke(SaverScope $this$Saver, TextFieldValue it) {
            return CollectionsKt.arrayListOf(SaversKt.save(it.getText(), SaversKt.getAnnotatedStringSaver(), $this$Saver), SaversKt.save(TextRange.m5559boximpl(it.getSelection()), SaversKt.getSaver(TextRange.INSTANCE), $this$Saver));
        }
    ...
    private TextFieldValue(AnnotatedString annotatedString, long selection, TextRange composition) {
        ...
        this.selection = TextRangeKt.m5577coerceIn8ffj60Q(selection, 0, getText().length());
        this.composition = composition != null ? TextRange.m5559boximpl(TextRangeKt.m5577coerceIn8ffj60Q(composition.getPackedValue(), 0, getText().length())) : null;
    }
    ...
    */
    public /* synthetic */ TextFieldValue(androidx.compose.ui.text.AnnotatedString r7, long r8, androidx.compose.ui.text.TextRange r10, int r11, kotlin.jvm.internal.DefaultConstructorMarker r12) {
        /*
            ...
            long r8 = r8.m5576getZerod9O1mEE()
            r2 = r8
            goto Ld
        Lc:
            r2 = r8
    ...
    public /* synthetic */ TextFieldValue(String str, long j, TextRange textRange, int i, DefaultConstructorMarker defaultConstructorMarker) {
        this((i & 1) != 0 ? "" : str, (i & 2) != 0 ? TextRange.INSTANCE.m5576getZerod9O1mEE() : j, (i & 4) != 0 ? null : textRange, (DefaultConstructorMarker) null);
    }
    ...
    */
    ...
    public static /* synthetic */ TextFieldValue m5804copy3r_uNRQ$default(TextFieldValue textFieldValue, AnnotatedString annotatedString, long j, TextRange textRange, int i, Object obj) {
        if ((i & 1) != 0) {
        ...
        return textFieldValue.m5806copy3r_uNRQ(annotatedString, j, textRange);
    }

    /* renamed from: copy-3r_uNRQ, reason: not valid java name */
    public final TextFieldValue m5806copy3r_uNRQ(AnnotatedString annotatedString, long selection, TextRange composition) {
        return new TextFieldValue(annotatedString, selection, composition, (DefaultConstructorMarker) null);
    }

    /* renamed from: copy-3r_uNRQ$default, reason: not valid java name */
    public static /* synthetic */ TextFieldValue m5805copy3r_uNRQ$default(TextFieldValue textFieldValue, String str, long j, TextRange textRange, int i, Object obj) {
        if ((i & 2) != 0) {
            j = textFieldValue.selection;
        }
        if ((i & 4) != 0) {
        ...
        return textFieldValue.m5807copy3r_uNRQ(str, j, textRange);
    }

    /* renamed from: copy-3r_uNRQ, reason: not valid java name */
    public final TextFieldValue m5807copy3r_uNRQ(String text, long selection, TextRange composition) {
    ...
    public boolean equals(Object other) {
        ...
        if (other instanceof TextFieldValue) {
            return TextRange.m5564equalsimpl0(this.selection, ((TextFieldValue) other).selection) && Intrinsics.areEqual(this.composition, ((TextFieldValue) other).composition) && Intrinsics.areEqual(this.text, ((TextFieldValue) other).text);
        }
        return false;
    }
    ...
    public int hashCode() {
        ...
        int result2 = ((result * 31) + TextRange.m5572hashCodeimpl(this.selection)) * 31;
        TextRange textRange = this.composition;
        return result2 + (textRange != null ? TextRange.m5572hashCodeimpl(textRange.getPackedValue()) : 0);
    }

    public String toString() {
        return "TextFieldValue(text='" + ((Object) this.text) + "', selection=" + ((Object) TextRange.m5574toStringimpl(this.selection)) + ", composition=" + this.composition + ')';
    }
