...
public final class AndroidParagraphHelper_androidKt {
    ...
    public static final CharSequence createCharSequence(String text, float contextFontSize, TextStyle contextTextStyle, List<AnnotatedString.Range<SpanStyle>> list, List<AnnotatedString.Range<Placeholder>> list2, Density density, Function4<? super FontFamily, ? super FontWeight, ? super FontStyle, ? super FontSynthesis, ? extends Typeface> function4, boolean useEmojiCompat) {
        ...
        if (list.isEmpty() && list2.isEmpty() && Intrinsics.areEqual(contextTextStyle.getTextIndent(), TextIndent.INSTANCE.getNone()) && TextUnitKt.m6303isUnspecifiedR2X_6o(contextTextStyle.m5610getLineHeightXSAIIZE())) {
            return currentText;
        }
        ...
        if (isIncludeFontPaddingEnabled(contextTextStyle) && contextTextStyle.getLineHeightStyle() == null) {
            SpannableExtensions_androidKt.m5842setLineHeightr9BaKPg(spannableString, contextTextStyle.m5610getLineHeightXSAIIZE(), contextFontSize, density);
        } else {
            ...
            SpannableExtensions_androidKt.m5841setLineHeightKmRG4DE(spannableString, contextTextStyle.m5610getLineHeightXSAIIZE(), contextFontSize, density, lineHeightStyle2);
        }
