...
public final class AndroidParagraphIntrinsics implements ParagraphIntrinsics {
    ...
    public AndroidParagraphIntrinsics(String text, TextStyle style, List<AnnotatedString.Range<SpanStyle>> list, List<AnnotatedString.Range<Placeholder>> list2, FontFamily.Resolver fontFamilyResolver, Density density) {
        ...
        this.textDirectionHeuristic = AndroidParagraphIntrinsics_androidKt.m5820resolveTextDirectionHeuristicsHklW4sA(this.style.m5614getTextDirections_7Xco(), this.style.getLocaleList());
        Function4 resolveTypeface = new Function4<FontFamily, FontWeight, FontStyle, FontSynthesis, Typeface>() { // from class: androidx.compose.ui.text.platform.AndroidParagraphIntrinsics$resolveTypeface$1
            ...
            public /* bridge */ /* synthetic */ Typeface invoke(FontFamily fontFamily, FontWeight fontWeight, FontStyle fontStyle, FontSynthesis fontSynthesis) {
                return m5819invokeDPcqOEQ(fontFamily, fontWeight, fontStyle.m5683unboximpl(), fontSynthesis.getValue());
            }

            /* renamed from: invoke-DPcqOEQ, reason: not valid java name */
            public final Typeface m5819invokeDPcqOEQ(FontFamily fontFamily, FontWeight fontWeight, int fontStyle, int fontSynthesis) {
                TypefaceDirtyTrackerLinkedList typefaceDirtyTrackerLinkedList;
                State result = AndroidParagraphIntrinsics.this.getFontFamilyResolver().mo5655resolveDPcqOEQ(fontFamily, fontWeight, fontStyle, fontSynthesis);
