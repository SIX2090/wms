...
public final class AndroidParagraph_androidKt {
    ...
    public static final Paragraph m5823ActualParagraphO3s9Psw(String text, TextStyle style, List<AnnotatedString.Range<SpanStyle>> list, List<AnnotatedString.Range<Placeholder>> list2, int maxLines, boolean ellipsis, long constraints, Density density, FontFamily.Resolver fontFamilyResolver) {
    ...
    public static final Paragraph m5822ActualParagraphhBUhpc(ParagraphIntrinsics paragraphIntrinsics, int maxLines, boolean ellipsis, long constraints) {
