...
public final class AndroidTextPaint extends TextPaint {
    ...
    public final void setShadow(Shadow shadow) {
        if (shadow != null && !Intrinsics.areEqual(this.shadow, shadow)) {
            ...
            if (Intrinsics.areEqual(this.shadow, Shadow.INSTANCE.getNone())) {
                ...
                setShadowLayer(TextPaintExtensions_androidKt.correctBlurRadius(this.shadow.getBlurRadius()), Offset.m3505getXimpl(this.shadow.getOffset()), Offset.m3506getYimpl(this.shadow.getOffset()), ColorKt.m3800toArgb8_81llA(this.shadow.getColor()));
            }
        }
    }

    /* renamed from: setColor-8_81llA, reason: not valid java name */
    public final void m5829setColor8_81llA(long color) {
        if (color != Color.INSTANCE.m3782getUnspecified0d7_KjU()) {
            this.composePaint.mo3625setColor8_81llA(color);
            this.composePaint.setShader(null);
        }
    }

    /* renamed from: setBrush-12SF9DM$default, reason: not valid java name */
    public static /* synthetic */ void m5825setBrush12SF9DM$default(AndroidTextPaint androidTextPaint, Brush brush, long j, float f, int i, Object obj) {
        if ((i & 4) != 0) {
            f = Float.NaN;
        }
        androidTextPaint.m5828setBrush12SF9DM(brush, j, f);
    }

    /* JADX WARN: Code restructure failed: missing block: B:10:0x0049, code lost:
    
        r8.mo3693applyToPq9zytI(r9, r0, r1);
     */
    ...
    /* JADX WARN: Code restructure failed: missing block: B:20:0x002f, code lost:
        ...
        if ((r9 != androidx.compose.ui.geometry.Size.INSTANCE.m3582getUnspecifiedNHjbRc()) != false) goto L17;
     */
    /* JADX WARN: Code restructure failed: missing block: B:6:0x001b, code lost:
    
        if ((r3 != androidx.compose.ui.graphics.Color.INSTANCE.m3782getUnspecified0d7_KjU() ? 1 : 0) == 0) goto L9;
     */
    ...
    */
    public final void m5828setBrush12SF9DM(androidx.compose.ui.graphics.Brush r8, long r9, float r11) {
        /*
            r7 = this;
        ...
        L1d:
            ...
            long r5 = r5.m3582getUnspecifiedNHjbRc()
            int r5 = (r3 > r5 ? 1 : (r3 == r5 ? 0 : -1))
            if (r5 == 0) goto L2e
            goto L2f
        L2e:
        ...
        L55:
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: androidx.compose.ui.text.platform.AndroidTextPaint.m5828setBrush12SF9DM(androidx.compose.ui.graphics.Brush, long, float):void");
    }
    ...
    public final void setDrawStyle(DrawStyle drawStyle) {
        if (drawStyle != null && !Intrinsics.areEqual(this.drawStyle, drawStyle)) {
            ...
            if (Intrinsics.areEqual(drawStyle, Fill.INSTANCE)) {
                this.composePaint.mo3629setStylek9PVt8s(PaintingStyle.INSTANCE.m4013getFillTiuSbCo());
                return;
            }
            if (drawStyle instanceof Stroke) {
                this.composePaint.mo3629setStylek9PVt8s(PaintingStyle.INSTANCE.m4014getStrokeTiuSbCo());
                ...
                this.composePaint.mo3628setStrokeJoinWw9F2mQ(((Stroke) drawStyle).getJoin());
                this.composePaint.mo3627setStrokeCapBeK7IIE(((Stroke) drawStyle).getCap());
    ...
    public final int m5826getBlendMode0nO6VwU() {
        return this.composePaint.get_blendMode();
    }

    /* renamed from: setBlendMode-s9anfk8, reason: not valid java name */
    public final void m5827setBlendModes9anfk8(int i) {
        this.composePaint.mo3624setBlendModes9anfk8(i);
    }
}
