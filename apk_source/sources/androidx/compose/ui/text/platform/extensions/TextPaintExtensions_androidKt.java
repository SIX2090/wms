...
public final class TextPaintExtensions_androidKt {
    ...
    public static final SpanStyle applySpanStyle(AndroidTextPaint $this$applySpanStyle, SpanStyle style, Function4<? super FontFamily, ? super FontWeight, ? super FontStyle, ? super FontSynthesis, ? extends Typeface> function4, Density density, boolean requiresLetterSpacing) {
        long m6284getTypeUIouoOA = TextUnit.m6284getTypeUIouoOA(style.getFontSize());
        if (TextUnitType.m6313equalsimpl0(m6284getTypeUIouoOA, TextUnitType.INSTANCE.m6318getSpUIouoOA())) {
            $this$applySpanStyle.setTextSize(density.mo312toPxR2X_6o(style.getFontSize()));
        } else if (TextUnitType.m6313equalsimpl0(m6284getTypeUIouoOA, TextUnitType.INSTANCE.m6317getEmUIouoOA())) {
            $this$applySpanStyle.setTextSize($this$applySpanStyle.getTextSize() * TextUnit.m6285getValueimpl(style.getFontSize()));
        }
        if (hasFontAttributes(style)) {
            ...
            $this$applySpanStyle.setTypeface(function4.invoke(fontFamily, fontWeight, m5677boximpl, FontSynthesis.m5688boximpl(fontSynthesis != null ? fontSynthesis.getValue() : FontSynthesis.INSTANCE.m5697getAllGVVA2EU())));
        }
        ...
        $this$applySpanStyle.m5829setColor8_81llA(style.m5530getColor0d7_KjU());
        $this$applySpanStyle.m5828setBrush12SF9DM(style.getBrush(), Size.INSTANCE.m3582getUnspecifiedNHjbRc(), style.getAlpha());
        ...
        if (TextUnitType.m6313equalsimpl0(TextUnit.m6284getTypeUIouoOA(style.getLetterSpacing()), TextUnitType.INSTANCE.m6318getSpUIouoOA())) {
            if (!(TextUnit.m6285getValueimpl(style.getLetterSpacing()) == 0.0f)) {
                float emWidth = $this$applySpanStyle.getTextSize() * $this$applySpanStyle.getTextScaleX();
                float letterSpacingPx = density.mo312toPxR2X_6o(style.getLetterSpacing());
                if (!(emWidth == 0.0f)) {
                    $this$applySpanStyle.setLetterSpacing(letterSpacingPx / emWidth);
                }
                return m5843generateFallbackSpanStyle62GTOB8(style.getLetterSpacing(), requiresLetterSpacing, style.getBackground(), style.getBaselineShift());
            }
        }
        if (TextUnitType.m6313equalsimpl0(TextUnit.m6284getTypeUIouoOA(style.getLetterSpacing()), TextUnitType.INSTANCE.m6317getEmUIouoOA())) {
            $this$applySpanStyle.setLetterSpacing(TextUnit.m6285getValueimpl(style.getLetterSpacing()));
        }
        return m5843generateFallbackSpanStyle62GTOB8(style.getLetterSpacing(), requiresLetterSpacing, style.getBackground(), style.getBaselineShift());
    }
    ...
    /* JADX WARN: Code restructure failed: missing block: B:17:0x0053, code lost:
        ...
        if (androidx.compose.ui.text.style.BaselineShift.m5851equalsimpl0(r36.m5854unboximpl(), androidx.compose.ui.text.style.BaselineShift.INSTANCE.m5858getNoney9eOQZs()) == false) goto L24;
     */
    ...
    */
    private static final androidx.compose.ui.text.SpanStyle m5843generateFallbackSpanStyle62GTOB8(long r31, boolean r33, long r34, androidx.compose.ui.text.style.BaselineShift r36) {
        /*
            r0 = r34
            r2 = 1
            r3 = 0
            if (r33 == 0) goto L26
            long r4 = androidx.compose.ui.unit.TextUnit.m6284getTypeUIouoOA(r31)
            androidx.compose.ui.unit.TextUnitType$Companion r6 = androidx.compose.ui.unit.TextUnitType.INSTANCE
            long r6 = r6.m6318getSpUIouoOA()
            boolean r4 = androidx.compose.ui.unit.TextUnitType.m6313equalsimpl0(r4, r6)
            if (r4 == 0) goto L26
            float r4 = androidx.compose.ui.unit.TextUnit.m6285getValueimpl(r31)
            r5 = 0
        ...
        L27:
            ...
            long r5 = r5.m3782getUnspecified0d7_KjU()
            boolean r5 = androidx.compose.ui.graphics.Color.m3747equalsimpl0(r0, r5)
            if (r5 != 0) goto L42
            androidx.compose.ui.graphics.Color$Companion r5 = androidx.compose.ui.graphics.Color.INSTANCE
            long r5 = r5.m3781getTransparent0d7_KjU()
            boolean r5 = androidx.compose.ui.graphics.Color.m3747equalsimpl0(r0, r5)
            if (r5 != 0) goto L42
            r5 = r2
            goto L43
        ...
        L43:
            ...
            float r6 = r6.m5858getNoney9eOQZs()
            float r7 = r36.m5854unboximpl()
            boolean r6 = androidx.compose.ui.text.style.BaselineShift.m5851equalsimpl0(r7, r6)
            if (r6 != 0) goto L56
            goto L57
        L56:
            r2 = r3
        ...
        L64:
            ...
            long r6 = r6.m6296getUnspecifiedXSAIIZE()
            r18 = r6
        L6c:
            if (r5 == 0) goto L71
            r23 = r0
        ...
        L71:
            ...
            long r6 = r6.m3782getUnspecified0d7_KjU()
            r23 = r6
        L79:
            if (r2 == 0) goto L7e
            r20 = r36
        ...
        La6:
            return r3
        */
        throw new UnsupportedOperationException("Method not decompiled: androidx.compose.ui.text.platform.extensions.TextPaintExtensions_androidKt.m5843generateFallbackSpanStyle62GTOB8(long, boolean, long, androidx.compose.ui.text.style.BaselineShift):androidx.compose.ui.text.SpanStyle");
    }
    ...
    public static final void setTextMotion(AndroidTextPaint $this$setTextMotion, TextMotion textMotion) {
        ...
        if (TextMotion.Linearity.m5996equalsimpl0(linearity, TextMotion.Linearity.INSTANCE.m6001getLinear4e0Vf04())) {
            $this$setTextMotion.setFlags($this$setTextMotion.getFlags() | 64);
            $this$setTextMotion.setHinting(0);
        } else if (TextMotion.Linearity.m5996equalsimpl0(linearity, TextMotion.Linearity.INSTANCE.m6000getFontHinting4e0Vf04())) {
            $this$setTextMotion.getFlags();
            $this$setTextMotion.setHinting(1);
        } else if (TextMotion.Linearity.m5996equalsimpl0(linearity, TextMotion.Linearity.INSTANCE.m6002getNone4e0Vf04())) {
            $this$setTextMotion.getFlags();
            $this$setTextMotion.setHinting(0);
        } else {
            $this$setTextMotion.getFlags();
