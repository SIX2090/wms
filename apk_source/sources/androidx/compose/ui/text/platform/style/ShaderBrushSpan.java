...
public final class ShaderBrushSpan extends CharacterStyle implements UpdateAppearance {
    ...
    private final MutableState size = SnapshotStateKt__SnapshotStateKt.mutableStateOf$default(Size.m3562boximpl(Size.INSTANCE.m3582getUnspecifiedNHjbRc()), null, 2, null);
    private final State<Shader> shaderState = SnapshotStateKt.derivedStateOf(new Function0<Shader>() { // from class: androidx.compose.ui.text.platform.style.ShaderBrushSpan$shaderState$1
        ...
        public final Shader invoke() {
            long $this$isUnspecified$iv = ShaderBrushSpan.this.m5846getSizeNHjbRc();
            if (($this$isUnspecified$iv == Size.INSTANCE.m3582getUnspecifiedNHjbRc()) || Size.m3576isEmptyimpl(ShaderBrushSpan.this.m5846getSizeNHjbRc())) {
                return null;
            }
            return ShaderBrushSpan.this.getShaderBrush().mo3715createShaderuvyYCjk(ShaderBrushSpan.this.m5846getSizeNHjbRc());
        }
    });
