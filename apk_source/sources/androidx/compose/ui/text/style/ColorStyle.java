...
final /* data */ class ColorStyle implements TextForegroundStyle {
    ...
    public static /* synthetic */ ColorStyle m5863copy8_81llA$default(ColorStyle colorStyle, long j, int i, Object obj) {
        if ((i & 1) != 0) {
            j = colorStyle.value;
        }
        return colorStyle.m5865copy8_81llA(j);
    }
    ...
    public final ColorStyle m5865copy8_81llA(long value) {
    ...
    public boolean equals(Object other) {
        ...
        return (other instanceof ColorStyle) && Color.m3747equalsimpl0(this.value, ((ColorStyle) other).value);
    }

    public int hashCode() {
        return Color.m3753hashCodeimpl(this.value);
    }

    public String toString() {
        return "ColorStyle(value=" + ((Object) Color.m3754toStringimpl(this.value)) + ')';
    }
    ...
    public final long m5866getValue0d7_KjU() {
        return this.value;
    }

    @Override // androidx.compose.ui.text.style.TextForegroundStyle
    /* renamed from: getColor-0d7_KjU */
    public long mo5862getColor0d7_KjU() {
        return this.value;
    }
    ...
    public float getAlpha() {
        return Color.m3748getAlphaimpl(mo5862getColor0d7_KjU());
    }
}
