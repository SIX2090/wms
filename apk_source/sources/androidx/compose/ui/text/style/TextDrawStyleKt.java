...
public final class TextDrawStyleKt {
    public static final TextForegroundStyle lerp(TextForegroundStyle start, TextForegroundStyle stop, float fraction) {
        if (!(start instanceof BrushStyle) && !(stop instanceof BrushStyle)) {
            return TextForegroundStyle.INSTANCE.m5985from8_81llA(ColorKt.m3797lerpjxsXWHM(start.mo5862getColor0d7_KjU(), stop.mo5862getColor0d7_KjU(), fraction));
        }
        if ((start instanceof BrushStyle) && (stop instanceof BrushStyle)) {
    ...
    public static final long m5984modulateDxMtmZc(long $this$modulate_u2dDxMtmZc, float alpha) {
        long m3744copywmQWz5c;
        if (Float.isNaN(alpha) || alpha >= 1.0f) {
            return $this$modulate_u2dDxMtmZc;
        }
        m3744copywmQWz5c = Color.m3744copywmQWz5c($this$modulate_u2dDxMtmZc, (r12 & 1) != 0 ? Color.m3748getAlphaimpl($this$modulate_u2dDxMtmZc) : Color.m3748getAlphaimpl($this$modulate_u2dDxMtmZc) * alpha, (r12 & 2) != 0 ? Color.m3752getRedimpl($this$modulate_u2dDxMtmZc) : 0.0f, (r12 & 4) != 0 ? Color.m3751getGreenimpl($this$modulate_u2dDxMtmZc) : 0.0f, (r12 & 8) != 0 ? Color.m3749getBlueimpl($this$modulate_u2dDxMtmZc) : 0.0f);
