...
public interface TextForegroundStyle {
    ...
    public static final class Companion {
        ...
        public final TextForegroundStyle m5985from8_81llA(long color) {
            return (color > Color.INSTANCE.m3782getUnspecified0d7_KjU() ? 1 : (color == Color.INSTANCE.m3782getUnspecified0d7_KjU() ? 0 : -1)) != 0 ? new ColorStyle(color, null) : Unspecified.INSTANCE;
        }
        ...
        public final TextForegroundStyle from(Brush brush, float alpha) {
            ...
            if (brush instanceof SolidColor) {
                return m5985from8_81llA(TextDrawStyleKt.m5984modulateDxMtmZc(((SolidColor) brush).getValue(), alpha));
            }
