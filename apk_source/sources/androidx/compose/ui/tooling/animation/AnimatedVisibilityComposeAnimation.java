...
public final class AnimatedVisibilityComposeAnimation implements ComposeAnimation {
    ...
    private final Set<AnimatedVisibilityState> states = SetsKt.setOf((Object[]) new AnimatedVisibilityState[]{AnimatedVisibilityState.m6029boximpl(AnimatedVisibilityState.INSTANCE.m6036getEnterjXw82LU()), AnimatedVisibilityState.m6029boximpl(AnimatedVisibilityState.INSTANCE.m6037getExitjXw82LU())});
    ...
    public Transition<Boolean> m6022getAnimationObject() {
    ...
    public final Transition<Object> getChildTransition() {
        Object orNull = CollectionsKt.getOrNull(m6022getAnimationObject().getTransitions(), 0);
