...
public final class TransitionClock<T> implements ComposeAnimationClock<TransitionBasedAnimation<T>, TargetState<T>> {
    ...
    private TargetState<T> state = new TargetState<>(getAnimation().m6021getAnimationObject().getCurrentState(), getAnimation().m6021getAnimationObject().getTargetState());
    ...
    public List<ComposeAnimatedProperty> getAnimatedProperties() {
        Iterable $this$mapNotNull$iv = Utils_androidKt.allAnimations(getAnimation().m6021getAnimationObject());
    ...
    public long getMaxDurationPerIteration() {
        return Utils_androidKt.nanosToMillis(getAnimation().m6021getAnimationObject().getTotalDurationNanos());
    }
    ...
    public List<TransitionInfo> getTransitions(long stepMillis) {
        Transition transition = getAnimation().m6021getAnimationObject();
    ...
    public void setClockTime(long animationTimeNanos) {
        getAnimation().m6021getAnimationObject().seek(getState().getInitial(), getState().getTarget(), animationTimeNanos);
    }
}
