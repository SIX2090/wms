...
public final class SlotTreeKt {
    ...
    */
    ...
    public static final IntRect boundsOfLayoutNode(LayoutInfo node) {
        ...
        long size = coordinates.mo5023getSizeYbymL2g();
        int left = MathKt.roundToInt(Offset.m3505getXimpl(position));
        int top = MathKt.roundToInt(Offset.m3506getYimpl(position));
        int right = IntSize.m6264getWidthimpl(size) + left;
        int bottom = IntSize.m6263getHeightimpl(size) + top;
                    ...
                    if (blockField != null && (block = blockField.get(recomposeScope)) != null) {
                        ...
                        while (i4 < size) {
                            ...
                            if (metadata.getSortedIndex() >= fields2.size()) {
                                ...
                                Intrinsics.checkNotNullExpressionValue(substring, "this as java.lang.String).substring(startIndex)");
                                parameters.add(new ParameterInformation(substring, value, fromDefault, z, compared && !fromDefault, metadata.getInlineClass(), stable));
                            }
                            i4++;
                            fields2 = fields;
                            block = block2;
