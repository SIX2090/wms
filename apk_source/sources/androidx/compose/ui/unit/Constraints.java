...
public final class Constraints {
    ...
    public static final /* synthetic */ Constraints m6038boximpl(long j) {
        return new Constraints(j);
    }

    /* renamed from: constructor-impl, reason: not valid java name */
    public static long m6039constructorimpl(long j) {
        return j;
    }
    ...
    public static int m6053hashCodeimpl(long j) {
    ...
    private static final int m6044getFocusIndeximpl(long arg0) {
        return (int) (3 & arg0);
    }

    /* renamed from: getMinWidth-impl, reason: not valid java name */
    public static final int m6052getMinWidthimpl(long arg0) {
        int mask = WidthMask[m6044getFocusIndeximpl(arg0)];
        return ((int) (arg0 >> MinFocusHeight)) & mask;
    }

    /* renamed from: getMaxWidth-impl, reason: not valid java name */
    public static final int m6050getMaxWidthimpl(long arg0) {
        int mask = WidthMask[m6044getFocusIndeximpl(arg0)];
    ...
    public static final int m6051getMinHeightimpl(long arg0) {
        int focus = m6044getFocusIndeximpl(arg0);
    ...
    public static final int m6049getMaxHeightimpl(long arg0) {
        int focus = m6044getFocusIndeximpl(arg0);
        int mask = HeightMask[focus];
    ...
    public static final boolean m6046getHasBoundedWidthimpl(long arg0) {
        int mask = WidthMask[m6044getFocusIndeximpl(arg0)];
        return (((int) (arg0 >> 33)) & mask) != 0;
    }

    /* renamed from: getHasBoundedHeight-impl, reason: not valid java name */
    public static final boolean m6045getHasBoundedHeightimpl(long arg0) {
        int focus = m6044getFocusIndeximpl(arg0);
        int mask = HeightMask[focus];
        int offset = MinHeightOffsets[focus] + 31;
    ...
    public static final boolean m6048getHasFixedWidthimpl(long arg0) {
        return m6050getMaxWidthimpl(arg0) == m6052getMinWidthimpl(arg0);
    }

    /* renamed from: getHasFixedHeight-impl, reason: not valid java name */
    public static final boolean m6047getHasFixedHeightimpl(long arg0) {
        return m6049getMaxHeightimpl(arg0) == m6051getMinHeightimpl(arg0);
    }

    /* renamed from: isZero-impl, reason: not valid java name */
    public static final boolean m6054isZeroimpl(long arg0) {
        return m6050getMaxWidthimpl(arg0) == 0 || m6049getMaxHeightimpl(arg0) == 0;
    }

    /* renamed from: copy-Zbe2FdA, reason: not valid java name */
    public static final long m6040copyZbe2FdA(long arg0, int minWidth, int maxWidth, int minHeight, int maxHeight) {
        boolean z = true;
        ...
        return INSTANCE.m6057createConstraintsZbe2FdA$ui_unit_release(minWidth, maxWidth, minHeight, maxHeight);
    }
    ...
    public static String m6055toStringimpl(long arg0) {
        int maxWidth = m6050getMaxWidthimpl(arg0);
        String maxWidthStr = maxWidth == Integer.MAX_VALUE ? "Infinity" : String.valueOf(maxWidth);
        int maxHeight = m6049getMaxHeightimpl(arg0);
        String maxHeightStr = maxHeight != Integer.MAX_VALUE ? String.valueOf(maxHeight) : "Infinity";
        return "Constraints(minWidth = " + m6052getMinWidthimpl(arg0) + ", maxWidth = " + maxWidthStr + ", minHeight = " + m6051getMinHeightimpl(arg0) + ", maxHeight = " + maxHeightStr + ')';
    }
    ...
    public static final class Companion {
        ...
        public final long m6058fixedJhjzzOo(int width, int height) {
            if (!(width >= 0 && height >= 0)) {
                throw new IllegalArgumentException(("width(" + width + ") and height(" + height + ") must be >= 0").toString());
            }
            return m6057createConstraintsZbe2FdA$ui_unit_release(width, width, height, height);
        }

        /* renamed from: fixedWidth-OenEA2s, reason: not valid java name */
        public final long m6060fixedWidthOenEA2s(int width) {
            if (width >= 0) {
                return m6057createConstraintsZbe2FdA$ui_unit_release(width, width, 0, Integer.MAX_VALUE);
            }
            throw new IllegalArgumentException(("width(" + width + ") must be >= 0").toString());
        }

        /* renamed from: fixedHeight-OenEA2s, reason: not valid java name */
        public final long m6059fixedHeightOenEA2s(int height) {
            if (height >= 0) {
                return m6057createConstraintsZbe2FdA$ui_unit_release(0, Integer.MAX_VALUE, height, height);
            }
            throw new IllegalArgumentException(("height(" + height + ") must be >= 0").toString());
        }

        /* renamed from: createConstraints-Zbe2FdA$ui_unit_release, reason: not valid java name */
        public final long m6057createConstraintsZbe2FdA$ui_unit_release(int minWidth, int maxWidth, int minHeight, int maxHeight) {
            long focus;
            ...
            return Constraints.m6039constructorimpl(value);
        }
