...
public final /* data */ class IntRect {
    ...
    public final IntRect m6252translategyyYBs(long offset) {
        return new IntRect(this.left + IntOffset.m6222getXimpl(offset), this.top + IntOffset.m6223getYimpl(offset), this.right + IntOffset.m6222getXimpl(offset), this.bottom + IntOffset.m6223getYimpl(offset));
    }
    ...
    public final boolean m6241containsgyyYBs(long offset) {
        return IntOffset.m6222getXimpl(offset) >= this.left && IntOffset.m6222getXimpl(offset) < this.right && IntOffset.m6223getYimpl(offset) >= this.top && IntOffset.m6223getYimpl(offset) < this.bottom;
    }
