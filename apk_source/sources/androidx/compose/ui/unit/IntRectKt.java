...
public final class IntRectKt {
    ...
    public static final IntRect m6254IntRectVbeCjmY(long offset, long size) {
        return new IntRect(IntOffset.m6222getXimpl(offset), IntOffset.m6223getYimpl(offset), IntOffset.m6222getXimpl(offset) + IntSize.m6264getWidthimpl(size), IntOffset.m6223getYimpl(offset) + IntSize.m6263getHeightimpl(size));
    }

    /* renamed from: IntRect-E1MhUcY, reason: not valid java name */
    public static final IntRect m6253IntRectE1MhUcY(long topLeft, long bottomRight) {
        return new IntRect(IntOffset.m6222getXimpl(topLeft), IntOffset.m6223getYimpl(topLeft), IntOffset.m6222getXimpl(bottomRight), IntOffset.m6223getYimpl(bottomRight));
    }

    /* renamed from: IntRect-ar5cAso, reason: not valid java name */
    public static final IntRect m6255IntRectar5cAso(long center, int radius) {
        return new IntRect(IntOffset.m6222getXimpl(center) - radius, IntOffset.m6223getYimpl(center) - radius, IntOffset.m6222getXimpl(center) + radius, IntOffset.m6223getYimpl(center) + radius);
    }
