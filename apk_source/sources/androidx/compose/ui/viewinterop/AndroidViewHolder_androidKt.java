...
public final class AndroidViewHolder_androidKt {
    ...
    public static final void layoutAccordingTo(View $this$layoutAccordingTo, LayoutNode layoutNode) {
        ...
        int x = MathKt.roundToInt(Offset.m3505getXimpl(position));
        int y = MathKt.roundToInt(Offset.m3506getYimpl(position));
    ...
    public static final int toNestedScrollSource(int type) {
        return type == 0 ? NestedScrollSource.INSTANCE.m4784getDragWNlRxjI() : NestedScrollSource.INSTANCE.m4785getFlingWNlRxjI();
    }
}
