...
public final class AndroidDialog_androidKt {
    public static final void Dialog(final Function0<Unit> function0, DialogProperties dialogProperties, final Function2<? super Composer, ? super Integer, Unit> function2, Composer composer, final int i, final int i2) {
        ...
        if ((i5 & 731) == 146 && startRestartGroup.getSkipping()) {
            ...
            UUID uuid = (UUID) RememberSaveableKt.m3363rememberSaveable(new Object[0], (Saver) null, (String) null, (Function0) new Function0<UUID>() { // from class: androidx.compose.ui.window.AndroidDialog_androidKt$Dialog$dialogId$1
            ...
            EffectsKt.SideEffect(new Function0<Unit>() { // from class: androidx.compose.ui.window.AndroidDialog_androidKt$Dialog$2
                ...
                public final void invoke2() {
                    DialogWrapper.this.updateParameters(function0, dialogProperties3, layoutDirection3);
                }
            }, composer4, 0);
            composer3 = composer4;
            if (ComposerKt.isTraceInProgress()) {
