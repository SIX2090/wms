...
final class AdjustedTimeMark implements TimeMark {
    ...
    public TimeMark mo7795minusLRDsOJo(long duration) {
        return TimeMark.DefaultImpls.m7941minusLRDsOJo(this, duration);
    }

    @Override // kotlin.time.TimeMark
    /* renamed from: elapsedNow-UwyO8pc */
    public long mo7794elapsedNowUwyO8pc() {
        return Duration.m7839minusLRDsOJo(this.mark.mo7794elapsedNowUwyO8pc(), this.adjustment);
    }

    @Override // kotlin.time.TimeMark
    /* renamed from: plus-LRDsOJo */
    public TimeMark mo7797plusLRDsOJo(long duration) {
        return new AdjustedTimeMark(this.mark, Duration.m7840plusLRDsOJo(this.adjustment, duration), null);
    }
}
