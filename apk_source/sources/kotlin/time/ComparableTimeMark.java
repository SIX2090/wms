...
public interface ComparableTimeMark extends TimeMark, Comparable<ComparableTimeMark> {
    ...
    ComparableTimeMark mo7795minusLRDsOJo(long duration);

    /* renamed from: minus-UwyO8pc */
    long mo7796minusUwyO8pc(ComparableTimeMark other);

    @Override // kotlin.time.TimeMark
    /* renamed from: plus-LRDsOJo */
    ComparableTimeMark mo7797plusLRDsOJo(long duration);
    ...
    public static final class DefaultImpls {
        ...
        public static ComparableTimeMark m7799minusLRDsOJo(ComparableTimeMark $this, long duration) {
            return $this.mo7797plusLRDsOJo(Duration.m7857unaryMinusUwyO8pc(duration));
        }

        public static int compareTo(ComparableTimeMark $this, ComparableTimeMark other) {
            Intrinsics.checkNotNullParameter(other, "other");
            return Duration.m7803compareToLRDsOJo($this.mo7796minusUwyO8pc(other), Duration.INSTANCE.m7907getZEROUwyO8pc());
        }
    }
}
