...
public final class MonotonicTimeSource implements TimeSource.WithComparableMarks {
    ...
    public /* bridge */ /* synthetic */ ComparableTimeMark markNow() {
        return TimeSource.Monotonic.ValueTimeMark.m7944boximpl(m7938markNowz9LOYto());
    }
    ...
    public long m7938markNowz9LOYto() {
        return TimeSource.Monotonic.ValueTimeMark.m7947constructorimpl(read());
    }

    /* renamed from: elapsedFrom-6eNON_k, reason: not valid java name */
    public final long m7937elapsedFrom6eNON_k(long timeMark) {
    ...
    public final long m7936differenceBetweenfRLX17w(long one, long another) {
        return LongSaturatedMathKt.saturatingOriginsDiff(one, another, DurationUnit.NANOSECONDS);
    }

    /* renamed from: adjustReading-6QKq23U, reason: not valid java name */
    public final long m7935adjustReading6QKq23U(long timeMark, long duration) {
        return TimeSource.Monotonic.ValueTimeMark.m7947constructorimpl(LongSaturatedMathKt.m7933saturatingAddNuflL3o(timeMark, DurationUnit.NANOSECONDS, duration));
    }
}
