...
public interface TimeMark {
    ...
    TimeMark mo7795minusLRDsOJo(long duration);

    /* renamed from: plus-LRDsOJo */
    TimeMark mo7797plusLRDsOJo(long duration);

    /* compiled from: TimeSource.kt */
    @Metadata(k = 3, mv = {1, 9, 0}, xi = 48)
    public static final class DefaultImpls {
        /* renamed from: plus-LRDsOJo, reason: not valid java name */
        public static TimeMark m7942plusLRDsOJo(TimeMark $this, long duration) {
            return new AdjustedTimeMark($this, duration, null);
        }

        /* renamed from: minus-LRDsOJo, reason: not valid java name */
        public static TimeMark m7941minusLRDsOJo(TimeMark $this, long duration) {
            return $this.mo7797plusLRDsOJo(Duration.m7857unaryMinusUwyO8pc(duration));
        }

        public static boolean hasPassedNow(TimeMark $this) {
            return !Duration.m7837isNegativeimpl($this.mo7794elapsedNowUwyO8pc());
        }
