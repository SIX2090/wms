...
public final class Uuid implements Serializable {
    ...
    private final <T> T toULongs(Function2<? super ULong, ? super ULong, ? extends T> action) {
        Intrinsics.checkNotNullParameter(action, "action");
        return action.invoke(ULong.m6646boximpl(ULong.m6652constructorimpl(getMostSignificantBits())), ULong.m6646boximpl(ULong.m6652constructorimpl(getLeastSignificantBits())));
    }
    ...
    public static final class Companion {
        ...
        public final Uuid m7967fromULongseb3DHEI(long mostSignificantBits, long leastSignificantBits) {
    ...
    public static final int LEXICAL_ORDER$lambda$2(Uuid a, Uuid b) {
        if (a.mostSignificantBits != b.mostSignificantBits) {
            return Long.compareUnsigned(ULong.m6652constructorimpl(a.mostSignificantBits), ULong.m6652constructorimpl(b.mostSignificantBits));
        }
        return Long.compareUnsigned(ULong.m6652constructorimpl(a.leastSignificantBits), ULong.m6652constructorimpl(b.leastSignificantBits));
    }
}
