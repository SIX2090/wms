...
public final class DebugStringsKt {
    ...
    public static final String toDebugString(Continuation<?> continuation) {
        ...
        try {
            ...
            m6478constructorimpl = Result.m6478constructorimpl(continuation + '@' + getHexAddress(continuation));
        } catch (Throwable th) {
            Result.Companion companion2 = Result.INSTANCE;
            m6478constructorimpl = Result.m6478constructorimpl(ResultKt.createFailure(th));
        }
        if (Result.m6481exceptionOrNullimpl(m6478constructorimpl) != null) {
            m6478constructorimpl = continuation.getClass().getName() + '@' + getHexAddress(continuation);
        }
        return (String) m6478constructorimpl;
    }
