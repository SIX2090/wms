...
public final class HandlerDispatcherKt {
    ...
    static {
        ...
        try {
            ...
            m6478constructorimpl = Result.m6478constructorimpl(new HandlerContext(asHandler(Looper.getMainLooper(), true), null, 2, null));
        } catch (Throwable th) {
            Result.Companion companion2 = Result.INSTANCE;
            m6478constructorimpl = Result.m6478constructorimpl(ResultKt.createFailure(th));
        }
        Main = (HandlerDispatcher) (Result.m6484isFailureimpl(m6478constructorimpl) ? null : m6478constructorimpl);
    }
    ...
    public static final Object awaitFrameSlowPath(Continuation<? super Long> continuation) {
        ...
        if (Looper.myLooper() == Looper.getMainLooper()) {
            ...
            Dispatchers.getMain().mo8037dispatch(cont.get$context(), new Runnable() { // from class: kotlinx.coroutines.android.HandlerDispatcherKt$awaitFrameSlowPath$lambda$3$$inlined$Runnable$1
