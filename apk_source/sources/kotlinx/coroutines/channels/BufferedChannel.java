...
public class BufferedChannel<E> implements Channel<E> {
    ...
    public Object mo7985receiveCatchingJP2dKIU(Continuation<? super ChannelResult<? extends E>> continuation) {
        return m7983receiveCatchingJP2dKIU$suspendImpl(this, continuation);
    }
    ...
    public final Object onClosedSend(E e, Continuation<? super Unit> continuation) {
        ...
        if (function1 != null && (it = OnUndeliveredElementKt.callUndeliveredElementCatchingException$default(function1, e, null, 2, null)) != null) {
            ...
            $this$resumeWithStackTrace$iv.resumeWith(Result.m6478constructorimpl(ResultKt.createFailure(undeliveredElementException)));
        } else {
            ...
            $this$resumeWithStackTrace$iv2.resumeWith(Result.m6478constructorimpl(ResultKt.createFailure(th)));
        }
    ...
    */
    ...
    public final void onClosedSendOnNoWaiterSuspend(E element, CancellableContinuation<? super Unit> cont) {
        ...
        Result.Companion companion = Result.INSTANCE;
        cancellableContinuation.resumeWith(Result.m6478constructorimpl(ResultKt.createFailure(exception$iv)));
    }

    @Override // kotlinx.coroutines.channels.SendChannel
    /* renamed from: trySend-JP2dKIU */
    public Object mo7981trySendJP2dKIU(E element) {
        Object waiter$iv;
        ChannelSegment segment$iv;
        ChannelSegment segment$iv2;
        if (shouldSendSuspend(sendersAndCloseStatus$FU.get(this))) {
            return ChannelResult.INSTANCE.m8005failurePtdJZtk();
        }
        ...
        while (true) {
            ...
            if (segment$iv3.id != id$iv) {
                ...
                if (segment$iv4 != null) {
                    ...
                    return ChannelResult.INSTANCE.m8004closedJP2dKIU(getSendException());
                }
            } else {
                segment$iv = segment$iv3;
            }
            ...
            switch (updateCellSend(segment$iv, i$iv, element, $this$sendersCounter$iv$iv, waiter$iv, closed$iv)) {
                case 0:
                    ...
                    return ChannelResult.INSTANCE.m8006successJP2dKIU(Unit.INSTANCE);
                case 1:
                    return ChannelResult.INSTANCE.m8006successJP2dKIU(Unit.INSTANCE);
                case 2:
                    if (closed$iv) {
        ...
        while (true) {
            ...
            if (segment$iv2.id != id$iv) {
                ...
                if (segment$iv3 != null) {
                    ...
                    Result.Companion companion = Result.INSTANCE;
                    cont.resumeWith(Result.m6478constructorimpl(Boxing.boxBoolean(false)));
                } else {
            ...
            switch (bufferedChannel.updateCellSend(segment$iv, i$iv, e, $this$sendersCounter$iv$iv, waiter$iv, closed$iv)) {
                case 0:
                    segment$iv.cleanPrev();
                    Result.Companion companion2 = Result.INSTANCE;
                    cont.resumeWith(Result.m6478constructorimpl(Boxing.boxBoolean(true)));
                    break;
                case 1:
    ...
    private final boolean tryResumeReceiver(Object $this$tryResumeReceiver, E e) {
        ...
        if ($this$tryResumeReceiver instanceof ReceiveCatching) {
            ...
            ChannelResult m7991boximpl = ChannelResult.m7991boximpl(ChannelResult.INSTANCE.m8006successJP2dKIU(e));
            Function1<E, Unit> function1 = this.onUndeliveredElement;
            tryResume02 = BufferedChannelKt.tryResume0(cancellableContinuationImpl, m7991boximpl, function1 != null ? OnUndeliveredElementKt.bindCancellationFun(function1, e, ((ReceiveCatching) $this$tryResumeReceiver).cont.getContext()) : null);
            return tryResume02;
        }
    ...
    public final void onClosedReceiveOnNoWaiterSuspend(CancellableContinuation<? super E> cont) {
        Result.Companion companion = Result.INSTANCE;
        cont.resumeWith(Result.m6478constructorimpl(ResultKt.createFailure(getReceiveException())));
    }
    ...
    /*
        ...
        To view partially-correct add '--show-bad-code' argument
    */
    static /* synthetic */ <E> java.lang.Object m7983receiveCatchingJP2dKIU$suspendImpl(kotlinx.coroutines.channels.BufferedChannel<E> r17, kotlin.coroutines.Continuation<? super kotlinx.coroutines.channels.ChannelResult<? extends E>> r18) {
        /*
            Method dump skipped, instructions count: 240
            To view this dump add '--comments-level debug' option
        */
        throw new UnsupportedOperationException("Method not decompiled: kotlinx.coroutines.channels.BufferedChannel.m7983receiveCatchingJP2dKIU$suspendImpl(kotlinx.coroutines.channels.BufferedChannel, kotlin.coroutines.Continuation):java.lang.Object");
    }
    ...
    /*
        ...
        To view partially-correct add '--show-bad-code' argument
    */
    public final java.lang.Object m7984receiveCatchingOnNoWaiterSuspendGKJJFZk(kotlinx.coroutines.channels.ChannelSegment<E> r28, int r29, long r30, kotlin.coroutines.Continuation<? super kotlinx.coroutines.channels.ChannelResult<? extends E>> r32) {
        /*
            Method dump skipped, instructions count: 444
            To view this dump add '--comments-level debug' option
        */
        throw new UnsupportedOperationException("Method not decompiled: kotlinx.coroutines.channels.BufferedChannel.m7984receiveCatchingOnNoWaiterSuspendGKJJFZk(kotlinx.coroutines.channels.ChannelSegment, int, long, kotlin.coroutines.Continuation):java.lang.Object");
    }

    /* JADX INFO: Access modifiers changed from: private */
    public final void onClosedReceiveCatchingOnNoWaiterSuspend(CancellableContinuation<? super ChannelResult<? extends E>> cont) {
        Result.Companion companion = Result.INSTANCE;
        cont.resumeWith(Result.m6478constructorimpl(ChannelResult.m7991boximpl(ChannelResult.INSTANCE.m8004closedJP2dKIU(getCloseCause()))));
    }

    /* JADX WARN: Multi-variable type inference failed */
    @Override // kotlinx.coroutines.channels.ReceiveChannel
    /* renamed from: tryReceive-PtdJZtk, reason: not valid java name */
    public Object mo7986tryReceivePtdJZtk() {
        Object waiter$iv;
        ChannelSegment segment$iv;
        Symbol symbol;
        Symbol symbol2;
        ...
        if (isClosedForReceive0(sendersAndCloseStatusCur)) {
            return ChannelResult.INSTANCE.m8004closedJP2dKIU(getCloseCause());
        }
        long $this$sendersCounter$iv = sendersAndCloseStatusCur & 1152921504606846975L;
        ...
        while (!isClosedForReceive()) {
            ...
            if (updCellResult$iv != symbol) {
                ...
                if (updCellResult$iv != symbol2) {
                    ...
                    segment$iv4.cleanPrev();
                    return ChannelResult.INSTANCE.m8006successJP2dKIU(updCellResult$iv);
                }
    ...
    public final Object processResultSelectReceiveCatching(Object ignoredParam, Object selectResult) {
        return ChannelResult.m7991boximpl(selectResult == BufferedChannelKt.getCHANNEL_CLOSED() ? ChannelResult.INSTANCE.m8004closedJP2dKIU(getCloseCause()) : ChannelResult.INSTANCE.m8006successJP2dKIU(selectResult));
    }
    ...
    private final class BufferedChannelIterator implements ChannelIterator<E>, Waiter {
        ...
        public final void onClosedHasNextNoWaiterSuspend() {
            ...
            if (cause == null) {
                Result.Companion companion = Result.INSTANCE;
                cont.resumeWith(Result.m6478constructorimpl(false));
                return;
            }
            ...
            Result.Companion companion2 = Result.INSTANCE;
            cancellableContinuationImpl.resumeWith(Result.m6478constructorimpl(ResultKt.createFailure(th)));
        }
    ...
    */
    ...
    private final void cancelSuspendedReceiveRequests(ChannelSegment<E> lastSegment, long sendersCounter) {
        Symbol symbol;
        Object suspendedReceivers = InlineList.m8028constructorimpl$default(null, 1, null);
                        ...
                        if (state != symbol) {
                            if (state instanceof WaiterEB) {
                                if (segment.casState$kotlinx_coroutines_core(index, state, BufferedChannelKt.getCHANNEL_CLOSED())) {
                                    suspendedReceivers = InlineList.m8033plusFjFbRPM(suspendedReceivers, ((WaiterEB) state).waiter);
                                    segment.onCancelledRequest(index, true);
                                    break;
                                }
                            } else {
                                ...
                                if (segment.casState$kotlinx_coroutines_core(index, state, BufferedChannelKt.getCHANNEL_CLOSED())) {
                                    suspendedReceivers = InlineList.m8033plusFjFbRPM(suspendedReceivers, state);
                                    segment.onCancelledRequest(index, true);
                                    break;
                                }
                            }
    ...
    private final void resumeWaiterOnClosedChannel(Waiter $this$resumeWaiterOnClosedChannel, boolean receiver) {
        if (!($this$resumeWaiterOnClosedChannel instanceof SendBroadcast)) {
            if (!($this$resumeWaiterOnClosedChannel instanceof CancellableContinuation)) {
                ...
                Result.Companion companion = Result.INSTANCE;
                cancellableContinuationImpl.resumeWith(Result.m6478constructorimpl(ChannelResult.m7991boximpl(ChannelResult.INSTANCE.m8004closedJP2dKIU(getCloseCause()))));
                return;
            }
            Continuation continuation = (Continuation) $this$resumeWaiterOnClosedChannel;
            Result.Companion companion2 = Result.INSTANCE;
            continuation.resumeWith(Result.m6478constructorimpl(ResultKt.createFailure(receiver ? getReceiveException() : getSendException())));
            return;
        }
    ...
    public final ChannelSegment<E> findSegmentSend(long id, ChannelSegment<E> startFrom) {
        ...
        while (true) {
            ...
            if (SegmentOrClosed.m8045isClosedimpl(s$iv)) {
                break;
            }
            Segment to$iv$iv = SegmentOrClosed.m8043getSegmentimpl(s$iv);
            while (true) {
        ...
        ChannelSegment segment = (ChannelSegment) SegmentOrClosed.m8043getSegmentimpl(s$iv);
        if (segment.id > id) {
    ...
    public final ChannelSegment<E> findSegmentReceive(long id, ChannelSegment<E> startFrom) {
        ...
        Object it = s$iv;
        if (SegmentOrClosed.m8045isClosedimpl(it)) {
            completeCloseOrCancel();
        ...
        ChannelSegment segment = (ChannelSegment) SegmentOrClosed.m8043getSegmentimpl(it);
