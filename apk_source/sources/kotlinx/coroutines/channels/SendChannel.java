...
public interface SendChannel<E> {
    ...
    Object mo7981trySendJP2dKIU(E element);
    ...
    public static final class DefaultImpls {
        ...
        public static <E> boolean offer(SendChannel<? super E> sendChannel, E e) {
            Object result = sendChannel.mo7981trySendJP2dKIU(e);
            if (ChannelResult.m8001isSuccessimpl(result)) {
                return true;
            }
            Throwable m7995exceptionOrNullimpl = ChannelResult.m7995exceptionOrNullimpl(result);
