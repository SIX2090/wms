...
public final class AgentPremain {
    ...
    static {
        ...
        try {
            ...
            m6478constructorimpl = Result.m6478constructorimpl(property != null ? Boolean.valueOf(Boolean.parseBoolean(property)) : null);
        } catch (Throwable th) {
            Result.Companion companion2 = Result.INSTANCE;
            m6478constructorimpl = Result.m6478constructorimpl(ResultKt.createFailure(th));
        }
        Boolean bool = (Boolean) (Result.m6484isFailureimpl(m6478constructorimpl) ? null : m6478constructorimpl);
