...
public final class ExceptionsConstructorKt {
    ...
    public static final <E extends Throwable> E tryCopyException(E e) {
        ...
        if (e instanceof CopyableThrowable) {
            try {
                ...
                m6478constructorimpl = Result.m6478constructorimpl(((CopyableThrowable) e).createCopy());
            } catch (Throwable th) {
                Result.Companion companion2 = Result.INSTANCE;
                m6478constructorimpl = Result.m6478constructorimpl(ResultKt.createFailure(th));
            }
            if (Result.m6484isFailureimpl(m6478constructorimpl)) {
                m6478constructorimpl = null;
            }
            return (E) m6478constructorimpl;
        }
        ...
        return new Function1<Throwable, Throwable>() { // from class: kotlinx.coroutines.internal.ExceptionsConstructorKt$safeCtor$1
            ...
            public final Throwable invoke(Throwable e) {
                ...
                try {
                    ...
                    m6478constructorimpl = Result.m6478constructorimpl((Intrinsics.areEqual(e.getMessage(), result.getMessage()) || Intrinsics.areEqual(result.getMessage(), e.toString())) ? result : null);
                } catch (Throwable th) {
                    Result.Companion companion2 = Result.INSTANCE;
                    m6478constructorimpl = Result.m6478constructorimpl(ResultKt.createFailure(th));
                }
                return (Throwable) (Result.m6484isFailureimpl(m6478constructorimpl) ? null : m6478constructorimpl);
            }
        };
    }
    ...
    private static final int fieldsCountOrDefault(Class<?> cls, int defaultValue) {
        ...
        try {
            Result.Companion companion = Result.INSTANCE;
            m6478constructorimpl = Result.m6478constructorimpl(Integer.valueOf(fieldsCount$default(cls, 0, 1, null)));
        } catch (Throwable th) {
            Result.Companion companion2 = Result.INSTANCE;
            m6478constructorimpl = Result.m6478constructorimpl(ResultKt.createFailure(th));
        }
        ...
        if (Result.m6484isFailureimpl(m6478constructorimpl)) {
            m6478constructorimpl = valueOf;
        }
        return ((Number) m6478constructorimpl).intValue();
    }
