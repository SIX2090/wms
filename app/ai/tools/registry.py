...
AI_TOOL_REGISTRY = MappingProxyType({
    ...
    'purchase_followup_agent': _tool('purchase_followup_agent', 'Run a controlled purchase follow-up agent and persist auditable task steps.', 'agent_task', PURCHASE_FOLLOWUP_SCHEMA, confirmation_required=True, handler_name='_ai_run_purchase_followup_agent'),
