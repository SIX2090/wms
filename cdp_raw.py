...
print("FIELDS:", eval_js("""
(function(){
  return JSON.stringify(Array.from(document.querySelectorAll('input')).map(function(i){return {name:i.name,type:i.type,id:i.id};}));
})()
"""))
print("FILL:", eval_js("""
(function(){
...
print("AFTER_BODY:", (eval_js("document.body ? document.body.innerText.slice(0,200) : 'NO_BODY')") or ""))
s.close()