...
def _set_setting(key: str, value: str) -> None:
    ...
    row.value = value
    # BUG-2026-08-23-002 / BUG-2026-09-01-001：请求级缓存同步。
    # 脚本在同一个 app_context 内嵌套多个 test_request_context，Flask 的 g
    # 跨请求上下文共享；若只改库不同步 g._system_setting_cache，后续断言会
    # 读到陈旧值（如 admin_only 被旧 all 遮蔽，AI-STAGE5-OPS-001 回归 FAIL）。
