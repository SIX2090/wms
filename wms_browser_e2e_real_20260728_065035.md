...
| FORM | modal-category | /category 模态字段 | 含 name='name' | has=False | ❌ |
| FORM | modal-unit | /unit 模态字段 | 含 name='name' | has=False | ❌ |
| FORM | modal-supplier | /supplier 模态字段 | 含 name='name' | has=False | ❌ |
| FORM | modal-customer | /customer 模态字段 | 含 name='name' | has=False | ❌ |
| FORM | modal-warehouse | /warehouse 模态字段 | 含 name='name' | has=False | ❌ |
| FORM | modal-department | /department 模态字段 | 含 name='name' | has=False | ❌ |
| FORM | modal-employee | /employee 模态字段 | 含 name='name' | has=False | ❌ |
| FIX | P0-1b-full | P0-1b 完整 ids (1-5) | 占位消失 + 含 5 个材料 + 显示数量 | empty_gone=True has_data=False has_count=False match=none | ❌ |

## 失败项

- **add-transfer** /transfer 工具栏 | expect=含'新增调拨'按钮 | actual=has=False
- **form-material_add** /material/add 字段 | expect=含 name='name' | actual=has=False
...
- **modal-category** /category 模态字段 | expect=含 name='name' | actual=has=False
- **modal-unit** /unit 模态字段 | expect=含 name='name' | actual=has=False
- **modal-supplier** /supplier 模态字段 | expect=含 name='name' | actual=has=False
- **modal-customer** /customer 模态字段 | expect=含 name='name' | actual=has=False
- **modal-warehouse** /warehouse 模态字段 | expect=含 name='name' | actual=has=False
- **modal-department** /department 模态字段 | expect=含 name='name' | actual=has=False
- **modal-employee** /employee 模态字段 | expect=含 name='name' | actual=has=False
- **P0-1b-full** P0-1b 完整 ids (1-5) | expect=占位消失 + 含 5 个材料 + 显示数量 | actual=empty_gone=True has_data=False has_count=False match=none
